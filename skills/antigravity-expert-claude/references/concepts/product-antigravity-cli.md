...
description: Lightweight, terminal-first interface for developers who work in the shell.
...
[Install](/download#antigravity-cli)

![](/assets/image/product/antigravity-cli/hero.png)

## Explore the main features

[](/assets/video/product-page/antigravity-cli/agy-cli-prompt.mp4)
...
![Subagents functionalities](/assets/image/product/antigravity-cli/subagents-functionality.jpg)
