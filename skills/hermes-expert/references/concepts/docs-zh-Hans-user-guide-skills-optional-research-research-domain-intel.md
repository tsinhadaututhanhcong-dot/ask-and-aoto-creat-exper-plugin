# Domain Intel — 使用 Python 标准库进行被动域名侦察 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-domain-intel](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-domain-intel)
...
## 何时使用此 skill 而非内置工具[​](#何时使用此-skill-而非内置工具 "何时使用此 skill 而非内置工具的直接链接")
...
* [辅助脚本](#辅助脚本)
* [可用命令](#可用命令)
* [何时使用此 skill 而非内置工具](#何时使用此-skill-而非内置工具)
* [平台兼容性](#平台兼容性)
* [数据来源](#数据来源)
* [注意事项](#注意事项)