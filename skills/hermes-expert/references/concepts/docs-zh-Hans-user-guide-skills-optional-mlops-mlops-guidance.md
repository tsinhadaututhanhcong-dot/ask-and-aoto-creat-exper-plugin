...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-guidance](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-guidance)
...
### 基础示例：结构化生成[​](#基础示例结构化生成 "基础示例：结构化生成的直接链接")
...
### 使用 Anthropic Claude[​](#使用-anthropic-claude "使用 Anthropic Claude的直接链接")
...
### 1. 上下文管理器[​](#1-上下文管理器 "1. 上下文管理器的直接链接")
...
### 2. 约束生成[​](#2-约束生成 "2. 约束生成的直接链接")

Guidance 使用正则表达式或语法确保输出符合指定模式。

#### 正则表达式约束[​](#正则表达式约束 "正则表达式约束的直接链接")
...
### 3. Token 修复（Token Healing）[​](#3-token-修复token-healing "3. Token 修复（Token Healing）的直接链接")
...
### 4. 基于语法的生成[​](#4-基于语法的生成 "4. 基于语法的生成的直接链接")
...
### 5. Guidance 函数[​](#5-guidance-函数 "5. Guidance 函数的直接链接")
...
### 本地模型（Transformers）[​](#本地模型transformers "本地模型（Transformers）的直接链接")
...
### 本地模型（llama.cpp）[​](#本地模型llamacpp "本地模型（llama.cpp）的直接链接")
...
### 模式 1：JSON 生成[​](#模式-1json-生成 "模式 1：JSON 生成的直接链接")
...
### 模式 3：多步骤推理[​](#模式-3多步骤推理 "模式 3：多步骤推理的直接链接")
...
### 模式 4：ReAct Agent[​](#模式-4react-agent "模式 4：ReAct Agent的直接链接")
...
### 模式 5：数据提取[​](#模式-5数据提取 "模式 5：数据提取的直接链接")
...
### 1. 使用正则表达式进行格式验证[​](#1-使用正则表达式进行格式验证 "1. 使用正则表达式进行格式验证的直接链接")
...
### 2. 对固定类别使用 select()[​](#2-对固定类别使用-select "2. 对固定类别使用 select()的直接链接")
...
### 3. 利用 Token 修复[​](#3-利用-token-修复 "3. 利用 Token 修复的直接链接")
...
### 4. 使用停止序列[​](#4-使用停止序列 "4. 使用停止序列的直接链接")
...
### 5. 创建可复用函数[​](#5-创建可复用函数 "5. 创建可复用函数的直接链接")
...
### 6. 平衡约束力度[​](#6-平衡约束力度 "6. 平衡约束力度的直接链接")
...
* **GitHub**：[https://github.com/guidance-ai/guidance（18k+](https://github.com/guidance-ai/guidance%EF%BC%8818k+) stars）
...
* [安装](#安装)
* [快速开始](#快速开始)
  + [基础示例：结构化生成](#基础示例结构化生成)
  + [使用 Anthropic Claude](#使用-anthropic-claude)
* [核心概念](#核心概念)
  + [1. 上下文管理器](#1-上下文管理器)
  + [2. 约束生成](#2-约束生成)
  + [3. Token 修复（Token Healing）](#3-token-修复token-healing)
  + [4. 基于语法的生成](#4-基于语法的生成)
  + [5. Guidance 函数](#5-guidance-函数)
* [后端配置](#后端配置)
  + [Anthropic Claude](#anthropic-claude)
  + [OpenAI](#openai)
  + [本地模型（Transformers）](#本地模型transformers)
  + [本地模型（llama.cpp）](#本地模型llamacpp)
* [常用模式](#常用模式)
  + [模式 1：JSON 生成](#模式-1json-生成)
  + [模式 2：分类](#模式-2分类)
  + [模式 3：多步骤推理](#模式-3多步骤推理)
  + [模式 4：ReAct Agent](#模式-4react-agent)
  + [模式 5：数据提取](#模式-5数据提取)
* [最佳实践](#最佳实践)
  + [1. 使用正则表达式进行格式验证](#1-使用正则表达式进行格式验证)
  + [2. 对固定类别使用 select()](#2-对固定类别使用-select)
  + [3. 利用 Token 修复](#3-利用-token-修复)
  + [4. 使用停止序列](#4-使用停止序列)
  + [5. 创建可复用函数](#5-创建可复用函数)
  + [6. 平衡约束力度](#6-平衡约束力度)
* [与替代方案的对比](#与替代方案的对比)
