...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat)
...
## Step 1: Create or pick a GCP project[​](#step-1-create-or-pick-a-gcp-project "Direct link to Step 1: Create or pick a GCP project")
...
## Step 2: Enable two APIs[​](#step-2-enable-two-apis "Direct link to Step 2: Enable two APIs")
...
## Step 3: Create a Service Account[​](#step-3-create-a-service-account "Direct link to Step 3: Create a Service Account")
...
## Step 4: Create the Pub/Sub topic and subscription[​](#step-4-create-the-pubsub-topic-and-subscription "Direct link to Step 4: Create the Pub/Sub topic and subscription")
...
## Step 5: IAM binding on the topic (critical)[​](#step-5-iam-binding-on-the-topic-critical "Direct link to Step 5: IAM binding on the topic (critical)")
...
## Step 6: IAM binding on the subscription[​](#step-6-iam-binding-on-the-subscription "Direct link to Step 6: IAM binding on the subscription")
...
## Step 7: Configure the Chat app[​](#step-7-configure-the-chat-app "Direct link to Step 7: Configure the Chat app")
...
## Step 8: Install the bot in a test space[​](#step-8-install-the-bot-in-a-test-space "Direct link to Step 8: Install the bot in a test space")
...
## Step 9: Configure Hermes[​](#step-9-configure-hermes "Direct link to Step 9: Configure Hermes")
...
## Formatting and capabilities[​](#formatting-and-capabilities "Direct link to Formatting and capabilities")
...
## Step 10: Native attachment delivery (optional)[​](#step-10-native-attachment-delivery-optional "Direct link to Step 10: Native attachment delivery (optional)")
...
### Why a separate flow[​](#why-a-separate-flow "Direct link to Why a separate flow")
...
### One-time setup (per profile)[​](#one-time-setup-per-profile "Direct link to One-time setup (per profile)")
...
### Per-user authorization (in chat)[​](#per-user-authorization-in-chat "Direct link to Per-user authorization (in chat)")
...
### Multi-user behavior[​](#multi-user-behavior "Direct link to Multi-user behavior")
...
* [Step 10: Native attachment delivery (optional)](#step-10-native-attachment-delivery-optional)
  + [Why a separate flow](#why-a-separate-flow)
  + [One-time setup (per profile)](#one-time-setup-per-profile)
  + [Per-user authorization (in chat)](#per-user-authorization-in-chat)
  + [Scope](#scope)
