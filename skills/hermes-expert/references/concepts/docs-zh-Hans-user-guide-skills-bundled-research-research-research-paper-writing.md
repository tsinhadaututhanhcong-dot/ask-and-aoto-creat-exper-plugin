# 研究论文写作 — 为 NeurIPS/ICML/ICLR 撰写 ML 论文：设计→投稿 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-research-paper-writing](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-research-paper-writing)
...
| 相关 skill | [`arxiv`](/docs/zh-Hans/user-guide/skills/bundled/research/research-arxiv), `ml-paper-writing`, [`subagent-driven-development`](/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-subagent-driven-development), [`plan`](/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-plan) |
...
## 何时使用本 Skill[​](#何时使用本-skill "何时使用本 Skill的直接链接")
...
## 阶段 0：项目设置[​](#阶段-0项目设置 "阶段 0：项目设置的直接链接")

**目标**：建立工作空间，了解现有工作，明确贡献点。

### 步骤 0.1：探索代码库[​](#步骤-01探索代码库 "步骤 0.1：探索代码库的直接链接")
...
### 步骤 0.2：组织工作空间[​](#步骤-02组织工作空间 "步骤 0.2：组织工作空间的直接链接")
...
### 步骤 0.3：设置版本控制[​](#步骤-03设置版本控制 "步骤 0.3：设置版本控制的直接链接")
...
### 步骤 0.4：明确贡献点[​](#步骤-04明确贡献点 "步骤 0.4：明确贡献点的直接链接")
...
### 步骤 0.5：创建 TODO 列表[​](#步骤-05创建-todo-列表 "步骤 0.5：创建 TODO 列表的直接链接")
...
### 步骤 0.6：估算计算预算[​](#步骤-06估算计算预算 "步骤 0.6：估算计算预算的直接链接")
...
### 步骤 0.7：多作者协调[​](#步骤-07多作者协调 "步骤 0.7：多作者协调的直接链接")
...
## 阶段 1：文献综述[​](#阶段-1文献综述 "阶段 1：文献综述的直接链接")

**目标**：查找相关工作，确定基线，收集引用。

### 步骤 1.1：确定种子论文[​](#步骤-11确定种子论文 "步骤 1.1：确定种子论文的直接链接")
...
### 步骤 1.2：搜索相关工作[​](#步骤-12搜索相关工作 "步骤 1.2：搜索相关工作的直接链接")
...
### 步骤 1.2b：深化搜索（先广度，后深度）[​](#步骤-12b深化搜索先广度后深度 "步骤 1.2b：深化搜索（先广度，后深度）的直接链接")
...
### 步骤 1.3：核实每条引用[​](#步骤-13核实每条引用 "步骤 1.3：核实每条引用的直接链接")
...
### 步骤 1.4：整理相关工作[​](#步骤-14整理相关工作 "步骤 1.4：整理相关工作的直接链接")
...
## 阶段 2：实验设计[​](#阶段-2实验设计 "阶段 2：实验设计的直接链接")

**目标**：设计直接支撑论文论点的实验。每个实验都必须回答一个具体问题。

### 步骤 2.1：将论点映射到实验[​](#步骤-21将论点映射到实验 "步骤 2.1：将论点映射到实验的直接链接")
...
### 步骤 2.2：设计基线[​](#步骤-22设计基线 "步骤 2.2：设计基线的直接链接")
...
### 步骤 2.3：定义评估协议[​](#步骤-23定义评估协议 "步骤 2.3：定义评估协议的直接链接")
...
### 步骤 2.4：编写实验脚本[​](#步骤-24编写实验脚本 "步骤 2.4：编写实验脚本的直接链接")
...
### 步骤 2.5：设计人工评估（如适用）[​](#步骤-25设计人工评估如适用 "步骤 2.5：设计人工评估（如适用）的直接链接")
...
## 阶段 3：实验执行与监控[​](#阶段-3实验执行与监控 "阶段 3：实验执行与监控的直接链接")

**目标**：可靠地运行实验，监控进度，从故障中恢复。

### 步骤 3.1：启动实验[​](#步骤-31启动实验 "步骤 3.1：启动实验的直接链接")
...
### 步骤 3.2：设置监控（Cron 模式）[​](#步骤-32设置监控cron-模式 "步骤 3.2：设置监控（Cron 模式）的直接链接")
...
### 步骤 3.3：处理故障[​](#步骤-33处理故障 "步骤 3.3：处理故障的直接链接")
...
### 步骤 3.4：提交已完成的结果[​](#步骤-34提交已完成的结果 "步骤 3.4：提交已完成的结果的直接链接")
...
### 步骤 3.5：维护实验日志[​](#步骤-35维护实验日志 "步骤 3.5：维护实验日志的直接链接")
...
**选择最佳路径**：当日志显示分支树（exp\_001 → exp\_002a、exp\_002b、exp\_003）时，找出最能支撑论文论点的路径。在附录中将死胡同分支记录为消融实验或负面结果。
...
## 阶段 4：结果分析[​](#阶段-4结果分析 "阶段 4：结果分析的直接链接")

**目标**：提取发现，计算统计数据，找出故事主线。

### 步骤 4.1：汇总结果[​](#步骤-41汇总结果 "步骤 4.1：汇总结果的直接链接")
...
### 步骤 4.2：统计显著性[​](#步骤-42统计显著性 "步骤 4.2：统计显著性的直接链接")
...
### 步骤 4.3：找出故事主线[​](#步骤-43找出故事主线 "步骤 4.3：找出故事主线的直接链接")
...
#### 处理负面或零结果[​](#处理负面或零结果 "处理负面或零结果的直接链接")
...
### 步骤 4.4：创建图表[​](#步骤-44创建图表 "步骤 4.4：创建图表的直接链接")
...
### 步骤 4.5：决策：继续实验还是开始写作？[​](#步骤-45决策继续实验还是开始写作 "步骤 4.5：决策：继续实验还是开始写作？的直接链接")
...
### 步骤 4.6：撰写实验日志（写作前的桥梁）[​](#步骤-46撰写实验日志写作前的桥梁 "步骤 4.6：撰写实验日志（写作前的桥梁）的直接链接")
...
### Autoreason 循环（摘要）[​](#autoreason-循环摘要 "Autoreason 循环（摘要）的直接链接")
...
## 阶段 5：论文起草[​](#阶段-5论文起草 "阶段 5：论文起草的直接链接")

**目标**：撰写完整的、可发表的论文。

### 大型项目的上下文管理[​](#大型项目的上下文管理 "大型项目的上下文管理的直接链接")
...
### LaTeX 错误清单[​](#latex-错误清单 "LaTeX 错误清单的直接链接")
...
### 步骤 5.0：标题[​](#步骤-50标题 "步骤 5.0：标题的直接链接")
...
### 步骤 5.1：摘要（5 句公式）[​](#步骤-51摘要5-句公式 "步骤 5.1：摘要（5 句公式）的直接链接")
...
### 步骤 5.2：图 1[​](#步骤-52图-1 "步骤 5.2：图 1的直接链接")
...
### 步骤 5.3：引言（最多 1-1.5 页）[​](#步骤-53引言最多-1-15-页 "步骤 5.3：引言（最多 1-1.5 页）的直接链接")
...
### 步骤 5.4：方法[​](#步骤-54方法 "步骤 5.4：方法的直接链接")
...
### 步骤 5.5：实验与结果[​](#步骤-55实验与结果 "步骤 5.5：实验与结果的直接链接")
...
### 步骤 5.6：相关工作[​](#步骤-56相关工作 "步骤 5.6：相关工作的直接链接")

按方法论组织，而非逐篇论文列举。慷慨引用——审稿人很可能是相关论文的作者。

### 步骤 5.7：局限性（必须）[​](#步骤-57局限性必须 "步骤 5.7：局限性（必须）的直接链接")
...
### 步骤 5.8：结论与讨论[​](#步骤-58结论与讨论 "步骤 5.8：结论与讨论的直接链接")
...
### 步骤 5.9：附录策略[​](#步骤-59附录策略 "步骤 5.9：附录策略的直接链接")
...
### 步骤 5.10：伦理与更广泛影响声明[​](#步骤-510伦理与更广泛影响声明 "步骤 5.10：伦理与更广泛影响声明的直接链接")
...
### 步骤 5.11：数据集说明书与模型卡（如适用）[​](#步骤-511数据集说明书与模型卡如适用 "步骤 5.11：数据集说明书与模型卡（如适用）的直接链接")
...
### 使用 LaTeX 模板[​](#使用-latex-模板 "使用 LaTeX 模板的直接链接")
...
### 专业 LaTeX 前言[​](#专业-latex-前言 "专业 LaTeX 前言的直接链接")
...
### siunitx 表格对齐[​](#siunitx-表格对齐 "siunitx 表格对齐的直接链接")
...
### 使用 algorithm2e 编写伪代码[​](#使用-algorithm2e-编写伪代码 "使用 algorithm2e 编写伪代码的直接链接")
...
### TikZ 图形模式[​](#tikz-图形模式 "TikZ 图形模式的直接链接")
...
### latexdiff 用于修改追踪[​](#latexdiff-用于修改追踪 "latexdiff 用于修改追踪的直接链接")
...
### SciencePlots 用于 matplotlib[​](#scienceplots-用于-matplotlib "SciencePlots 用于 matplotlib的直接链接")
...
## 阶段 6：自我审阅与修改[​](#阶段-6自我审阅与修改 "阶段 6：自我审阅与修改的直接链接")

**目标**：在投稿前模拟审稿过程。尽早发现弱点。

### 步骤 6.1：模拟审稿（集成模式）[​](#步骤-61模拟审稿集成模式 "步骤 6.1：模拟审稿（集成模式）的直接链接")
...
### 步骤 6.1b：视觉审阅（VLM）[​](#步骤-61b视觉审阅vlm "步骤 6.1b：视觉审阅（VLM）的直接链接")
...
### 步骤 6.1c：论点核实[​](#步骤-61c论点核实 "步骤 6.1c：论点核实的直接链接")
...
### 步骤 6.2：优先处理反馈[​](#步骤-62优先处理反馈 "步骤 6.2：优先处理反馈的直接链接")
...
### 步骤 6.3：修改循环[​](#步骤-63修改循环 "步骤 6.3：修改循环的直接链接")
...
### 步骤 6.4：撰写答辩[​](#步骤-64撰写答辩 "步骤 6.4：撰写答辩的直接链接")
...
### 步骤 6.5：论文演变追踪[​](#步骤-65论文演变追踪 "步骤 6.5：论文演变追踪的直接链接")
...
## 阶段 7：投稿准备[​](#阶段-7投稿准备 "阶段 7：投稿准备的直接链接")

**目标**：最终检查、格式化和投稿。

### 步骤 7.1：会议清单[​](#步骤-71会议清单 "步骤 7.1：会议清单的直接链接")
...
### 步骤 7.2：匿名化清单[​](#步骤-72匿名化清单 "步骤 7.2：匿名化清单的直接链接")
...
### 步骤 7.3：格式验证[​](#步骤-73格式验证 "步骤 7.3：格式验证的直接链接")
...
### 步骤 7.4：编译前验证[​](#步骤-74编译前验证 "步骤 7.4：编译前验证的直接链接")
...
### 步骤 7.5：最终编译[​](#步骤-75最终编译 "步骤 7.5：最终编译的直接链接")
...
### 步骤 7.6：会议特定要求[​](#步骤-76会议特定要求 "步骤 7.6：会议特定要求的直接链接")
...
### 步骤 7.7：会议重投与格式转换[​](#步骤-77会议重投与格式转换 "步骤 7.7：会议重投与格式转换的直接链接")
...
### 步骤 7.8：最终版本准备（接收后）[​](#步骤-78最终版本准备接收后 "步骤 7.8：最终版本准备（接收后）的直接链接")
...
### 步骤 7.9：arXiv 与预印本策略[​](#步骤-79arxiv-与预印本策略 "步骤 7.9：arXiv 与预印本策略的直接链接")
...
### 步骤 7.10：研究代码打包[​](#步骤-710研究代码打包 "步骤 7.10：研究代码打包的直接链接")
...
## 阶段 8：接收后的交付物[​](#阶段-8接收后的交付物 "阶段 8：接收后的交付物的直接链接")

**目标**：通过演示材料和社区参与最大化已接收论文的影响力。

### 步骤 8.1：会议海报[​](#步骤-81会议海报 "步骤 8.1：会议海报的直接链接")
...
### 步骤 8.2：会议演讲/亮点展示[​](#步骤-82会议演讲亮点展示 "步骤 8.2：会议演讲/亮点展示的直接链接")
...
### 步骤 8.3：博客文章/社交媒体[​](#步骤-83博客文章社交媒体 "步骤 8.3：博客文章/社交媒体的直接链接")
...
### ACL 短文与 Findings[​](#acl-短文与-findings "ACL 短文与 Findings的直接链接")
...
## 超越实证 ML 的论文类型[​](#超越实证-ml-的论文类型 "超越实证 ML 的论文类型的直接链接")
...
## Hermes Agent 集成[​](#hermes-agent-集成 "Hermes Agent 集成的直接链接")

本 skill 专为 Hermes agent 设计。它使用 Hermes 工具、委派、调度和记忆来支撑完整的研究生命周期。

### 相关 Skill[​](#相关-skill "相关 Skill的直接链接")
...
### Hermes 工具参考[​](#hermes-工具参考 "Hermes 工具参考的直接链接")
...
### 使用 `memory` 和 `todo` 进行状态管理[​](#使用-memory-和-todo-进行状态管理 "使用-memory-和-todo-进行状态管理的直接链接")
...
### 使用 `cronjob` 进行 Cron 监控[​](#使用-cronjob-进行-cron-监控 "使用-cronjob-进行-cron-监控的直接链接")
...
### 需要人工输入的决策点[​](#需要人工输入的决策点 "需要人工输入的决策点的直接链接")
...
### LaTeX 模板[​](#latex-模板 "LaTeX 模板的直接链接")
...
* [核心理念](#核心理念)
  + [主动性与协作](#主动性与协作)
* [阶段 0：项目设置](#阶段-0项目设置)
  + [步骤 0.1：探索代码库](#步骤-01探索代码库)
  + [步骤 0.2：组织工作空间](#步骤-02组织工作空间)
  + [步骤 0.3：设置版本控制](#步骤-03设置版本控制)
  + [步骤 0.4：明确贡献点](#步骤-04明确贡献点)
  + [步骤 0.5：创建 TODO 列表](#步骤-05创建-todo-列表)
  + [步骤 0.6：估算计算预算](#步骤-06估算计算预算)
  + [步骤 0.7：多作者协调](#步骤-07多作者协调)
* [阶段 1：文献综述](#阶段-1文献综述)
  + [步骤 1.1：确定种子论文](#步骤-11确定种子论文)
  + [步骤 1.2：搜索相关工作](#步骤-12搜索相关工作)
  + [步骤 1.2b：深化搜索（先广度，后深度）](#步骤-12b深化搜索先广度后深度)
  + [步骤 1.3：核实每条引用](#步骤-13核实每条引用)
  + [步骤 1.4：整理相关工作](#步骤-14整理相关工作)
* [阶段 2：实验设计](#阶段-2实验设计)
  + [步骤 2.1：将论点映射到实验](#步骤-21将论点映射到实验)
  + [步骤 2.2：设计基线](#步骤-22设计基线)
  + [步骤 2.3：定义评估协议](#步骤-23定义评估协议)
  + [步骤 2.4：编写实验脚本](#步骤-24编写实验脚本)
  + [步骤 2.5：设计人工评估（如适用）](#步骤-25设计人工评估如适用)
* [阶段 3：实验执行与监控](#阶段-3实验执行与监控)
  + [步骤 3.1：启动实验](#步骤-31启动实验)
  + [步骤 3.2：设置监控（Cron 模式）](#步骤-32设置监控cron-模式)
  + [步骤 3.3：处理故障](#步骤-33处理故障)
  + [步骤 3.4：提交已完成的结果](#步骤-34提交已完成的结果)
  + [步骤 3.5：维护实验日志](#步骤-35维护实验日志)
* [阶段 4：结果分析](#阶段-4结果分析)
  + [步骤 4.1：汇总结果](#步骤-41汇总结果)
  + [步骤 4.2：统计显著性](#步骤-42统计显著性)
  + [步骤 4.3：找出故事主线](#步骤-43找出故事主线)
  + [步骤 4.4：创建图表](#步骤-44创建图表)
  + [步骤 4.5：决策：继续实验还是开始写作？](#步骤-45决策继续实验还是开始写作)
  + [步骤 4.6：撰写实验日志（写作前的桥梁）](#步骤-46撰写实验日志写作前的桥梁)
* [迭代精炼：策略选择](#迭代精炼策略选择)
  + [快速决策表](#快速决策表)
  + [生成-评估差距](#生成-评估差距)
  + [Autoreason 循环（摘要）](#autoreason-循环摘要)
  + [应用于论文草稿](#应用于论文草稿)
  + [失败模式](#失败模式)
* [阶段 5：论文起草](#阶段-5论文起草)
  + [大型项目的上下文管理](#大型项目的上下文管理)
  + [叙事原则](#叙事原则)
  + [本指导的来源](#本指导的来源)
  + [时间分配](#时间分配)
  + [写作工作流](#写作工作流)
  + [两遍精炼模式](#两遍精炼模式)
  + [LaTeX 错误清单](#latex-错误清单)
  + [步骤 5.0：标题](#步骤-50标题)
  + [步骤 5.1：摘要（5 句公式）](#步骤-51摘要5-句公式)
  + [步骤 5.2：图 1](#步骤-52图-1)
  + [步骤 5.3：引言（最多 1-1.5 页）](#步骤-53引言最多-1-15-页)
  + [步骤 5.4：方法](#步骤-54方法)
  + [步骤 5.5：实验与结果](#步骤-55实验与结果)
  + [步骤 5.6：相关工作](#步骤-56相关工作)
  + [步骤 5.7：局限性（必须）](#步骤-57局限性必须)
  + [步骤 5.8：结论与讨论](#步骤-58结论与讨论)
  + [步骤 5.9：附录策略](#步骤-59附录策略)
  + [页面预算管理](#页面预算管理)
  + [步骤 5.10：伦理与更广泛影响声明](#步骤-510伦理与更广泛影响声明)
  + [步骤 5.11：数据集说明书与模型卡（如适用）](#步骤-511数据集说明书与模型卡如适用)
  + [写作风格](#写作风格)
  + [使用 LaTeX 模板](#使用-latex-模板)
  + [模板陷阱](#模板陷阱)
  + [快速模板参考](#快速模板参考)
  + [表格与图形](#表格与图形)
  + [会议重投](#会议重投)
  + [专业 LaTeX 前言](#专业-latex-前言)
  + [siunitx 表格对齐](#siunitx-表格对齐)
  + [子图](#子图)
  + [使用 algorithm2e 编写伪代码](#使用-algorithm2e-编写伪代码)
  + [TikZ 图形模式](#tikz-图形模式)
  + [latexdiff 用于修改追踪](#latexdiff-用于修改追踪)
  + [SciencePlots 用于 matplotlib](#scienceplots-用于-matplotlib)
* [阶段 6：自我审阅与修改](#阶段-6自我审阅与修改)
  + [步骤 6.1：模拟审稿（集成模式）](#步骤-61模拟审稿集成模式)
  + [步骤 6.1b：视觉审阅（VLM）](#步骤-61b视觉审阅vlm)
  + [步骤 6.1c：论点核实](#步骤-61c论点核实)
  + [步骤 6.2：优先处理反馈](#步骤-62优先处理反馈)
  + [步骤 6.3：修改循环](#步骤-63修改循环)
  + [步骤 6.4：撰写答辩](#步骤-64撰写答辩)
  + [步骤 6.5：论文演变追踪](#步骤-65论文演变追踪)
* [阶段 7：投稿准备](#阶段-7投稿准备)
  + [步骤 7.1：会议清单](#步骤-71会议清单)
  + [步骤 7.2：匿名化清单](#步骤-72匿名化清单)
  + [步骤 7.3：格式验证](#步骤-73格式验证)
  + [步骤 7.4：编译前验证](#步骤-74编译前验证)
  + [步骤 7.5：最终编译](#步骤-75最终编译)
  + [步骤 7.6：会议特定要求](#步骤-76会议特定要求)
  + [步骤 7.7：会议重投与格式转换](#步骤-77会议重投与格式转换)
  + [步骤 7.8：最终版本准备（接收后）](#步骤-78最终版本准备接收后)
  + [步骤 7.9：arXiv 与预印本策略](#步骤-79arxiv-与预印本策略)
  + [步骤 7.10：研究代码打包](#步骤-710研究代码打包)
* [阶段 8：接收后的交付物](#阶段-8接收后的交付物)
  + [步骤 8.1：会议海报](#步骤-81会议海报)
  + [步骤 8.2：会议演讲/亮点展示](#步骤-82会议演讲亮点展示)
  + [步骤 8.3：博客文章/社交媒体](#步骤-83博客文章社交媒体)
* [研讨会与短文](#研讨会与短文)
  + [研讨会论文](#研讨会论文)
  + [ACL 短文与 Findings](#acl-短文与-findings)
* [超越实证 ML 的论文类型](#超越实证-ml-的论文类型)
  + [理论论文](#理论论文)
  + [综述/教程论文](#综述教程论文)
  + [基准测试论文](#基准测试论文)
  + [立场论文](#立场论文)
* [Hermes Agent 集成](#hermes-agent-集成)
  + [相关 Skill](#相关-skill)
  + [Hermes 工具参考](#hermes-工具参考)
  + [工具使用模式](#工具使用模式)
  + [使用 `memory` 和 `todo` 进行状态管理](#使用-memory-和-todo-进行状态管理)
  + [使用 `cronjob` 进行 Cron 监控](#使用-cronjob-进行-cron-监控)
  + [通信模式](#通信模式)
  + [需要人工输入的决策点](#需要人工输入的决策点)
* [审稿人评估标准](#审稿人评估标准)
* [常见问题与解决方案](#常见问题与解决方案)
* [参考文档](#参考文档)
  + [LaTeX 模板](#latex-模板)
