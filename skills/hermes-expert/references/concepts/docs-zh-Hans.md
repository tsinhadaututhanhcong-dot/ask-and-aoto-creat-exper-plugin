# Hermes Agent 文档 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/](https://hermes-agent.nousresearch.com/docs/zh-Hans/)

由 [Nous Research](https://nousresearch.com) 构建的自我改进 AI 智能体。唯一内置学习循环的智能体——它从经验中创建技能，在使用过程中持续改进，主动提示自身持久化知识，并在会话间不断深化对你的建模。

[快速开始 →](/docs/zh-Hans/getting-started/installation)[在 GitHub 上查看](https://github.com/NousResearch/hermes-agent)
...
## Hermes Agent 是什么？[​](#hermes-agent-是什么 "Hermes Agent 是什么？的直接链接")
...
## 面向 LLM 和编程智能体[​](#面向-llm-和编程智能体 "面向 LLM 和编程智能体的直接链接")

本文档的机器可读入口：

* **[`/llms.txt`](/docs/zh-Hans/assets/files/llms-96828202fb001238524b85bb053418e2.txt)** — 每个文档页面的精选索引，附简短描述。约 17 KB，可安全加载到 LLM 上下文中。
* **[`/llms-full.txt`](/docs/zh-Hans/assets/files/llms-full-85605f39b09716dbb9931ad83d6252c2.txt)** — 所有文档页面拼接为单一 markdown 文件，支持一次性摄取。约 1.8 MB。
...
- [https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/learning-path](./docs-zh-Hans-getting-started-learning-path.md)
