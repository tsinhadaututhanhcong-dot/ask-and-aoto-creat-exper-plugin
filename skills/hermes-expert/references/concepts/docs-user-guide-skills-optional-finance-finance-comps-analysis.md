...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-comps-analysis](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-comps-analysis)
...
## ⚠️ CRITICAL: Data Source Priority (READ FIRST)[​](#️-critical-data-source-priority-read-first "Direct link to ⚠️ CRITICAL: Data Source Priority (READ FIRST)")
...
## ⚠️ CRITICAL: Formulas Over Hardcodes + Step-by-Step Verification[​](#️-critical-formulas-over-hardcodes--step-by-step-verification "Direct link to ⚠️ CRITICAL: Formulas Over Hardcodes + Step-by-Step Verification")
...
## Section 1: Document Structure & Setup[​](#section-1-document-structure--setup "Direct link to Section 1: Document Structure & Setup")

### Header Block (Rows 1-3)[​](#header-block-rows-1-3 "Direct link to Header Block (Rows 1-3)")
...
### Visual Convention Standards (OPTIONAL - User preferences and uploaded templates always override)[​](#visual-convention-standards-optional---user-preferences-and-uploaded-templates-always-override "Direct link to Visual Convention Standards (OPTIONAL - User preferences and uploaded templates always override)")
...
## Section 2: Operating Statistics & Financial Metrics[​](#section-2-operating-statistics--financial-metrics "Direct link to Section 2: Operating Statistics & Financial Metrics")

### Core Columns (Start with these)[​](#core-columns-start-with-these "Direct link to Core Columns (Start with these)")
...
### Optional Additions (Choose based on industry/purpose)[​](#optional-additions-choose-based-on-industrypurpose "Direct link to Optional Additions (Choose based on industry/purpose)")
...
### Formula Examples (Using Row 7 as example)[​](#formula-examples-using-row-7-as-example "Direct link to Formula Examples (Using Row 7 as example)")
...
### Statistics Block (After company data)[​](#statistics-block-after-company-data "Direct link to Statistics Block (After company data)")
...
## Section 3: Valuation Multiples & Investment Metrics[​](#section-3-valuation-multiples--investment-metrics "Direct link to Section 3: Valuation Multiples & Investment Metrics")

### Core Valuation Columns (Start with these)[​](#core-valuation-columns-start-with-these "Direct link to Core Valuation Columns (Start with these)")
...
### Optional Valuation Metrics (Choose based on context)[​](#optional-valuation-metrics-choose-based-on-context "Direct link to Optional Valuation Metrics (Choose based on context)")
...
### Formula Examples[​](#formula-examples "Direct link to Formula Examples")
...
### Cross-Reference Rule[​](#cross-reference-rule "Direct link to Cross-Reference Rule")
...
### Statistics Block[​](#statistics-block "Direct link to Statistics Block")
...
## Section 4: Notes & Methodology Documentation[​](#section-4-notes--methodology-documentation "Direct link to Section 4: Notes & Methodology Documentation")
...
## Section 5: Choosing the Right Metrics (Decision Framework)[​](#section-5-choosing-the-right-metrics-decision-framework "Direct link to Section 5: Choosing the Right Metrics (Decision Framework)")

### Start with "What question am I answering?"[​](#start-with-what-question-am-i-answering "Direct link to Start with \"What question am I answering?\"")
...
### Industry-Specific Metric Selection[​](#industry-specific-metric-selection "Direct link to Industry-Specific Metric Selection")
...
### The "5-10 Rule"[​](#the-5-10-rule "Direct link to The \"5-10 Rule\"")
...
## Section 6: Best Practices & Quality Checks[​](#section-6-best-practices--quality-checks "Direct link to Section 6: Best Practices & Quality Checks")
...
### As You Build[​](#as-you-build "Direct link to As You Build")
...
### Sanity Checks[​](#sanity-checks "Direct link to Sanity Checks")
...
## Section 6: Advanced Features[​](#section-6-advanced-features "Direct link to Section 6: Advanced Features")

### Dynamic Headers[​](#dynamic-headers "Direct link to Dynamic Headers")
...
### Quartile Analysis Benefits[​](#quartile-analysis-benefits "Direct link to Quartile Analysis Benefits")
...
### Industry-Specific Modifications[​](#industry-specific-modifications "Direct link to Industry-Specific Modifications")
...
## Section 7: Workflow & Practical Tips[​](#section-7-workflow--practical-tips "Direct link to Section 7: Workflow & Practical Tips")

### Step-by-Step Process[​](#step-by-step-process "Direct link to Step-by-Step Process")
...
### Excel Formatting Checklist (Optional - adapt to user preferences)[​](#excel-formatting-checklist-optional---adapt-to-user-preferences "Direct link to Excel Formatting Checklist (Optional - adapt to user preferences)")
...
## Section 8: Example Template Layout[​](#section-8-example-template-layout "Direct link to Section 8: Example Template Layout")
...
## Section 9: Industry-Specific Additions (Optional)[​](#section-9-industry-specific-additions-optional "Direct link to Section 9: Industry-Specific Additions (Optional)")
...
## Section 10: Red Flags & Warning Signs[​](#section-10-red-flags--warning-signs "Direct link to Section 10: Red Flags & Warning Signs")

### Data Quality Issues[​](#data-quality-issues "Direct link to Data Quality Issues")
...
### Valuation Red Flags[​](#valuation-red-flags "Direct link to Valuation Red Flags")
...
### Comparability Issues[​](#comparability-issues "Direct link to Comparability Issues")
...
## Section 11: Formulas Reference Guide[​](#section-11-formulas-reference-guide "Direct link to Section 11: Formulas Reference Guide")

### Essential Excel Formulas[​](#essential-excel-formulas "Direct link to Essential Excel Formulas")
...
### Common Ratio Formulas[​](#common-ratio-formulas "Direct link to Common Ratio Formulas")
...
## Key Principles Summary[​](#key-principles-summary "Direct link to Key Principles Summary")
...
## Output Checklist[​](#output-checklist "Direct link to Output Checklist")
...
* [⚠️ CRITICAL: Data Source Priority (READ FIRST)](#️-critical-data-source-priority-read-first)
* [Overview](#overview)
* [Core Philosophy](#core-philosophy)
* [⚠️ CRITICAL: Formulas Over Hardcodes + Step-by-Step Verification](#️-critical-formulas-over-hardcodes--step-by-step-verification)
* [Section 1: Document Structure & Setup](#section-1-document-structure--setup)
  + [Header Block (Rows 1-3)](#header-block-rows-1-3)
  + [Visual Convention Standards (OPTIONAL - User preferences and uploaded templates always override)](#visual-convention-standards-optional---user-preferences-and-uploaded-templates-always-override)
* [Section 2: Operating Statistics & Financial Metrics](#section-2-operating-statistics--financial-metrics)
  + [Core Columns (Start with these)](#core-columns-start-with-these)
  + [Optional Additions (Choose based on industry/purpose)](#optional-additions-choose-based-on-industrypurpose)
  + [Formula Examples (Using Row 7 as example)](#formula-examples-using-row-7-as-example)
  + [Statistics Block (After company data)](#statistics-block-after-company-data)
* [Section 3: Valuation Multiples & Investment Metrics](#section-3-valuation-multiples--investment-metrics)
  + [Core Valuation Columns (Start with these)](#core-valuation-columns-start-with-these)
  + [Optional Valuation Metrics (Choose based on context)](#optional-valuation-metrics-choose-based-on-context)
  + [Formula Examples](#formula-examples)
  + [Cross-Reference Rule](#cross-reference-rule)
  + [Statistics Block](#statistics-block)
* [Section 4: Notes & Methodology Documentation](#section-4-notes--methodology-documentation)
  + [Required Components](#required-components)
* [Section 5: Choosing the Right Metrics (Decision Framework)](#section-5-choosing-the-right-metrics-decision-framework)
  + [Start with "What question am I answering?"](#start-with-what-question-am-i-answering)
  + [Industry-Specific Metric Selection](#industry-specific-metric-selection)
  + [The "5-10 Rule"](#the-5-10-rule)
* [Section 6: Best Practices & Quality Checks](#section-6-best-practices--quality-checks)
  + [Before You Start](#before-you-start)
  + [As You Build](#as-you-build)
  + [Sanity Checks](#sanity-checks)
  + [Common Mistakes to Avoid](#common-mistakes-to-avoid)
* [Section 6: Advanced Features](#section-6-advanced-features)
  + [Dynamic Headers](#dynamic-headers)
  + [Quartile Analysis Benefits](#quartile-analysis-benefits)
  + [Industry-Specific Modifications](#industry-specific-modifications)
* [Section 7: Workflow & Practical Tips](#section-7-workflow--practical-tips)
  + [Step-by-Step Process](#step-by-step-process)
  + [Pro Tips](#pro-tips)
  + [Excel Formatting Checklist (Optional - adapt to user preferences)](#excel-formatting-checklist-optional---adapt-to-user-preferences)
* [Section 8: Example Template Layout](#section-8-example-template-layout)
* [Section 9: Industry-Specific Additions (Optional)](#section-9-industry-specific-additions-optional)
* [Section 10: Red Flags & Warning Signs](#section-10-red-flags--warning-signs)
  + [Data Quality Issues](#data-quality-issues)
  + [Valuation Red Flags](#valuation-red-flags)
  + [Comparability Issues](#comparability-issues)
* [Section 11: Formulas Reference Guide](#section-11-formulas-reference-guide)
  + [Essential Excel Formulas](#essential-excel-formulas)
  + [Common Ratio Formulas](#common-ratio-formulas)
