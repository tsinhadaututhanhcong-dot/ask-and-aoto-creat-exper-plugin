...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers)
...
## 可用提供者[​](#可用提供者 "可用提供者的直接链接")

### Honcho[​](#honcho "Honcho的直接链接")
...
### 新建 profile，创建新 Honcho peer[​](#新建-profile创建新-honcho-peer "新建 profile，创建新 Honcho peer的直接链接")
...
### 为现有 profile 补充 Honcho peer[​](#为现有-profile-补充-honcho-peer "为现有 profile 补充 Honcho peer的直接链接")
...
### 每个 profile 的 observation 配置[​](#每个-profile-的-observation-配置 "每个 profile 的 observation 配置的直接链接")
...
参见 [Honcho 页面](/docs/zh-Hans/user-guide/features/honcho#observation-directional-vs-unified) 获取完整的 observation 参考。
...
### OpenViking[​](#openviking "OpenViking的直接链接")
...
### Hindsight[​](#hindsight "Hindsight的直接链接")
...
### Holographic[​](#holographic "Holographic的直接链接")
...
### RetainDB[​](#retaindb "RetainDB的直接链接")
...
### ByteRover[​](#byterover "ByteRover的直接链接")
...
### Supermemory[​](#supermemory "Supermemory的直接链接")
...
## Profile 隔离[​](#profile-隔离 "Profile 隔离的直接链接")

每个提供者的数据按 [profile](/docs/zh-Hans/user-guide/profiles) 隔离：
...
## 构建记忆提供者[​](#构建记忆提供者 "构建记忆提供者的直接链接")

参见[开发者指南：Memory Provider 插件](/docs/zh-Hans/developer-guide/memory-provider-plugin)了解如何创建自己的提供者。

* [快速开始](#快速开始)
* [工作原理](#工作原理)
* [可用提供者](#可用提供者)
  + [Honcho](#honcho)
  + [新建 profile，创建新 Honcho peer](#新建-profile创建新-honcho-peer)
  + [为现有 profile 补充 Honcho peer](#为现有-profile-补充-honcho-peer)
  + [每个 profile 的 observation 配置](#每个-profile-的-observation-配置)
...
- [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho](./docs-zh-Hans-user-guide-features-honcho.md)
