...
**Source:** [https://hermes-agent.nousresearch.com/docs/reference/mcp-config-reference](https://hermes-agent.nousresearch.com/docs/reference/mcp-config-reference)
...
### TLS client certificate (mTLS)[​](#tls-client-certificate-mtls "Direct link to TLS client certificate (mTLS)")
...
* [Example configs](#example-configs)
  ...
  + [TLS client certificate (mTLS)](#tls-client-certificate-mtls)
