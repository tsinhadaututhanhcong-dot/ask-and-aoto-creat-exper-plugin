...
**Source:** [https://hermes-agent.nousresearch.com/docs/reference/automation-blueprints-catalog](https://hermes-agent.nousresearch.com/docs/reference/automation-blueprints-catalog)
...
[Creating Skills → Automation Blueprints](/docs/developer-guide/creating-skills) for the
