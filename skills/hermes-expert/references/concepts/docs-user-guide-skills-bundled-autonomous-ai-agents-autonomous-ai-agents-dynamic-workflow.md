# Dynamic Workflow | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-dynamic-workflow](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-dynamic-workflow)
...
## The two orchestration-script layers (pick the right one — they are NOT interchangeable)[​](#the-two-orchestration-script-layers-pick-the-right-one--they-are-not-interchangeable "Direct link to The two orchestration-script layers (pick the right one — they are NOT interchangeable)")
...
## The synchronous trap (READ THIS — it is the #1 way a "workflow" disappoints)[​](#the-synchronous-trap-read-this--it-is-the-1-way-a-workflow-disappoints "Direct link to The synchronous trap (READ THIS — it is the #1 way a \"workflow\" disappoints)")
...
## Workflow recipe (foreground)[​](#workflow-recipe-foreground "Direct link to Workflow recipe (foreground)")
...
1. **Decompose into independent units.** What is the unit — a file? an endpoint?
   ...
   (else it's serial, not fan-out — see when\_not\_to\_use).
...
5. **Synthesize on the parent.** Read the out\_\*.csv files yourself — verify the
...
## The novel mechanic worth building: adversarial convergence[​](#the-novel-mechanic-worth-building-adversarial-convergence "Direct link to The novel mechanic worth building: adversarial convergence")
...
### Recipe: N independent attempts + M refuters[​](#recipe-n-independent-attempts--m-refuters "Direct link to Recipe: N independent attempts + M refuters")
...
### Why atomic claims matter[​](#why-atomic-claims-matter "Direct link to Why atomic claims matter")
...
## Cost discipline (this is the thing that bites)[​](#cost-discipline-this-is-the-thing-that-bites "Direct link to Cost discipline (this is the thing that bites)")
...
## Verification before you call it done[​](#verification-before-you-call-it-done "Direct link to Verification before you call it done")
...
* [The two orchestration-script layers (pick the right one — they are NOT interchangeable)](#the-two-orchestration-script-layers-pick-the-right-one--they-are-not-interchangeable)
* [The synchronous trap (READ THIS — it is the #1 way a "workflow" disappoints)](#the-synchronous-trap-read-this--it-is-the-1-way-a-workflow-disappoints)
* [Workflow recipe (foreground)](#workflow-recipe-foreground)
* [The novel mechanic worth building: adversarial convergence](#the-novel-mechanic-worth-building-adversarial-convergence)
  + [Recipe: N independent attempts + M refuters](#recipe-n-independent-attempts--m-refuters)
  + [Why atomic claims matter](#why-atomic-claims-matter)
* [Cost discipline (this is the thing that bites)](#cost-discipline-this-is-the-thing-that-bites)
* [Pitfalls](#pitfalls)
* [Verification before you call it done](#verification-before-you-call-it-done)