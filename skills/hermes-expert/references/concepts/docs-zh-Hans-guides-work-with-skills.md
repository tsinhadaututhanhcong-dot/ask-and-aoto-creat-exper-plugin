# 使用 Skills | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/work-with-skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/work-with-skills)

本页总览

Skills（技能）是按需加载的知识文档，用于教会 Hermes 如何处理特定任务——从生成 ASCII 艺术到管理 GitHub PR。本指南介绍日常使用方法。

完整技术参考请见 [Skills 系统](/docs/zh-Hans/user-guide/features/skills)。

---

## 查找 Skills[​](#查找-skills "查找 Skills的直接链接")
...
### 搜索 Skill[​](#搜索-skill "搜索 Skill的直接链接")
...
## 使用 Skill[​](#使用-skill "使用 Skill的直接链接")
...
## 从 Hub 安装[​](#从-hub-安装 "从 Hub 安装的直接链接")
...
## 插件提供的 Skills[​](#插件提供的-skills "插件提供的 Skills的直接链接")
...
关于如何在自己的插件中捆绑 skills，请参见 [构建 Hermes 插件 → 捆绑 skills](/docs/zh-Hans/developer-guide/plugins#bundle-skills)。

---

## 配置 Skill 设置[​](#配置-skill-设置 "配置 Skill 设置的直接链接")
...
## 创建自己的 Skill[​](#创建自己的-skill "创建自己的 Skill的直接链接")

Skills 只是带有 YAML frontmatter 的 Markdown 文件，创建一个不超过五分钟。

### 1. 创建目录[​](#1-创建目录 "1. 创建目录的直接链接")

```
mkdir -p ~/.hermes/skills/my-category/my-skill
```

### 2. 编写 SKILL.md[​](#2-编写-skillmd "2. 编写 SKILL.md的直接链接")
...
### 3. 添加参考文件（可选）[​](#3-添加参考文件可选 "3. 添加参考文件（可选）的直接链接")
...
## 按平台管理 Skills[​](#按平台管理-skills "按平台管理 Skills的直接链接")
...
## Skills 与 Memory 的区别[​](#skills-与-memory-的区别 "Skills 与 Memory 的区别的直接链接")
...
*完整的 skills 参考——frontmatter 字段、条件激活、外部目录等——请见 [Skills 系统](/docs/zh-Hans/user-guide/features/skills)。*
...
* [配置 Skill 设置](#配置-skill-设置)
* [创建自己的 Skill](#创建自己的-skill)
  + [1. 创建目录](#1-创建目录)
  + [2. 编写 SKILL.md](#2-编写-skillmd)
  + [3. 添加参考文件（可选）](#3-添加参考文件可选)
  + [4. 测试](#4-测试)
* [按平台管理 Skills](#按平台管理-skills)
* [Skills 与 Memory 的区别](#skills-与-memory-的区别)
* [使用技巧](#使用技巧)
