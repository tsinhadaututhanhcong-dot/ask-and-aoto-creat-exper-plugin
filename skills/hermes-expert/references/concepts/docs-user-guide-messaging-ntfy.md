# ntfy | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/ntfy](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/ntfy)
...
## Configure Hermes[​](#configure-hermes "Direct link to Configure Hermes")
...
## Identity model — read this before deploying[​](#identity-model--read-this-before-deploying "Direct link to Identity model — read this before deploying")
...
## Quick start — talk to your agent from your phone[​](#quick-start--talk-to-your-agent-from-your-phone "Direct link to Quick start — talk to your agent from your phone")
...
## Using ntfy with cron jobs[​](#using-ntfy-with-cron-jobs "Direct link to Using ntfy with cron jobs")
...
## Self-hosting ntfy[​](#self-hosting-ntfy "Direct link to Self-hosting ntfy")
...
## Outgoing-only setup (notifications without inbound)[​](#outgoing-only-setup-notifications-without-inbound "Direct link to Outgoing-only setup (notifications without inbound)")
...
* [Identity model — read this before deploying](#identity-model--read-this-before-deploying)
* [Quick start — talk to your agent from your phone](#quick-start--talk-to-your-agent-from-your-phone)
* [Using ntfy with cron jobs](#using-ntfy-with-cron-jobs)
* [Self-hosting ntfy](#self-hosting-ntfy)
* [Markdown formatting](#markdown-formatting)
* [Outgoing-only setup (notifications without inbound)](#outgoing-only-setup-notifications-without-inbound)
* [Limits](#limits)
