# 检查点与 /rollback | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/checkpoints-and-rollback](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/checkpoints-and-rollback)
...
## 触发检查点的条件[​](#触发检查点的条件 "触发检查点的条件的直接链接")
...
## 检查点的工作原理[​](#检查点的工作原理 "检查点的工作原理的直接链接")
...
## 从 Shell 检查存储[​](#从-shell-检查存储 "从 Shell 检查存储的直接链接")
...
## 使用 `/rollback diff` 预览变更[​](#使用-rollback-diff-预览变更 "使用-rollback-diff-预览变更的直接链接")
...
## 使用 `/rollback` 恢复[​](#使用-rollback-恢复 "使用-rollback-恢复的直接链接")
...
## 检查点的存储位置[​](#检查点的存储位置 "检查点的存储位置的直接链接")
...
关于在同一仓库中并行运行多个 Agent，请参阅 [Git worktrees](/docs/zh-Hans/user-guide/git-worktrees) 指南。
...
* [配置](#配置)
* [列出检查点](#列出检查点)
* [从 Shell 检查存储](#从-shell-检查存储)
* [使用 `/rollback diff` 预览变更](#使用-rollback-diff-预览变更)
* [使用 `/rollback` 恢复](#使用-rollback-恢复)
* [单文件恢复](#单文件恢复)
* [安全与性能保障](#安全与性能保障)
* [检查点的存储位置](#检查点的存储位置)
  + [从 v1 迁移](#从-v1-迁移)
...
- [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees](./docs-zh-Hans-user-guide-git-worktrees.md)
