...
## Intentional Silence Tokens[​](#intentional-silence-tokens "Direct link to Intentional Silence Tokens")
...
### Admins vs Regular Users[​](#admins-vs-regular-users "Direct link to Admins vs Regular Users")
...
#### Inspecting your access[​](#inspecting-your-access "Direct link to Inspecting your access")
...
### Queue vs interrupt vs steer (busy-input mode)[​](#queue-vs-interrupt-vs-steer-busy-input-mode "Direct link to Queue vs interrupt vs steer (busy-input mode)")
...
## Tool Progress Notifications[​](#tool-progress-notifications "Direct link to Tool Progress Notifications")
...
### Message timestamps in model context[​](#message-timestamps-in-model-context "Direct link to Message timestamps in model context")
...
## Platform-Specific Toolsets[​](#platform-specific-toolsets "Direct link to Platform-Specific Toolsets")
...
| Home Assistant | `hermes-homeassistant` | Full tools + HA device control (ha\_list\_entities, ha\_get\_state, ha\_call\_service, ha\_list\_services) |
...
## Operating a multi-platform gateway[​](#operating-a-multi-platform-gateway "Direct link to Operating a multi-platform gateway")
...
### `/platform` command[​](#platform-command "Direct link to platform-command")
...
### Automatic circuit breaker[​](#automatic-circuit-breaker "Direct link to Automatic circuit breaker")
...
### Where to look when a platform is paused[​](#where-to-look-when-a-platform-is-paused "Direct link to Where to look when a platform is paused")
...
### Restart notifications[​](#restart-notifications "Direct link to Restart notifications")
...
### Session resume across gateway restarts[​](#session-resume-across-gateway-restarts "Direct link to Session resume across gateway restarts")
...
### Mobile-friendly progress defaults[​](#mobile-friendly-progress-defaults "Direct link to Mobile-friendly progress defaults")
...
### Progress bubble cleanup (opt-in)[​](#progress-bubble-cleanup-opt-in "Direct link to Progress bubble cleanup (opt-in)")
...
* [Intentional Silence Tokens](#intentional-silence-tokens)
...
* [Security](#security)
  ...
  + [Admins vs Regular Users](#admins-vs-regular-users)
* [Interrupting the Agent](#interrupting-the-agent)
  + [Queue vs interrupt vs steer (busy-input mode)](#queue-vs-interrupt-vs-steer-busy-input-mode)
* [Tool Progress Notifications](#tool-progress-notifications)
  + [Message timestamps in model context](#message-timestamps-in-model-context)
...
* [Operating a multi-platform gateway](#operating-a-multi-platform-gateway)
  + [`/platform` command](#platform-command)
  + [Automatic circuit breaker](#automatic-circuit-breaker)
  + [Where to look when a platform is paused](#where-to-look-when-a-platform-is-paused)
  + [Restart notifications](#restart-notifications)
  + [Typing indicators](#typing-indicators)
  + [Session resume across gateway restarts](#session-resume-across-gateway-restarts)
  + [Mobile-friendly progress defaults](#mobile-friendly-progress-defaults)
  + [Progress bubble cleanup (opt-in)](#progress-bubble-cleanup-opt-in)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/irc](./docs-user-guide-messaging-irc.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/raft](./docs-user-guide-messaging-raft.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp-cloud](./docs-user-guide-messaging-whatsapp-cloud.md)
