...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/video-gen-provider-plugin](https://hermes-agent.nousresearch.com/docs/developer-guide/video-gen-provider-plugin)
...
## The unified surface (one tool, two modalities)[​](#the-unified-surface-one-tool-two-modalities "Direct link to The unified surface (one tool, two modalities)")
...
## The VideoGenProvider ABC[​](#the-videogenprovider-abc "Direct link to The VideoGenProvider ABC")
...
## The plugin manifest[​](#the-plugin-manifest "Direct link to The plugin manifest")
...
## The `video_generate` schema[​](#the-video_generate-schema "Direct link to the-video_generate-schema")
...
## Model families and endpoint routing (the FAL pattern)[​](#model-families-and-endpoint-routing-the-fal-pattern "Direct link to Model families and endpoint routing (the FAL pattern)")
...
## Selection precedence[​](#selection-precedence "Direct link to Selection precedence")
...
## Where to save artifacts[​](#where-to-save-artifacts "Direct link to Where to save artifacts")
...
* [The unified surface (one tool, two modalities)](#the-unified-surface-one-tool-two-modalities)
* [How discovery works](#how-discovery-works)
* [Directory structure](#directory-structure)
* [The VideoGenProvider ABC](#the-videogenprovider-abc)
* [The plugin manifest](#the-plugin-manifest)
* [The `video_generate` schema](#the-video_generate-schema)
* [Model families and endpoint routing (the FAL pattern)](#model-families-and-endpoint-routing-the-fal-pattern)
* [Selection precedence](#selection-precedence)
* [Response shape](#response-shape)
* [Where to save artifacts](#where-to-save-artifacts)
* [Testing](#testing)
