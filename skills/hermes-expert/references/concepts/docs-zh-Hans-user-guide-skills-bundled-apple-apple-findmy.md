# Findmy — 通过 FindMy 追踪 Apple 设备/AirTag | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/apple/apple-findmy](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/apple/apple-findmy)
...
## 方法一：AppleScript + 截图（基础方式）[​](#方法一applescript--截图基础方式 "方法一：AppleScript + 截图（基础方式）的直接链接")

### 打开 FindMy 并导航[​](#打开-findmy-并导航 "打开 FindMy 并导航的直接链接")
...
## 方法二：Peekaboo UI 自动化（推荐）[​](#方法二peekaboo-ui-自动化推荐 "方法二：Peekaboo UI 自动化（推荐）的直接链接")
...
## 工作流：随时间追踪 AirTag 位置[​](#工作流随时间追踪-airtag-位置 "工作流：随时间追踪 AirTag 位置的直接链接")
...
* [前提条件](#前提条件)
* [使用场景](#使用场景)
* [方法一：AppleScript + 截图（基础方式）](#方法一applescript--截图基础方式)
  + [打开 FindMy 并导航](#打开-findmy-并导航)
  + [切换标签页](#切换标签页)
* [方法二：Peekaboo UI 自动化（推荐）](#方法二peekaboo-ui-自动化推荐)
* [工作流：随时间追踪 AirTag 位置](#工作流随时间追踪-airtag-位置)
* [限制](#限制)
* [规则](#规则)