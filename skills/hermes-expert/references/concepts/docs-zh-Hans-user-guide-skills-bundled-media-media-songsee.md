# Songsee — 通过 CLI 生成音频频谱图/特征（mel、chroma、MFCC） | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/media/media-songsee](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/media/media-songsee)
