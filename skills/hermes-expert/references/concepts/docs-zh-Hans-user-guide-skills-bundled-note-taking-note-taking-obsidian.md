# Obsidian — 在 Obsidian 知识库中读取、搜索、创建和编辑笔记 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/note-taking/note-taking-obsidian](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/note-taking/note-taking-obsidian)
...
## Wikilink[​](#wikilink "Wikilink的直接链接")
