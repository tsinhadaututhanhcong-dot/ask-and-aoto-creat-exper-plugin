...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/x-search](https://hermes-agent.nousresearch.com/docs/user-guide/features/x-search)
...
| --- | --- | --- |
| **SuperGrok / X Premium+ OAuth** (preferred) | Browser login at `accounts.x.ai`, refreshed automatically | `hermes auth add xai-oauth` — see [xAI Grok OAuth (SuperGrok / X Premium+)](/docs/guides/xai-grok-oauth) |
...
## Enabling the tool[​](#enabling-the-tool "Direct link to Enabling the tool")
...
## Tool parameters[​](#tool-parameters "Direct link to Tool parameters")
...
### "No xAI credentials available"[​](#no-xai-credentials-available "Direct link to \"No xAI credentials available\"")
...
### "`x_search` is not enabled for this model"[​](#x_search-is-not-enabled-for-this-model "Direct link to x_search-is-not-enabled-for-this-model")
...
### Tool doesn't appear in the schema[​](#tool-doesnt-appear-in-the-schema "Direct link to Tool doesn't appear in the schema")
...
### `degraded: true` — answer with no citations[​](#degraded-true--answer-with-no-citations "Direct link to degraded-true--answer-with-no-citations")
...
* [Troubleshooting](#troubleshooting)
  + ["No xAI credentials available"](#no-xai-credentials-available)
  + ["`x_search` is not enabled for this model"](#x_search-is-not-enabled-for-this-model)
  + [Tool doesn't appear in the schema](#tool-doesnt-appear-in-the-schema)
  + [`degraded: true` — answer with no citations](#degraded-true--answer-with-no-citations)
* [See Also](#see-also)
