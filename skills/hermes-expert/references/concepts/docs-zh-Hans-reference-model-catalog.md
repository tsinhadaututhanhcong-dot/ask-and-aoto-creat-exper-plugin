# 模型目录 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/model-catalog](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/model-catalog)
...
## 线上清单 URL[​](#线上清单-url "线上清单 URL的直接链接")
...
## Schema（模式）[​](#schema模式 "Schema（模式）的直接链接")
...
### 按 provider 覆盖 URL[​](#按-provider-覆盖-url "按 provider 覆盖 URL的直接链接")
...
* [获取行为](#获取行为)
* [配置](#配置)
  + [按 provider 覆盖 URL](#按-provider-覆盖-url)
* [更新清单](#更新清单)