...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/browser-supervisor](https://hermes-agent.nousresearch.com/docs/developer-guide/browser-supervisor)
...
## Backend support[​](#backend-support "Direct link to Backend support")
...
## Agent surface[​](#agent-surface "Direct link to Agent surface")

### `browser_dialog` tool[​](#browser_dialog-tool "Direct link to browser_dialog-tool")
...
* **`recent_dialogs`** — ring buffer of up to 20 recently-closed dialogs with
  ...
  auto\_dismiss/auto\_accept), `"watchdog"` (must\_respond timeout hit), or
...
`sessionId`. Agents pick frame\_ids out of
...
* [Agent surface](#agent-surface)
  + [`browser_dialog` tool](#browser_dialog-tool)
