...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/dingtalk](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/dingtalk)
...
### 钉钉中的会话模型[​](#钉钉中的会话模型 "钉钉中的会话模型的直接链接")
...
## 第一步：创建钉钉应用[​](#第一步创建钉钉应用 "第一步：创建钉钉应用的直接链接")
...
## 第二步：启用机器人能力[​](#第二步启用机器人能力 "第二步：启用机器人能力的直接链接")
...
## 第三步：找到你的钉钉用户 ID[​](#第三步找到你的钉钉用户-id "第三步：找到你的钉钉用户 ID的直接链接")
...
### Emoji 反应[​](#emoji-反应 "Emoji 反应的直接链接")
...
### "dingtalk-stream not installed" 错误[​](#dingtalk-stream-not-installed-错误 "\"dingtalk-stream not installed\" 错误的直接链接")
...
### "DINGTALK\_CLIENT\_ID and DINGTALK\_CLIENT\_SECRET required"[​](#dingtalk_client_id-and-dingtalk_client_secret-required "\"DINGTALK_CLIENT_ID and DINGTALK_CLIENT_SECRET required\"的直接链接")
...
### Stream 断开 / 重连循环[​](#stream-断开--重连循环 "Stream 断开 / 重连循环的直接链接")
...
### "No session\_webhook available"[​](#no-session_webhook-available "\"No session_webhook available\"的直接链接")
...
* [Hermes 的行为方式](#hermes-的行为方式)
  + [钉钉中的会话模型](#钉钉中的会话模型)
* [前置条件](#前置条件)
* [第一步：创建钉钉应用](#第一步创建钉钉应用)
* [第二步：启用机器人能力](#第二步启用机器人能力)
* [第三步：找到你的钉钉用户 ID](#第三步找到你的钉钉用户-id)
...
* [故障排查](#故障排查)
  + [机器人不响应消息](#机器人不响应消息)
  + ["dingtalk-stream not installed" 错误](#dingtalk-stream-not-installed-错误)
  + ["DINGTALK\_CLIENT\_ID and DINGTALK\_CLIENT\_SECRET required"](#dingtalk_client_id-and-dingtalk_client_secret-required)
  + [Stream 断开 / 重连循环](#stream-断开--重连循环)
  + [机器人离线](#机器人离线)
  + ["No session\_webhook available"](#no-session_webhook-available)
* [安全](#安全)
* [注意事项](#注意事项)
