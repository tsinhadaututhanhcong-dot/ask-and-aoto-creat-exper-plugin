# Sherlock — 跨 400+ 社交网络的 OSINT 用户名搜索 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/security/security-sherlock](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/security/security-sherlock)
...
### 1. 检查 Sherlock 是否已安装[​](#1-检查-sherlock-是否已安装 "1. 检查 Sherlock 是否已安装的直接链接")
...
### 5. 解析并呈现结果[​](#5-解析并呈现结果 "5. 解析并呈现结果的直接链接")
...
### Linux 软件包[​](#linux-软件包 "Linux 软件包的直接链接")
...
* [前置要求](#前置要求)
* [操作流程](#操作流程)
  + [1. 检查 Sherlock 是否已安装](#1-检查-sherlock-是否已安装)
  + [2. 提取用户名](#2-提取用户名)
  + [3. 构建命令](#3-构建命令)
  + [4. 执行搜索](#4-执行搜索)
  + [5. 解析并呈现结果](#5-解析并呈现结果)
