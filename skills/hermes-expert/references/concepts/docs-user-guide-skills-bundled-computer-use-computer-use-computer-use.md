...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/computer-use/computer-use-computer-use](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/computer-use/computer-use-computer-use)
...
## The canonical workflow[​](#the-canonical-workflow "Direct link to The canonical workflow")
...
### Key shortcuts vary per platform[​](#key-shortcuts-vary-per-platform "Direct link to Key shortcuts vary per platform")
...
## Background rules (the whole point)[​](#background-rules-the-whole-point "Direct link to Background rules (the whole point)")
...
## Drag & drop[​](#drag--drop "Direct link to Drag & drop")
...
## Managing what's focused[​](#managing-whats-focused "Direct link to Managing what's focused")
...
## Delivering screenshots to the user[​](#delivering-screenshots-to-the-user "Direct link to Delivering screenshots to the user")
...
## Safety — these are hard rules[​](#safety--these-are-hard-rules "Direct link to Safety — these are hard rules")
...
## Failure modes — what to do when things go sideways[​](#failure-modes--what-to-do-when-things-go-sideways "Direct link to Failure modes — what to do when things go sideways")
...
## When NOT to use `computer_use`[​](#when-not-to-use-computer_use "Direct link to when-not-to-use-computer_use")
...
## Going deeper — read the cua-driver skill pack[​](#going-deeper--read-the-cua-driver-skill-pack "Direct link to Going deeper — read the cua-driver skill pack")
...
* [The canonical workflow](#the-canonical-workflow)
* [Capture modes](#capture-modes)
* [Actions](#actions)
  + [Key shortcuts vary per platform](#key-shortcuts-vary-per-platform)
* [Background rules (the whole point)](#background-rules-the-whole-point)
* [Drag & drop](#drag--drop)
* [Scroll](#scroll)
* [Managing what's focused](#managing-whats-focused)
* [Delivering screenshots to the user](#delivering-screenshots-to-the-user)
* [Safety — these are hard rules](#safety--these-are-hard-rules)
* [Failure modes — what to do when things go sideways](#failure-modes--what-to-do-when-things-go-sideways)
* [When NOT to use `computer_use`](#when-not-to-use-computer_use)
* [Going deeper — read the cua-driver skill pack](#going-deeper--read-the-cua-driver-skill-pack)