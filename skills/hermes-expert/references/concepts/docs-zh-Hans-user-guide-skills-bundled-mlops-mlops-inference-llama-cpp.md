...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/mlops/mlops-inference-llama-cpp](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/mlops/mlops-inference-llama-cpp)
...
### 安装 llama.cpp[​](#安装-llamacpp "安装 llama.cpp的直接链接")
...
### 直接从 Hugging Face Hub 运行[​](#直接从-hugging-face-hub-运行 "直接从 Hugging Face Hub 运行的直接链接")
...
### 从 Hub 运行精确的 GGUF 文件[​](#从-hub-运行精确的-gguf-文件 "从 Hub 运行精确的 GGUF 文件的直接链接")
...
### OpenAI 兼容服务器检查[​](#openai-兼容服务器检查 "OpenAI 兼容服务器检查的直接链接")
...
## Python 绑定（llama-cpp-python）[​](#python-绑定llama-cpp-python "Python 绑定（llama-cpp-python）的直接链接")
...
### Embedding（嵌入向量）[​](#embedding嵌入向量 "Embedding（嵌入向量）的直接链接")
...
## 从仓库提取可用的 GGUF 文件[​](#从仓库提取可用的-gguf-文件 "从仓库提取可用的 GGUF 文件的直接链接")
...
* [模型发现工作流](#模型发现工作流)
* [快速开始](#快速开始)
  + [安装 llama.cpp](#安装-llamacpp)
  + [直接从 Hugging Face Hub 运行](#直接从-hugging-face-hub-运行)
  + [从 Hub 运行精确的 GGUF 文件](#从-hub-运行精确的-gguf-文件)
  + [OpenAI 兼容服务器检查](#openai-兼容服务器检查)
* [Python 绑定（llama-cpp-python）](#python-绑定llama-cpp-python)
  + [基础生成](#基础生成)
  + [对话 + 流式输出](#对话--流式输出)
  + [Embedding（嵌入向量）](#embedding嵌入向量)
* [选择量化方案](#选择量化方案)
* [从仓库提取可用的 GGUF 文件](#从仓库提取可用的-gguf-文件)
* [搜索模式](#搜索模式)
* [输出格式](#输出格式)
* [参考资料](#参考资料)
* [资源](#资源)