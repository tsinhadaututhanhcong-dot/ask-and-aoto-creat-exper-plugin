# Claude Design — 设计一次性 HTML 制品（落地页、幻灯片、原型） | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-claude-design](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-claude-design)
...
| 相关 skill | [`design-md`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-design-md), [`popular-web-designs`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-popular-web-designs), [`excalidraw`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-excalidraw), [`architecture-diagram`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-architecture-diagram) |
...
## 何时使用此 Skill vs `popular-web-designs` vs `design-md`[​](#何时使用此-skill-vs-popular-web-designs-vs-design-md "何时使用此-skill-vs-popular-web-designs-vs-design-md的直接链接")
...
## 设计原则：从上下文出发，而非凭感觉[​](#设计原则从上下文出发而非凭感觉 "设计原则：从上下文出发，而非凭感觉的直接链接")
...
## HTML / CSS / JS 标准[​](#html--css--js-标准 "HTML / CSS / JS 标准的直接链接")
...
## 独立 HTML 中的 React 指南[​](#独立-html-中的-react-指南 "独立 HTML 中的 React 指南的直接链接")
...
## CLI/API 模式中的可调整设计[​](#cliapi-模式中的可调整设计 "CLI/API 模式中的可调整设计的直接链接")
...
## 可移植的开场 Prompt 模式[​](#可移植的开场-prompt-模式 "可移植的开场 Prompt 模式的直接链接")
...
* [何时使用此 Skill vs `popular-web-designs` vs `design-md`](#何时使用此-skill-vs-popular-web-designs-vs-design-md)
* [运行模式](#运行模式)
* [核心身份](#核心身份)
* [适用场景](#适用场景)
* [设计原则：从上下文出发，而非凭感觉](#设计原则从上下文出发而非凭感觉)
* [提问](#提问)
* [工作流程](#工作流程)
* [制品格式规则](#制品格式规则)
* [HTML / CSS / JS 标准](#html--css--js-标准)
* [独立 HTML 中的 React 指南](#独立-html-中的-react-指南)
* [幻灯片规则](#幻灯片规则)
* [原型规则](#原型规则)
* [变体规则](#变体规则)
* [CLI/API 模式中的可调整设计](#cliapi-模式中的可调整设计)
* [内容纪律](#内容纪律)
* [反糟粕规则](#反糟粕规则)
* [字体排版](#字体排版)
* [颜色](#颜色)
...
* [验证](#验证)
* [最终响应格式](#最终响应格式)
* [可移植的开场 Prompt 模式](#可移植的开场-prompt-模式)
* [常见陷阱](#常见陷阱)
