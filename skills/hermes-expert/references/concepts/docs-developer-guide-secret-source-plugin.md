...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/secret-source-plugin](https://hermes-agent.nousresearch.com/docs/developer-guide/secret-source-plugin)
...
## What the framework owns vs. what you own[​](#what-the-framework-owns-vs-what-you-own "Direct link to What the framework owns vs. what you own")
...
## The SecretSource ABC[​](#the-secretsource-abc "Direct link to The SecretSource ABC")
...
### Contract rules (enforced, not suggestions)[​](#contract-rules-enforced-not-suggestions "Direct link to Contract rules (enforced, not suggestions)")
...
### Choosing your `shape`[​](#choosing-your-shape "Direct link to choosing-your-shape")
...
## Subprocess safety: use `run_secret_cli()`[​](#subprocess-safety-use-run_secret_cli "Direct link to subprocess-safety-use-run_secret_cli")
...
## Registering[​](#registering "Direct link to Registering")
...
## Users configure it like any other source[​](#users-configure-it-like-any-other-source "Direct link to Users configure it like any other source")
...
## Validate with the conformance kit[​](#validate-with-the-conformance-kit "Direct link to Validate with the conformance kit")
...
## ErrorKind reference[​](#errorkind-reference "Direct link to ErrorKind reference")
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/secrets/](./docs-user-guide-secrets.md)
