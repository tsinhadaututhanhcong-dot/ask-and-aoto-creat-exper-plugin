# 视觉与图像粘贴 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/vision](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/vision)
...
### `/paste` 命令[​](#paste-命令 "paste-命令的直接链接")
...
### Ctrl+V / Cmd+V[​](#ctrlv--cmdv "Ctrl+V / Cmd+V的直接链接")
...
### `/terminal-setup`（适用于 VS Code / Cursor / Windsurf）[​](#terminal-setup适用于-vs-code--cursor--windsurf "terminal-setup适用于-vs-code--cursor--windsurf的直接链接")
...
### Linux（X11）[​](#linuxx11 "Linux（X11）的直接链接")
...
### Linux（Wayland）[​](#linuxwayland "Linux（Wayland）的直接链接")
...
#### 验证 WSL2 剪贴板访问[​](#验证-wsl2-剪贴板访问 "验证 WSL2 剪贴板访问的直接链接")
...
## SSH 与远程会话[​](#ssh-与远程会话 "SSH 与远程会话的直接链接")
...
### SSH 的变通方案[​](#ssh-的变通方案 "SSH 的变通方案的直接链接")
...
## 为什么终端无法粘贴图像[​](#为什么终端无法粘贴图像 "为什么终端无法粘贴图像的直接链接")
...
## 图像路由（视觉模型 vs 纯文本模型）[​](#图像路由视觉模型-vs-纯文本模型 "图像路由（视觉模型 vs 纯文本模型）的直接链接")
...
处理文本描述路径的辅助模型可在 `auxiliary.vision` 下配置——参见[辅助模型](/docs/zh-Hans/user-guide/configuration#auxiliary-models)。

### `vision_analyze` 具有相同的双重行为[​](#vision_analyze-具有相同的双重行为 "vision_analyze-具有相同的双重行为的直接链接")
...
* [粘贴方式](#粘贴方式)
  ...
  + [`/terminal-setup`（适用于 VS Code / Cursor / Windsurf）](#terminal-setup适用于-vs-code--cursor--windsurf)
* [平台兼容性](#平台兼容性)
* [各平台配置说明](#各平台配置说明)
  + [macOS](#macos)
  + [Linux（X11）](#linuxx11)
...
* [SSH 与远程会话](#ssh-与远程会话)
  + [SSH 的变通方案](#ssh-的变通方案)
* [为什么终端无法粘贴图像](#为什么终端无法粘贴图像)
* [支持的模型](#支持的模型)
* [图像路由（视觉模型 vs 纯文本模型）](#图像路由视觉模型-vs-纯文本模型)
  + [`vision_analyze` 具有相同的双重行为](#vision_analyze-具有相同的双重行为)
