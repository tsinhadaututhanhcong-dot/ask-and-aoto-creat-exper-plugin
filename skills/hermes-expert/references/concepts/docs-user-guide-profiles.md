...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/profiles](https://hermes-agent.nousresearch.com/docs/user-guide/profiles)
...
The [web dashboard](/docs/user-guide/features/web-dashboard#managing-multiple-profiles)
...
## Sharing profiles as distributions[​](#sharing-profiles-as-distributions "Direct link to Sharing profiles as distributions")
