...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-peft](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-peft)
...
* [LoRA parameter selection](#lora-parameter-selection)
  ...
  + [Alpha (lora\_alpha) - scaling factor](#alpha-lora_alpha---scaling-factor)
