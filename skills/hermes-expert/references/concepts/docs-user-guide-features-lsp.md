...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/lsp](https://hermes-agent.nousresearch.com/docs/user-guide/features/lsp)
...
## When LSP runs[​](#when-lsp-runs "Direct link to When LSP runs")
...
### Per-server keys[​](#per-server-keys "Direct link to Per-server keys")
...
## Installation locations[​](#installation-locations "Direct link to Installation locations")
...
* [Configuration](#configuration)
  + [Per-server keys](#per-server-keys)
