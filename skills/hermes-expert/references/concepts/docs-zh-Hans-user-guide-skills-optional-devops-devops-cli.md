# Inference Sh Cli — 通过 inference 运行 150+ AI 应用 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/devops/devops-cli](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/devops/devops-cli)
