...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation)
...
## Image-to-Image / Editing[​](#image-to-image--editing "Direct link to Image-to-Image / Editing")
...
### Which backends support editing[​](#which-backends-support-editing "Direct link to Which backends support editing")
...
* [Usage](#usage)
* [Image-to-Image / Editing](#image-to-image--editing)
  + [Which backends support editing](#which-backends-support-editing)
