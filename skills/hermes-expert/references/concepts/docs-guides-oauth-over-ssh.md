...
**Source:** [https://hermes-agent.nousresearch.com/docs/guides/oauth-over-ssh](https://hermes-agent.nousresearch.com/docs/guides/oauth-over-ssh)
...
## Which Providers Need This[​](#which-providers-need-this "Direct link to Which Providers Need This")
...
## Why the listener can't just bind 0.0.0.0[​](#why-the-listener-cant-just-bind-0000 "Direct link to Why the listener can't just bind 0.0.0.0")
...
## Step-by-step: single SSH hop[​](#step-by-step-single-ssh-hop "Direct link to Step-by-step: single SSH hop")

### 1. Start the tunnel from your local machine[​](#1-start-the-tunnel-from-your-local-machine "Direct link to 1. Start the tunnel from your local machine")
...
### 2. In a separate SSH session, run the auth command[​](#2-in-a-separate-ssh-session-run-the-auth-command "Direct link to 2. In a separate SSH session, run the auth command")
...
### 3. Open the URL in your local browser[​](#3-open-the-url-in-your-local-browser "Direct link to 3. Open the URL in your local browser")
...
## Step-by-step: through a jump box[​](#step-by-step-through-a-jump-box "Direct link to Step-by-step: through a jump box")
...
## Mosh, tmux, ssh ControlMaster[​](#mosh-tmux-ssh-controlmaster "Direct link to Mosh, tmux, ssh ControlMaster")
...
### `bind [127.0.0.1]:43827: Address already in use`[​](#bind-12700143827-address-already-in-use "Direct link to bind-12700143827-address-already-in-use")
...
### Authorization timed out waiting for the local callback[​](#authorization-timed-out-waiting-for-the-local-callback "Direct link to Authorization timed out waiting for the local callback")
...
### Tokens land in the wrong `~/.hermes`[​](#tokens-land-in-the-wrong-hermes "Direct link to tokens-land-in-the-wrong-hermes")
...
* [TL;DR](#tldr)
* [Which Providers Need This](#which-providers-need-this)
* [MCP Servers](#mcp-servers)
* [Why the listener can't just bind 0.0.0.0](#why-the-listener-cant-just-bind-0000)
* [Step-by-step: single SSH hop](#step-by-step-single-ssh-hop)
  + [1. Start the tunnel from your local machine](#1-start-the-tunnel-from-your-local-machine)
  + [2. In a separate SSH session, run the auth command](#2-in-a-separate-ssh-session-run-the-auth-command)
  + [3. Open the URL in your local browser](#3-open-the-url-in-your-local-browser)
* [Step-by-step: through a jump box](#step-by-step-through-a-jump-box)
...
* [Troubleshooting](#troubleshooting)
  ...
  + [Authorization timed out waiting for the local callback](#authorization-timed-out-waiting-for-the-local-callback)
  + [Tokens land in the wrong `~/.hermes`](#tokens-land-in-the-wrong-hermes)
* [See Also](#see-also)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify](./docs-user-guide-features-spotify.md)
