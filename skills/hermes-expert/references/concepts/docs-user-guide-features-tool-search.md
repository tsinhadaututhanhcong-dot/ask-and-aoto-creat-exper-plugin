...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-search](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-search)
...
## When does it activate?[​](#when-does-it-activate "Direct link to When does it activate?")
...
## When NOT to use it[​](#when-not-to-use-it "Direct link to When NOT to use it")
...
## Trade-offs that don't go away[​](#trade-offs-that-dont-go-away "Direct link to Trade-offs that don't go away")
