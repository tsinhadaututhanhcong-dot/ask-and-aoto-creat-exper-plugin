# DCF 模型 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-dcf-model](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-dcf-model)
...
| 相关 skill | [`excel-author`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-excel-author), [`pptx-author`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-pptx-author), [`comps-analysis`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis), [`lbo-model`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-lbo-model), [`3-statement-model`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-3-statement-model) |
...
## 关键约束——请先阅读[​](#关键约束请先阅读 "关键约束——请先阅读的直接链接")
...
## DCF 流程工作流[​](#dcf-流程工作流 "DCF 流程工作流的直接链接")

### 第 1 步：数据获取与验证[​](#第-1-步数据获取与验证 "第 1 步：数据获取与验证的直接链接")
...
### 第 2 步：历史分析（3-5 年）[​](#第-2-步历史分析3-5-年 "第 2 步：历史分析（3-5 年）的直接链接")
...
### 第 3 步：构建收入预测[​](#第-3-步构建收入预测 "第 3 步：构建收入预测的直接链接")
...
### 第 4 步：运营费用建模[​](#第-4-步运营费用建模 "第 4 步：运营费用建模的直接链接")
...
### 第 5 步：自由现金流计算[​](#第-5-步自由现金流计算 "第 5 步：自由现金流计算的直接链接")
...
### 第 6 步：资本成本（WACC）研究[​](#第-6-步资本成本wacc研究 "第 6 步：资本成本（WACC）研究的直接链接")
...
### 第 7 步：折现率应用（5-10 年预测）[​](#第-7-步折现率应用5-10-年预测 "第 7 步：折现率应用（5-10 年预测）的直接链接")
...
### 第 8 步：终值计算[​](#第-8-步终值计算 "第 8 步：终值计算的直接链接")
...
### 第 9 步：企业价值到股权价值桥接[​](#第-9-步企业价值到股权价值桥接 "第 9 步：企业价值到股权价值桥接的直接链接")
...
### 第 10 步：敏感性分析[​](#第-10-步敏感性分析 "第 10 步：敏感性分析的直接链接")
...
### 情景块选择模式——遵循此方法[​](#情景块选择模式遵循此方法 "情景块选择模式——遵循此方法的直接链接")
...
### 正确的收入预测模式[​](#正确的收入预测模式 "正确的收入预测模式的直接链接")
...
### 正确的 FCF 公式模式[​](#正确的-fcf-公式模式 "正确的 FCF 公式模式的直接链接")
...
### 正确的单元格注释格式[​](#正确的单元格注释格式 "正确的单元格注释格式的直接链接")
...
### 正确的假设表格结构[​](#正确的假设表格结构 "正确的假设表格结构的直接链接")
...
### 正确的行规划流程[​](#正确的行规划流程 "正确的行规划流程的直接链接")
...
### 正确的敏感性表格实现[​](#正确的敏感性表格实现 "正确的敏感性表格实现的直接链接")
...
### 错误：简化的敏感性表格近似或占位文本[​](#错误简化的敏感性表格近似或占位文本 "错误：简化的敏感性表格近似或占位文本的直接链接")
...
### 错误：缺少单元格注释[​](#错误缺少单元格注释 "错误：缺少单元格注释的直接链接")
...
### 错误：公式行引用偏移[​](#错误公式行引用偏移 "错误：公式行引用偏移的直接链接")
...
### 错误：每个情景中每个假设使用单行[​](#错误每个情景中每个假设使用单行 "错误：每个情景中每个假设使用单行的直接链接")
...
### 错误：错误的字体颜色或无字体颜色区分[​](#错误错误的字体颜色或无字体颜色区分 "错误：错误的字体颜色或无字体颜色区分的直接链接")
...
### 错误：运营费用基于毛利润[​](#错误运营费用基于毛利润 "错误：运营费用基于毛利润的直接链接")
...
### 前 5 大错误汇总[​](#前-5-大错误汇总 "前 5 大错误汇总的直接链接")
...
### WACC 计算错误[​](#wacc-计算错误 "WACC 计算错误的直接链接")
...
## Excel 文件创建[​](#excel-文件创建 "Excel 文件创建的直接链接")
...
## Excel 模型结构[​](#excel-模型结构 "Excel 模型结构的直接链接")

### 工作表架构[​](#工作表架构 "工作表架构的直接链接")
...
### 公式重新计算（必须执行）[​](#公式重新计算必须执行 "公式重新计算（必须执行）的直接链接")
...
### 边框标准（专业外观的必要要求）[​](#边框标准专业外观的必要要求 "边框标准（专业外观的必要要求）的直接链接")
...
### DCF 工作表详细结构[​](#dcf-工作表详细结构 "DCF 工作表详细结构的直接链接")
...
### WACC 工作表结构[​](#wacc-工作表结构 "WACC 工作表结构的直接链接")
...
### 敏感性分析（DCF 工作表底部）[​](#敏感性分析dcf-工作表底部 "敏感性分析（DCF 工作表底部）的直接链接")
...
## 工作流集成[​](#工作流集成 "工作流集成的直接链接")

### DCF 构建开始时[​](#dcf-构建开始时 "DCF 构建开始时的直接链接")
...
## 最终输出检查清单[​](#最终输出检查清单 "最终输出检查清单的直接链接")
...
## 数据来源——MCP 优先，网络备用[​](#数据来源mcp-优先网络备用 "数据来源——MCP 优先，网络备用的直接链接")
...
* [关键约束——请先阅读](#关键约束请先阅读)
* [DCF 流程工作流](#dcf-流程工作流)
  + [第 1 步：数据获取与验证](#第-1-步数据获取与验证)
  + [第 2 步：历史分析（3-5 年）](#第-2-步历史分析3-5-年)
  + [第 3 步：构建收入预测](#第-3-步构建收入预测)
  + [第 4 步：运营费用建模](#第-4-步运营费用建模)
  + [第 5 步：自由现金流计算](#第-5-步自由现金流计算)
  + [第 6 步：资本成本（WACC）研究](#第-6-步资本成本wacc研究)
  + [第 7 步：折现率应用（5-10 年预测）](#第-7-步折现率应用5-10-年预测)
  + [第 8 步：终值计算](#第-8-步终值计算)
  + [第 9 步：企业价值到股权价值桥接](#第-9-步企业价值到股权价值桥接)
  + [第 10 步：敏感性分析](#第-10-步敏感性分析)
  + [情景块选择模式——遵循此方法](#情景块选择模式遵循此方法)
  + [正确的收入预测模式](#正确的收入预测模式)
  + [正确的 FCF 公式模式](#正确的-fcf-公式模式)
  + [正确的单元格注释格式](#正确的单元格注释格式)
  + [正确的假设表格结构](#正确的假设表格结构)
  + [正确的行规划流程](#正确的行规划流程)
  + [正确的敏感性表格实现](#正确的敏感性表格实现)
  + [错误：简化的敏感性表格近似或占位文本](#错误简化的敏感性表格近似或占位文本)
  + [错误：缺少单元格注释](#错误缺少单元格注释)
  + [错误：公式行引用偏移](#错误公式行引用偏移)
  + [错误：每个情景中每个假设使用单行](#错误每个情景中每个假设使用单行)
  + [错误：无边框](#错误无边框)
  + [错误：错误的字体颜色或无字体颜色区分](#错误错误的字体颜色或无字体颜色区分)
  + [错误：运营费用基于毛利润](#错误运营费用基于毛利润)
  + [前 5 大错误汇总](#前-5-大错误汇总)
  + [WACC 计算错误](#wacc-计算错误)
  + [增长假设缺陷](#增长假设缺陷)
  + [终值错误](#终值错误)
  + [现金流预测错误](#现金流预测错误)
* [Excel 文件创建](#excel-文件创建)
* [质量评估标准](#质量评估标准)
* [输入要求](#输入要求)
  + [最低必需输入](#最低必需输入)
* [Excel 模型结构](#excel-模型结构)
  + [工作表架构](#工作表架构)
  + [公式重新计算（必须执行）](#公式重新计算必须执行)
  + [格式标准](#格式标准)
  + [边框标准（专业外观的必要要求）](#边框标准专业外观的必要要求)
  + [DCF 工作表详细结构](#dcf-工作表详细结构)
  + [WACC 工作表结构](#wacc-工作表结构)
  + [敏感性分析（DCF 工作表底部）](#敏感性分析dcf-工作表底部)
* [情景选择器实现](#情景选择器实现)
  + [熊市情景](#熊市情景)
  + [基准情景](#基准情景)
  + [牛市情景](#牛市情景)
...
* [工作流集成](#工作流集成)
  + [DCF 构建开始时](#dcf-构建开始时)
  + [模型构建期间](#模型构建期间)
  + [交付模型前（必须执行）](#交付模型前必须执行)
  + [可用数据来源](#可用数据来源)
* [最终输出检查清单](#最终输出检查清单)
* [数据来源——MCP 优先，网络备用](#数据来源mcp-优先网络备用)
* [归属](#归属)
