# 流行网页设计 — 54 个真实设计系统（Stripe、Linear、Vercel）的 HTML/CSS | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-popular-web-designs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-popular-web-designs)
...
## 相关设计 skill[​](#相关设计-skill "相关设计 skill的直接链接")
...
## HTML 生成模式[​](#html-生成模式 "HTML 生成模式的直接链接")
...
### AI 与机器学习[​](#ai-与机器学习 "AI 与机器学习的直接链接")
...
### 开发者工具与平台[​](#开发者工具与平台 "开发者工具与平台的直接链接")
...
### 金融科技与加密货币[​](#金融科技与加密货币 "金融科技与加密货币的直接链接")
