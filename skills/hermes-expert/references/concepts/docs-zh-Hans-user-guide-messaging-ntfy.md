# ntfy | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/ntfy](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/ntfy)
...
## 配置 Hermes[​](#配置-hermes "配置 Hermes的直接链接")
...
## 身份模型——部署前请阅读[​](#身份模型部署前请阅读 "身份模型——部署前请阅读的直接链接")
...
## 快速开始——从手机与 agent 对话[​](#快速开始从手机与-agent-对话 "快速开始——从手机与 agent 对话的直接链接")
...
## 在 cron 任务中使用 ntfy[​](#在-cron-任务中使用-ntfy "在 cron 任务中使用 ntfy的直接链接")
...
## 自托管 ntfy[​](#自托管-ntfy "自托管 ntfy的直接链接")
...
## 仅出站设置（只推送通知，不接收消息）[​](#仅出站设置只推送通知不接收消息 "仅出站设置（只推送通知，不接收消息）的直接链接")
...
* [配置 Hermes](#配置-hermes)
  + [通过设置向导](#通过设置向导)
  + [通过环境变量](#通过环境变量)
* [身份模型——部署前请阅读](#身份模型部署前请阅读)
* [快速开始——从手机与 agent 对话](#快速开始从手机与-agent-对话)
* [在 cron 任务中使用 ntfy](#在-cron-任务中使用-ntfy)
* [自托管 ntfy](#自托管-ntfy)
* [Markdown 格式化](#markdown-格式化)
* [仅出站设置（只推送通知，不接收消息）](#仅出站设置只推送通知不接收消息)
* [限制](#限制)
* [故障排查](#故障排查)