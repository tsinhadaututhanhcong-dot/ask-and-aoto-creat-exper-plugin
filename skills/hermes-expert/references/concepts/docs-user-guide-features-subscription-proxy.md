...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/subscription-proxy](https://hermes-agent.nousresearch.com/docs/user-guide/features/subscription-proxy)
...
### 1. Log into your provider (one-time)[​](#1-log-into-your-provider-one-time "Direct link to 1. Log into your provider (one-time)")
...
### 3. Point your app at it[​](#3-point-your-app-at-it "Direct link to 3. Point your app at it")
...
## Check status[​](#check-status "Direct link to Check status")
...
## Allowed paths[​](#allowed-paths "Direct link to Allowed paths")
...
## Configuring OpenViking to use Portal[​](#configuring-openviking-to-use-portal "Direct link to Configuring OpenViking to use Portal")
...
## Configuring Karakeep (or any bookmark/summarizer app)[​](#configuring-karakeep-or-any-bookmarksummarizer-app "Direct link to Configuring Karakeep (or any bookmark/summarizer app)")
...
## Exposing on LAN[​](#exposing-on-lan "Direct link to Exposing on LAN")
...
## Future: more OAuth providers[​](#future-more-oauth-providers "Direct link to Future: more OAuth providers")
...
* [Quick Start](#quick-start)
  ...
  + [3. Point your app at it](#3-point-your-app-at-it)
* [Available providers](#available-providers)
* [Check status](#check-status)
* [Allowed paths](#allowed-paths)
* [Configuring OpenViking to use Portal](#configuring-openviking-to-use-portal)
* [Configuring Karakeep (or any bookmark/summarizer app)](#configuring-karakeep-or-any-bookmarksummarizer-app)
* [Exposing on LAN](#exposing-on-lan)
* [Rate limits](#rate-limits)
* [Architecture](#architecture)
* [Future: more OAuth providers](#future-more-oauth-providers)
