...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/provider-runtime](https://hermes-agent.nousresearch.com/docs/developer-guide/provider-runtime)
...
## OpenRouter and custom OpenAI-compatible base URLs[​](#openrouter-and-custom-openai-compatible-base-urls "Direct link to OpenRouter and custom OpenAI-compatible base URLs")
...
* [OpenRouter and custom OpenAI-compatible base URLs](#openrouter-and-custom-openai-compatible-base-urls)
