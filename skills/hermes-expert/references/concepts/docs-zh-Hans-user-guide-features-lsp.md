# LSP — 语义诊断 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp)
...
## LSP 的触发时机[​](#lsp-的触发时机 "LSP 的触发时机的直接链接")
