...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/software-development/software-development-code-wiki](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/software-development/software-development-code-wiki)
...
### 1. Resolve the target[​](#1-resolve-the-target "Direct link to 1. Resolve the target")
...
### 2. Scan repo structure[​](#2-scan-repo-structure "Direct link to 2. Scan repo structure")
...
### 3. Pick modules to document[​](#3-pick-modules-to-document "Direct link to 3. Pick modules to document")
...
### 4. Write `README.md`[​](#4-write-readmemd "Direct link to 4-write-readmemd")
...
### 5. Write `architecture.md`[​](#5-write-architecturemd "Direct link to 5-write-architecturemd")
...
### 6. Write per-module docs in `modules/`[​](#6-write-per-module-docs-in-modules "Direct link to 6-write-per-module-docs-in-modules")
...
### 7. Write `diagrams/class-diagram.md`[​](#7-write-diagramsclass-diagrammd "Direct link to 7-write-diagramsclass-diagrammd")
...
### 8. Write `diagrams/sequences.md`[​](#8-write-diagramssequencesmd "Direct link to 8-write-diagramssequencesmd")
...
### 9. Write `getting-started.md`[​](#9-write-getting-startedmd "Direct link to 9-write-getting-startedmd")
...
### 10. Write `api.md` (skip if not applicable)[​](#10-write-apimd-skip-if-not-applicable "Direct link to 10-write-apimd-skip-if-not-applicable")
...
### 11. Write the state file[​](#11-write-the-state-file "Direct link to 11. Write the state file")
...
### 12. Report to user[​](#12-report-to-user "Direct link to 12. Report to user")
...
## Scope Control[​](#scope-control "Direct link to Scope Control")
...
## Re-Run / Update[​](#re-run--update "Direct link to Re-Run / Update")
...
* [Procedure](#procedure)
  + [1. Resolve the target](#1-resolve-the-target)
  + [2. Scan repo structure](#2-scan-repo-structure)
  + [3. Pick modules to document](#3-pick-modules-to-document)
  + [4. Write `README.md`](#4-write-readmemd)
  + [5. Write `architecture.md`](#5-write-architecturemd)
  + [6. Write per-module docs in `modules/`](#6-write-per-module-docs-in-modules)
  + [7. Write `diagrams/class-diagram.md`](#7-write-diagramsclass-diagrammd)
  + [8. Write `diagrams/sequences.md`](#8-write-diagramssequencesmd)
  + [9. Write `getting-started.md`](#9-write-getting-startedmd)
  + [10. Write `api.md` (skip if not applicable)](#10-write-apimd-skip-if-not-applicable)
  + [11. Write the state file](#11-write-the-state-file)
  + [12. Report to user](#12-report-to-user)
* [Scope Control](#scope-control)
* [Re-Run / Update](#re-run--update)
* [Pitfalls](#pitfalls)
