# agent/transports/hermes_tools_mcp_server.py (repo source)
**Source:** https://github.com/NousResearch/hermes-agent/blob/main/agent/transports/hermes_tools_mcp_server.py
