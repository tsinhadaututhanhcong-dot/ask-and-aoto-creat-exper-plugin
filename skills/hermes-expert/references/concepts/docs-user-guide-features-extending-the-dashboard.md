...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/extending-the-dashboard](https://hermes-agent.nousresearch.com/docs/user-guide/features/extending-the-dashboard)
...
##### Changing the font from the UI (no YAML)[​](#changing-the-font-from-the-ui-no-yaml "Direct link to Changing the font from the UI (no YAML)")
