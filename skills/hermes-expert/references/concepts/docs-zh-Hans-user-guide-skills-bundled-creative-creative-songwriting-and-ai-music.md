# Songwriting And Ai Music — 歌词创作与 Suno AI 音乐提示词 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music)
...
## 1. 歌曲结构（选一种或自创）[​](#1-歌曲结构选一种或自创 "1. 歌曲结构（选一种或自创）的直接链接")
...
## 2. 押韵、韵律与音效[​](#2-押韵韵律与音效 "2. 押韵、韵律与音效的直接链接")
...
## 3. 情感弧线与动态[​](#3-情感弧线与动态 "3. 情感弧线与动态的直接链接")
...
## 4. 写出有效的歌词[​](#4-写出有效的歌词 "4. 写出有效的歌词的直接链接")
...
## 6. Suno AI Prompt 工程[​](#6-suno-ai-prompt-工程 "6. Suno AI Prompt 工程的直接链接")

### 风格/流派描述字段[​](#风格流派描述字段 "风格/流派描述字段的直接链接")
...
### Metatag（元标签，放在歌词字段的 [方括号] 内）[​](#metatag元标签放在歌词字段的-方括号-内 "Metatag（元标签，放在歌词字段的 [方括号] 内）的直接链接")
...
### Custom Mode（自定义模式）[​](#custom-mode自定义模式 "Custom Mode（自定义模式）的直接链接")
...
## 7. 为 AI 歌手设计的音韵技巧[​](#7-为-ai-歌手设计的音韵技巧 "7. 为 AI 歌手设计的音韵技巧的直接链接")
...
* [1. 歌曲结构（选一种或自创）](#1-歌曲结构选一种或自创)
* [2. 押韵、韵律与音效](#2-押韵韵律与音效)
* [3. 情感弧线与动态](#3-情感弧线与动态)
* [4. 写出有效的歌词](#4-写出有效的歌词)
* [5. 戏仿与改编](#5-戏仿与改编)
* [6. Suno AI Prompt 工程](#6-suno-ai-prompt-工程)
  + [风格/流派描述字段](#风格流派描述字段)
  + [Metatag（元标签，放在歌词字段的 [方括号] 内）](#metatag元标签放在歌词字段的-方括号-内)
  + [Custom Mode（自定义模式）](#custom-mode自定义模式)
* [7. 为 AI 歌手设计的音韵技巧](#7-为-ai-歌手设计的音韵技巧)
* [8. 工作流程](#8-工作流程)
* [9. 经验总结](#9-经验总结)