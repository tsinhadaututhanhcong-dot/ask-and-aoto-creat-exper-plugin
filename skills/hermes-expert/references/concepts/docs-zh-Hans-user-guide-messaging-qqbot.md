# QQ Bot | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/qqbot](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/qqbot)
...
## 语音消息（STT）[​](#语音消息stt "语音消息（STT）的直接链接")
...
### 机器人立即断开连接（快速断连）[​](#机器人立即断开连接快速断连 "机器人立即断开连接（快速断连）的直接链接")
...
### 语音消息未被转写[​](#语音消息未被转写 "语音消息未被转写的直接链接")
