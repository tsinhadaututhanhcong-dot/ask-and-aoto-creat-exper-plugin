...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/payments/payments-stripe-link-cli](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/payments/payments-stripe-link-cli)
...
| Related skills | [`mpp-agent`](/docs/zh-Hans/docs/user-guide/skills/optional/payments/payments-mpp-agent), [`stripe-projects`](/docs/zh-Hans/docs/user-guide/skills/optional/payments/payments-stripe-projects) |
...
### 1. Check / establish auth[​](#1-check--establish-auth "1. Check / establish auth的直接链接")
...
### 2. Evaluate the merchant before creating a spend request[​](#2-evaluate-the-merchant-before-creating-a-spend-request "2. Evaluate the merchant before creating a spend request的直接链接")
...
### 3. List payment methods + shipping[​](#3-list-payment-methods--shipping "3. List payment methods + shipping的直接链接")
...
### 4. Create the spend request[​](#4-create-the-spend-request "4. Create the spend request的直接链接")
...
### 5. Retrieve the credential — SECURELY[​](#5-retrieve-the-credential--securely "5. Retrieve the credential — SECURELY的直接链接")
...
### 6. Use the credential[​](#6-use-the-credential "6. Use the credential的直接链接")
...
### 7. Clean up[​](#7-clean-up "7. Clean up的直接链接")
...
## Optional: run as an MCP server instead[​](#optional-run-as-an-mcp-server-instead "Optional: run as an MCP server instead的直接链接")
