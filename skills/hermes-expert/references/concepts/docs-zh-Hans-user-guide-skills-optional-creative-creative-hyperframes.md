...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes)
...
| 相关技能 | [`manim-video`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-manim-video), [`meme-generation`](/docs/zh-Hans/user-guide/skills/optional/creative/creative-meme-generation) |
...
## 初始设置（一次性）[​](#初始设置一次性 "初始设置（一次性）的直接链接")
...
### 1. 编写 HTML 前先规划[​](#1-编写-html-前先规划 "1. 编写 HTML 前先规划的直接链接")
...
### 2. 初始化脚手架[​](#2-初始化脚手架 "2. 初始化脚手架的直接链接")
...
### 3. 先布局，后动画[​](#3-先布局后动画 "3. 先布局，后动画的直接链接")
...
### 4. 使用 GSAP 制作动画[​](#4-使用-gsap-制作动画 "4. 使用 GSAP 制作动画的直接链接")
...
### 6. 音频、字幕、TTS、音频响应、高亮[​](#6-音频字幕tts音频响应高亮 "6. 音频、字幕、TTS、音频响应、高亮的直接链接")
...
### 7. Lint、验证、检查、预览、渲染[​](#7-lint验证检查预览渲染 "7. Lint、验证、检查、预览、渲染的直接链接")
...
### 8. 网站转视频（若用户提供 URL）[​](#8-网站转视频若用户提供-url "8. 网站转视频（若用户提供 URL）的直接链接")
...
* [初始设置（一次性）](#初始设置一次性)
* [操作流程](#操作流程)
  + [1. 编写 HTML 前先规划](#1-编写-html-前先规划)
  + [2. 初始化脚手架](#2-初始化脚手架)
  + [3. 先布局，后动画](#3-先布局后动画)
  + [4. 使用 GSAP 制作动画](#4-使用-gsap-制作动画)
  + [5. 场景间转场](#5-场景间转场)
  + [6. 音频、字幕、TTS、音频响应、高亮](#6-音频字幕tts音频响应高亮)
  + [7. Lint、验证、检查、预览、渲染](#7-lint验证检查预览渲染)
  + [8. 网站转视频（若用户提供 URL）](#8-网站转视频若用户提供-url)
* [常见陷阱](#常见陷阱)
* [验证](#验证)
* [参考资料](#参考资料)
