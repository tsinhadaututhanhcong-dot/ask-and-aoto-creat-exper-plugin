...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills](https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills)
...
### Deliver media as documents (`[[as_document]]`)[​](#deliver-media-as-documents-as_document "Direct link to deliver-media-as-documents-as_document")
...
## Blueprints: skills that are also automations[​](#blueprints-skills-that-are-also-automations "Direct link to Blueprints: skills that are also automations")
...
## Suggested Cron Jobs[​](#suggested-cron-jobs "Direct link to Suggested Cron Jobs")
...
* [Skill Guidelines](#skill-guidelines)
  ...
  + [Deliver media as documents (`[[as_document]]`)](#deliver-media-as-documents-as_document)
  + [Test It](#test-it)
* [Where Should the Skill Live?](#where-should-the-skill-live)
* [Blueprints: skills that are also automations](#blueprints-skills-that-are-also-automations)
* [Suggested Cron Jobs](#suggested-cron-jobs)
