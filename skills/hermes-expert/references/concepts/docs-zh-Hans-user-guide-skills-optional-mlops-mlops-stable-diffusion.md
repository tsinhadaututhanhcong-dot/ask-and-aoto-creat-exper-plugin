# Stable Diffusion 图像生成 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-stable-diffusion](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-stable-diffusion)
...
## 何时使用 Stable Diffusion[​](#何时使用-stable-diffusion "何时使用 Stable Diffusion的直接链接")
...
### 使用 SDXL（更高质量）[​](#使用-sdxl更高质量 "使用 SDXL（更高质量）的直接链接")
...
### Pipeline 推理流程[​](#pipeline-推理流程 "Pipeline 推理流程的直接链接")
...
### Pipeline[​](#pipeline "Pipeline的直接链接")
...
### Scheduler[​](#scheduler "Scheduler的直接链接")
...
### 切换 Scheduler[​](#切换-scheduler "切换 Scheduler的直接链接")
...
### Negative prompt[​](#negative-prompt "Negative prompt的直接链接")
...
## Inpainting[​](#inpainting "Inpainting的直接链接")
...
## ControlNet[​](#controlnet "ControlNet的直接链接")
...
### 可用的 ControlNet[​](#可用的-controlnet "可用的 ControlNet的直接链接")
...
## LoRA 适配器[​](#lora-适配器 "LoRA 适配器的直接链接")
...
### 启用 CPU 卸载[​](#启用-cpu-卸载 "启用 CPU 卸载的直接链接")
...
### Attention 切片[​](#attention-切片 "Attention 切片的直接链接")
...
### xFormers 内存高效 Attention[​](#xformers-内存高效-attention "xFormers 内存高效 Attention的直接链接")
...
### 大图像的 VAE 切片[​](#大图像的-vae-切片 "大图像的 VAE 切片的直接链接")
...
### 工作流 1：高质量生成[​](#工作流-1高质量生成 "工作流 1：高质量生成的直接链接")
...
### 工作流 2：快速原型验证[​](#工作流-2快速原型验证 "工作流 2：快速原型验证的直接链接")
...
* [何时使用 Stable Diffusion](#何时使用-stable-diffusion)
* [快速开始](#快速开始)
  + [安装](#安装)
  + [基础文本到图像](#基础文本到图像)
  + [使用 SDXL（更高质量）](#使用-sdxl更高质量)
* [架构概览](#架构概览)
  + [三支柱设计](#三支柱设计)
  + [Pipeline 推理流程](#pipeline-推理流程)
* [核心概念](#核心概念)
  + [Pipeline](#pipeline)
  + [Scheduler](#scheduler)
  + [切换 Scheduler](#切换-scheduler)
* [生成参数](#生成参数)
  + [关键参数](#关键参数)
  + [可复现生成](#可复现生成)
...
* [ControlNet](#controlnet)
  + [可用的 ControlNet](#可用的-controlnet)
* [LoRA 适配器](#lora-适配器)
  + [多个 LoRA](#多个-lora)
* [内存优化](#内存优化)
  + [启用 CPU 卸载](#启用-cpu-卸载)
  + [Attention 切片](#attention-切片)
  + [xFormers 内存高效 Attention](#xformers-内存高效-attention)
  + [大图像的 VAE 切片](#大图像的-vae-切片)
* [模型变体](#模型变体)
  + [加载不同精度](#加载不同精度)
  + [加载特定组件](#加载特定组件)
* [批量生成](#批量生成)
* [常见工作流](#常见工作流)
  + [工作流 1：高质量生成](#工作流-1高质量生成)
  + [工作流 2：快速原型验证](#工作流-2快速原型验证)
* [常见问题](#常见问题)
* [参考资料](#参考资料)
* [资源](#资源)