# 电脑操控 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use)
...
## 保持 cua-driver 最新[​](#保持-cua-driver-最新 "保持 cua-driver 最新的直接链接")
...
* 破坏性操作（click、type、drag、scroll、key、focus\_app）需要审批——通过 CLI 对话框交互确认，或通过消息平台审批按钮确认。
...
## Token 效率[​](#token-效率 "Token 效率的直接链接")
...
* 跨平台 Web 任务请参阅[浏览器自动化](/docs/zh-Hans/user-guide/features/browser)。

* [工作原理](#工作原理)
* [启用](#启用)
* [保持 cua-driver 最新](#保持-cua-driver-最新)
* [快速示例](#快速示例)
* [提供商兼容性](#提供商兼容性)
* [安全性](#安全性)
* [Token 效率](#token-效率)
