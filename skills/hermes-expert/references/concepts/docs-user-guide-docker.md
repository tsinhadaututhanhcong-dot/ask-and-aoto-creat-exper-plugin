# Docker | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/docker](https://hermes-agent.nousresearch.com/docs/user-guide/docker)
...
### Immutable install tree[​](#immutable-install-tree "Direct link to Immutable install tree")
...
### Reaching more than one profile from outside the container[​](#reaching-more-than-one-profile-from-outside-the-container "Direct link to Reaching more than one profile from outside the container")
...
### Why one container with many profiles, not many containers[​](#why-one-container-with-many-profiles-not-many-containers "Direct link to Why one container with many profiles, not many containers")
...
### When you DO want a separate container[​](#when-you-do-want-a-separate-container "Direct link to When you DO want a separate container")
...
## Where the logs go[​](#where-the-logs-go "Direct link to Where the logs go")
...
## Optional: Linux desktop audio bridge[​](#optional-linux-desktop-audio-bridge "Direct link to Optional: Linux desktop audio bridge")
...
### `docker exec` automatically drops to the `hermes` user[​](#docker-exec-automatically-drops-to-the-hermes-user "Direct link to docker-exec-automatically-drops-to-the-hermes-user")
...
### Per-profile gateway supervision[​](#per-profile-gateway-supervision "Direct link to Per-profile gateway supervision")
...
## Installing more tools in the container[​](#installing-more-tools-in-the-container "Direct link to Installing more tools in the container")
...
### npm or Python tools — use `npx` or `uvx`[​](#npm-or-python-tools--use-npx-or-uvx "Direct link to npm-or-python-tools--use-npx-or-uvx")
...
### Other tools (apt packages, binaries) — install and remember[​](#other-tools-apt-packages-binaries--install-and-remember "Direct link to Other tools (apt packages, binaries) — install and remember")
...
### Durable installs — build a derived image[​](#durable-installs--build-a-derived-image "Direct link to Durable installs — build a derived image")
...
### Complex tools or multi-service stacks — run a sidecar container[​](#complex-tools-or-multi-service-stacks--run-a-sidecar-container "Direct link to Complex tools or multi-service stacks — run a sidecar container")
...
### Broadly useful tools — open an issue or pull request[​](#broadly-useful-tools--open-an-issue-or-pull-request "Direct link to Broadly useful tools — open an issue or pull request")
