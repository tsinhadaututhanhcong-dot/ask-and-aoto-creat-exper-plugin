# Pets (Petdex Mascots) | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/pets](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/pets)
...
* Pets are installed into your profile's `pets/` directory
  (`<HERMES_HOME>/pets/<slug>/`), so each [profile](/docs/zh-Hans/user-guide/profiles.md) keeps its
  own set.
...
## Rendering[​](#rendering "Rendering的直接链接")
...
## Quick start (CLI)[​](#quick-start-cli "Quick start (CLI)的直接链接")
...
## `hermes pets` commands[​](#hermes-pets-commands "hermes-pets-commands的直接链接")
...
## `/pet` slash command[​](#pet-slash-command "pet-slash-command的直接链接")
...
## Generating a pet (`/hatch`)[​](#generating-a-pet-hatch "generating-a-pet-hatch的直接链接")
...
## Desktop app[​](#desktop-app "Desktop app的直接链接")
...
### Pop-out overlay[​](#pop-out-overlay "Pop-out overlay的直接链接")
...
* The [`petdex` skill](/docs/zh-Hans/user-guide/skills/bundled/productivity/productivity-petdex)
  lets the agent install and switch pets for you on request.

* [How it works](#how-it-works)
* [Rendering](#rendering)
* [Quick start (CLI)](#quick-start-cli)
* [`hermes pets` commands](#hermes-pets-commands)
* [`/pet` slash command](#pet-slash-command)
* [Generating a pet (`/hatch`)](#generating-a-pet-hatch)
  + [Image backend](#image-backend)
* [Desktop app](#desktop-app)
  + [Pop-out overlay](#pop-out-overlay)
...
- [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/productivity/productivity-petdex](./docs-zh-Hans-user-guide-skills-bundled-productivity-productivity-petdex.md)
