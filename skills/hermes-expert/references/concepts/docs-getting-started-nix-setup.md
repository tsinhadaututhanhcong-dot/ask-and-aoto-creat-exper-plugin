...
**Source:** [https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup)
...
### Optional Dependency Groups (`extraDependencyGroups`)[​](#optional-dependency-groups-extradependencygroups "Direct link to optional-dependency-groups-extradependencygroups")
...
* [Plugins](#plugins)
  ...
  + [Optional Dependency Groups (`extraDependencyGroups`)](#optional-dependency-groups-extradependencygroups)
