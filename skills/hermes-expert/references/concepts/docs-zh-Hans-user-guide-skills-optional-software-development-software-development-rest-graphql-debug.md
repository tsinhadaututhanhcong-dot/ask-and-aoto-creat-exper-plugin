# Rest Graphql Debug — 调试 REST/GraphQL API：状态码、认证、Schema、复现 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/software-development/software-development-rest-graphql-debug](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/software-development/software-development-rest-graphql-debug)
...
| 相关 skill | [`systematic-debugging`](/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-systematic-debugging)、[`test-driven-development`](/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-test-driven-development) |
...
## 5 分钟快速上手[​](#5-分钟快速上手 "5 分钟快速上手的直接链接")

### 通过 terminal 调试 REST[​](#通过-terminal-调试-rest "通过 terminal 调试 REST的直接链接")
...
### 通过 terminal 调试 GraphQL[​](#通过-terminal-调试-graphql "通过 terminal 调试 GraphQL的直接链接")
...
### 通过 execute\_code 使用 Python（requests）[​](#通过-execute_code-使用-pythonrequests "通过 execute_code 使用 Python（requests）的直接链接")
...
## 分层调试流程[​](#分层调试流程 "分层调试流程的直接链接")

### 第 1 步 — 连通性[​](#第-1-步--连通性 "第 1 步 — 连通性的直接链接")
...
### 第 1.5 步 — 超时[​](#第-15-步--超时 "第 1.5 步 — 超时的直接链接")
...
### 第 2 步 — TLS/SSL[​](#第-2-步--tlsssl "第 2 步 — TLS/SSL的直接链接")
...
### 第 3 步 — 认证[​](#第-3-步--认证 "第 3 步 — 认证的直接链接")
...
### 第 4 步 — 请求格式[​](#第-4-步--请求格式 "第 4 步 — 请求格式的直接链接")
...
### 第 5 步 — 响应解析[​](#第-5-步--响应解析 "第 5 步 — 响应解析的直接链接")
...
### 第 6 步 — 语义验证[​](#第-6-步--语义验证 "第 6 步 — 语义验证的直接链接")
...
## HTTP 状态码处理手册[​](#http-状态码处理手册 "HTTP 状态码处理手册的直接链接")

### 401 Unauthorized — 凭据缺失或无效[​](#401-unauthorized--凭据缺失或无效 "401 Unauthorized — 凭据缺失或无效的直接链接")
...
### 403 Forbidden — 已认证但无权限[​](#403-forbidden--已认证但无权限 "403 Forbidden — 已认证但无权限的直接链接")
...
### 404 Not Found — 资源不存在或 URL 错误[​](#404-not-found--资源不存在或-url-错误 "404 Not Found — 资源不存在或 URL 错误的直接链接")
...
### 409 Conflict — 状态冲突[​](#409-conflict--状态冲突 "409 Conflict — 状态冲突的直接链接")

1. 资源是否已存在（重复创建）？
2. `ETag` / `If-Match` 是否过期？
3. 是否有其他进程并发修改？

### 422 Unprocessable Entity — JSON 合法但数据无效[​](#422-unprocessable-entity--json-合法但数据无效 "422 Unprocessable Entity — JSON 合法但数据无效的直接链接")
...
### 429 Too Many Requests — 触发限流[​](#429-too-many-requests--触发限流 "429 Too Many Requests — 触发限流的直接链接")
...
### 5xx — 服务端问题，通常不是你的错[​](#5xx--服务端问题通常不是你的错 "5xx — 服务端问题，通常不是你的错的直接链接")
...
## Correlation ID[​](#correlation-id "Correlation ID的直接链接")
...
### Token 处理[​](#token-处理 "Token 处理的直接链接")
...
## Hermes 工具使用模式[​](#hermes-工具使用模式 "Hermes 工具使用模式的直接链接")

### terminal — 用于 curl、dig、openssl[​](#terminal--用于-curldigopenssl "terminal — 用于 curl、dig、openssl的直接链接")
...
### execute\_code — 用于多步骤 Python 流程[​](#execute_code--用于多步骤-python-流程 "execute_code — 用于多步骤 Python 流程的直接链接")
...
### web\_extract — 用于查阅厂商 API 文档[​](#web_extract--用于查阅厂商-api-文档 "web_extract — 用于查阅厂商 API 文档的直接链接")
...
### delegate\_task — 用于完整的 CRUD 测试扫描[​](#delegate_task--用于完整的-crud-测试扫描 "delegate_task — 用于完整的 CRUD 测试扫描的直接链接")
...
* [核心原则](#核心原则)
* [5 分钟快速上手](#5-分钟快速上手)
  + [通过 terminal 调试 REST](#通过-terminal-调试-rest)
  + [通过 terminal 调试 GraphQL](#通过-terminal-调试-graphql)
  + [通过 execute\_code 使用 Python（requests）](#通过-execute_code-使用-pythonrequests)
* [分层调试流程](#分层调试流程)
  + [第 1 步 — 连通性](#第-1-步--连通性)
  + [第 1.5 步 — 超时](#第-15-步--超时)
  + [第 2 步 — TLS/SSL](#第-2-步--tlsssl)
  + [第 3 步 — 认证](#第-3-步--认证)
  + [第 4 步 — 请求格式](#第-4-步--请求格式)
  + [第 5 步 — 响应解析](#第-5-步--响应解析)
  + [第 6 步 — 语义验证](#第-6-步--语义验证)
* [HTTP 状态码处理手册](#http-状态码处理手册)
  + [401 Unauthorized — 凭据缺失或无效](#401-unauthorized--凭据缺失或无效)
  + [403 Forbidden — 已认证但无权限](#403-forbidden--已认证但无权限)
  + [404 Not Found — 资源不存在或 URL 错误](#404-not-found--资源不存在或-url-错误)
  + [409 Conflict — 状态冲突](#409-conflict--状态冲突)
  + [422 Unprocessable Entity — JSON 合法但数据无效](#422-unprocessable-entity--json-合法但数据无效)
  + [429 Too Many Requests — 触发限流](#429-too-many-requests--触发限流)
  + [5xx — 服务端问题，通常不是你的错](#5xx--服务端问题通常不是你的错)
* [分页与幂等性](#分页与幂等性)
* [契约验证](#契约验证)
...
* [安全](#安全)
  ...
  + [安全日志记录](#安全日志记录)
  + [泄露检查清单](#泄露检查清单)
* [Hermes 工具使用模式](#hermes-工具使用模式)
  + [terminal — 用于 curl、dig、openssl](#terminal--用于-curldigopenssl)
  + [execute\_code — 用于多步骤 Python 流程](#execute_code--用于多步骤-python-流程)
  + [web\_extract — 用于查阅厂商 API 文档](#web_extract--用于查阅厂商-api-文档)
  + [delegate\_task — 用于完整的 CRUD 测试扫描](#delegate_task--用于完整的-crud-测试扫描)
* [输出格式](#输出格式)
* [相关 Skill](#相关-skill)
