...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-dcf-model](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-dcf-model)
...
## Critical Constraints - Read These First[​](#critical-constraints---read-these-first "Direct link to Critical Constraints - Read These First")
...
## DCF Process Workflow[​](#dcf-process-workflow "Direct link to DCF Process Workflow")

### Step 1: Data Retrieval and Validation[​](#step-1-data-retrieval-and-validation "Direct link to Step 1: Data Retrieval and Validation")
...
### Step 2: Historical Analysis (3-5 years)[​](#step-2-historical-analysis-3-5-years "Direct link to Step 2: Historical Analysis (3-5 years)")
...
### Step 3: Build Revenue Projections[​](#step-3-build-revenue-projections "Direct link to Step 3: Build Revenue Projections")
...
### Step 4: Operating Expense Modeling[​](#step-4-operating-expense-modeling "Direct link to Step 4: Operating Expense Modeling")
...
### Step 5: Free Cash Flow Calculation[​](#step-5-free-cash-flow-calculation "Direct link to Step 5: Free Cash Flow Calculation")
...
### Step 6: Cost of Capital (WACC) Research[​](#step-6-cost-of-capital-wacc-research "Direct link to Step 6: Cost of Capital (WACC) Research")
...
### Step 7: Discount Rate Application (5-10 Year Forecast)[​](#step-7-discount-rate-application-5-10-year-forecast "Direct link to Step 7: Discount Rate Application (5-10 Year Forecast)")
...
### Step 8: Terminal Value Calculation[​](#step-8-terminal-value-calculation "Direct link to Step 8: Terminal Value Calculation")
...
### Step 9: Enterprise to Equity Value Bridge[​](#step-9-enterprise-to-equity-value-bridge "Direct link to Step 9: Enterprise to Equity Value Bridge")
...
### Step 10: Sensitivity Analysis[​](#step-10-sensitivity-analysis "Direct link to Step 10: Sensitivity Analysis")
...
### Scenario Block Selection Pattern - Follow This Approach[​](#scenario-block-selection-pattern---follow-this-approach "Direct link to Scenario Block Selection Pattern - Follow This Approach")
...
### Correct Revenue Projection Pattern[​](#correct-revenue-projection-pattern "Direct link to Correct Revenue Projection Pattern")
...
### Correct FCF Formula Pattern[​](#correct-fcf-formula-pattern "Direct link to Correct FCF Formula Pattern")
...
### Correct Cell Comment Format[​](#correct-cell-comment-format "Direct link to Correct Cell Comment Format")
...
### Correct Assumption Table Structure[​](#correct-assumption-table-structure "Direct link to Correct Assumption Table Structure")
...
### Correct Row Planning Process[​](#correct-row-planning-process "Direct link to Correct Row Planning Process")
...
### Correct Sensitivity Table Implementation[​](#correct-sensitivity-table-implementation "Direct link to Correct Sensitivity Table Implementation")
...
### WRONG: Simplified Sensitivity Table Approximations or Placeholder Text[​](#wrong-simplified-sensitivity-table-approximations-or-placeholder-text "Direct link to WRONG: Simplified Sensitivity Table Approximations or Placeholder Text")
...
### WRONG: Missing Cell Comments[​](#wrong-missing-cell-comments "Direct link to WRONG: Missing Cell Comments")
...
### WRONG: Formula Row References Off[​](#wrong-formula-row-references-off "Direct link to WRONG: Formula Row References Off")
...
### WRONG: Single Row for Each Assumption Across Scenarios[​](#wrong-single-row-for-each-assumption-across-scenarios "Direct link to WRONG: Single Row for Each Assumption Across Scenarios")
...
### WRONG: No Borders[​](#wrong-no-borders "Direct link to WRONG: No Borders")
...
### WRONG: Wrong Font Colors or No Font Color Distinction[​](#wrong-wrong-font-colors-or-no-font-color-distinction "Direct link to WRONG: Wrong Font Colors or No Font Color Distinction")
...
### WRONG: Operating Expenses Based on Gross Profit[​](#wrong-operating-expenses-based-on-gross-profit "Direct link to WRONG: Operating Expenses Based on Gross Profit")
...
### TOP 5 ERRORS SUMMARY[​](#top-5-errors-summary "Direct link to TOP 5 ERRORS SUMMARY")
...
### WACC Calculation Errors[​](#wacc-calculation-errors "Direct link to WACC Calculation Errors")
...
### Growth Assumption Flaws[​](#growth-assumption-flaws "Direct link to Growth Assumption Flaws")
...
### Terminal Value Mistakes[​](#terminal-value-mistakes "Direct link to Terminal Value Mistakes")
...
### Cash Flow Projection Errors[​](#cash-flow-projection-errors "Direct link to Cash Flow Projection Errors")
...
## Excel File Creation[​](#excel-file-creation "Direct link to Excel File Creation")
...
## Quality Rubric[​](#quality-rubric "Direct link to Quality Rubric")
...
### Minimum Required Inputs[​](#minimum-required-inputs "Direct link to Minimum Required Inputs")
...
## Excel Model Structure[​](#excel-model-structure "Direct link to Excel Model Structure")

### Sheet Architecture[​](#sheet-architecture "Direct link to Sheet Architecture")
...
### Formula Recalculation (MANDATORY)[​](#formula-recalculation-mandatory "Direct link to Formula Recalculation (MANDATORY)")
...
### Formatting Standards[​](#formatting-standards "Direct link to Formatting Standards")
...
### Border Standards (REQUIRED for Professional Appearance)[​](#border-standards-required-for-professional-appearance "Direct link to Border Standards (REQUIRED for Professional Appearance)")
...
### DCF Sheet Detailed Structure[​](#dcf-sheet-detailed-structure "Direct link to DCF Sheet Detailed Structure")
...
### WACC Sheet Structure[​](#wacc-sheet-structure "Direct link to WACC Sheet Structure")
...
### Sensitivity Analysis (Bottom of DCF Sheet)[​](#sensitivity-analysis-bottom-of-dcf-sheet "Direct link to Sensitivity Analysis (Bottom of DCF Sheet)")
...
## Case Selector Implementation[​](#case-selector-implementation "Direct link to Case Selector Implementation")

**Three-Case Framework:**

### Bear Case[​](#bear-case "Direct link to Bear Case")
...
### Base Case[​](#base-case "Direct link to Base Case")
...
### Bull Case[​](#bull-case "Direct link to Bull Case")
...
## Deliverables Structure[​](#deliverables-structure "Direct link to Deliverables Structure")
...
### Model Construction[​](#model-construction "Direct link to Model Construction")
...
### Quality Control[​](#quality-control "Direct link to Quality Control")
...
## Common Variations[​](#common-variations "Direct link to Common Variations")

### High-Growth Technology Companies[​](#high-growth-technology-companies "Direct link to High-Growth Technology Companies")
...
### Mature/Stable Companies[​](#maturestable-companies "Direct link to Mature/Stable Companies")
...
### Cyclical Companies[​](#cyclical-companies "Direct link to Cyclical Companies")
...
### Multi-Segment Companies[​](#multi-segment-companies "Direct link to Multi-Segment Companies")
...
### At Start of DCF Build[​](#at-start-of-dcf-build "Direct link to At Start of DCF Build")
...
### During Model Construction[​](#during-model-construction "Direct link to During Model Construction")
...
### Before Delivering Model (MANDATORY)[​](#before-delivering-model-mandatory "Direct link to Before Delivering Model (MANDATORY)")
...
### Available Data Sources[​](#available-data-sources "Direct link to Available Data Sources")
...
## Final Output Checklist[​](#final-output-checklist "Direct link to Final Output Checklist")
...
## Data sources — MCP first, web fallback[​](#data-sources--mcp-first-web-fallback "Direct link to Data sources — MCP first, web fallback")
...
* [Overview](#overview)
* [Tools](#tools)
* [Critical Constraints - Read These First](#critical-constraints---read-these-first)
* [DCF Process Workflow](#dcf-process-workflow)
  + [Step 1: Data Retrieval and Validation](#step-1-data-retrieval-and-validation)
  + [Step 2: Historical Analysis (3-5 years)](#step-2-historical-analysis-3-5-years)
  ...
  + [Step 6: Cost of Capital (WACC) Research](#step-6-cost-of-capital-wacc-research)
  + [Step 7: Discount Rate Application (5-10 Year Forecast)](#step-7-discount-rate-application-5-10-year-forecast)
  ...
  + [Scenario Block Selection Pattern - Follow This Approach](#scenario-block-selection-pattern---follow-this-approach)
  ...
  + [WRONG: Simplified Sensitivity Table Approximations or Placeholder Text](#wrong-simplified-sensitivity-table-approximations-or-placeholder-text)
  ...
  + [WRONG: Wrong Font Colors or No Font Color Distinction](#wrong-wrong-font-colors-or-no-font-color-distinction)
...
* [Common Variations](#common-variations)
  + [High-Growth Technology Companies](#high-growth-technology-companies)
  + [Mature/Stable Companies](#maturestable-companies)
  + [Cyclical Companies](#cyclical-companies)
  + [Multi-Segment Companies](#multi-segment-companies)
* [Troubleshooting](#troubleshooting)
* [Workflow Integration](#workflow-integration)
  + [At Start of DCF Build](#at-start-of-dcf-build)
  + [During Model Construction](#during-model-construction)
  + [Before Delivering Model (MANDATORY)](#before-delivering-model-mandatory)
  + [Available Data Sources](#available-data-sources)
* [Final Output Checklist](#final-output-checklist)
* [Data sources — MCP first, web fallback](#data-sources--mcp-first-web-fallback)
