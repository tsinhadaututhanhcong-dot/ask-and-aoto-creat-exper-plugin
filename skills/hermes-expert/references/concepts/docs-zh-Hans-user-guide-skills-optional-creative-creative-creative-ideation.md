...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-creative-ideation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-creative-ideation)
...
## Operating rules[​](#operating-rules "Operating rules的直接链接")
...
## Routing — 4-step procedure[​](#routing--4-step-procedure "Routing — 4-step procedure的直接链接")
...
### Step 1 — Extract three signals from the prompt[​](#step-1--extract-three-signals-from-the-prompt "Step 1 — Extract three signals from the prompt的直接链接")
...
### Step 2 — Apply overrides (highest priority, fire first)[​](#step-2--apply-overrides-highest-priority-fire-first "Step 2 — Apply overrides (highest priority, fire first)的直接链接")
...
### Step 3 — Route by phase first, then domain[​](#step-3--route-by-phase-first-then-domain "Step 3 — Route by phase first, then domain的直接链接")
...
### Step 4 — Handle ambiguity and contradiction[​](#step-4--handle-ambiguity-and-contradiction "Step 4 — Handle ambiguity and contradiction的直接链接")
...
### Anti-default check (run before generating)[​](#anti-default-check-run-before-generating "Anti-default check (run before generating)的直接链接")
...
## Output format[​](#output-format "Output format的直接链接")
...
## File map[​](#file-map "File map的直接链接")
...
## Attribution[​](#attribution "Attribution的直接链接")
...
* [Routing — 4-step procedure](#routing--4-step-procedure)
  + [Step 1 — Extract three signals from the prompt](#step-1--extract-three-signals-from-the-prompt)
  + [Step 2 — Apply overrides (highest priority, fire first)](#step-2--apply-overrides-highest-priority-fire-first)
  + [Step 3 — Route by phase first, then domain](#step-3--route-by-phase-first-then-domain)
  + [Step 4 — Handle ambiguity and contradiction](#step-4--handle-ambiguity-and-contradiction)
  + [Anti-default check (run before generating)](#anti-default-check-run-before-generating)
