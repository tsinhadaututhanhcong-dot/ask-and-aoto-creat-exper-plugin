# apps/desktop/src/hooks/use-resize-observer.ts (repo source)
**Source:** https://github.com/NousResearch/hermes-agent/blob/main/apps/desktop/src/hooks/use-resize-observer.ts
