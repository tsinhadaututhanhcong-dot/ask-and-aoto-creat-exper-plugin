...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom)
...
## Reply-Mode Responses[​](#reply-mode-responses "Direct link to Reply-Mode Responses")
...
| `WeCom websocket closed during authentication` | Network issue or incorrect credentials. Verify bot\_id and secret. |
...
* [Reply-Mode Responses](#reply-mode-responses)
