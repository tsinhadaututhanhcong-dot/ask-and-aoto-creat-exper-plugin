...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/managed-scope](https://hermes-agent.nousresearch.com/docs/user-guide/managed-scope)
...
### Relocating the directory[​](#relocating-the-directory "Direct link to Relocating the directory")
...
## Seeing what's managed[​](#seeing-whats-managed "Direct link to Seeing what's managed")
...
## Setting up a managed scope (administrators)[​](#setting-up-a-managed-scope-administrators "Direct link to Setting up a managed scope (administrators)")
...
## Security model and limitations (v1)[​](#security-model-and-limitations-v1 "Direct link to Security model and limitations (v1)")
