...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord)
...
#### `discord.thread_require_mention`[​](#discordthread_require_mention "Direct link to discordthread_require_mention")
...
#### `discord.history_backfill`[​](#discordhistory_backfill "Direct link to discordhistory_backfill")
...
#### `discord.history_backfill_limit`[​](#discordhistory_backfill_limit "Direct link to discordhistory_backfill_limit")
...
### Restricting exec-approval buttons to admins[​](#restricting-exec-approval-buttons-to-admins "Direct link to Restricting exec-approval buttons to admins")
...
## Sending Media (inline `MEDIA:` tags)[​](#sending-media-inline-media-tags "Direct link to sending-media-inline-media-tags")
...
## Receiving Arbitrary File Types[​](#receiving-arbitrary-file-types "Direct link to Receiving Arbitrary File Types")
...
### Voice Channel Audio Effects (ambient + verbal acks)[​](#voice-channel-audio-effects-ambient--verbal-acks "Direct link to Voice Channel Audio Effects (ambient + verbal acks)")
...
* [Slash Command Access Control](#slash-command-access-control)
  + [Restricting exec-approval buttons to admins](#restricting-exec-approval-buttons-to-admins)
...
* [Sending Media (inline `MEDIA:` tags)](#sending-media-inline-media-tags)
* [Receiving Arbitrary File Types](#receiving-arbitrary-file-types)
...
* [Voice Messages](#voice-messages)
  + [Voice Channel Audio Effects (ambient + verbal acks)](#voice-channel-audio-effects-ambient--verbal-acks)
