# Docker 管理 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/devops/devops-docker-management](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/devops/devops-docker-management)
...
### 4. Docker Compose[​](#4-docker-compose "4. Docker Compose的直接链接")
...
### 6. 磁盘使用与清理[​](#6-磁盘使用与清理 "6. 磁盘使用与清理的直接链接")
...
## Dockerfile 优化建议[​](#dockerfile-优化建议 "Dockerfile 优化建议的直接链接")
...
* [常见问题](#常见问题)
* [验证](#验证)
* [Dockerfile 优化建议](#dockerfile-优化建议)