...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-simplify-code](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-simplify-code)
...
| Related skills | [`requesting-code-review`](/docs/zh-Hans/docs/user-guide/skills/bundled/software-development/software-development-requesting-code-review), [`test-driven-development`](/docs/zh-Hans/docs/user-guide/skills/bundled/software-development/software-development-test-driven-development), [`plan`](/docs/zh-Hans/docs/user-guide/skills/bundled/software-development/software-development-plan) |
...
### Phase 1 — Identify the changes[​](#phase-1--identify-the-changes "Phase 1 — Identify the changes的直接链接")
...
### Phase 2 — Launch three reviewers in parallel[​](#phase-2--launch-three-reviewers-in-parallel "Phase 2 — Launch three reviewers in parallel的直接链接")
...
> (use search\_files / grep) for existing functions, constants, or patterns
...
### Phase 3 — Aggregate and apply[​](#phase-3--aggregate-and-apply "Phase 3 — Aggregate and apply的直接链接")
...
* [The Process](#the-process)
  + [Phase 1 — Identify the changes](#phase-1--identify-the-changes)
  + [Phase 2 — Launch three reviewers in parallel](#phase-2--launch-three-reviewers-in-parallel)
  + [Phase 3 — Aggregate and apply](#phase-3--aggregate-and-apply)
* [Pitfalls](#pitfalls)
* [Related](#related)