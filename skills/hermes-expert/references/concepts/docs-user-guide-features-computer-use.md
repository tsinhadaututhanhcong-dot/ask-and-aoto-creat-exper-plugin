...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use)
...
## `hermes computer-use doctor` — your first triage stop[​](#hermes-computer-use-doctor--your-first-triage-stop "Direct link to hermes-computer-use-doctor--your-first-triage-stop")
...
## The agent cursor and sessions[​](#the-agent-cursor-and-sessions "Direct link to The agent cursor and sessions")
...
## Going deeper — the cua-driver skill pack[​](#going-deeper--the-cua-driver-skill-pack "Direct link to Going deeper — the cua-driver skill pack")
...
## Provider compatibility[​](#provider-compatibility "Direct link to Provider compatibility")
...
## Token efficiency[​](#token-efficiency "Direct link to Token efficiency")
...
## Testing against a local cua-driver build[​](#testing-against-a-local-cua-driver-build "Direct link to Testing against a local cua-driver build")
...
### Option A — `install-local` (build + put it on PATH)[​](#option-a--install-local-build--put-it-on-path "Direct link to option-a--install-local-build--put-it-on-path")
...
### Option B — point Hermes straight at the built binary (fastest loop)[​](#option-b--point-hermes-straight-at-the-built-binary-fastest-loop "Direct link to Option B — point Hermes straight at the built binary (fastest loop)")
...
### Confirm Hermes is using your build[​](#confirm-hermes-is-using-your-build "Direct link to Confirm Hermes is using your build")
...
### Notes & gotchas[​](#notes--gotchas "Direct link to Notes & gotchas")
...
* [Enabling](#enabling)
* [`hermes computer-use doctor` — your first triage stop](#hermes-computer-use-doctor--your-first-triage-stop)
* [The agent cursor and sessions](#the-agent-cursor-and-sessions)
* [Going deeper — the cua-driver skill pack](#going-deeper--the-cua-driver-skill-pack)
...
* [Configuration](#configuration)
  + [Telemetry](#telemetry)
* [Testing against a local cua-driver build](#testing-against-a-local-cua-driver-build)
  + [Option A — `install-local` (build + put it on PATH)](#option-a--install-local-build--put-it-on-path)
  + [Option B — point Hermes straight at the built binary (fastest loop)](#option-b--point-hermes-straight-at-the-built-binary-fastest-loop)
  + [Confirm Hermes is using your build](#confirm-hermes-is-using-your-build)
