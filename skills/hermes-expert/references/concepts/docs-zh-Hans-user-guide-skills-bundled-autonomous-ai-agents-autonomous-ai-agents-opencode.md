# Opencode — 将编码任务委托给 OpenCode CLI（功能开发、PR 审查） | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-opencode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-opencode)
...
| 相关 skill | [`claude-code`](/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`codex`](/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`hermes-agent`](/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) |
...
* 已配置认证：`opencode auth login` 或设置 provider 环境变量（OPENROUTER\_API\_KEY 等）
* 验证：`opencode auth list` 应显示至少一个 provider
* 代码任务推荐使用 Git 仓库
* 交互式 TUI 会话需要 `pty=true`

## 二进制文件解析（重要）[​](#二进制文件解析重要 "二进制文件解析（重要）的直接链接")
...
## 交互式会话（后台运行）[​](#交互式会话后台运行 "交互式会话（后台运行）的直接链接")
...
## PR 审查工作流[​](#pr-审查工作流 "PR 审查工作流的直接链接")
...
* [适用场景](#适用场景)
* [前置条件](#前置条件)
* [二进制文件解析（重要）](#二进制文件解析重要)
* [单次任务](#单次任务)
* [交互式会话（后台运行）](#交互式会话后台运行)
  + [TUI 快捷键](#tui-快捷键)
  + [恢复会话](#恢复会话)
* [常用标志](#常用标志)
* [操作流程](#操作流程)
