...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/gaming/gaming-minecraft-modpack-server](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/gaming/gaming-minecraft-modpack-server)
...
## Gather User Preferences First[​](#gather-user-preferences-first "Gather User Preferences First的直接链接")
...
## Steps[​](#steps "Steps的直接链接")

### 1. Download & Inspect the Pack[​](#1-download--inspect-the-pack "1. Download & Inspect the Pack的直接链接")
...
### 2. Install Java[​](#2-install-java "2. Install Java的直接链接")
...
### 3. Install the Mod Loader[​](#3-install-the-mod-loader "3. Install the Mod Loader的直接链接")
...
### 4. Accept EULA[​](#4-accept-eula "4. Accept EULA的直接链接")

```
echo "eula=true" > ~/minecraft-server/server/eula.txt
```

### 5. Configure server.properties[​](#5-configure-serverproperties "5. Configure server.properties的直接链接")
...
### 6. Tune JVM Args (user\_jvm\_args.txt)[​](#6-tune-jvm-args-user_jvm_argstxt "6. Tune JVM Args (user_jvm_args.txt)的直接链接")
...
### 7. Open Firewall[​](#7-open-firewall "7. Open Firewall的直接链接")
...
### 8. Create Launch Script[​](#8-create-launch-script "8. Create Launch Script的直接链接")
...
### 9. Set Up Automated Backups[​](#9-set-up-automated-backups "9. Set Up Automated Backups的直接链接")
...
* [Steps](#steps)
  ...
  + [6. Tune JVM Args (user\_jvm\_args.txt)](#6-tune-jvm-args-user_jvm_argstxt)
