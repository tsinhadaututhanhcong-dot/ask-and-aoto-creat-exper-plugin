# Google Workspace — 通过 gws CLI 或 Python 使用 Gmail、Calendar、Drive、Docs、Sheets | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/productivity/productivity-google-workspace](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/productivity/productivity-google-workspace)
...
| 相关 skill | [`himalaya`](/docs/zh-Hans/user-guide/skills/bundled/email/email-himalaya) |
...
* `references/gmail-search-syntax.md` —— Gmail 搜索运算符（is:unread、from:、newer\_than: 等）
...
### 步骤 0：检查是否已完成设置[​](#步骤-0检查是否已完成设置 "步骤 0：检查是否已完成设置的直接链接")
...
### 步骤 1：分流 —— 询问用户需求[​](#步骤-1分流--询问用户需求 "步骤 1：分流 —— 询问用户需求的直接链接")
...
### 步骤 2：创建 OAuth 凭据（一次性，约 5 分钟）[​](#步骤-2创建-oauth-凭据一次性约-5-分钟 "步骤 2：创建 OAuth 凭据（一次性，约 5 分钟）的直接链接")
...
### 步骤 3：获取授权 URL[​](#步骤-3获取授权-url "步骤 3：获取授权 URL的直接链接")
...
### 步骤 4：交换授权码[​](#步骤-4交换授权码 "步骤 4：交换授权码的直接链接")
...
### Calendar[​](#calendar "Calendar的直接链接")
...
### Contacts[​](#contacts "Contacts的直接链接")

```
$GAPI contacts list --max 20
```

### Sheets[​](#sheets "Sheets的直接链接")
...
* [脚本](#脚本)
* [首次设置](#首次设置)
  + [步骤 0：检查是否已完成设置](#步骤-0检查是否已完成设置)
  + [步骤 1：分流 —— 询问用户需求](#步骤-1分流--询问用户需求)
  + [步骤 2：创建 OAuth 凭据（一次性，约 5 分钟）](#步骤-2创建-oauth-凭据一次性约-5-分钟)
  + [步骤 3：获取授权 URL](#步骤-3获取授权-url)
  + [步骤 4：交换授权码](#步骤-4交换授权码)
  + [步骤 5：验证](#步骤-5验证)
  + [注意事项](#注意事项)
* [使用方法](#使用方法)
  + [Gmail](#gmail)
