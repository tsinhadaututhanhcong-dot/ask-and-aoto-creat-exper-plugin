...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-pytorch-lightning](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-pytorch-lightning)
...
### 工作流 1：从 PyTorch 迁移到 Lightning[​](#工作流-1从-pytorch-迁移到-lightning "工作流 1：从 PyTorch 迁移到 Lightning的直接链接")
...
### 工作流 2：验证与测试[​](#工作流-2验证与测试 "工作流 2：验证与测试的直接链接")
...
* 默认每个 epoch 运行验证
* 指标自动记录到 TensorBoard
* 基于 val\_loss 保存最优模型检查点

### 工作流 3：分布式训练（DDP）[​](#工作流-3分布式训练ddp "工作流 3：分布式训练（DDP）的直接链接")
...
### 工作流 4：用于监控的回调（Callbacks）[​](#工作流-4用于监控的回调callbacks "工作流 4：用于监控的回调（Callbacks）的直接链接")
...
### 工作流 5：学习率调度[​](#工作流-5学习率调度 "工作流 5：学习率调度的直接链接")
...
## 何时使用与替代方案对比[​](#何时使用与替代方案对比 "何时使用与替代方案对比的直接链接")
...
* [快速开始](#快速开始)
* [常见工作流](#常见工作流)
  + [工作流 1：从 PyTorch 迁移到 Lightning](#工作流-1从-pytorch-迁移到-lightning)
  + [工作流 2：验证与测试](#工作流-2验证与测试)
  + [工作流 3：分布式训练（DDP）](#工作流-3分布式训练ddp)
  + [工作流 4：用于监控的回调（Callbacks）](#工作流-4用于监控的回调callbacks)
  + [工作流 5：学习率调度](#工作流-5学习率调度)
* [何时使用与替代方案对比](#何时使用与替代方案对比)
* [常见问题](#常见问题)
* [进阶主题](#进阶主题)
* [硬件要求](#硬件要求)
* [资源](#资源)