# Environment Variables | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/reference/environment-variables](https://hermes-agent.nousresearch.com/docs/reference/environment-variables)
...
### Skill API Keys[​](#skill-api-keys "Direct link to Skill API Keys")
...
### Web Dashboard & Hermes Desktop[​](#web-dashboard--hermes-desktop "Direct link to Web Dashboard & Hermes Desktop")
...
### Microsoft Graph (Teams Meetings)[​](#microsoft-graph-teams-meetings "Direct link to Microsoft Graph (Teams Meetings)")
...
### Microsoft Graph Webhook Listener[​](#microsoft-graph-webhook-listener "Direct link to Microsoft Graph Webhook Listener")
...
### Teams Meeting Summary Delivery[​](#teams-meeting-summary-delivery "Direct link to Teams Meeting Summary Delivery")
...
### LINE Messaging API[​](#line-messaging-api "Direct link to LINE Messaging API")
...
### ntfy (push notifications)[​](#ntfy-push-notifications "Direct link to ntfy (push notifications)")
...
### SimpleX[​](#simplex "Direct link to SimpleX")
...
### Photon[​](#photon "Direct link to Photon")
...
### Microsoft Teams (adapter)[​](#microsoft-teams-adapter "Direct link to Microsoft Teams (adapter)")
...
* [Messaging](#messaging)
  + [Web Dashboard & Hermes Desktop](#web-dashboard--hermes-desktop)
  + [Microsoft Graph (Teams Meetings)](#microsoft-graph-teams-meetings)
  + [Microsoft Graph Webhook Listener](#microsoft-graph-webhook-listener)
  + [Teams Meeting Summary Delivery](#teams-meeting-summary-delivery)
  + [LINE Messaging API](#line-messaging-api)
  + [ntfy (push notifications)](#ntfy-push-notifications)
  + [IRC](#irc)
  + [SimpleX](#simplex)
  + [Photon](#photon)
  + [Microsoft Teams (adapter)](#microsoft-teams-adapter)
  + [Raft](#raft)
...
- [https://hermes-agent.nousresearch.com/docs/guides/azure-foundry](./docs-guides-azure-foundry.md)
- [https://hermes-agent.nousresearch.com/docs/guides/microsoft-graph-app-registration](./docs-guides-microsoft-graph-app-registration.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins](./docs-user-guide-features-built-in-plugins.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime](./docs-user-guide-features-codex-app-server-runtime.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/photon](./docs-user-guide-messaging-photon.md)
