...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/gaming/gaming-minecraft-modpack-server](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/gaming/gaming-minecraft-modpack-server)
...
### 6. Tune JVM Args (user\_jvm\_args.txt)[​](#6-tune-jvm-args-user_jvm_argstxt "Direct link to 6. Tune JVM Args (user_jvm_args.txt)")
