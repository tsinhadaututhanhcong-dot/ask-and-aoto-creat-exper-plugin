...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-evm](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-evm)
...
### 2. Multi-Chain Scan[​](#2-multi-chain-scan "Direct link to 2. Multi-Chain Scan")
...
### 3. Compare (Gas + Prices)[​](#3-compare-gas--prices "Direct link to 3. Compare (Gas + Prices)")
...
### 4. Transaction Details & Decode[​](#4-transaction-details--decode "Direct link to 4. Transaction Details & Decode")
...
### 5. ENS Resolution[​](#5-ens-resolution "Direct link to 5. ENS Resolution")
...
### 6. Allowance Checker (Security)[​](#6-allowance-checker-security "Direct link to 6. Allowance Checker (Security)")
...
### 7. Contract Inspector[​](#7-contract-inspector "Direct link to 7. Contract Inspector")
...
### 8. Whale Detection[​](#8-whale-detection "Direct link to 8. Whale Detection")
...
### 9. Gas Tracker[​](#9-gas-tracker "Direct link to 9. Gas Tracker")
...
* [Procedure](#procedure)
  ...
  + [2. Multi-Chain Scan](#2-multi-chain-scan)
  + [3. Compare (Gas + Prices)](#3-compare-gas--prices)
  + [4. Transaction Details & Decode](#4-transaction-details--decode)
  + [5. ENS Resolution](#5-ens-resolution)
  + [6. Allowance Checker (Security)](#6-allowance-checker-security)
  + [7. Contract Inspector](#7-contract-inspector)
  + [8. Whale Detection](#8-whale-detection)
  + [9. Gas Tracker](#9-gas-tracker)
