...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/curator](https://hermes-agent.nousresearch.com/docs/user-guide/features/curator)
...
### Rename map in the summary[​](#rename-map-in-the-summary "Direct link to Rename map in the summary")
...
* [Per-run reports](#per-run-reports)
  + [Rename map in the summary](#rename-map-in-the-summary)
