...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-darwinian-evolver](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-darwinian-evolver)
...
Run Imbue's [darwinian\_evolver](https://github.com/imbue-ai/darwinian_evolver) — an
...
## Install (One-Time)[​](#install-one-time "Direct link to Install (One-Time)")
...
## Quick Start — The Built-In Parrot Example[​](#quick-start--the-built-in-parrot-example "Direct link to Quick Start — The Built-In Parrot Example")
...
## Quick Start — OpenRouter Driver (No Anthropic Key)[​](#quick-start--openrouter-driver-no-anthropic-key "Direct link to Quick Start — OpenRouter Driver (No Anthropic Key)")
...
## Defining a Custom Problem[​](#defining-a-custom-problem "Direct link to Defining a Custom Problem")
...
## Hyperparameters That Actually Matter[​](#hyperparameters-that-actually-matter "Direct link to Hyperparameters That Actually Matter")
...
* [Quick Start — The Built-In Parrot Example](#quick-start--the-built-in-parrot-example)
* [Quick Start — OpenRouter Driver (No Anthropic Key)](#quick-start--openrouter-driver-no-anthropic-key)
* [Defining a Custom Problem](#defining-a-custom-problem)
* [Hyperparameters That Actually Matter](#hyperparameters-that-actually-matter)
* [Pitfalls](#pitfalls)
