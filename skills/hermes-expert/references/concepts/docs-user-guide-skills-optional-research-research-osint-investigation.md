...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-osint-investigation](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-osint-investigation)
...
* US **federal** campaign finance — FEC is intentionally NOT covered here
  ...
  DEMO\_KEY tier). For federal donations, point users at
...
### 1. Identify which sources apply[​](#1-identify-which-sources-apply "Direct link to 1. Identify which sources apply")
...
### 2. Acquire data[​](#2-acquire-data "Direct link to 2. Acquire data")
...
### 3. Resolve entities across sources[​](#3-resolve-entities-across-sources "Direct link to 3. Resolve entities across sources")
...
### 4. Statistical timing correlation (optional)[​](#4-statistical-timing-correlation-optional "Direct link to 4. Statistical timing correlation (optional)")
...
### 5. Build the findings JSON (evidence chain)[​](#5-build-the-findings-json-evidence-chain "Direct link to 5. Build the findings JSON (evidence chain)")
...
## Confidence and evidence discipline[​](#confidence-and-evidence-discipline "Direct link to Confidence and evidence discipline")
...
## Adding a new data source[​](#adding-a-new-data-source "Direct link to Adding a new data source")
...
## Tools and their limits[​](#tools-and-their-limits "Direct link to Tools and their limits")
...
## Legal note[​](#legal-note "Direct link to Legal note")
...
* [Workflow](#workflow)
  + [1. Identify which sources apply](#1-identify-which-sources-apply)
  + [2. Acquire data](#2-acquire-data)
  + [3. Resolve entities across sources](#3-resolve-entities-across-sources)
  + [4. Statistical timing correlation (optional)](#4-statistical-timing-correlation-optional)
  + [5. Build the findings JSON (evidence chain)](#5-build-the-findings-json-evidence-chain)
* [Confidence and evidence discipline](#confidence-and-evidence-discipline)
* [Adding a new data source](#adding-a-new-data-source)
* [Tools and their limits](#tools-and-their-limits)
