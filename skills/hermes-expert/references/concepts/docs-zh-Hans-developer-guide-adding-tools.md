# 添加工具 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/adding-tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/adding-tools)

本页总览

在编写工具之前，先问自己：**这是否应该是一个 [skill](/docs/zh-Hans/developer-guide/creating-skills)？**
...
* [插件](/docs/zh-Hans/user-guide/features/plugins)
* [构建 Hermes 插件](/docs/zh-Hans/developer-guide/plugins)
...
## 第一步：创建内置工具文件[​](#第一步创建内置工具文件 "第一步：创建内置工具文件的直接链接")
...
## 第二步：将内置工具添加到 Toolset[​](#第二步将内置工具添加到-toolset "第二步：将内置工具添加到 Toolset的直接链接")
...
## 需要 task\_id 的 Handler[​](#需要-task_id-的-handler "需要 task_id 的 Handler的直接链接")
...
## Agent 循环拦截工具[​](#agent-循环拦截工具 "Agent 循环拦截工具的直接链接")
...
## 可选：Setup Wizard 集成[​](#可选setup-wizard-集成 "可选：Setup Wizard 集成的直接链接")
...
* [概述](#概述)
* [第一步：创建内置工具文件](#第一步创建内置工具文件)
  + [关键规则](#关键规则)
* [第二步：将内置工具添加到 Toolset](#第二步将内置工具添加到-toolset)
* [~~第三步：添加发现导入~~（不再需要）](#第三步添加发现导入不再需要)
* [异步 Handler](#异步-handler)
* [需要 task\_id 的 Handler](#需要-task_id-的-handler)
* [Agent 循环拦截工具](#agent-循环拦截工具)
* [可选：Setup Wizard 集成](#可选setup-wizard-集成)
* [检查清单](#检查清单)
