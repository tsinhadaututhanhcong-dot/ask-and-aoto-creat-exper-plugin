...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-openhands](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-openhands)
...
### One-shot task[​](#one-shot-task "Direct link to One-shot task")
...
### Background for long tasks[​](#background-for-long-tasks "Direct link to Background for long tasks")
...
### Resume a previous conversation[​](#resume-a-previous-conversation "Direct link to Resume a previous conversation")
...
## Real Flag List[​](#real-flag-list "Direct link to Real Flag List")
...
## JSON Event Schema[​](#json-event-schema "Direct link to JSON Event Schema")
...
* [How to Run](#how-to-run)
  ...
  + [Background for long tasks](#background-for-long-tasks)
  + [Resume a previous conversation](#resume-a-previous-conversation)
* [Real Flag List](#real-flag-list)
