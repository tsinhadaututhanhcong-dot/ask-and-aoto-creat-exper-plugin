...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/deliverable-mode](https://hermes-agent.nousresearch.com/docs/user-guide/features/deliverable-mode)
...
## Encouraging the agent to produce artifacts[​](#encouraging-the-agent-to-produce-artifacts "Direct link to Encouraging the agent to produce artifacts")
...
## Kanban: artifacts ride completion notifications[​](#kanban-artifacts-ride-completion-notifications "Direct link to Kanban: artifacts ride completion notifications")
...
## Connecting more services with MCP[​](#connecting-more-services-with-mcp "Direct link to Connecting more services with MCP")
...
section. See [MCP integration](/docs/user-guide/features/mcp) for the full setup guide.

## Comparison to Perplexity Computer in Slack[​](#comparison-to-perplexity-computer-in-slack "Direct link to Comparison to Perplexity Computer in Slack")
...
* [Encouraging the agent to produce artifacts](#encouraging-the-agent-to-produce-artifacts)
* [Kanban: artifacts ride completion notifications](#kanban-artifacts-ride-completion-notifications)
* [Connecting more services with MCP](#connecting-more-services-with-mcp)
* [Comparison to Perplexity Computer in Slack](#comparison-to-perplexity-computer-in-slack)
