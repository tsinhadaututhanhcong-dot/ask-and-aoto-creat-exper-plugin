...
**Source:** [https://hermes-agent.nousresearch.com/docs/guides/azure-foundry](https://hermes-agent.nousresearch.com/docs/guides/azure-foundry)
...
## Microsoft Entra ID (keyless, RBAC) — recommended[​](#microsoft-entra-id-keyless-rbac--recommended "Direct link to Microsoft Entra ID (keyless, RBAC) — recommended")
...
### Why use Entra ID?[​](#why-use-entra-id "Direct link to Why use Entra ID?")
...
### One-time setup (Azure side)[​](#one-time-setup-azure-side "Direct link to One-time setup (Azure side)")
...
### One-time setup (Hermes side)[​](#one-time-setup-hermes-side "Direct link to One-time setup (Hermes side)")
...
### Credential resolution order[​](#credential-resolution-order "Direct link to Credential resolution order")
...
### Deployment patterns[​](#deployment-patterns "Direct link to Deployment patterns")
...
#### Sovereign clouds (Government, China)[​](#sovereign-clouds-government-china "Direct link to Sovereign clouds (Government, China)")
...
## Configuration (written to `config.yaml`)[​](#configuration-written-to-configyaml-1 "Direct link to configuration-written-to-configyaml-1")
...
## Anthropic-style endpoints (Claude via Microsoft Foundry)[​](#anthropic-style-endpoints-claude-via-microsoft-foundry "Direct link to Anthropic-style endpoints (Claude via Microsoft Foundry)")
...
| Variable | Purpose |
| --- | --- |
| `AZURE_FOUNDRY_API_KEY` | Primary API key for Microsoft Foundry / Azure OpenAI (api\_key mode) |
...
* [Microsoft Entra ID (keyless, RBAC) — recommended](#microsoft-entra-id-keyless-rbac--recommended)
  + [Why use Entra ID?](#why-use-entra-id)
  + [One-time setup (Azure side)](#one-time-setup-azure-side)
  + [One-time setup (Hermes side)](#one-time-setup-hermes-side)
...
* [Configuration (written to `config.yaml`)](#configuration-written-to-configyaml-1)
* [OpenAI-style endpoints (GPT, Llama, etc.)](#openai-style-endpoints-gpt-llama-etc)
* [Anthropic-style endpoints (Claude via Microsoft Foundry)](#anthropic-style-endpoints-claude-via-microsoft-foundry)
