...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/mixture-of-agents](https://hermes-agent.nousresearch.com/docs/user-guide/features/mixture-of-agents)
...
## Select a MoA preset as your model[​](#select-a-moa-preset-as-your-model "Direct link to Select a MoA preset as your model")
...
## Slash command shortcut[​](#slash-command-shortcut "Direct link to Slash command shortcut")
...
## How it works in the agent loop[​](#how-it-works-in-the-agent-loop "Direct link to How it works in the agent loop")
...
## Configure presets[​](#configure-presets "Direct link to Configure presets")
...
### Tuning advisor speed with `reference_max_tokens`[​](#tuning-advisor-speed-with-reference_max_tokens "Direct link to tuning-advisor-speed-with-reference_max_tokens")
...
## Terminal preset management[​](#terminal-preset-management "Direct link to Terminal preset management")
