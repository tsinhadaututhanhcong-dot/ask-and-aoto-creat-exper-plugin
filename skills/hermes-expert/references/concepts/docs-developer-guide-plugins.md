...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/plugins/](https://hermes-agent.nousresearch.com/docs/developer-guide/plugins/)
...
### Debugging plugin discovery[​](#debugging-plugin-discovery "Direct link to Debugging plugin discovery")
...
### Lazy-install optional Python dependencies[​](#lazy-install-optional-python-dependencies "Direct link to Lazy-install optional Python dependencies")
...
### Thread-safe lazy singletons[​](#thread-safe-lazy-singletons "Direct link to Thread-safe lazy singletons")
...
### Overriding a built-in tool[​](#overriding-a-built-in-tool "Direct link to Overriding a built-in tool")
...
#### Oversized-context spill[​](#oversized-context-spill "Direct link to Oversized-context spill")
...
### Act from inside a hook (profile + tools)[​](#act-from-inside-a-hook-profile--tools "Direct link to Act from inside a hook (profile + tools)")
...
### Handle Slack Block Kit button clicks[​](#handle-slack-block-kit-button-clicks "Direct link to Handle Slack Block Kit button clicks")
...
| `callback` | async callable | Receives `(ack, body, action)` per the slack\_bolt convention |
...
* [Step 6: Test it](#step-6-test-it)
  + [Debugging plugin discovery](#debugging-plugin-discovery)
...
* [What else can plugins do?](#what-else-can-plugins-do)
  ...
  + [Lazy-install optional Python dependencies](#lazy-install-optional-python-dependencies)
  + [Thread-safe lazy singletons](#thread-safe-lazy-singletons)
  + [Conditional tool availability](#conditional-tool-availability)
  + [Overriding a built-in tool](#overriding-a-built-in-tool)
  ...
  + [Act from inside a hook (profile + tools)](#act-from-inside-a-hook-profile--tools)
  + [Handle Slack Block Kit button clicks](#handle-slack-block-kit-button-clicks)
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/adding-platform-adapters](./docs-developer-guide-adding-platform-adapters.md)
- [https://hermes-agent.nousresearch.com/docs/developer-guide/adding-providers](./docs-developer-guide-adding-providers.md)
- [https://hermes-agent.nousresearch.com/docs/developer-guide/browser-provider-plugin](./docs-developer-guide-browser-provider-plugin.md)
- [https://hermes-agent.nousresearch.com/docs/developer-guide/context-engine-plugin](./docs-developer-guide-context-engine-plugin.md)
- [https://hermes-agent.nousresearch.com/docs/developer-guide/image-gen-provider-plugin](./docs-developer-guide-image-gen-provider-plugin.md)
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/model-provider-plugin](./docs-developer-guide-model-provider-plugin.md)
- [https://hermes-agent.nousresearch.com/docs/developer-guide/secret-source-plugin](./docs-developer-guide-secret-source-plugin.md)
- [https://hermes-agent.nousresearch.com/docs/developer-guide/video-gen-provider-plugin](./docs-developer-guide-video-gen-provider-plugin.md)
- [https://hermes-agent.nousresearch.com/docs/developer-guide/web-search-provider-plugin](./docs-developer-guide-web-search-provider-plugin.md)
