...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/secrets/bitwarden](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/secrets/bitwarden)
...
## 为什么使用机器账户（以及为什么没有双因素认证提示）[​](#为什么使用机器账户以及为什么没有双因素认证提示 "为什么使用机器账户（以及为什么没有双因素认证提示）的直接链接")
...
### 1. 创建机器账户和访问令牌[​](#1-创建机器账户和访问令牌 "1. 创建机器账户和访问令牌的直接链接")
...
* [工作原理](#工作原理)
* [为什么使用机器账户（以及为什么没有双因素认证提示）](#为什么使用机器账户以及为什么没有双因素认证提示)
* [设置](#设置)
  + [1. 创建机器账户和访问令牌](#1-创建机器账户和访问令牌)
  + [2. 运行向导](#2-运行向导)
  + [3. 确认](#3-确认)
* [CLI](#cli)
* [配置](#配置)
