...
**Source:** [https://hermes-agent.nousresearch.com/docs/guides/xai-grok-oauth](https://hermes-agent.nousresearch.com/docs/guides/xai-grok-oauth)
...
## How the Login Works[​](#how-the-login-works "Direct link to How the Login Works")
...
## Direct-to-xAI Tools (TTS / Image / Video / Transcription / X Search)[​](#direct-to-xai-tools-tts--image--video--transcription--x-search "Direct link to Direct-to-xAI Tools (TTS / Image / Video / Transcription / X Search)")
...
### HTTP 403 after a successful login (tier / entitlement)[​](#http-403-after-a-successful-login-tier--entitlement "Direct link to HTTP 403 after a successful login (tier / entitlement)")
...
### "No xAI credentials found" error at runtime[​](#no-xai-credentials-found-error-at-runtime "Direct link to \"No xAI credentials found\" error at runtime")
...
* [Direct-to-xAI Tools (TTS / Image / Video / Transcription / X Search)](#direct-to-xai-tools-tts--image--video--transcription--x-search)
  + [Models](#models)
...
* [Troubleshooting](#troubleshooting)
  ...
  + [HTTP 403 after a successful login (tier / entitlement)](#http-403-after-a-successful-login-tier--entitlement)
