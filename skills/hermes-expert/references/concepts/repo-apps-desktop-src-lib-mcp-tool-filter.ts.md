# apps/desktop/src/lib/mcp-tool-filter.ts (repo source)
**Source:** https://github.com/NousResearch/hermes-agent/blob/main/apps/desktop/src/lib/mcp-tool-filter.ts
