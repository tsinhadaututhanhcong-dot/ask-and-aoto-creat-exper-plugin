...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-manim-video](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-manim-video)
...
| Context | run\_time | self.wait() after |
| --- | --- | --- |
...
| `references/updaters-and-trackers.md` | ValueTracker, add\_updater, always\_redraw, time-based updaters, patterns |
