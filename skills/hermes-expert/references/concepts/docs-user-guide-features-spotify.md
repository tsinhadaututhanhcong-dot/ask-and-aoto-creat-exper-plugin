...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify)
...
### One-shot: `hermes tools` or first-run setup[​](#one-shot-hermes-tools-or-first-run-setup "Direct link to one-shot-hermes-tools-or-first-run-setup")
...
### Home Assistant-managed speakers[​](#home-assistant-managed-speakers "Direct link to Home Assistant-managed speakers")
...
| --- | --- |
| `spotify_search` (all) | `spotify_playback` — play, pause, next, previous, seek, set\_repeat, set\_shuffle, set\_volume |
...
* [Setup](#setup)
  + [One-shot: `hermes tools` or first-run setup](#one-shot-hermes-tools-or-first-run-setup)
...
* [Using it](#using-it)
  ...
  + [Home Assistant-managed speakers](#home-assistant-managed-speakers)
