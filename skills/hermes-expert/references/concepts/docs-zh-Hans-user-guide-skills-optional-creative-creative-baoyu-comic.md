...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-baoyu-comic](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-baoyu-comic)
...
## Reference Images[​](#reference-images "Reference Images的直接链接")
...
## Options[​](#options "Options的直接链接")

### Visual Dimensions[​](#visual-dimensions "Visual Dimensions的直接链接")
...
### Partial Workflow Options[​](#partial-workflow-options "Partial Workflow Options的直接链接")
...
### Art, Tone & Preset Catalogue[​](#art-tone--preset-catalogue "Art, Tone & Preset Catalogue的直接链接")
...
## File Structure[​](#file-structure "File Structure的直接链接")
...
## Language Handling[​](#language-handling "Language Handling的直接链接")
...
### Progress Checklist[​](#progress-checklist "Progress Checklist的直接链接")
...
### Step Summary[​](#step-summary "Step Summary的直接链接")
...
### User Questions[​](#user-questions "User Questions的直接链接")
...
### Step 7: Image Generation[​](#step-7-image-generation "Step 7: Image Generation的直接链接")
...
## Page Modification[​](#page-modification "Page Modification的直接链接")
