...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho)
...
Honcho 是一个 Memory Provider 插件

Honcho 已集成到 [Memory Providers](/docs/zh-Hans/user-guide/features/memory-providers) 系统中。以下所有功能均可通过统一的 memory provider 接口使用。

## Honcho 新增了什么[​](#honcho-新增了什么 "Honcho 新增了什么的直接链接")
...
### 冷启动/热启动 Prompt 选择[​](#冷启动热启动-prompt-选择 "冷启动/热启动 Prompt 选择的直接链接")
...
### 三个正交配置旋钮[​](#三个正交配置旋钮 "三个正交配置旋钮的直接链接")
...
### 查询自适应推理级别[​](#查询自适应推理级别 "查询自适应推理级别的直接链接")
...
## 观察模式（定向 vs. 统一）[​](#观察模式定向-vs-统一 "观察模式（定向 vs. 统一）的直接链接")
...
## 从 `hermes honcho` 迁移[​](#从-hermes-honcho-迁移 "从-hermes-honcho-迁移的直接链接")
...
参见 [Memory Providers — Honcho](/docs/zh-Hans/user-guide/features/memory-providers#honcho) 获取完整参考文档。

* [Honcho 新增了什么](#honcho-新增了什么)
* [设置](#设置)
* [架构](#架构)
  + [双层上下文注入](#双层上下文注入)
  + [冷启动/热启动 Prompt 选择](#冷启动热启动-prompt-选择)
  + [三个正交配置旋钮](#三个正交配置旋钮)
  + [辩证深度（多轮）](#辩证深度多轮)
  + [会话启动预热](#会话启动预热)
  + [查询自适应推理级别](#查询自适应推理级别)
* [配置选项](#配置选项)
  + [完整配置参考](#完整配置参考)
* [观察模式（定向 vs. 统一）](#观察模式定向-vs-统一)
* [Tools](#tools)
* [CLI 命令](#cli-命令)
* [从 `hermes honcho` 迁移](#从-hermes-honcho-迁移)
* [完整文档](#完整文档)
