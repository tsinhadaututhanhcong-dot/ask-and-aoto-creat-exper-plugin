...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/cron-internals](https://hermes-agent.nousresearch.com/docs/developer-guide/cron-internals)
...
### Managed cron (Chronos) for scale-to-zero[​](#managed-cron-chronos-for-scale-to-zero "Direct link to Managed cron (Chronos) for scale-to-zero")
...
* [Scheduler Runtime](#scheduler-runtime)
  ...
  + [Managed cron (Chronos) for scale-to-zero](#managed-cron-chronos-for-scale-to-zero)
