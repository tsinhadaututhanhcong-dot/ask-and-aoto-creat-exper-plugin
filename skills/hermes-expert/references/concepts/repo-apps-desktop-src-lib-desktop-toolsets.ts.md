# apps/desktop/src/lib/desktop-toolsets.ts (repo source)
**Source:** https://github.com/NousResearch/hermes-agent/blob/main/apps/desktop/src/lib/desktop-toolsets.ts
