...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/browser](https://hermes-agent.nousresearch.com/docs/user-guide/features/browser)
...
#### Externally managed Camofox sessions[​](#externally-managed-camofox-sessions "Direct link to Externally managed Camofox sessions")
...
### Local Chromium-family browser via CDP (`/browser connect`)[​](#local-chromium-family-browser-via-cdp-browser-connect "Direct link to local-chromium-family-browser-via-cdp-browser-connect")
...
* [Setup](#setup)
  ...
  + [Local Chromium-family browser via CDP (`/browser connect`)](#local-chromium-family-browser-via-cdp-browser-connect)
