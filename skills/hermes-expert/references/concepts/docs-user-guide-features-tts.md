...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/tts](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts)
...
### Gemini Persona Prompts[​](#gemini-persona-prompts "Direct link to Gemini Persona Prompts")
...
### Gemini Audio Tags[​](#gemini-audio-tags "Direct link to Gemini Audio Tags")
...
### Python plugin providers[​](#python-plugin-providers "Direct link to Python plugin providers")
...
#### When to pick which[​](#when-to-pick-which "Direct link to When to pick which")
...
#### Minimal plugin[​](#minimal-plugin "Direct link to Minimal plugin")
...
### STT custom command providers[​](#stt-custom-command-providers "Direct link to STT custom command providers")
...
#### STT placeholders[​](#stt-placeholders "Direct link to STT placeholders")
...
#### How the transcript is read back[​](#how-the-transcript-is-read-back "Direct link to How the transcript is read back")
...
#### STT command-provider optional keys[​](#stt-command-provider-optional-keys "Direct link to STT command-provider optional keys")
...
#### STT command-provider behavior notes[​](#stt-command-provider-behavior-notes "Direct link to STT command-provider behavior notes")
...
#### STT command-provider security[​](#stt-command-provider-security "Direct link to STT command-provider security")
...
### Python plugin providers (STT)[​](#python-plugin-providers-stt "Direct link to Python plugin providers (STT)")
...
#### When to pick which (STT)[​](#when-to-pick-which-stt "Direct link to When to pick which (STT)")
...
#### Per-provider config namespace[​](#per-provider-config-namespace "Direct link to Per-provider config namespace")
...
#### Minimal plugin[​](#minimal-plugin-1 "Direct link to Minimal plugin")
...
#### Optional hooks[​](#optional-hooks-1 "Direct link to Optional hooks")
...
* [Text-to-Speech](#text-to-speech)
  ...
  + [Gemini Persona Prompts](#gemini-persona-prompts)
  + [Gemini Audio Tags](#gemini-audio-tags)
  ...
  + [Python plugin providers](#python-plugin-providers)
* [Voice Message Transcription (STT)](#voice-message-transcription-stt)
  + [Configuration](#configuration-1)
  + [Provider Details](#provider-details)
  + [Fallback Behavior](#fallback-behavior)
  + [STT custom command providers](#stt-custom-command-providers)
  + [Python plugin providers (STT)](#python-plugin-providers-stt)
