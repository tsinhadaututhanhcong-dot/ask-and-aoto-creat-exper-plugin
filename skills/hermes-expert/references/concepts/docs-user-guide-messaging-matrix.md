# Matrix | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix)
...
## Capability Matrix[​](#capability-matrix "Direct link to Capability Matrix")
...
### Project Room Isolation[​](#project-room-isolation "Direct link to Project Room Isolation")
...
## Private Deployment Hardening[​](#private-deployment-hardening "Direct link to Private Deployment Hardening")
...
### Matrix Tools and Controls[​](#matrix-tools-and-controls "Direct link to Matrix Tools and Controls")
...
### Media Limits[​](#media-limits "Direct link to Media Limits")
...
## Synapse Integration Tests[​](#synapse-integration-tests "Direct link to Synapse Integration Tests")
...
## Room allowlist (`allowed_rooms`)[​](#room-allowlist-allowed_rooms "Direct link to room-allowlist-allowed_rooms")
...
## Commands in Matrix[​](#commands-in-matrix "Direct link to Commands in Matrix")
...
### Bot joins rooms but silently drops every message (clock skew)[​](#bot-joins-rooms-but-silently-drops-every-message-clock-skew "Direct link to Bot joins rooms but silently drops every message (clock skew)")
...
### Bot connects and sends, but ignores inbound messages[​](#bot-connects-and-sends-but-ignores-inbound-messages "Direct link to Bot connects and sends, but ignores inbound messages")
...
### Bot ignores an entire room[​](#bot-ignores-an-entire-room "Direct link to Bot ignores an entire room")
...
### Bridge messages loop or echo[​](#bridge-messages-loop-or-echo "Direct link to Bridge messages loop or echo")
...
* [Capability Matrix](#capability-matrix)
  ...
  + [Project Room Isolation](#project-room-isolation)
...
* [Private Deployment Hardening](#private-deployment-hardening)
...
* [Synapse Integration Tests](#synapse-integration-tests)
...
* [Room allowlist (`allowed_rooms`)](#room-allowlist-allowed_rooms)
* [Commands in Matrix](#commands-in-matrix)
* [Troubleshooting](#troubleshooting)
  + [Bot is not responding to messages](#bot-is-not-responding-to-messages)
  + [Bot joins rooms but silently drops every message (clock skew)](#bot-joins-rooms-but-silently-drops-every-message-clock-skew)
...
* [Proxy Mode (E2EE on macOS)](#proxy-mode-e2ee-on-macos)
  ...
  + [Bot connects and sends, but ignores inbound messages](#bot-connects-and-sends-but-ignores-inbound-messages)
  ...
  + [Bot ignores an entire room](#bot-ignores-an-entire-room)
  + [Bridge messages loop or echo](#bridge-messages-loop-or-echo)
* [Security](#security)
* [Notes](#notes)
