...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp)
...
## Catalog: one-click install for Nous-approved MCPs[​](#catalog-one-click-install-for-nous-approved-mcps "Direct link to Catalog: one-click install for Nous-approved MCPs")
...
### Tool selection at install time[​](#tool-selection-at-install-time "Direct link to Tool selection at install time")
...
### Manifest version compatibility[​](#manifest-version-compatibility "Direct link to Manifest version compatibility")
...
### Runtime `${ENV_VAR}` substitution[​](#runtime-env_var-substitution "Direct link to runtime-env_var-substitution")
...
### Updating tool selection later[​](#updating-tool-selection-later "Direct link to Updating tool selection later")
...
### Updating the catalog manifest[​](#updating-the-catalog-manifest "Direct link to Updating the catalog manifest")
...
### OAuth-authenticated HTTP servers[​](#oauth-authenticated-http-servers "Direct link to OAuth-authenticated HTTP servers")
...
## mTLS / client certificates[​](#mtls--client-certificates "Direct link to mTLS / client certificates")
...
## Built-in presets[​](#built-in-presets "Direct link to Built-in presets")
...
## Parallel Tool Calls[​](#parallel-tool-calls "Direct link to Parallel Tool Calls")
...
* [Catalog: one-click install for Nous-approved MCPs](#catalog-one-click-install-for-nous-approved-mcps)
  + [Tool selection at install time](#tool-selection-at-install-time)
  + [Trust model](#trust-model)
  + [Manifest version compatibility](#manifest-version-compatibility)
  + [Runtime `${ENV_VAR}` substitution](#runtime-env_var-substitution)
  + [Updating tool selection later](#updating-tool-selection-later)
  + [Updating the catalog manifest](#updating-the-catalog-manifest)
* [Two kinds of MCP servers](#two-kinds-of-mcp-servers)
  + [Stdio servers](#stdio-servers)
  + [HTTP servers](#http-servers)
  + [OAuth-authenticated HTTP servers](#oauth-authenticated-http-servers)
