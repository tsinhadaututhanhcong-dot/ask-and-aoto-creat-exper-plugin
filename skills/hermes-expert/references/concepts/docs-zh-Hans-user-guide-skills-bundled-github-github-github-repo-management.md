# Github 仓库管理 — 克隆/创建/fork 仓库；管理远程、发布 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/github/github-github-repo-management](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/github/github-github-repo-management)
...
| 相关 skill | [`github-auth`](/docs/zh-Hans/user-guide/skills/bundled/github/github-github-auth), [`github-pr-workflow`](/docs/zh-Hans/user-guide/skills/bundled/github/github-github-pr-workflow), [`github-issues`](/docs/zh-Hans/user-guide/skills/bundled/github/github-github-issues) |
...
## 3. Fork 仓库[​](#3-fork-仓库 "3. Fork 仓库的直接链接")
...
### 保持 Fork 同步[​](#保持-fork-同步 "保持 Fork 同步的直接链接")
...
## 7. Secrets 管理（GitHub Actions）[​](#7-secrets-管理github-actions "7. Secrets 管理（GitHub Actions）的直接链接")
...
## 8. 发布（Releases）[​](#8-发布releases "8. 发布（Releases）的直接链接")
...
## 9. GitHub Actions 工作流[​](#9-github-actions-工作流 "9. GitHub Actions 工作流的直接链接")
...
## 10. Gists[​](#10-gists "10. Gists的直接链接")
...
* [5. 仓库设置](#5-仓库设置)
* [6. 分支保护](#6-分支保护)
* [7. Secrets 管理（GitHub Actions）](#7-secrets-管理github-actions)
* [8. 发布（Releases）](#8-发布releases)
