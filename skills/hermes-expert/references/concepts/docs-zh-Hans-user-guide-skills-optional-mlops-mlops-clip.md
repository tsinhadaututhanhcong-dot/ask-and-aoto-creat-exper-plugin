# Clip — OpenAI 连接视觉与语言的模型 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-clip](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-clip)
...
## 何时使用 CLIP[​](#何时使用-clip "何时使用 CLIP的直接链接")
...
## 与向量数据库集成[​](#与向量数据库集成 "与向量数据库集成的直接链接")
