# Profile 命令参考 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/profile-commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/profile-commands)

本页总览

本页涵盖所有与 [Hermes profiles](/docs/zh-Hans/user-guide/profiles) 相关的命令。通用 CLI 命令请参阅 [CLI 命令参考](/docs/zh-Hans/reference/cli-commands)。
...
| `install` | 从 git URL 或本地目录安装 profile 发行版。参见 [Profile 发行版](/docs/zh-Hans/user-guide/profile-distributions)。 |
| `update` | 重新拉取发行版管理的 profile 并重新应用其 bundle。 |
| `info` | 显示 profile 的发行版元数据（来源 URL、commit、最后更新时间）。 |

## `hermes profile list`[​](#hermes-profile-list "hermes-profile-list的直接链接")
...
## `hermes profile use`[​](#hermes-profile-use "hermes-profile-use的直接链接")
...
## `hermes profile create`[​](#hermes-profile-create "hermes-profile-create的直接链接")
...
## `hermes profile describe`[​](#hermes-profile-describe "hermes-profile-describe的直接链接")
...
## `hermes profile delete`[​](#hermes-profile-delete "hermes-profile-delete的直接链接")
...
## `hermes profile show`[​](#hermes-profile-show "hermes-profile-show的直接链接")
...
## `hermes profile alias`[​](#hermes-profile-alias "hermes-profile-alias的直接链接")
...
## `hermes profile rename`[​](#hermes-profile-rename "hermes-profile-rename的直接链接")
...
## `hermes profile export`[​](#hermes-profile-export "hermes-profile-export的直接链接")
...
## `hermes profile import`[​](#hermes-profile-import "hermes-profile-import的直接链接")
...
## 发行版命令[​](#发行版命令 "发行版命令的直接链接")

提示

**初次接触发行版？** 请先阅读 [Profile 发行版用户指南](/docs/zh-Hans/user-guide/profile-distributions) — 其中通过完整示例介绍了原因、时机和方法。以下章节是在你已知需求时使用的简明 CLI 参考。
...
### `hermes profile install`[​](#hermes-profile-install "hermes-profile-install的直接链接")
...
### `hermes profile update`[​](#hermes-profile-update "hermes-profile-update的直接链接")
...
### `hermes profile info`[​](#hermes-profile-info "hermes-profile-info的直接链接")
...
### 发行版 manifest（`distribution.yaml`）[​](#发行版-manifestdistributionyaml "发行版-manifestdistributionyaml的直接链接")
...
## `hermes -p` / `hermes --profile`[​](#hermes--p--hermes---profile "hermes--p--hermes---profile的直接链接")
...
* [Profiles 用户指南](/docs/zh-Hans/user-guide/profiles)
* [CLI 命令参考](/docs/zh-Hans/reference/cli-commands)
* [FAQ — Profiles 章节](/docs/zh-Hans/reference/faq#profiles)
...
* [发行版命令](#发行版命令)
  ...
  + [私有发行版](#私有发行版)
  + [发行版 manifest（`distribution.yaml`）](#发行版-manifestdistributionyaml)
  + [发布发行版](#发布发行版)
