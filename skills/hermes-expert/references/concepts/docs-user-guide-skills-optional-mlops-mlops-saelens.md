...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-saelens](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-saelens)
...
| --- | --- | --- |
| `d_sae` | 4-16× d\_model | More features, higher capacity |
