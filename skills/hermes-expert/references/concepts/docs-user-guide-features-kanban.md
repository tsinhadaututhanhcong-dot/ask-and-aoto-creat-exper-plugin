...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban)
...
### The worker lifecycle[​](#the-worker-lifecycle "Direct link to The worker lifecycle")
...
### Goal-mode cards (`--goal`)[​](#goal-mode-cards---goal "Direct link to goal-mode-cards---goal")
...
### How the orchestrator behaves[​](#how-the-orchestrator-behaves "Direct link to How the orchestrator behaves")
...
### Auto vs Manual orchestration[​](#auto-vs-manual-orchestration "Direct link to Auto vs Manual orchestration")
...
### Concurrency, scheduling, and child promotion config[​](#concurrency-scheduling-and-child-promotion-config "Direct link to Concurrency, scheduling, and child promotion config")
...
### Scheduled task starts (`scheduled_at`)[​](#scheduled-task-starts-scheduled_at "Direct link to scheduled-task-starts-scheduled_at")
...
### Respawn guard[​](#respawn-guard "Direct link to Respawn guard")
...
### Drag-to-delete and bulk delete (dashboard)[​](#drag-to-delete-and-bulk-delete-dashboard "Direct link to Drag-to-delete and bulk delete (dashboard)")
...
### Worker visibility endpoints[​](#worker-visibility-endpoints "Direct link to Worker visibility endpoints")
...
### Kanban Swarm topology helper[​](#kanban-swarm-topology-helper "Direct link to Kanban Swarm topology helper")
...
* [How workers interact with the board](#how-workers-interact-with-the-board)
  ...
  + [Goal-mode cards (`--goal`)](#goal-mode-cards---goal)
  + [How the orchestrator behaves](#how-the-orchestrator-behaves)
* [Dashboard (GUI)](#dashboard-gui)
  + [What the plugin gives you](#what-the-plugin-gives-you)
  + [Auto vs Manual orchestration](#auto-vs-manual-orchestration)
...
* [CLI command reference](#cli-command-reference)
  + [Concurrency, scheduling, and child promotion config](#concurrency-scheduling-and-child-promotion-config)
  + [Scheduled task starts (`scheduled_at`)](#scheduled-task-starts-scheduled_at)
  + [Respawn guard](#respawn-guard)
  + [Drag-to-delete and bulk delete (dashboard)](#drag-to-delete-and-bulk-delete-dashboard)
  + [Worker visibility endpoints](#worker-visibility-endpoints)
  + [Kanban Swarm topology helper](#kanban-swarm-topology-helper)
