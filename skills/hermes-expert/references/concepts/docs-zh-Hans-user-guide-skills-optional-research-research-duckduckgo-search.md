# Duckduckgo Search — 通过 DuckDuckGo 免费搜索网络 — 文本、新闻、图片、视频 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-duckduckgo-search](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-duckduckgo-search)
...
| 相关 skill | [`arxiv`](/docs/zh-Hans/user-guide/skills/bundled/research/research-arxiv) |
...
## 方法一：CLI 搜索（推荐）[​](#方法一cli-搜索推荐 "方法一：CLI 搜索（推荐）的直接链接")
...
## 方法二：Python API（仅在验证后使用）[​](#方法二python-api仅在验证后使用 "方法二：Python API（仅在验证后使用）的直接链接")
...
* [检测流程](#检测流程)
* [安装](#安装)
* [方法一：CLI 搜索（推荐）](#方法一cli-搜索推荐)
  + [CLI 参数](#cli-参数)
* [方法二：Python API（仅在验证后使用）](#方法二python-api仅在验证后使用)
  + [文本搜索](#文本搜索)
  + [新闻搜索](#新闻搜索)
  + [图片搜索](#图片搜索)
  + [视频搜索](#视频搜索)
