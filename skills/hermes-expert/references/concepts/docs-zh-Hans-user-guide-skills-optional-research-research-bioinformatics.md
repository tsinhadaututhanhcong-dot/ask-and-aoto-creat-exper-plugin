# 生物信息学 — 来自 bioSkills 和 ClawBio 的 400+ 生物信息学技能网关 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-bioinformatics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-bioinformatics)
...
## 如何获取并使用技能[​](#如何获取并使用技能 "如何获取并使用技能的直接链接")
...
## 按领域划分的技能索引[​](#按领域划分的技能索引 "按领域划分的技能索引的直接链接")
...
### 差异表达（Bulk RNA-seq）[​](#差异表达bulk-rna-seq "差异表达（Bulk RNA-seq）的直接链接")
...
### 单细胞 RNA-seq[​](#单细胞-rna-seq "单细胞 RNA-seq的直接链接")
...
### 药物基因组学与临床[​](#药物基因组学与临床 "药物基因组学与临床的直接链接")
...
nutrigx\_advisor — 基于消费者基因数据的个性化营养建议

### 群体遗传学与 GWAS[​](#群体遗传学与-gwas "群体遗传学与 GWAS的直接链接")
...
### 宏基因组学与微生物组[​](#宏基因组学与微生物组 "宏基因组学与微生物组的直接链接")
...
### 基因组组装与注释[​](#基因组组装与注释 "基因组组装与注释的直接链接")
...
### 结构生物学与化学信息学[​](#结构生物学与化学信息学 "结构生物学与化学信息学的直接链接")
...
### 通路分析与基因网络[​](#通路分析与基因网络 "通路分析与基因网络的直接链接")
...
### CRISPR 与基因组工程[​](#crispr-与基因组工程 "CRISPR 与基因组工程的直接链接")
...
### 数据可视化与报告[​](#数据可视化与报告 "数据可视化与报告的直接链接")
...
* [来源](#来源)
* [如何获取并使用技能](#如何获取并使用技能)
* [按领域划分的技能索引](#按领域划分的技能索引)
  + [序列基础](#序列基础)
  + [读段质控与比对](#读段质控与比对)
  + [变异检测与注释](#变异检测与注释)
  + [差异表达（Bulk RNA-seq）](#差异表达bulk-rna-seq)
  + [单细胞 RNA-seq](#单细胞-rna-seq)
  + [空间转录组学](#空间转录组学)
  + [表观基因组学](#表观基因组学)
  + [药物基因组学与临床](#药物基因组学与临床)
  + [群体遗传学与 GWAS](#群体遗传学与-gwas)
  + [宏基因组学与微生物组](#宏基因组学与微生物组)
  + [基因组组装与注释](#基因组组装与注释)
  + [结构生物学与化学信息学](#结构生物学与化学信息学)
  + [蛋白质组学](#蛋白质组学)
  + [通路分析与基因网络](#通路分析与基因网络)
  + [免疫信息学](#免疫信息学)
  + [CRISPR 与基因组工程](#crispr-与基因组工程)
  + [工作流管理](#工作流管理)
  + [专业领域](#专业领域)
  + [数据可视化与报告](#数据可视化与报告)
  + [数据库访问](#数据库访问)
