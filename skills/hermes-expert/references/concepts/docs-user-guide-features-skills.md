...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/skills](https://hermes-agent.nousresearch.com/docs/user-guide/features/skills)
...
## Starting with a blank slate[​](#starting-with-a-blank-slate "Direct link to Starting with a blank slate")
...
### Stacking multiple skills in one command[​](#stacking-multiple-skills-in-one-command "Direct link to Stacking multiple skills in one command")
...
## Learning a skill from sources (`/learn`)[​](#learning-a-skill-from-sources-learn "Direct link to learning-a-skill-from-sources-learn")
...
## Skill output and media delivery[​](#skill-output-and-media-delivery "Direct link to Skill output and media delivery")
...
### Forcing document-style delivery: `[[as_document]]`[​](#forcing-document-style-delivery-as_document "Direct link to forcing-document-style-delivery-as_document")
...
## Skill Bundles[​](#skill-bundles "Direct link to Skill Bundles")
...
### YAML schema[​](#yaml-schema "Direct link to YAML schema")
...
### Managing bundles[​](#managing-bundles "Direct link to Managing bundles")
...
### When bundles beat installing each skill manually[​](#when-bundles-beat-installing-each-skill-manually "Direct link to When bundles beat installing each skill manually")
...
### Gating agent skill writes (`skills.write_approval`)[​](#gating-agent-skill-writes-skillswrite_approval "Direct link to gating-agent-skill-writes-skillswrite_approval")
...
`memory.write_approval` — see [Controlling memory writes](/docs/user-guide/features/memory#controlling-memory-writes-write_approval).
...
> independent. See [Guard on agent-created skill writes](/docs/user-guide/configuration#guard-on-agent-created-skill-writes).
...
#### 8. browse.sh (`browse-sh`)[​](#8-browsesh-browse-sh "Direct link to 8-browsesh-browse-sh")
...
#### 9. Direct URL (`url`)[​](#9-direct-url-url "Direct link to 9-direct-url-url")
...
* [Starting with a blank slate](#starting-with-a-blank-slate)
* [Using Skills](#using-skills)
  + [Stacking multiple skills in one command](#stacking-multiple-skills-in-one-command)
* [Learning a skill from sources (`/learn`)](#learning-a-skill-from-sources-learn)
* [Progressive Disclosure](#progressive-disclosure)
* [SKILL.md Format](#skillmd-format)
  + [Platform-Specific Skills](#platform-specific-skills)
* [Skill output and media delivery](#skill-output-and-media-delivery)
  + [Forcing document-style delivery: `[[as_document]]`](#forcing-document-style-delivery-as_document)
...
* [Skill Bundles](#skill-bundles)
  ...
  + [Behavior](#behavior)
  + [When bundles beat installing each skill manually](#when-bundles-beat-installing-each-skill-manually)
* [Agent-Managed Skills (skill\_manage tool)](#agent-managed-skills-skill_manage-tool)
  + [When the Agent Creates Skills](#when-the-agent-creates-skills)
  + [Actions](#actions)
  + [Gating agent skill writes (`skills.write_approval`)](#gating-agent-skill-writes-skillswrite_approval)
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills](./docs-developer-guide-creating-skills.md)
- [https://hermes-agent.nousresearch.com/docs/reference/optional-skills-catalog](./docs-reference-optional-skills-catalog.md)
