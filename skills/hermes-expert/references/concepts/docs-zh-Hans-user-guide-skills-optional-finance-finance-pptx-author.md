# Pptx Author — 使用 python-pptx 无头构建 PowerPoint 演示文稿 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-pptx-author](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-pptx-author)
...
| 相关 skill | [`excel-author`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-excel-author), [`powerpoint`](/docs/zh-Hans/user-guide/skills/bundled/productivity/productivity-powerpoint) |
...
### 存在公司模板时使用公司模板[​](#存在公司模板时使用公司模板 "存在公司模板时使用公司模板的直接链接")
...
### 图表：从模型导出 PNG 优于原生 pptx 图表[​](#图表从模型导出-png-优于原生-pptx-图表 "图表：从模型导出 PNG 优于原生 pptx 图表的直接链接")
...
## 将演示文稿数字绑定到源工作簿[​](#将演示文稿数字绑定到源工作簿 "将演示文稿数字绑定到源工作簿的直接链接")
...
## 融资路演幻灯片类型清单[​](#融资路演幻灯片类型清单 "融资路演幻灯片类型清单的直接链接")
...
## 不适用本 skill 的情形[​](#不适用本-skill-的情形 "不适用本 skill 的情形的直接链接")
...
* [核心约定](#核心约定)
  + [每张幻灯片一个观点](#每张幻灯片一个观点)
  + [每个数字都追溯到模型](#每个数字都追溯到模型)
  + [存在公司模板时使用公司模板](#存在公司模板时使用公司模板)
  + [图表：从模型导出 PNG 优于原生 pptx 图表](#图表从模型导出-png-优于原生-pptx-图表)
  + [不对外发送](#不对外发送)
* [骨架代码](#骨架代码)
* [将演示文稿数字绑定到源工作簿](#将演示文稿数字绑定到源工作簿)
* [融资路演幻灯片类型清单](#融资路演幻灯片类型清单)
* [不适用本 skill 的情形](#不适用本-skill-的情形)
* [致谢](#致谢)
