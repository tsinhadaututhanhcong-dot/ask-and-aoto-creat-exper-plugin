...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-pretext](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-pretext)
...
### Use-case 2 — measure *and* render yourself[​](#use-case-2--measure-and-render-yourself "Direct link to use-case-2--measure-and-render-yourself")
...
* [The Two Use Cases](#the-two-use-cases)
  ...
  + [Use-case 2 — measure *and* render yourself](#use-case-2--measure-and-render-yourself)
