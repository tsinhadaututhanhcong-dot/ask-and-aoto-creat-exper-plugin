# Prompt 组装 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly)
...
## 已缓存的系统 prompt 层[​](#已缓存的系统-prompt-层 "已缓存的系统 prompt 层的直接链接")
...
### 具体示例：组装后的系统 prompt[​](#具体示例组装后的系统-prompt "具体示例：组装后的系统 prompt的直接链接")
...
## SOUL.md 在 prompt 中的位置[​](#soulmd-在-prompt-中的位置 "SOUL.md 在 prompt 中的位置的直接链接")
...
## 上下文文件的注入方式[​](#上下文文件的注入方式 "上下文文件的注入方式的直接链接")
...
### 上下文文件发现详情[​](#上下文文件发现详情 "上下文文件发现详情的直接链接")
...
## 仅在 API 调用时生效的层[​](#仅在-api-调用时生效的层 "仅在 API 调用时生效的层的直接链接")
...
## Prompt 组装为何如此拆分[​](#prompt-组装为何如此拆分 "Prompt 组装为何如此拆分的直接链接")
...
* [已缓存的系统 prompt 层](#已缓存的系统-prompt-层)
  + [具体示例：组装后的系统 prompt](#具体示例组装后的系统-prompt)
* [SOUL.md 在 prompt 中的位置](#soulmd-在-prompt-中的位置)
* [上下文文件的注入方式](#上下文文件的注入方式)
  + [上下文文件发现详情](#上下文文件发现详情)
* [仅在 API 调用时生效的层](#仅在-api-调用时生效的层)
* [记忆快照](#记忆快照)
* [上下文文件](#上下文文件)
* [Skills 索引](#skills-索引)
* [支持的 prompt 自定义入口](#支持的-prompt-自定义入口)
  + [优先使用这些入口](#优先使用这些入口)
  + [何时应编辑代码](#何时应编辑代码)
* [Prompt 组装为何如此拆分](#prompt-组装为何如此拆分)
* [相关文档](#相关文档)
