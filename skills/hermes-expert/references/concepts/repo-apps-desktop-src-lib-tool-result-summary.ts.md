# apps/desktop/src/lib/tool-result-summary.ts (repo source)
**Source:** https://github.com/NousResearch/hermes-agent/blob/main/apps/desktop/src/lib/tool-result-summary.ts
