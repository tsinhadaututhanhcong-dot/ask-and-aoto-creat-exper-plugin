# 贡献指南 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/contributing](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/contributing)

本页总览

感谢您为 Hermes Agent 做贡献！本指南涵盖开发环境配置、代码库结构说明以及 PR 合并流程。

## 贡献优先级[​](#贡献优先级 "贡献优先级的直接链接")
...
5. **新 skill** — 具有广泛用途的 skill（参见 [创建 Skill](/docs/zh-Hans/developer-guide/creating-skills)）
6. **新工具** — 极少需要；大多数能力应以 skill 形式实现
7. **文档** — 修正、说明、新示例

## 常见贡献路径[​](#常见贡献路径 "常见贡献路径的直接链接")

* 构建自定义/本地工具而不修改 Hermes 核心？从 [构建 Hermes 插件](/docs/zh-Hans/developer-guide/plugins/) 开始
* 为 Hermes 本身构建新的内置核心工具？从 [添加工具](/docs/zh-Hans/developer-guide/adding-tools) 开始
* 构建新的 skill？从 [创建 Skill](/docs/zh-Hans/developer-guide/creating-skills) 开始
* 构建新的推理提供商？从 [添加提供商](/docs/zh-Hans/developer-guide/adding-providers) 开始

## 开发环境配置[​](#开发环境配置 "开发环境配置的直接链接")
...
### 手动克隆备用路径[​](#手动克隆备用路径 "手动克隆备用路径的直接链接")
...
### 1. `termios` 和 `fcntl` 仅适用于 Unix[​](#1-termios-和-fcntl-仅适用于-unix "1-termios-和-fcntl-仅适用于-unix的直接链接")
...
### 贡献安全敏感代码[​](#贡献安全敏感代码 "贡献安全敏感代码的直接链接")
...
## Pull Request 流程[​](#pull-request-流程 "Pull Request 流程的直接链接")
...
### Commit 消息[​](#commit-消息 "Commit 消息的直接链接")
...
* [代码风格](#代码风格)
* [跨平台兼容性](#跨平台兼容性)
  + [1. `termios` 和 `fcntl` 仅适用于 Unix](#1-termios-和-fcntl-仅适用于-unix)
  + [2. 文件编码](#2-文件编码)
  + [3. 进程管理](#3-进程管理)
  + [4. 路径分隔符](#4-路径分隔符)
* [安全注意事项](#安全注意事项)
