...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/browser-provider-plugin](https://hermes-agent.nousresearch.com/docs/developer-guide/browser-provider-plugin)
...
## How it fits together[​](#how-it-fits-together "Direct link to How it fits together")
...
## The BrowserProvider ABC[​](#the-browserprovider-abc "Direct link to The BrowserProvider ABC")
...
### The session-metadata contract[​](#the-session-metadata-contract "Direct link to The session-metadata contract")
...
### `get_setup_schema()` — the `hermes tools` picker row[​](#get_setup_schema--the-hermes-tools-picker-row "Direct link to get_setup_schema--the-hermes-tools-picker-row")
...
## Users configure it[​](#users-configure-it "Direct link to Users configure it")
