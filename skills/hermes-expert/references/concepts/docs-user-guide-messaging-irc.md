# IRC | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/irc](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/irc)
...
### Option A — gateway-config.yaml[​](#option-a--gateway-configyaml "Direct link to Option A — gateway-config.yaml")
...
### Option B — environment variables[​](#option-b--environment-variables "Direct link to Option B — environment variables")
...
## Channels vs. DMs[​](#channels-vs-dms "Direct link to Channels vs. DMs")
