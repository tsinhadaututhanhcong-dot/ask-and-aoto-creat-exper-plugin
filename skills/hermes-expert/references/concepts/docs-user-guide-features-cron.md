...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/cron](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron)
...
### Routing intent (`all`)[​](#routing-intent-all "Direct link to routing-intent-all")
...
### Telegram cron topic (`TELEGRAM_CRON_THREAD_ID`)[​](#telegram-cron-topic-telegram_cron_thread_id "Direct link to telegram-cron-topic-telegram_cron_thread_id")
...
### Continuable jobs (reply to a cron delivery)[​](#continuable-jobs-reply-to-a-cron-delivery "Direct link to Continuable jobs (reply to a cron delivery)")
...
#### Flat, in-channel continuation (Slack)[​](#flat-in-channel-continuation-slack "Direct link to Flat, in-channel continuation (Slack)")
...
#### Recipes: cheap pre-run gates[​](#recipes-cheap-pre-run-gates "Direct link to Recipes: cheap pre-run gates")
...
* [Delivery options](#delivery-options)
  + [Routing intent (`all`)](#routing-intent-all)
  + [Telegram cron topic (`TELEGRAM_CRON_THREAD_ID`)](#telegram-cron-topic-telegram_cron_thread_id)
  + [Response wrapping](#response-wrapping)
  + [Continuable jobs (reply to a cron delivery)](#continuable-jobs-reply-to-a-cron-delivery)
...
- [https://hermes-agent.nousresearch.com/docs/guides/cron-script-only](./docs-guides-cron-script-only.md)
