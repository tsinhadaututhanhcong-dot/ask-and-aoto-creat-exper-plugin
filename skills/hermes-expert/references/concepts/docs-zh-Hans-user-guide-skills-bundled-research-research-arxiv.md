# Arxiv — 通过关键词、作者、分类或 ID 搜索 arXiv 论文 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-arxiv](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-arxiv)
...
| 相关 skill | [`ocr-and-documents`](/docs/zh-Hans/user-guide/skills/bundled/productivity/productivity-ocr-and-documents) |
...
### 整洁输出（将 XML 解析为可读格式）[​](#整洁输出将-xml-解析为可读格式 "整洁输出（将 XML 解析为可读格式）的直接链接")
...
## 生成 BibTeX[​](#生成-bibtex "生成 BibTeX的直接链接")
...
## Semantic Scholar（引用、相关论文、作者主页）[​](#semantic-scholar引用相关论文作者主页 "Semantic Scholar（引用、相关论文、作者主页）的直接链接")

arXiv 不提供引用数据或推荐功能。请使用 **Semantic Scholar API**——免费，基本使用无需 API key（1 次请求/秒），返回 JSON 格式。

### 获取论文详情及引用信息[​](#获取论文详情及引用信息 "获取论文详情及引用信息的直接链接")
...
### 获取引用该论文的文献（被引情况）[​](#获取引用该论文的文献被引情况 "获取引用该论文的文献（被引情况）的直接链接")

```
curl -s "https://api.semanticscholar.org/graph/v1/paper/arXiv:2402.03300/citations?fields=title,authors,year,citationCount&limit=10" | python3 -m json.tool
```

### 获取该论文的参考文献（引用情况）[​](#获取该论文的参考文献引用情况 "获取该论文的参考文献（引用情况）的直接链接")

```
curl -s "https://api.semanticscholar.org/graph/v1/paper/arXiv:2402.03300/references?fields=title,authors,year,citationCount&limit=10" | python3 -m json.tool
```

### 搜索论文（arXiv 搜索的替代方案，返回 JSON）[​](#搜索论文arxiv-搜索的替代方案返回-json "搜索论文（arXiv 搜索的替代方案，返回 JSON）的直接链接")

```
curl -s "https://api.semanticscholar.org/graph/v1/paper/search?query=GRPO+reinforcement+learning&limit=5&fields=title,authors,year,citationCount,externalIds" | python3 -m json.tool
```

### 获取论文推荐[​](#获取论文推荐 "获取论文推荐的直接链接")
...
### 常用 Semantic Scholar 字段[​](#常用-semantic-scholar-字段 "常用 Semantic Scholar 字段的直接链接")
...
* [搜索论文](#搜索论文)
  + [基本搜索](#基本搜索)
  + [整洁输出（将 XML 解析为可读格式）](#整洁输出将-xml-解析为可读格式)
* [搜索查询语法](#搜索查询语法)
  + [布尔运算符](#布尔运算符)
* [排序与分页](#排序与分页)
* [获取指定论文](#获取指定论文)
...
* [常用分类](#常用分类)
* [辅助脚本](#辅助脚本)
* [Semantic Scholar（引用、相关论文、作者主页）](#semantic-scholar引用相关论文作者主页)
  + [获取论文详情及引用信息](#获取论文详情及引用信息)
  + [获取引用该论文的文献（被引情况）](#获取引用该论文的文献被引情况)
  + [获取该论文的参考文献（引用情况）](#获取该论文的参考文献引用情况)
  + [搜索论文（arXiv 搜索的替代方案，返回 JSON）](#搜索论文arxiv-搜索的替代方案返回-json)
  + [获取论文推荐](#获取论文推荐)
  + [作者主页](#作者主页)
  + [常用 Semantic Scholar 字段](#常用-semantic-scholar-字段)
* [完整研究工作流](#完整研究工作流)
* [速率限制](#速率限制)
* [注意事项](#注意事项)
* [ID 版本控制](#id-版本控制)
