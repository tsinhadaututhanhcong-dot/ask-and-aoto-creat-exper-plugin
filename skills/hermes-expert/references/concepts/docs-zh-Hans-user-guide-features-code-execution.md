# 代码执行 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/code-execution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/code-execution)
...
## Agent 何时使用此功能[​](#agent-何时使用此功能 "Agent 何时使用此功能的直接链接")
...
### 构建与测试流水线[​](#构建与测试流水线 "构建与测试流水线的直接链接")
...
## 脚本内工具调用的工作方式[​](#脚本内工具调用的工作方式 "脚本内工具调用的工作方式的直接链接")
...
### Skill 环境变量透传[​](#skill-环境变量透传 "Skill 环境变量透传的直接链接")
...
详情参见[安全指南](/docs/zh-Hans/user-guide/security#environment-variable-passthrough)。
...
## execute\_code 与 terminal 对比[​](#execute_code-与-terminal-对比 "execute_code 与 terminal 对比的直接链接")

| 使用场景 | execute\_code | terminal |
| --- | --- | --- |
| 调用之间含逻辑的多步骤工作流 | ✅ | ❌ |
| 简单 shell 命令 | ❌ | ✅ |
| 过滤/处理大量工具输出 | ✅ | ❌ |
...
| 对搜索结果进行循环处理 | ✅ | ❌ |
| 交互式/后台进程 | ❌ | ✅ |
| 需要环境变量中的 API key | ⚠️ 仅通过[透传](/docs/zh-Hans/user-guide/security#environment-variable-passthrough) | ✅（大多数可透传） |
...
* [执行模式](#执行模式)
* [资源限制](#资源限制)
* [脚本内工具调用的工作方式](#脚本内工具调用的工作方式)
* [错误处理](#错误处理)
* [安全性](#安全性)
  + [Skill 环境变量透传](#skill-环境变量透传)
* [execute\_code 与 terminal 对比](#execute_code-与-terminal-对比)
* [平台支持](#平台支持)
