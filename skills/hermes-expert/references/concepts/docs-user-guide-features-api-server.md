...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/api-server](https://hermes-agent.nousresearch.com/docs/user-guide/features/api-server)
...
### GET /v1/runs/{run\_id}[​](#get-v1runsrun_id "Direct link to GET /v1/runs/{run_id}")
...
### POST /v1/runs/{run\_id}/stop[​](#post-v1runsrun_idstop "Direct link to POST /v1/runs/{run_id}/stop")
...
### POST /v1/runs/{run\_id}/approval[​](#post-v1runsrun_idapproval "Direct link to POST /v1/runs/{run_id}/approval")
...
## Sessions API (session control over REST)[​](#sessions-api-session-control-over-rest "Direct link to Sessions API (session control over REST)")
...
## Skills and toolsets discovery[​](#skills-and-toolsets-discovery "Direct link to Skills and toolsets discovery")
...
## Long-term memory scoping (`X-Hermes-Session-Key`)[​](#long-term-memory-scoping-x-hermes-session-key "Direct link to long-term-memory-scoping-x-hermes-session-key")
...
* [Runs API (streaming-friendly alternative)](#runs-api-streaming-friendly-alternative)
  ...
  + [POST /v1/runs/{run\_id}/approval](#post-v1runsrun_idapproval)
...
* [Sessions API (session control over REST)](#sessions-api-session-control-over-rest)
* [Skills and toolsets discovery](#skills-and-toolsets-discovery)
* [Long-term memory scoping (`X-Hermes-Session-Key`)](#long-term-memory-scoping-x-hermes-session-key)
