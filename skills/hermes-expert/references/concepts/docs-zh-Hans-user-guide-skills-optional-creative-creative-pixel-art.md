...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-pixel-art](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-pixel-art)
...
### Step 1 — Offer a style[​](#step-1--offer-a-style "Step 1 — Offer a style的直接链接")
...
### Step 2 — Offer animation (optional)[​](#step-2--offer-animation-optional "Step 2 — Offer animation (optional)的直接链接")
...
### Step 3 — Generate[​](#step-3--generate "Step 3 — Generate的直接链接")

Run `pixel_art()` first; if animation was requested, chain into
`pixel_art_video()` on the result.

## Preset Catalog[​](#preset-catalog "Preset Catalog的直接链接")
...
## Scene Catalog (for video)[​](#scene-catalog-for-video "Scene Catalog (for video)的直接链接")
...
## Invocation Patterns[​](#invocation-patterns "Invocation Patterns的直接链接")

### Python (import)[​](#python-import "Python (import)的直接链接")
...
## Pipeline Rationale[​](#pipeline-rationale "Pipeline Rationale的直接链接")
...
## Dependencies[​](#dependencies "Dependencies的直接链接")
