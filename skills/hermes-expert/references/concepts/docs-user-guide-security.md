...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/security](https://hermes-agent.nousresearch.com/docs/user-guide/security)
...
### User-Defined Deny Rules (`approvals.deny`)[​](#user-defined-deny-rules-approvalsdeny "Direct link to user-defined-deny-rules-approvalsdeny")
...
cannot read them — the approval is silently ignored ([#10270](https://github.com/NousResearch/hermes-agent/issues/10270)).
...
## Supply-chain advisory checking[​](#supply-chain-advisory-checking "Direct link to Supply-chain advisory checking")
...
### Lazy install of optional dependencies[​](#lazy-install-of-optional-dependencies "Direct link to Lazy install of optional dependencies")
