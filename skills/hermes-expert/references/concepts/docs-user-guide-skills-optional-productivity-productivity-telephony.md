...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-telephony](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-telephony)
...
### `${HERMES_HOME:-~/.hermes}/.env`[​](#hermes_home-hermesenv "Direct link to hermes_home-hermesenv")
...
* [Files and persistent state](#files-and-persistent-state)
  + [`${HERMES_HOME:-~/.hermes}/.env`](#hermes_home-hermesenv)
