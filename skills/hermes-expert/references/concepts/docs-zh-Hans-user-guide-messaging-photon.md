...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/photon](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/photon)

本页总览

Connect Hermes to **iMessage** through [Photon](https://photon.codes/), a managed
...
## Architecture[​](#architecture "Architecture的直接链接")
...
## First-time setup[​](#first-time-setup "First-time setup的直接链接")
...
## Authorizing users[​](#authorizing-users "Authorizing users的直接链接")
...
### Require mentions in group chats[​](#require-mentions-in-group-chats "Require mentions in group chats的直接链接")
...
## Start the gateway[​](#start-the-gateway "Start the gateway的直接链接")
...
## Status & troubleshooting[​](#status--troubleshooting "Status & troubleshooting的直接链接")
...
## Limits today[​](#limits-today "Limits today的直接链接")
...
## Env vars[​](#env-vars "Env vars的直接链接")
...
* [Authorizing users](#authorizing-users)
  + [Require mentions in group chats](#require-mentions-in-group-chats)
