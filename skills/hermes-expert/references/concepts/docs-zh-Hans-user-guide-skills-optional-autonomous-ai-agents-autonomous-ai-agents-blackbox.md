# Blackbox — 将编码任务委托给 Blackbox AI CLI 代理 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-blackbox](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-blackbox)
...
## 后台模式（长时任务）[​](#后台模式长时任务 "后台模式（长时任务）的直接链接")
...
## Token 限制[​](#token-限制 "Token 限制的直接链接")
