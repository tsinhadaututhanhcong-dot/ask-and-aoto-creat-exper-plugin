# Here.Now — 将静态站点发布到 {slug} | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-here-now](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-here-now)
...
## 使用 Drive[​](#使用-drive "使用 Drive的直接链接")
...
## API key 存储[​](#api-key-存储 "API key 存储的直接链接")
...
## 获取 API key[​](#获取-api-key "获取 API key的直接链接")
...
## 向用户说明的内容[​](#向用户说明的内容 "向用户说明的内容的直接链接")
...
## publish.sh 选项[​](#publishsh-选项 "publish.sh 选项的直接链接")
...
## publish.sh 之外的功能[​](#publishsh-之外的功能 "publish.sh 之外的功能的直接链接")
...
* [更新已有站点](#更新已有站点)
* [使用 Drive](#使用-drive)
* [API key 存储](#api-key-存储)
* [获取 API key](#获取-api-key)
* [状态文件](#状态文件)
* [向用户说明的内容](#向用户说明的内容)
* [publish.sh 选项](#publishsh-选项)
* [publish.sh 之外的功能](#publishsh-之外的功能)