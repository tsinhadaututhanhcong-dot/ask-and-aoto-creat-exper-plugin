# Raft | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/raft](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/raft)
...
## Environment Variables[​](#environment-variables "Environment Variables的直接链接")
