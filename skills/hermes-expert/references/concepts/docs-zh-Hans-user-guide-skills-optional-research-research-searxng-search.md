# Searxng Search — 通过 SearXNG 免费元搜索 — 聚合 70+ 搜索引擎的结果 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search)
...
## 方法一：通过 curl 使用 CLI（推荐）[​](#方法一通过-curl-使用-cli推荐 "方法一：通过 curl 使用 CLI（推荐）的直接链接")
...
### 常用 CLI 参数[​](#常用-cli-参数 "常用 CLI 参数的直接链接")
...
### 解析 JSON 结果[​](#解析-json-结果 "解析 JSON 结果的直接链接")
...
## 方法二：通过 `requests` 使用 Python API[​](#方法二通过-requests-使用-python-api "方法二通过-requests-使用-python-api的直接链接")
...
## 方法三：searxng-data Python 包[​](#方法三searxng-data-python-包 "方法三：searxng-data Python 包的直接链接")
...
## 自托管 SearXNG[​](#自托管-searxng "自托管 SearXNG的直接链接")
...
## 工作流：先搜索后提取[​](#工作流先搜索后提取 "工作流：先搜索后提取的直接链接")
...
* [配置](#配置)
* [检测流程](#检测流程)
* [方法一：通过 curl 使用 CLI（推荐）](#方法一通过-curl-使用-cli推荐)
  + [常用 CLI 参数](#常用-cli-参数)
  + [解析 JSON 结果](#解析-json-结果)
* [方法二：通过 `requests` 使用 Python API](#方法二通过-requests-使用-python-api)
* [方法三：searxng-data Python 包](#方法三searxng-data-python-包)
* [自托管 SearXNG](#自托管-searxng)
* [工作流：先搜索后提取](#工作流先搜索后提取)
* [限制](#限制)
* [故障排查](#故障排查)
* [注意事项](#注意事项)
* [实例发现](#实例发现)
