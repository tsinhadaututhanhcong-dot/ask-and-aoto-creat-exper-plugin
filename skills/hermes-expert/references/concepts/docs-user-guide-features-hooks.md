...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks)
...
### `pre_verify`[​](#pre_verify "Direct link to pre_verify")
...
### `subagent_start`[​](#subagent_start "Direct link to subagent_start")
...
### `transform_llm_output`[​](#transform_llm_output "Direct link to transform_llm_output")
...
#### Manual allowlisting[​](#manual-allowlisting "Direct link to Manual allowlisting")
