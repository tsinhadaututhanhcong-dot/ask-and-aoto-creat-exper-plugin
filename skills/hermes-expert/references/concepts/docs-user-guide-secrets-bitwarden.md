...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/secrets/bitwarden](https://hermes-agent.nousresearch.com/docs/user-guide/secrets/bitwarden)
...
## Why machine accounts (and why no 2FA prompt)[​](#why-machine-accounts-and-why-no-2fa-prompt "Direct link to Why machine accounts (and why no 2FA prompt)")
...
### 1. Create a machine account and access token[​](#1-create-a-machine-account-and-access-token "Direct link to 1. Create a machine account and access token")
...
### 2. Run the wizard[​](#2-run-the-wizard "Direct link to 2. Run the wizard")
...
### 3. Confirm[​](#3-confirm "Direct link to 3. Confirm")
...
* [Why machine accounts (and why no 2FA prompt)](#why-machine-accounts-and-why-no-2fa-prompt)
* [Setup](#setup)
  + [1. Create a machine account and access token](#1-create-a-machine-account-and-access-token)
