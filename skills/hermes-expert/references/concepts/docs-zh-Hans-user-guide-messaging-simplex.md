...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/simplex](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/simplex)
...
## 安装 simplex-chat[​](#安装-simplex-chat "安装 simplex-chat的直接链接")
...
## 查找联系人 ID[​](#查找联系人-id "查找联系人 ID的直接链接")
...
## 在 cron 任务中使用 SimpleX[​](#在-cron-任务中使用-simplex "在 cron 任务中使用 SimpleX的直接链接")
...
* [前提条件](#前提条件)
* [安装 simplex-chat](#安装-simplex-chat)
* [启动守护进程](#启动守护进程)
* [配置 Hermes](#配置-hermes)
  + [通过设置向导](#通过设置向导)
  + [通过环境变量](#通过环境变量)
* [查找联系人 ID](#查找联系人-id)
* [授权](#授权)
* [在 cron 任务中使用 SimpleX](#在-cron-任务中使用-simplex)
* [隐私说明](#隐私说明)
* [故障排查](#故障排查)