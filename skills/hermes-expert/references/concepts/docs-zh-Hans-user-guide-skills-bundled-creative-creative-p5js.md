...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-p5js](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-p5js)
...
| 相关 skill | [`ascii-video`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-manim-video), [`excalidraw`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-excalidraw) |
...
### 每个项目的变化规则[​](#每个项目的变化规则 "每个项目的变化规则的直接链接")
...
### 第一步：创意愿景[​](#第一步创意愿景 "第一步：创意愿景的直接链接")
...
### 第二步：技术设计[​](#第二步技术设计 "第二步：技术设计的直接链接")
...
### 第三步：编写草图代码[​](#第三步编写草图代码 "第三步：编写草图代码的直接链接")
...
### 第四步：预览与迭代[​](#第四步预览与迭代 "第四步：预览与迭代的直接链接")
...
### 第六步：质量验证[​](#第六步质量验证 "第六步：质量验证的直接链接")
...
## 关键实现注意事项[​](#关键实现注意事项 "关键实现注意事项的直接链接")

### 性能——首先禁用 FES[​](#性能首先禁用-fes "性能——首先禁用 FES的直接链接")
...
### 种子随机性——始终使用[​](#种子随机性始终使用 "种子随机性——始终使用的直接链接")
...
### 生成艺术平台支持（fxhash / Art Blocks）[​](#生成艺术平台支持fxhash--art-blocks "生成艺术平台支持（fxhash / Art Blocks）的直接链接")
...
### 色彩模式——使用 HSB[​](#色彩模式使用-hsb "色彩模式——使用 HSB的直接链接")
...
### 噪声——多倍频，而非原始噪声[​](#噪声多倍频而非原始噪声 "噪声——多倍频，而非原始噪声的直接链接")
...
### createGraphics() 分层——不可省略[​](#creategraphics-分层不可省略 "createGraphics() 分层——不可省略的直接链接")
...
### 性能——尽可能向量化[​](#性能尽可能向量化 "性能——尽可能向量化的直接链接")
...
### 多草图使用实例模式[​](#多草图使用实例模式 "多草图使用实例模式的直接链接")
...
### WebGL 模式注意事项[​](#webgl-模式注意事项 "WebGL 模式注意事项的直接链接")
...
### 导出——按键绑定约定[​](#导出按键绑定约定 "导出——按键绑定约定的直接链接")
...
### 无头视频导出——使用 noLoop()[​](#无头视频导出使用-noloop "无头视频导出——使用 noLoop()的直接链接")
...
### Agent 工作流程[​](#agent-工作流程 "Agent 工作流程的直接链接")
...
## 创意发散（仅在用户请求实验性/创意性/独特输出时使用）[​](#创意发散仅在用户请求实验性创意性独特输出时使用 "创意发散（仅在用户请求实验性/创意性/独特输出时使用）的直接链接")
...
### SCAMPER 变换[​](#scamper-变换 "SCAMPER 变换的直接链接")
...
* [工作流程](#工作流程)
  + [第一步：创意愿景](#第一步创意愿景)
  + [第二步：技术设计](#第二步技术设计)
  + [第三步：编写草图代码](#第三步编写草图代码)
  + [第四步：预览与迭代](#第四步预览与迭代)
  + [第五步：导出](#第五步导出)
  + [第六步：质量验证](#第六步质量验证)
* [关键实现注意事项](#关键实现注意事项)
  + [性能——首先禁用 FES](#性能首先禁用-fes)
  + [种子随机性——始终使用](#种子随机性始终使用)
  + [生成艺术平台支持（fxhash / Art Blocks）](#生成艺术平台支持fxhash--art-blocks)
  + [色彩模式——使用 HSB](#色彩模式使用-hsb)
  + [噪声——多倍频，而非原始噪声](#噪声多倍频而非原始噪声)
  + [createGraphics() 分层——不可省略](#creategraphics-分层不可省略)
  + [性能——尽可能向量化](#性能尽可能向量化)
  + [多草图使用实例模式](#多草图使用实例模式)
  + [WebGL 模式注意事项](#webgl-模式注意事项)
  + [导出——按键绑定约定](#导出按键绑定约定)
  + [无头视频导出——使用 noLoop()](#无头视频导出使用-noloop)
  + [Agent 工作流程](#agent-工作流程)
* [性能目标](#性能目标)
* [参考资料](#参考资料)
* [创意发散（仅在用户请求实验性/创意性/独特输出时使用）](#创意发散仅在用户请求实验性创意性独特输出时使用)
  + [概念混合](#概念混合)
  + [SCAMPER 变换](#scamper-变换)
  + [距离联想](#距离联想)
