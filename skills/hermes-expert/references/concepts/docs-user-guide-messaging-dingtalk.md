...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/dingtalk](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/dingtalk)
...
### "DINGTALK\_CLIENT\_ID and DINGTALK\_CLIENT\_SECRET required"[​](#dingtalk_client_id-and-dingtalk_client_secret-required "Direct link to \"DINGTALK_CLIENT_ID and DINGTALK_CLIENT_SECRET required\"")
...
### "No session\_webhook available"[​](#no-session_webhook-available "Direct link to \"No session_webhook available\"")
