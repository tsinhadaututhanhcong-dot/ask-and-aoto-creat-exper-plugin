# apps/desktop/src/lib/desktop-toolsets.test.ts (repo source)
**Source:** https://github.com/NousResearch/hermes-agent/blob/main/apps/desktop/src/lib/desktop-toolsets.test.ts
