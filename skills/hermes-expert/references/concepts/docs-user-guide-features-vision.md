...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/vision](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision)
...
### `vision_analyze` has the same dual behavior[​](#vision_analyze-has-the-same-dual-behavior "Direct link to vision_analyze-has-the-same-dual-behavior")
...
* [Image Routing (Vision-Capable vs Text-Only Models)](#image-routing-vision-capable-vs-text-only-models)
  + [`vision_analyze` has the same dual behavior](#vision_analyze-has-the-same-dual-behavior)
