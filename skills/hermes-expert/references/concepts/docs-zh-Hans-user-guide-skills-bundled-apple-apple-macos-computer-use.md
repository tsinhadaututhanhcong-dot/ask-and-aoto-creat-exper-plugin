...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/apple/apple-macos-computer-use](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/apple/apple-macos-computer-use)
...
## 后台规则（核心要点）[​](#后台规则核心要点 "后台规则（核心要点）的直接链接")
...
## 安全规则——硬性约束[​](#安全规则硬性约束 "安全规则——硬性约束的直接链接")
...
## 何时不使用 `computer_use`[​](#何时不使用-computer_use "何时不使用-computer_use的直接链接")
...
* [安全规则——硬性约束](#安全规则硬性约束)
* [故障排查](#故障排查)
* [何时不使用 `computer_use`](#何时不使用-computer_use)