# Mixture of Agents | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/mixture-of-agents](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/mixture-of-agents)
...
## Select a MoA preset as your model[​](#select-a-moa-preset-as-your-model "Select a MoA preset as your model的直接链接")
...
## Slash command shortcut[​](#slash-command-shortcut "Slash command shortcut的直接链接")
...
## How it works in the agent loop[​](#how-it-works-in-the-agent-loop "How it works in the agent loop的直接链接")
...
## Configure presets[​](#configure-presets "Configure presets的直接链接")
...
### Tuning advisor speed with `reference_max_tokens`[​](#tuning-advisor-speed-with-reference_max_tokens "tuning-advisor-speed-with-reference_max_tokens的直接链接")
...
## Terminal preset management[​](#terminal-preset-management "Terminal preset management的直接链接")
...
## Benchmarks[​](#benchmarks "Benchmarks的直接链接")
...
## Prompt caching[​](#prompt-caching "Prompt caching的直接链接")
...
* [Select a MoA preset as your model](#select-a-moa-preset-as-your-model)
* [Slash command shortcut](#slash-command-shortcut)
* [How it works in the agent loop](#how-it-works-in-the-agent-loop)
* [Configure presets](#configure-presets)
  + [Tuning advisor speed with `reference_max_tokens`](#tuning-advisor-speed-with-reference_max_tokens)
* [Terminal preset management](#terminal-preset-management)
