---
type: Reference
title: "Quick Usage - MinerU"
description: "**Source:** [https://opendatalab.github.io/MinerU/usage/quick_usage/](https://opendatalab.github.io/MinerU/usage/quick_usage/)"
timestamp: 2026-07-06T03:34:16Z
---
# Quick Usage - MinerU
**Source:** [https://opendatalab.github.io/MinerU/usage/quick_usage/](https://opendatalab.github.io/MinerU/usage/quick_usage/)
...
For more information about model source configuration and custom local model paths, please refer to the [Model Source Documentation](../model_source/) in the documentation.
...
For more information about output files, please refer to [Output File Documentation](../../reference/output_files/).
...
If you need to adjust parsing options through custom parameters, you can also check the more detailed [Command Line Tools Usage Instructions](../cli_tools/) in the documentation.
...
We have compiled some commonly used parameters and usage methods for `vllm/lmdeploy`, which can be found in the documentation [Advanced Command Line Parameters](../advanced_cli_parameters/).
...
- [https://opendatalab.github.io/MinerU/reference/output_files/](./MinerU-reference-outputfiles.md)
- [https://opendatalab.github.io/MinerU/usage/advanced_cli_parameters/](./MinerU-usage-advancedcliparameters.md)
- [https://opendatalab.github.io/MinerU/usage/cli_tools/](./MinerU-usage-clitools.md)
- [https://opendatalab.github.io/MinerU/usage/model_source/](./MinerU-usage-modelsource.md)
