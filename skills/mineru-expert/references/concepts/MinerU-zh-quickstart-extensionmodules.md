...
* 如需使用 CUDA 12.9 兼容环境，请参考 [vllm 官方文档](https://docs.vllm.ai/en/latest/getting_started/installation/index.html) 选择对应的 CUDA 安装方式，或直接使用 [Docker](../docker_deployment/) 中的`vllm/vllm-openai:v0.21.0-cu129`基础镜像。
