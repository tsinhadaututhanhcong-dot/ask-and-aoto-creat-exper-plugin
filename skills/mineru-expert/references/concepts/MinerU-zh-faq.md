...
在WSL2的Ubuntu22.04中遇到报错`ImportError: libGL.so.1: cannot open shared object file: No such file or directory`
...
也可以直接使用我们的[Docker部署](../quick_start/docker_deployment/)方式构建镜像，镜像中默认包含以上字体包。
