...
**Source:** [https://code.claude.com/docs/en/output-styles](https://code.claude.com/docs/en/output-styles)
...
[Escalate hard decisions with the advisor tool](/docs/en/advisor)[Terminal configuration](/docs/en/terminal-config)
