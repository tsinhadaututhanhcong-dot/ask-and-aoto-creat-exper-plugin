---
type: Reference
title: LLM gateways - Claude Code Docs
date_created: 2026-06-29
tags: [concept, auto-generated]
platform: enterprise-provider
---

# LLM gateways - Claude Code Docs
**Source:** [https://code.claude.com/docs/en/llm-gateway](https://code.claude.com/docs/en/llm-gateway)
...
All of these except provider switching apply whether the upstream is Anthropic’s API or a [cloud provider](/docs/en/third-party-integrations).
...
[Development containers](/docs/en/devcontainer)[Connect to a gateway](/docs/en/llm-gateway-connect)
