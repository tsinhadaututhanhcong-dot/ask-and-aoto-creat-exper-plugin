...
**Source:** [https://code.claude.com/docs/en/context-window](https://code.claude.com/docs/en/context-window)
...
[Explore the .claude directory](/docs/en/claude-directory)[Prompt caching](/docs/en/prompt-caching)
