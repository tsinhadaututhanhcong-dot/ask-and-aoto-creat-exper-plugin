...
**Source:** [https://code.claude.com/docs/en/large-codebases](https://code.claude.com/docs/en/large-codebases)
...
[Launch sessions from links](/docs/en/deep-links)[Troubleshoot installation and login](/docs/en/troubleshoot-install)
