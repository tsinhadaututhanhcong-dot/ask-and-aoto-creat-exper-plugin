...
**Source:** [https://code.claude.com/docs/en/debug-your-config](https://code.claude.com/docs/en/debug-your-config)
...
[Troubleshoot performance and stability](/docs/en/troubleshooting)[Error reference](/docs/en/errors)
