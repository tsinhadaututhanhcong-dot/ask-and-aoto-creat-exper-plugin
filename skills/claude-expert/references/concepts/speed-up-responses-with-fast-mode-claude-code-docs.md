...
**Source:** [https://code.claude.com/docs/en/fast-mode](https://code.claude.com/docs/en/fast-mode)
...
[Model configuration](/docs/en/model-config)[Escalate hard decisions with the advisor tool](/docs/en/advisor)
