...
**Source:** [https://code.claude.com/docs/en/mcp-quickstart](https://code.claude.com/docs/en/mcp-quickstart)
...
[Isolate sessions with worktrees](/docs/en/worktrees)[Reference](/docs/en/mcp)
