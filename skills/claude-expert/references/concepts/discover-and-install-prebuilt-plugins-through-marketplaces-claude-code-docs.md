...
**Source:** [https://code.claude.com/docs/en/discover-plugins](https://code.claude.com/docs/en/discover-plugins)
...
[Extend Claude with skills](/docs/en/skills)[Create plugins](/docs/en/plugins)
