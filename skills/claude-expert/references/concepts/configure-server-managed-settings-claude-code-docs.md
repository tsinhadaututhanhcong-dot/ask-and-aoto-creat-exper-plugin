...
**Source:** [https://code.claude.com/docs/en/server-managed-settings](https://code.claude.com/docs/en/server-managed-settings)
...
[Authentication](/docs/en/authentication)[Managed MCP configuration](/docs/en/managed-mcp)
