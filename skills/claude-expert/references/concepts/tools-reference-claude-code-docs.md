...
**Source:** [https://code.claude.com/docs/en/tools-reference](https://code.claude.com/docs/en/tools-reference)
...
[Environment variables](/docs/en/env-vars)[Interactive mode](/docs/en/interactive-mode)
