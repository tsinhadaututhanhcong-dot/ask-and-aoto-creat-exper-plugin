...
**Source:** [https://code.claude.com/docs/en/sessions](https://code.claude.com/docs/en/sessions)
...
[Permission modes](/docs/en/permission-modes)[Common workflows](/docs/en/common-workflows)
