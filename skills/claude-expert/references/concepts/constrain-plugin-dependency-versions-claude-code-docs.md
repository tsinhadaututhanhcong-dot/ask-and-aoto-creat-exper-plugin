...
**Source:** [https://code.claude.com/docs/en/plugin-dependencies](https://code.claude.com/docs/en/plugin-dependencies)
...
[Create and distribute a plugin marketplace](/docs/en/plugin-marketplaces)[Recommend your plugin from your CLI](/docs/en/plugin-hints)
