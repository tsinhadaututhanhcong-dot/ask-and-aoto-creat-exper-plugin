---
title: Track cost and usage - Claude Code Docs
...
**Source:** [https://code.claude.com/docs/en/agent-sdk/cost-tracking](https://code.claude.com/docs/en/agent-sdk/cost-tracking)
