...
**Source:** [https://code.claude.com/docs/en/auto-mode-config](https://code.claude.com/docs/en/auto-mode-config)
...
[Managed MCP configuration](/docs/en/managed-mcp)[Overview](/docs/en/third-party-integrations)
