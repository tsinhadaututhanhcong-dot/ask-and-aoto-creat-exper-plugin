---
title: Observability with OpenTelemetry - Claude Code Docs
...
**Source:** [https://code.claude.com/docs/en/agent-sdk/observability](https://code.claude.com/docs/en/agent-sdk/observability)
...
[Track cost and usage](/docs/en/agent-sdk/cost-tracking)[Todo Lists](/docs/en/agent-sdk/todo-tracking)
