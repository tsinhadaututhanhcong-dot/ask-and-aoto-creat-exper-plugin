...
**Source:** [https://code.claude.com/docs/en/prompt-caching](https://code.claude.com/docs/en/prompt-caching)
...
[Explore the context window](/docs/en/context-window)[Store instructions and memories](/docs/en/memory)
