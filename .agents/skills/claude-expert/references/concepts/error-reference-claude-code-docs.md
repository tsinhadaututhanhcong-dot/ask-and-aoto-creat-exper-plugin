...
**Source:** [https://code.claude.com/docs/en/errors](https://code.claude.com/docs/en/errors)
...
Environment variables and `apiKeyHelper` take precedence over `/login`, so running `/login` alone does not help while either is still supplying a key. See [Authentication precedence](/docs/en/authentication#authentication-precedence).
**What to do:**
