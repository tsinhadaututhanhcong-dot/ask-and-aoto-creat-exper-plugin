...
**Source:** [https://code.claude.com/docs/en/terminal-config](https://code.claude.com/docs/en/terminal-config)
...
[Output styles](/docs/en/output-styles)[Fullscreen rendering](/docs/en/fullscreen)
