...
**Source:** [https://code.claude.com/docs/en/voice-dictation](https://code.claude.com/docs/en/voice-dictation)
...
[Fullscreen rendering](/docs/en/fullscreen)[Customize status line](/docs/en/statusline)
