...
**Source:** [https://code.claude.com/docs/en/sandbox-environments](https://code.claude.com/docs/en/sandbox-environments)
...
[Permissions](/docs/en/permissions)[Bash sandbox](/docs/en/sandboxing)
