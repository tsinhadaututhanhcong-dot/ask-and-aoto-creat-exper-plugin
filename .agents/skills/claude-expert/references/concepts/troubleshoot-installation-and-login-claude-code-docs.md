...
**Source:** [https://code.claude.com/docs/en/troubleshoot-install](https://code.claude.com/docs/en/troubleshoot-install)
...
[Monorepos and large repos](/docs/en/large-codebases)[Troubleshoot performance and stability](/docs/en/troubleshooting)
