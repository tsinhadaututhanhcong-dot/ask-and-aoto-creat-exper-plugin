...
**Source:** [https://code.claude.com/docs/en/fullscreen](https://code.claude.com/docs/en/fullscreen)
...
[Terminal configuration](/docs/en/terminal-config)[Voice dictation](/docs/en/voice-dictation)
