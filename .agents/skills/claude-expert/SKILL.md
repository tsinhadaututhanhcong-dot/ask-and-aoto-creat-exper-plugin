...
**Quy tắc tuyệt đối:** Agent KHÔNG ĐƯỢC dựa vào trí nhớ pre-trained để trả lời về tính năng Claude. BẮT BUỘC đọc file trong thư mục `references/` bằng tool `view_file`.
