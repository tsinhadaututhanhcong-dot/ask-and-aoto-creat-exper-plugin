...
description: Sandbox controls and folder permissions.
...
### Understanding read\_url vs execute\_url Across the Platform[link](#understanding-read-url-vs-execute-url-across-the-platform)
