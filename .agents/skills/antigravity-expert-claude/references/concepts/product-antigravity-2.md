...
description: Graphical command center interface for monitoring and managing active background agents.
...
[Download](/download#antigravity-2)

[![](/assets/image/product/antigravity-2/hero.jpg)](/assets/image/product/AGY2-hype.mp4)

## Explore the main features

![An Abstracted UI](/assets/image/product/hero-middle-gradient.png)

### An Abstracted UI

Your AI agents' central command center, providing a unified platform to launch, monitor, and orchestrate their activities.

![Dynamic Subagents](/assets/image/product/subagents.png)
...
![Scheduled Tasks](/assets/image/product/scheduled.png)
...
![Artifacts](/assets/image/product/artifacts.png)

### Artifacts

Deliverables from the Agent that communicate its progress with you.

![Extend Customization](/assets/image/product/skills.jpg)
