...
type: Reference
title: "基础使用 - MinerU"
description: "**Source:** [https://opendatalab.github.io/MinerU/zh/usage/quick_usage/](https://opendatalab.github.io/MinerU/zh/usage/quick_usage/)"
timestamp: 2026-07-06T03:34:16Z
---
# 基础使用 - MinerU
**Source:** [https://opendatalab.github.io/MinerU/zh/usage/quick_usage/](https://opendatalab.github.io/MinerU/zh/usage/quick_usage/)
...
有关模型源配置和自定义本地模型路径的更多信息，请参考文档中的[模型源说明](../model_source/)。
...
更多关于输出文件的信息，请参考[输出文件说明](../../reference/output_files/)。
...
如果需要通过自定义参数调整解析选项，您也可以在文档中查看更详细的[命令行工具使用说明](../cli_tools/)。
...
我们整理了一些`vllm/lmdeploy`使用中的常用参数和使用方法，可以在文档[命令行进阶参数](../advanced_cli_parameters/)中获取。
