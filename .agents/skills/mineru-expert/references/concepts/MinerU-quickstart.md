...
If you encounter any installation issues, please check the [FAQ](../faq/) first.
...
| Accuracy1 | 86.47 | 95.39 (high) 95.26 (medium) | 95.30 | 95.39 (high) 95.26 (medium) | 95.30 |
...
| RAM | Min 16GB+, Recommended 32GB+ | | | 16GB | |
...
* If CUDA acceleration is unavailable after installing on Windows, see the [Windows CUDA acceleration FAQ](../faq/#windows-cuda-acceleration).
...
You can get the [Docker Deployment Instructions](docker_deployment/) in the documentation.
...
You can use MinerU for document parsing through the CLI, API, WebUI. For detailed instructions, please refer to the [Usage Guide](../usage/).
...
- [https://opendatalab.github.io/MinerU/quick_start/extension_modules/](./MinerU-quickstart-extensionmodules.md)
- [https://opendatalab.github.io/MinerU/usage/](./MinerU-usage.md)
