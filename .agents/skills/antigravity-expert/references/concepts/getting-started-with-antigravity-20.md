...
ActionmacOSWindows / Linux**Open Conversation Picker**`⌘K``Ctrl + K`**Open File Search**`⌘P``Ctrl + P`**Focus Input**`⌘L``Ctrl + L`**New Conversation**`⌘N``Ctrl + N`**Next/Previous Conversation**`⌥ Up / Down``Alt + Up / Down`
