...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model)
...
## TEMPLATE REQUIREMENT[​](#template-requirement "Direct link to TEMPLATE REQUIREMENT")
...
## CRITICAL INSTRUCTIONS — READ FIRST[​](#critical-instructions--read-first "Direct link to CRITICAL INSTRUCTIONS — READ FIRST")
...
### Formula Color Conventions[​](#formula-color-conventions "Direct link to Formula Color Conventions")
...
### Fill Color Palette — Professional Blues & Greys (Default unless user/template specifies otherwise)[​](#fill-color-palette--professional-blues--greys-default-unless-usertemplate-specifies-otherwise "Direct link to Fill Color Palette — Professional Blues & Greys (Default unless user/template specifies otherwise)")
...
### Number Formatting Standards[​](#number-formatting-standards "Direct link to Number Formatting Standards")
...
### Clarify Requirements First[​](#clarify-requirements-first "Direct link to Clarify Requirements First")
...
## TEMPLATE ANALYSIS PHASE - DO THIS FIRST[​](#template-analysis-phase---do-this-first "Direct link to TEMPLATE ANALYSIS PHASE - DO THIS FIRST")
...
## FILLING FORMULAS - GENERAL APPROACH[​](#filling-formulas---general-approach "Direct link to FILLING FORMULAS - GENERAL APPROACH")

For each cell that needs a formula, follow this hierarchy:

### Step 1: Check the Template[​](#step-1-check-the-template "Direct link to Step 1: Check the Template")
...
### Step 2: Check the User's Instructions[​](#step-2-check-the-users-instructions "Direct link to Step 2: Check the User's Instructions")
...
### Step 3: Apply Standard Practice[​](#step-3-apply-standard-practice "Direct link to Step 3: Apply Standard Practice")
...
## COMMON PROBLEM AREAS[​](#common-problem-areas "Direct link to COMMON PROBLEM AREAS")
...
### Balancing Sections[​](#balancing-sections "Direct link to Balancing Sections")
...
### Tax Calculations[​](#tax-calculations "Direct link to Tax Calculations")
...
### Interest and Circular References[​](#interest-and-circular-references "Direct link to Interest and Circular References")
...
### Debt Paydown / Cash Sweeps[​](#debt-paydown--cash-sweeps "Direct link to Debt Paydown / Cash Sweeps")
...
### Returns Calculations (IRR/MOIC)[​](#returns-calculations-irrmoic "Direct link to Returns Calculations (IRR/MOIC)")
...
### Sensitivity Tables[​](#sensitivity-tables "Direct link to Sensitivity Tables")
...
## VERIFICATION CHECKLIST - RUN AFTER COMPLETION[​](#verification-checklist---run-after-completion "Direct link to VERIFICATION CHECKLIST - RUN AFTER COMPLETION")

### Run Formula Validation[​](#run-formula-validation "Direct link to Run Formula Validation")
...
### Section Balancing[​](#section-balancing "Direct link to Section Balancing")
...
### Income/Operating Projections[​](#incomeoperating-projections "Direct link to Income/Operating Projections")
...
### Balance Sheet (if applicable)[​](#balance-sheet-if-applicable "Direct link to Balance Sheet (if applicable)")
...
### Cash Flow (if applicable)[​](#cash-flow-if-applicable "Direct link to Cash Flow (if applicable)")
...
### Supporting Schedules[​](#supporting-schedules "Direct link to Supporting Schedules")
...
### Debt/Financing Schedules (if applicable)[​](#debtfinancing-schedules-if-applicable "Direct link to Debt/Financing Schedules (if applicable)")
...
### Returns/Output Analysis[​](#returnsoutput-analysis "Direct link to Returns/Output Analysis")
...
### Sensitivity Tables (if applicable)[​](#sensitivity-tables-if-applicable "Direct link to Sensitivity Tables (if applicable)")
...
### Logical Sanity Checks[​](#logical-sanity-checks "Direct link to Logical Sanity Checks")
...
## COMMON ERRORS TO AVOID[​](#common-errors-to-avoid "Direct link to COMMON ERRORS TO AVOID")
...
## WORKING WITH THE USER — SECTION-BY-SECTION CHECKPOINTS[​](#working-with-the-user--section-by-section-checkpoints "Direct link to WORKING WITH THE USER — SECTION-BY-SECTION CHECKPOINTS")
...
* [TEMPLATE REQUIREMENT](#template-requirement)
* [CRITICAL INSTRUCTIONS — READ FIRST](#critical-instructions--read-first)
  + [Core Principles](#core-principles)
  + [Formula Color Conventions](#formula-color-conventions)
  + [Fill Color Palette — Professional Blues & Greys (Default unless user/template specifies otherwise)](#fill-color-palette--professional-blues--greys-default-unless-usertemplate-specifies-otherwise)
  + [Number Formatting Standards](#number-formatting-standards)
  + [Clarify Requirements First](#clarify-requirements-first)
* [TEMPLATE ANALYSIS PHASE - DO THIS FIRST](#template-analysis-phase---do-this-first)
* [FILLING FORMULAS - GENERAL APPROACH](#filling-formulas---general-approach)
  + [Step 1: Check the Template](#step-1-check-the-template)
  + [Step 2: Check the User's Instructions](#step-2-check-the-users-instructions)
  + [Step 3: Apply Standard Practice](#step-3-apply-standard-practice)
* [COMMON PROBLEM AREAS](#common-problem-areas)
  + [Balancing Sections](#balancing-sections)
  + [Tax Calculations](#tax-calculations)
  + [Interest and Circular References](#interest-and-circular-references)
  + [Debt Paydown / Cash Sweeps](#debt-paydown--cash-sweeps)
  + [Returns Calculations (IRR/MOIC)](#returns-calculations-irrmoic)
  + [Sensitivity Tables](#sensitivity-tables)
* [VERIFICATION CHECKLIST - RUN AFTER COMPLETION](#verification-checklist---run-after-completion)
  + [Run Formula Validation](#run-formula-validation)
  + [Section Balancing](#section-balancing)
  + [Income/Operating Projections](#incomeoperating-projections)
  + [Balance Sheet (if applicable)](#balance-sheet-if-applicable)
  + [Cash Flow (if applicable)](#cash-flow-if-applicable)
  + [Supporting Schedules](#supporting-schedules)
  + [Debt/Financing Schedules (if applicable)](#debtfinancing-schedules-if-applicable)
  + [Returns/Output Analysis](#returnsoutput-analysis)
  + [Sensitivity Tables (if applicable)](#sensitivity-tables-if-applicable)
  + [Formatting](#formatting)
  + [Logical Sanity Checks](#logical-sanity-checks)
* [COMMON ERRORS TO AVOID](#common-errors-to-avoid)
* [WORKING WITH THE USER — SECTION-BY-SECTION CHECKPOINTS](#working-with-the-user--section-by-section-checkpoints)
