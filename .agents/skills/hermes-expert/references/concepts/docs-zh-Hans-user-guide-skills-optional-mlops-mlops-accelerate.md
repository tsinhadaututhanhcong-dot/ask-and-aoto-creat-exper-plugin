# Huggingface Accelerate — 最简分布式训练 API | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-accelerate](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-accelerate)
...
### 工作流 1：从单 GPU 到多 GPU[​](#工作流-1从单-gpu-到多-gpu "工作流 1：从单 GPU 到多 GPU的直接链接")
...
### 工作流 2：混合精度训练[​](#工作流-2混合精度训练 "工作流 2：混合精度训练的直接链接")
...
### 工作流 3：DeepSpeed ZeRO 集成[​](#工作流-3deepspeed-zero-集成 "工作流 3：DeepSpeed ZeRO 集成的直接链接")
...
### 工作流 4：FSDP（全分片数据并行）[​](#工作流-4fsdp全分片数据并行 "工作流 4：FSDP（全分片数据并行）的直接链接")
...
### 工作流 5：梯度累积[​](#工作流-5梯度累积 "工作流 5：梯度累积的直接链接")
...
* [快速开始](#快速开始)
* [常见工作流](#常见工作流)
  + [工作流 1：从单 GPU 到多 GPU](#工作流-1从单-gpu-到多-gpu)
  + [工作流 2：混合精度训练](#工作流-2混合精度训练)
  + [工作流 3：DeepSpeed ZeRO 集成](#工作流-3deepspeed-zero-集成)
  + [工作流 4：FSDP（全分片数据并行）](#工作流-4fsdp全分片数据并行)
  + [工作流 5：梯度累积](#工作流-5梯度累积)
* [与替代方案的对比](#与替代方案的对比)
* [常见问题](#常见问题)
* [高级主题](#高级主题)
* [硬件要求](#硬件要求)
