# Plugin LLM 访问 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/plugin-llm-access](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/plugin-llm-access)
...
## 更完整的对话示例[​](#更完整的对话示例 "更完整的对话示例的直接链接")
...
### 对话补全——`/tldr`[​](#对话补全tldr "对话补全tldr的直接链接")
...
### 结构化提取——`/paste-to-tasks`[​](#结构化提取paste-to-tasks "结构化提取paste-to-tasks的直接链接")
...
## 何时使用哪种方式[​](#何时使用哪种方式 "何时使用哪种方式的直接链接")
...
## API 接口[​](#api-接口 "API 接口的直接链接")

`ctx.llm` 是 `agent.plugin_llm.PluginLlm` 的实例。

### `complete()`[​](#complete "complete的直接链接")
...
### `complete_structured()`[​](#complete_structured "complete_structured的直接链接")
...
### 门控无需执行的内容[​](#门控无需执行的内容 "门控无需执行的内容的直接链接")
...
## Plugin 负责的内容[​](#plugin-负责的内容 "Plugin 负责的内容的直接链接")
...
## 在 plugin 接口中的定位[​](#在-plugin-接口中的定位 "在 plugin 接口中的定位的直接链接")
...
* 辅助客户端（底层引擎）：参见
  [Provider 运行时](/docs/zh-Hans/developer-guide/provider-runtime)。
...
* [快速开始](#快速开始)
  + [对话补全——`/tldr`](#对话补全tldr)
  + [结构化提取——`/paste-to-tasks`](#结构化提取paste-to-tasks)
* [何时使用哪种方式](#何时使用哪种方式)
* [API 接口](#api-接口)
  + [`complete()`](#complete)
...
* [信任门控](#信任门控)
  ...
  + [门控无需执行的内容](#门控无需执行的内容)
* [宿主负责的内容](#宿主负责的内容)
* [Plugin 负责的内容](#plugin-负责的内容)
* [在 plugin 接口中的定位](#在-plugin-接口中的定位)
* [参考资料](#参考资料)
