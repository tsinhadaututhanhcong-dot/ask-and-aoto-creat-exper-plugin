...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/plugins](https://hermes-agent.nousresearch.com/docs/user-guide/features/plugins)
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/adding-tools](./docs-developer-guide-adding-tools.md)
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/extending-the-cli](./docs-developer-guide-extending-the-cli.md)
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/plugin-llm-access](./docs-developer-guide-plugin-llm-access.md)
