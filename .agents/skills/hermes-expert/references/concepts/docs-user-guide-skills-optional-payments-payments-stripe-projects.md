...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-stripe-projects](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-stripe-projects)
...
### 1. Initialize the project[​](#1-initialize-the-project "Direct link to 1. Initialize the project")
...
### 2. Discover available providers[​](#2-discover-available-providers "Direct link to 2. Discover available providers")
...
### 3. Add a service[​](#3-add-a-service "Direct link to 3. Add a service")
...
### 5. Manage / upgrade / remove[​](#5-manage--upgrade--remove "Direct link to 5. Manage / upgrade / remove")
