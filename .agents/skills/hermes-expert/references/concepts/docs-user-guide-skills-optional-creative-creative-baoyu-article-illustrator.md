...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-baoyu-article-illustrator](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-baoyu-article-illustrator)
...
## Three Dimensions[​](#three-dimensions "Direct link to Three Dimensions")
...
### Step 1: Detect Reference Images[​](#step-1-detect-reference-images "Direct link to Step 1: Detect Reference Images")
...
### Step 2: Analyze[​](#step-2-analyze "Direct link to Step 2: Analyze")
...
### Step 3: Confirm Settings[​](#step-3-confirm-settings "Direct link to Step 3: Confirm Settings")
...
### Step 4: Generate Outline → `outline.md`[​](#step-4-generate-outline--outlinemd "Direct link to step-4-generate-outline--outlinemd")
...
### Step 5: Generate Prompts[​](#step-5-generate-prompts "Direct link to Step 5: Generate Prompts")
...
### Step 6: Generate Images[​](#step-6-generate-images "Direct link to Step 6: Generate Images")
...
## Modification[​](#modification "Direct link to Modification")
