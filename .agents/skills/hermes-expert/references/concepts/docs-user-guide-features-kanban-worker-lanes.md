...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes)
...
## The hierarchy[​](#the-hierarchy "Direct link to The hierarchy")
...
## What a lane provides[​](#what-a-lane-provides "Direct link to What a lane provides")

To be a kanban worker lane, an integration must provide three things:

### 1. An assignee string[​](#1-an-assignee-string "Direct link to 1. An assignee string")
...
### 2. A spawn mechanism[​](#2-a-spawn-mechanism "Direct link to 2. A spawn mechanism")
...
### 3. A lifecycle terminator[​](#3-a-lifecycle-terminator "Direct link to 3. A lifecycle terminator")
...
## Outputs and the review-required convention[​](#outputs-and-the-review-required-convention "Direct link to Outputs and the review-required convention")
...
## Logs and audit trail[​](#logs-and-audit-trail "Direct link to Logs and audit trail")
...
## Existing lane shapes[​](#existing-lane-shapes "Direct link to Existing lane shapes")

### Hermes profile lane (default)[​](#hermes-profile-lane-default "Direct link to Hermes profile lane (default)")
...
### Orchestrator profile lane[​](#orchestrator-profile-lane "Direct link to Orchestrator profile lane")
...
## Adding an external CLI worker lane[​](#adding-an-external-cli-worker-lane "Direct link to Adding an external CLI worker lane")
...
## Failure modes the dispatcher handles[​](#failure-modes-the-dispatcher-handles "Direct link to Failure modes the dispatcher handles")
...
* [What a lane provides](#what-a-lane-provides)
  + [1. An assignee string](#1-an-assignee-string)
  + [2. A spawn mechanism](#2-a-spawn-mechanism)
  + [3. A lifecycle terminator](#3-a-lifecycle-terminator)
* [Outputs and the review-required convention](#outputs-and-the-review-required-convention)
* [Logs and audit trail](#logs-and-audit-trail)
* [Existing lane shapes](#existing-lane-shapes)
  + [Hermes profile lane (default)](#hermes-profile-lane-default)
  + [Orchestrator profile lane](#orchestrator-profile-lane)
* [Adding an external CLI worker lane](#adding-an-external-cli-worker-lane)
* [Failure modes the dispatcher handles](#failure-modes-the-dispatcher-handles)
* [Related](#related)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial](./docs-user-guide-features-kanban-tutorial.md)
