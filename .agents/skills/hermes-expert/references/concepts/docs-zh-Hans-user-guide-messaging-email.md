# 电子邮件 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email)
...
### Gmail 设置[​](#gmail-设置 "Gmail 设置的直接链接")
...
### Outlook / Microsoft 365[​](#outlook--microsoft-365 "Outlook / Microsoft 365的直接链接")
...
## 第一步：配置 Hermes[​](#第一步配置-hermes "第一步：配置 Hermes的直接链接")
