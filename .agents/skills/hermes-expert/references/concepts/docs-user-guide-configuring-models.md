...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/configuring-models](https://hermes-agent.nousresearch.com/docs/user-guide/configuring-models)
...
### Mid-session switches and context warnings[​](#mid-session-switches-and-context-warnings "Direct link to Mid-session switches and context warnings")
...
* [Setting the main model](#setting-the-main-model)
  + [Mid-session switches and context warnings](#mid-session-switches-and-context-warnings)
