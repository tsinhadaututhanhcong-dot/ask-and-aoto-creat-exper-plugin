...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/apple/apple-macos-computer-use](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/apple/apple-macos-computer-use)
...
## Text input patterns[​](#text-input-patterns "Direct link to Text input patterns")
...
* [Text input patterns](#text-input-patterns)
* [Drag & drop](#drag--drop)
* [Scroll](#scroll)
