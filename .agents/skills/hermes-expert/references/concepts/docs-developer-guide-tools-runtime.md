...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/tools-runtime](https://hermes-agent.nousresearch.com/docs/developer-guide/tools-runtime)
...
* [Dispatch](#dispatch)
  + [Dispatch flow: model tool\_call → handler execution](#dispatch-flow-model-tool_call--handler-execution)
  + [Error wrapping](#error-wrapping)
  + [Agent-loop tools](#agent-loop-tools)
  + [Async bridging](#async-bridging)
* [The DANGEROUS\_PATTERNS approval flow](#the-dangerous_patterns-approval-flow)
...
- [https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference](./docs-reference-toolsets-reference.md)
