...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/memory](https://hermes-agent.nousresearch.com/docs/user-guide/features/memory)
...
## Controlling memory writes (`write_approval`)[​](#controlling-memory-writes-write_approval "Direct link to controlling-memory-writes-write_approval")
...
## Background review notifications (`display.memory_notifications`)[​](#background-review-notifications-displaymemory_notifications "Direct link to background-review-notifications-displaymemory_notifications")
...
## Running the review on a cheaper model (`auxiliary.background_review`)[​](#running-the-review-on-a-cheaper-model-auxiliarybackground_review "Direct link to running-the-review-on-a-cheaper-model-auxiliarybackground_review")
...
## Controlling skill writes (`skills.write_approval`)[​](#controlling-skill-writes-skillswrite_approval "Direct link to controlling-skill-writes-skillswrite_approval")
...
When `write_approval: true`, skill writes (create / edit / patch / write\_file /
...
Full details in [Gating agent skill writes](/docs/user-guide/features/skills#gating-agent-skill-writes-skillswrite_approval).
...
* [Session Search](#session-search)
  + [session\_search vs memory](#session_search-vs-memory)
* [Configuration](#configuration)
* [Controlling memory writes (`write_approval`)](#controlling-memory-writes-write_approval)
* [Background review notifications (`display.memory_notifications`)](#background-review-notifications-displaymemory_notifications)
* [Running the review on a cheaper model (`auxiliary.background_review`)](#running-the-review-on-a-cheaper-model-auxiliarybackground_review)
* [Controlling skill writes (`skills.write_approval`)](#controlling-skill-writes-skillswrite_approval)
