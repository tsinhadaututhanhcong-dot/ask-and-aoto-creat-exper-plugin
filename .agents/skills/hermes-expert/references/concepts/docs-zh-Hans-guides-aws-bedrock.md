...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/aws-bedrock](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/aws-bedrock)
...
### Guardrails[​](#guardrails "Guardrails的直接链接")
...
### "No API key found" / "No AWS credentials"[​](#no-api-key-found--no-aws-credentials "\"No API key found\" / \"No AWS credentials\"的直接链接")
...
### "Invocation of model ID ... with on-demand throughput isn't supported"[​](#invocation-of-model-id--with-on-demand-throughput-isnt-supported "\"Invocation of model ID ... with on-demand throughput isn't supported\"的直接链接")
