# Llava — 大型语言与视觉助手 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-llava](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-llava)
...
## 何时使用 LLaVA[​](#何时使用-llava "何时使用 LLaVA的直接链接")
...
## Web UI（Gradio）[​](#web-uigradio "Web UI（Gradio）的直接链接")
...
### 目标检测（文本形式）[​](#目标检测文本形式 "目标检测（文本形式）的直接链接")
...
## 量化（降低显存占用）[​](#量化降低显存占用 "量化（降低显存占用）的直接链接")
...
## 与框架集成[​](#与框架集成 "与框架集成的直接链接")

### LangChain[​](#langchain "LangChain的直接链接")
...
### Gradio 应用[​](#gradio-应用 "Gradio 应用的直接链接")
...
* [何时使用 LLaVA](#何时使用-llava)
* [快速开始](#快速开始)
  + [安装](#安装)
  + [基本用法](#基本用法)
* [可用模型](#可用模型)
* [CLI 用法](#cli-用法)
* [Web UI（Gradio）](#web-uigradio)
* [多轮对话](#多轮对话)
* [常见任务](#常见任务)
  + [图像字幕生成](#图像字幕生成)
  + [视觉问答](#视觉问答)
