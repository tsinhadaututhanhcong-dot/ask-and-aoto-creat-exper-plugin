...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/fallback-providers](https://hermes-agent.nousresearch.com/docs/user-guide/features/fallback-providers)
...
## Auxiliary Capacity-Error Fallback[​](#auxiliary-capacity-error-fallback "Direct link to Auxiliary Capacity-Error Fallback")
...
### Optional: per-task fallback chain[​](#optional-per-task-fallback-chain "Direct link to Optional: per-task fallback chain")
...
### Provider quota errors that trigger fallback[​](#provider-quota-errors-that-trigger-fallback "Direct link to Provider quota errors that trigger fallback")
...
* [Auxiliary Capacity-Error Fallback](#auxiliary-capacity-error-fallback)
  + [Optional: per-task fallback chain](#optional-per-task-fallback-chain)
  + [Provider quota errors that trigger fallback](#provider-quota-errors-that-trigger-fallback)
