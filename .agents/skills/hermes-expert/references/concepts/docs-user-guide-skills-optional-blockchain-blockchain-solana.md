# Solana | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-solana](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-solana)
...
Override: export SOLANA\_RPC\_URL=<https://your-private-rpc.com>
...
* **Public RPC rate-limits** — Solana mainnet public RPC limits requests.
  For production use, set SOLANA\_RPC\_URL to a private endpoint
