# 订阅代理 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/subscription-proxy](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/subscription-proxy)
...
这与 [API 服务器](/docs/zh-Hans/user-guide/features/api-server) 不同：
...
### 1. 登录你的提供商（仅需一次）[​](#1-登录你的提供商仅需一次 "1. 登录你的提供商（仅需一次）的直接链接")
...
### 3. 将你的应用指向代理[​](#3-将你的应用指向代理 "3. 将你的应用指向代理的直接链接")
...
## 配置 OpenViking 使用 Portal[​](#配置-openviking-使用-portal "配置 OpenViking 使用 Portal的直接链接")
...
## 配置 Karakeep（或任何书签/摘要应用）[​](#配置-karakeep或任何书签摘要应用 "配置 Karakeep（或任何书签/摘要应用）的直接链接")
...
## 未来：更多 OAuth 提供商[​](#未来更多-oauth-提供商 "未来：更多 OAuth 提供商的直接链接")
...
* [快速开始](#快速开始)
  + [1. 登录你的提供商（仅需一次）](#1-登录你的提供商仅需一次)
  + [2. 启动代理](#2-启动代理)
  + [3. 将你的应用指向代理](#3-将你的应用指向代理)
* [可用提供商](#可用提供商)
* [检查状态](#检查状态)
* [允许的路径](#允许的路径)
* [配置 OpenViking 使用 Portal](#配置-openviking-使用-portal)
* [配置 Karakeep（或任何书签/摘要应用）](#配置-karakeep或任何书签摘要应用)
* [在局域网上暴露](#在局域网上暴露)
* [速率限制](#速率限制)
* [架构](#架构)
* [未来：更多 OAuth 提供商](#未来更多-oauth-提供商)
