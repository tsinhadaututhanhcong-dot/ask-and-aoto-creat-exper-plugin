...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/managed-scope](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/managed-scope)
...
## Where it lives[​](#where-it-lives "Where it lives的直接链接")
...
### Relocating the directory[​](#relocating-the-directory "Relocating the directory的直接链接")
...
## Precedence[​](#precedence "Precedence的直接链接")
...
## Seeing what's managed[​](#seeing-whats-managed "Seeing what's managed的直接链接")
...
## Setting up a managed scope (administrators)[​](#setting-up-a-managed-scope-administrators "Setting up a managed scope (administrators)的直接链接")
...
## Security model and limitations (v1)[​](#security-model-and-limitations-v1 "Security model and limitations (v1)的直接链接")
...
* [Where it lives](#where-it-lives)
  + [Relocating the directory](#relocating-the-directory)
* [Precedence](#precedence)
* [Seeing what's managed](#seeing-whats-managed)
* [Setting up a managed scope (administrators)](#setting-up-a-managed-scope-administrators)
* [Security model and limitations (v1)](#security-model-and-limitations-v1)