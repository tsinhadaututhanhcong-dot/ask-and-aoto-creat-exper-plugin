# 持久化记忆 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory)
...
## 记忆在系统 Prompt 中的呈现方式[​](#记忆在系统-prompt-中的呈现方式 "记忆在系统 Prompt 中的呈现方式的直接链接")
...
## Memory 工具操作[​](#memory-工具操作 "Memory 工具操作的直接链接")
...
## 两个目标说明[​](#两个目标说明 "两个目标说明的直接链接")

### `memory` — Agent 的个人笔记[​](#memory--agent-的个人笔记 "memory--agent-的个人笔记的直接链接")
...
### `user` — 用户档案[​](#user--用户档案 "user--用户档案的直接链接")
...
## 什么该保存，什么该跳过[​](#什么该保存什么该跳过 "什么该保存，什么该跳过的直接链接")

### 主动保存这些内容[​](#主动保存这些内容 "主动保存这些内容的直接链接")
...
### 记忆已满时的处理[​](#记忆已满时的处理 "记忆已满时的处理的直接链接")
...
### 优质记忆条目的实际示例[​](#优质记忆条目的实际示例 "优质记忆条目的实际示例的直接链接")
...
有关三种调用形式（发现 / 滚动 / 浏览）和响应格式，请参阅[会话搜索工具](/docs/zh-Hans/user-guide/sessions#session-search-tool)。

### session\_search 与 memory 的对比[​](#session_search-与-memory-的对比 "session_search 与 memory 的对比的直接链接")
...
有关每个提供商的完整详情、设置说明和对比，请参阅[记忆提供商](/docs/zh-Hans/user-guide/features/memory-providers)指南。

* [工作原理](#工作原理)
* [记忆在系统 Prompt 中的呈现方式](#记忆在系统-prompt-中的呈现方式)
* [Memory 工具操作](#memory-工具操作)
  + [子字符串匹配](#子字符串匹配)
* [两个目标说明](#两个目标说明)
  + [`memory` — Agent 的个人笔记](#memory--agent-的个人笔记)
  + [`user` — 用户档案](#user--用户档案)
* [什么该保存，什么该跳过](#什么该保存什么该跳过)
  + [主动保存这些内容](#主动保存这些内容)
  + [跳过这些内容](#跳过这些内容)
* [容量管理](#容量管理)
  + [记忆已满时的处理](#记忆已满时的处理)
  + [优质记忆条目的实际示例](#优质记忆条目的实际示例)
* [重复防护](#重复防护)
* [安全扫描](#安全扫描)
* [会话搜索](#会话搜索)
  + [session\_search 与 memory 的对比](#session_search-与-memory-的对比)
* [配置](#配置)
* [外部记忆提供商](#外部记忆提供商)
