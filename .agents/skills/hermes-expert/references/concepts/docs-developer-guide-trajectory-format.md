...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format)
...
2. **REASONING\_SCRATCHPAD XML** (when native thinking is disabled and the model
