...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/web-search](https://hermes-agent.nousresearch.com/docs/user-guide/features/web-search)
...
## How `web_extract` handles long pages[​](#how-web_extract-handles-long-pages "Direct link to how-web_extract-handles-long-pages")
...
### Which model does the summarizing?[​](#which-model-does-the-summarizing "Direct link to Which model does the summarizing?")
...
### When summarization gets in the way[​](#when-summarization-gets-in-the-way "Direct link to When summarization gets in the way")
...
### xAI (Grok)[​](#xai-grok "Direct link to xAI (Grok)")
...
### `web_extract` returns truncated content with a "summarization timed out" note[​](#web_extract-returns-truncated-content-with-a-summarization-timed-out-note "Direct link to web_extract-returns-truncated-content-with-a-summarization-timed-out-note")
...
* [Backends](#backends)
* [How `web_extract` handles long pages](#how-web_extract-handles-long-pages)
  + [Which model does the summarizing?](#which-model-does-the-summarizing)
  + [When summarization gets in the way](#when-summarization-gets-in-the-way)
* [Setup](#setup)
...
* [Troubleshooting](#troubleshooting)
  ...
  + [`web_extract` returns truncated content with a "summarization timed out" note](#web_extract-returns-truncated-content-with-a-summarization-timed-out-note)
