...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/simplex](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/simplex)
...
## Install simplex-chat[​](#install-simplex-chat "Direct link to Install simplex-chat")
...
## Start the daemon[​](#start-the-daemon "Direct link to Start the daemon")
...
## Find your contact ID or display name[​](#find-your-contact-id-or-display-name "Direct link to Find your contact ID or display name")
...
## Using SimpleX with cron jobs[​](#using-simplex-with-cron-jobs "Direct link to Using SimpleX with cron jobs")
...
## Privacy notes[​](#privacy-notes "Direct link to Privacy notes")
...
* [Find your contact ID or display name](#find-your-contact-id-or-display-name)
* [Authorization](#authorization)
* [Group chats](#group-chats)
* [Attachments](#attachments)
* [Using SimpleX with cron jobs](#using-simplex-with-cron-jobs)
