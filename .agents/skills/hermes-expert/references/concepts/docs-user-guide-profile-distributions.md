...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/profile-distributions](https://hermes-agent.nousresearch.com/docs/user-guide/profile-distributions)
...
## Why git?[​](#why-git "Direct link to Why git?")
...
## When should you use a distribution?[​](#when-should-you-use-a-distribution "Direct link to When should you use a distribution?")
...
## The lifecycle: author to installer to update[​](#the-lifecycle-author-to-installer-to-update "Direct link to The lifecycle: author to installer to update")

Below is the full end-to-end flow. Pick the side you care about.

---

## For authors: publishing a distribution[​](#for-authors-publishing-a-distribution "Direct link to For authors: publishing a distribution")

### Step 1 — Start from a working profile[​](#step-1--start-from-a-working-profile "Direct link to Step 1 — Start from a working profile")
...
### Step 2 — Add a `distribution.yaml`[​](#step-2--add-a-distributionyaml "Direct link to step-2--add-a-distributionyaml")
...
### Step 3 — Create a `.gitignore` before the first commit[​](#step-3--create-a-gitignore-before-the-first-commit "Direct link to step-3--create-a-gitignore-before-the-first-commit")
...
### Step 4 — Push to a git repo[​](#step-4--push-to-a-git-repo "Direct link to Step 4 — Push to a git repo")
...
### Step 5 — Tag versioned releases[​](#step-5--tag-versioned-releases "Direct link to Step 5 — Tag versioned releases")
...
### What the repo looks like[​](#what-the-repo-looks-like "Direct link to What the repo looks like")
...
### Distribution-owned vs user-owned[​](#distribution-owned-vs-user-owned "Direct link to Distribution-owned vs user-owned")
...
## For installers: using a distribution[​](#for-installers-using-a-distribution "Direct link to For installers: using a distribution")
...
### Override the profile name[​](#override-the-profile-name "Direct link to Override the profile name")
...
### Fill in env vars[​](#fill-in-env-vars "Direct link to Fill in env vars")
...
### Check what you installed[​](#check-what-you-installed "Direct link to Check what you installed")
...
## Use cases and patterns[​](#use-cases-and-patterns "Direct link to Use cases and patterns")

### Personal: sync one agent across machines[​](#personal-sync-one-agent-across-machines "Direct link to Personal: sync one agent across machines")
...
### Team: ship a reviewed internal agent[​](#team-ship-a-reviewed-internal-agent "Direct link to Team: ship a reviewed internal agent")
...
### Community: publish a public agent[​](#community-publish-a-public-agent "Direct link to Community: publish a public agent")
...
### Product: ship an opinionated agent[​](#product-ship-an-opinionated-agent "Direct link to Product: ship an opinionated agent")
...
### Ephemeral: one-off scripts on shared infra[​](#ephemeral-one-off-scripts-on-shared-infra "Direct link to Ephemeral: one-off scripts on shared infra")
...
### Check what version you're on vs. latest[​](#check-what-version-youre-on-vs-latest "Direct link to Check what version you're on vs. latest")
...
### Keep local config customizations through updates[​](#keep-local-config-customizations-through-updates "Direct link to Keep local config customizations through updates")
...
### Force a clean re-install[​](#force-a-clean-re-install "Direct link to Force a clean re-install")
...
### Fork and customize[​](#fork-and-customize "Direct link to Fork and customize")
...
### Test a distribution before pushing[​](#test-a-distribution-before-pushing "Direct link to Test a distribution before pushing")
...
## What's NOT in a distribution (ever)[​](#whats-not-in-a-distribution-ever "Direct link to What's NOT in a distribution (ever)")
...
## Security and trust[​](#security-and-trust "Direct link to Security and trust")
...
* [For authors: publishing a distribution](#for-authors-publishing-a-distribution)
  ...
  + [Step 3 — Create a `.gitignore` before the first commit](#step-3--create-a-gitignore-before-the-first-commit)
  + [Step 4 — Push to a git repo](#step-4--push-to-a-git-repo)
  + [Step 5 — Tag versioned releases](#step-5--tag-versioned-releases)
...
- [https://hermes-agent.nousresearch.com/docs/reference/profile-commands](./docs-reference-profile-commands.md)
