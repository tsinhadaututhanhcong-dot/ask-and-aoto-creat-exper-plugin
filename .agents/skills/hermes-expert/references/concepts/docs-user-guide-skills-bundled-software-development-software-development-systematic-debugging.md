...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging)
...
## The Feedback Loop Rule[​](#the-feedback-loop-rule "Direct link to The Feedback Loop Rule")
...
### 2. Build a Tight Feedback Loop[​](#2-build-a-tight-feedback-loop "Direct link to 2. Build a Tight Feedback Loop")
...
### 0. Minimize the Reproduction[​](#0-minimize-the-reproduction "Direct link to 0. Minimize the Reproduction")
...
### 1. Form Ranked Falsifiable Hypotheses[​](#1-form-ranked-falsifiable-hypotheses "Direct link to 1. Form Ranked Falsifiable Hypotheses")
...
* [The Feedback Loop Rule](#the-feedback-loop-rule)
...
* [Phase 1: Root Cause Investigation](#phase-1-root-cause-investigation)
  ...
  + [2. Build a Tight Feedback Loop](#2-build-a-tight-feedback-loop)
...
* [Phase 2: Pattern Analysis](#phase-2-pattern-analysis)
  + [0. Minimize the Reproduction](#0-minimize-the-reproduction)
...
* [Phase 3: Hypothesis and Testing](#phase-3-hypothesis-and-testing)
  + [1. Form Ranked Falsifiable Hypotheses](#1-form-ranked-falsifiable-hypotheses)
...
* [Hermes Agent Integration](#hermes-agent-integration)
  ...
  + [With delegate\_task](#with-delegate_task)
