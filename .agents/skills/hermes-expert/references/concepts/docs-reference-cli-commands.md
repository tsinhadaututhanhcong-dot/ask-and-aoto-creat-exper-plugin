...
**Source:** [https://hermes-agent.nousresearch.com/docs/reference/cli-commands](https://hermes-agent.nousresearch.com/docs/reference/cli-commands)
...
| `--cli` | Force the classic prompt\_toolkit REPL. Use this to override `display.interface: tui` for a single invocation. |
...
## `hermes lsp`[​](#hermes-lsp "Direct link to hermes-lsp")
...
## `hermes portal`[​](#hermes-portal "Direct link to hermes-portal")
...
## `hermes send`[​](#hermes-send "Direct link to hermes-send")
...
### Sending images and other media[​](#sending-images-and-other-media "Direct link to Sending images and other media")
...
## `hermes secrets`[​](#hermes-secrets "Direct link to hermes-secrets")
...
## `hermes migrate`[​](#hermes-migrate "Direct link to hermes-migrate")
...
## `hermes proxy`[​](#hermes-proxy "Direct link to hermes-proxy")
...
## `hermes security`[​](#hermes-security "Direct link to hermes-security")
...
[cron internals](/docs/developer-guide/cron-internals#gateway-integration) doc.
...
## `hermes project`[​](#hermes-project "Direct link to hermes-project")
...
## `hermes prompt-size`[​](#hermes-prompt-size "Direct link to hermes-prompt-size")
...
## `hermes bundles`[​](#hermes-bundles "Direct link to hermes-bundles")
...
## `hermes moa`[​](#hermes-moa "Direct link to hermes-moa")
...
## `hermes computer-use`[​](#hermes-computer-use "Direct link to hermes-computer-use")
...
## `hermes pets`[​](#hermes-pets "Direct link to hermes-pets")
...
## `hermes serve`[​](#hermes-serve "Direct link to hermes-serve")
...
### `hermes dashboard register`[​](#hermes-dashboard-register "Direct link to hermes-dashboard-register")
...
* [`hermes send`](#hermes-send)
  + [Sending images and other media](#sending-images-and-other-media)
* [`hermes secrets`](#hermes-secrets)
* [`hermes migrate`](#hermes-migrate)
* [`hermes proxy`](#hermes-proxy)
* [`hermes security`](#hermes-security)
* [`hermes login` / `hermes logout` *(Deprecated)*](#hermes-login--hermes-logout-deprecated)
...
- [https://hermes-agent.nousresearch.com/docs/guides/migrate-from-openclaw](./docs-guides-migrate-from-openclaw.md)
...
- [https://hermes-agent.nousresearch.com/docs/reference/mcp-config-reference](./docs-reference-mcp-config-reference.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/cli](./docs-user-guide-cli.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/lsp](./docs-user-guide-features-lsp.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp](./docs-user-guide-features-mcp.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/pets](./docs-user-guide-features-pets.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/web-dashboard](./docs-user-guide-features-web-dashboard.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/secrets/bitwarden](./docs-user-guide-secrets-bitwarden.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/sessions](./docs-user-guide-sessions.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/tui](./docs-user-guide-tui.md)
