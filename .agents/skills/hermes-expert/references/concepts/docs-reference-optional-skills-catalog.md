...
**Source:** [https://hermes-agent.nousresearch.com/docs/reference/optional-skills-catalog](https://hermes-agent.nousresearch.com/docs/reference/optional-skills-catalog)
...
| [**subagent-driven-development**](/docs/user-guide/skills/optional/software-development/software-development-subagent-driven-development) | Execute plans via delegate\_task subagents (2-stage review). |
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-antigravity-cli](./docs-user-guide-skills-optional-autonomous-ai-agents-autonomous-ai-agents-antigravity-cli.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-blackbox](./docs-user-guide-skills-optional-autonomous-ai-agents-autonomous-ai-agents-blackbox.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-grok](./docs-user-guide-skills-optional-autonomous-ai-agents-autonomous-ai-agents-grok.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-honcho](./docs-user-guide-skills-optional-autonomous-ai-agents-autonomous-ai-agents-honcho.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-openhands](./docs-user-guide-skills-optional-autonomous-ai-agents-autonomous-ai-agents-openhands.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-evm](./docs-user-guide-skills-optional-blockchain-blockchain-evm.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-hyperliquid](./docs-user-guide-skills-optional-blockchain-blockchain-hyperliquid.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-solana](./docs-user-guide-skills-optional-blockchain-blockchain-solana.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/communication/communication-one-three-one-rule](./docs-user-guide-skills-optional-communication-communication-one-three-one-rule.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-baoyu-article-illustrator](./docs-user-guide-skills-optional-creative-creative-baoyu-article-illustrator.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-baoyu-comic](./docs-user-guide-skills-optional-creative-creative-baoyu-comic.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-blender-mcp](./docs-user-guide-skills-optional-creative-creative-blender-mcp.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-creative-ideation](./docs-user-guide-skills-optional-creative-creative-creative-ideation.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-hyperframes](./docs-user-guide-skills-optional-creative-creative-hyperframes.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-kanban-video-orchestrator](./docs-user-guide-skills-optional-creative-creative-kanban-video-orchestrator.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-meme-generation](./docs-user-guide-skills-optional-creative-creative-meme-generation.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-pixel-art](./docs-user-guide-skills-optional-creative-creative-pixel-art.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-cli](./docs-user-guide-skills-optional-devops-devops-cli.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-docker-management](./docs-user-guide-skills-optional-devops-devops-docker-management.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-hermes-s6-container-supervision](./docs-user-guide-skills-optional-devops-devops-hermes-s6-container-supervision.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-pinggy-tunnel](./docs-user-guide-skills-optional-devops-devops-pinggy-tunnel.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers](./docs-user-guide-skills-optional-devops-devops-watchers.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test](./docs-user-guide-skills-optional-dogfood-dogfood-adversarial-ux-test.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/email/email-agentmail](./docs-user-guide-skills-optional-email-email-agentmail.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-3-statement-model](./docs-user-guide-skills-optional-finance-finance-3-statement-model.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-merger-model](./docs-user-guide-skills-optional-finance-finance-merger-model.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-pptx-author](./docs-user-guide-skills-optional-finance-finance-pptx-author.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-stocks](./docs-user-guide-skills-optional-finance-finance-stocks.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/gaming/gaming-minecraft-modpack-server](./docs-user-guide-skills-optional-gaming-gaming-minecraft-modpack-server.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/gaming/gaming-pokemon-player](./docs-user-guide-skills-optional-gaming-gaming-pokemon-player.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/health/health-fitness-nutrition](./docs-user-guide-skills-optional-health-health-fitness-nutrition.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/health/health-neuroskill-bci](./docs-user-guide-skills-optional-health-health-neuroskill-bci.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mcp/mcp-fastmcp](./docs-user-guide-skills-optional-mcp-mcp-fastmcp.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/migration/migration-openclaw-migration](./docs-user-guide-skills-optional-migration-migration-openclaw-migration.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-accelerate](./docs-user-guide-skills-optional-mlops-mlops-accelerate.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-chroma](./docs-user-guide-skills-optional-mlops-mlops-chroma.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-clip](./docs-user-guide-skills-optional-mlops-mlops-clip.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-faiss](./docs-user-guide-skills-optional-mlops-mlops-faiss.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-flash-attention](./docs-user-guide-skills-optional-mlops-mlops-flash-attention.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-guidance](./docs-user-guide-skills-optional-mlops-mlops-guidance.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-huggingface-tokenizers](./docs-user-guide-skills-optional-mlops-mlops-huggingface-tokenizers.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-inference-outlines](./docs-user-guide-skills-optional-mlops-mlops-inference-outlines.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-instructor](./docs-user-guide-skills-optional-mlops-mlops-instructor.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-lambda-labs](./docs-user-guide-skills-optional-mlops-mlops-lambda-labs.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-llava](./docs-user-guide-skills-optional-mlops-mlops-llava.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-modal](./docs-user-guide-skills-optional-mlops-mlops-modal.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-nemo-curator](./docs-user-guide-skills-optional-mlops-mlops-nemo-curator.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-obliteratus](./docs-user-guide-skills-optional-mlops-mlops-obliteratus.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-peft](./docs-user-guide-skills-optional-mlops-mlops-peft.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-pinecone](./docs-user-guide-skills-optional-mlops-mlops-pinecone.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-pytorch-fsdp](./docs-user-guide-skills-optional-mlops-mlops-pytorch-fsdp.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-pytorch-lightning](./docs-user-guide-skills-optional-mlops-mlops-pytorch-lightning.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-qdrant](./docs-user-guide-skills-optional-mlops-mlops-qdrant.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-research-dspy](./docs-user-guide-skills-optional-mlops-mlops-research-dspy.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-saelens](./docs-user-guide-skills-optional-mlops-mlops-saelens.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-simpo](./docs-user-guide-skills-optional-mlops-mlops-simpo.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-slime](./docs-user-guide-skills-optional-mlops-mlops-slime.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-stable-diffusion](./docs-user-guide-skills-optional-mlops-mlops-stable-diffusion.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-tensorrt-llm](./docs-user-guide-skills-optional-mlops-mlops-tensorrt-llm.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-torchtitan](./docs-user-guide-skills-optional-mlops-mlops-torchtitan.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-training-axolotl](./docs-user-guide-skills-optional-mlops-mlops-training-axolotl.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning](./docs-user-guide-skills-optional-mlops-mlops-training-trl-fine-tuning.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-training-unsloth](./docs-user-guide-skills-optional-mlops-mlops-training-unsloth.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-whisper](./docs-user-guide-skills-optional-mlops-mlops-whisper.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-mpp-agent](./docs-user-guide-skills-optional-payments-payments-mpp-agent.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-stripe-link-cli](./docs-user-guide-skills-optional-payments-payments-stripe-link-cli.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-stripe-projects](./docs-user-guide-skills-optional-payments-payments-stripe-projects.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-canvas](./docs-user-guide-skills-optional-productivity-productivity-canvas.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-here-now](./docs-user-guide-skills-optional-productivity-productivity-here-now.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-memento-flashcards](./docs-user-guide-skills-optional-productivity-productivity-memento-flashcards.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-shop](./docs-user-guide-skills-optional-productivity-productivity-shop.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-shopify](./docs-user-guide-skills-optional-productivity-productivity-shopify.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-siyuan](./docs-user-guide-skills-optional-productivity-productivity-siyuan.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-telephony](./docs-user-guide-skills-optional-productivity-productivity-telephony.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-bioinformatics](./docs-user-guide-skills-optional-research-research-bioinformatics.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-darwinian-evolver](./docs-user-guide-skills-optional-research-research-darwinian-evolver.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-domain-intel](./docs-user-guide-skills-optional-research-research-domain-intel.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-drug-discovery](./docs-user-guide-skills-optional-research-research-drug-discovery.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-gitnexus-explorer](./docs-user-guide-skills-optional-research-research-gitnexus-explorer.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-osint-investigation](./docs-user-guide-skills-optional-research-research-osint-investigation.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-parallel-cli](./docs-user-guide-skills-optional-research-research-parallel-cli.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-qmd](./docs-user-guide-skills-optional-research-research-qmd.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-scrapling](./docs-user-guide-skills-optional-research-research-scrapling.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-searxng-search](./docs-user-guide-skills-optional-research-research-searxng-search.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/security/security-1password](./docs-user-guide-skills-optional-security-security-1password.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/security/security-godmode](./docs-user-guide-skills-optional-security-security-godmode.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/security/security-oss-forensics](./docs-user-guide-skills-optional-security-security-oss-forensics.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/security/security-sherlock](./docs-user-guide-skills-optional-security-security-sherlock.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/security/security-unbroker](./docs-user-guide-skills-optional-security-security-unbroker.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/security/security-web-pentest](./docs-user-guide-skills-optional-security-security-web-pentest.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/software-development/software-development-code-wiki](./docs-user-guide-skills-optional-software-development-software-development-code-wiki.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/software-development/software-development-rest-graphql-debug](./docs-user-guide-skills-optional-software-development-software-development-rest-graphql-debug.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/web-development/web-development-cloudflare-temporary-deploy](./docs-user-guide-skills-optional-web-development-web-development-cloudflare-temporary-deploy.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/web-development/web-development-page-agent](./docs-user-guide-skills-optional-web-development-web-development-page-agent.md)
