# Simpo 训练 — 用于 LLM 对齐的简单偏好优化 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-simpo](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-simpo)
...
### 工作流 1：从基础模型训练（Mistral 7B）[​](#工作流-1从基础模型训练mistral-7b "工作流 1：从基础模型训练（Mistral 7B）的直接链接")
...
### 工作流 2：微调指令模型（Llama 3 8B）[​](#工作流-2微调指令模型llama-3-8b "工作流 2：微调指令模型（Llama 3 8B）的直接链接")
...
### 工作流 3：推理密集型任务（较低学习率）[​](#工作流-3推理密集型任务较低学习率 "工作流 3：推理密集型任务（较低学习率）的直接链接")
...
* 论文：[https://arxiv.org/abs/2405.14734（NeurIPS](https://arxiv.org/abs/2405.14734%EF%BC%88NeurIPS) 2024）
...
* [快速开始](#快速开始)
* [常见工作流](#常见工作流)
  + [工作流 1：从基础模型训练（Mistral 7B）](#工作流-1从基础模型训练mistral-7b)
  + [工作流 2：微调指令模型（Llama 3 8B）](#工作流-2微调指令模型llama-3-8b)
  + [工作流 3：推理密集型任务（较低学习率）](#工作流-3推理密集型任务较低学习率)
* [何时使用及替代方案](#何时使用及替代方案)
* [常见问题](#常见问题)
* [进阶主题](#进阶主题)
* [硬件要求](#硬件要求)
