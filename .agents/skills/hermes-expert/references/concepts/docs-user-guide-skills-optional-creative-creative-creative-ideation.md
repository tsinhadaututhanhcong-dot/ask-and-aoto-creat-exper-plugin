...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-creative-ideation](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-creative-ideation)
...
## Operating rules[​](#operating-rules "Direct link to Operating rules")
...
## Routing — 4-step procedure[​](#routing--4-step-procedure "Direct link to Routing — 4-step procedure")
...
### Step 1 — Extract three signals from the prompt[​](#step-1--extract-three-signals-from-the-prompt "Direct link to Step 1 — Extract three signals from the prompt")
...
### Step 2 — Apply overrides (highest priority, fire first)[​](#step-2--apply-overrides-highest-priority-fire-first "Direct link to Step 2 — Apply overrides (highest priority, fire first)")
...
### Step 3 — Route by phase first, then domain[​](#step-3--route-by-phase-first-then-domain "Direct link to Step 3 — Route by phase first, then domain")
...
### Step 4 — Handle ambiguity and contradiction[​](#step-4--handle-ambiguity-and-contradiction "Direct link to Step 4 — Handle ambiguity and contradiction")
...
### Anti-default check (run before generating)[​](#anti-default-check-run-before-generating "Direct link to Anti-default check (run before generating)")
