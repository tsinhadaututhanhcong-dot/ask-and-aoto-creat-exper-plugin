# Pinecone — 面向生产级 AI 应用的托管向量数据库 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-pinecone](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-pinecone)
...
## 何时使用 Pinecone[​](#何时使用-pinecone "何时使用 Pinecone的直接链接")
...
### 插入向量（Upsert）[​](#插入向量upsert "插入向量（Upsert）的直接链接")
...
## 混合搜索（稠密 + 稀疏向量）[​](#混合搜索稠密--稀疏向量 "混合搜索（稠密 + 稀疏向量）的直接链接")
...
## 定价（截至 2025 年）[​](#定价截至-2025-年 "定价（截至 2025 年）的直接链接")
...
* [何时使用 Pinecone](#何时使用-pinecone)
* [快速开始](#快速开始)
  + [安装](#安装)
  + [基本用法](#基本用法)
* [核心操作](#核心操作)
  + [创建索引](#创建索引)
  + [插入向量（Upsert）](#插入向量upsert)
  + [查询向量](#查询向量)
  + [元数据过滤](#元数据过滤)
* [命名空间](#命名空间)
* [混合搜索（稠密 + 稀疏向量）](#混合搜索稠密--稀疏向量)
