# Drug Discovery — 药物发现工作流的制药研究助手 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-drug-discovery](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-drug-discovery)
...
## Core Workflows[​](#core-workflows "Core Workflows的直接链接")

### 1 — Bioactive Compound Search (ChEMBL)[​](#1--bioactive-compound-search-chembl "1 — Bioactive Compound Search (ChEMBL)的直接链接")
...
### 2 — Drug-Likeness Calculation (Lipinski Ro5 + Veber)[​](#2--drug-likeness-calculation-lipinski-ro5--veber "2 — Drug-Likeness Calculation (Lipinski Ro5 + Veber)的直接链接")
...
### 3 — Drug Interaction & Safety Lookup (OpenFDA)[​](#3--drug-interaction--safety-lookup-openfda "3 — Drug Interaction & Safety Lookup (OpenFDA)的直接链接")
...
### 4 — PubChem Compound Search[​](#4--pubchem-compound-search "4 — PubChem Compound Search的直接链接")
...
### 5 — Target & Disease Literature (OpenTargets)[​](#5--target--disease-literature-opentargets "5 — Target & Disease Literature (OpenTargets)的直接链接")
...
对于 ADMET（吸收、分布、代谢、排泄、毒性）问题，需系统性地逐项推理。详细指导请参阅 references/ADMET\_REFERENCE.md。
