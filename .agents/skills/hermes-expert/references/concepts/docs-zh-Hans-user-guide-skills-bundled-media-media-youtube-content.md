# Youtube Content — YouTube 视频转文字摘要、推文、博客 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/media/media-youtube-content](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/media/media-youtube-content)
