# 技巧与最佳实践 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/tips](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/tips)
...
## 获得最佳结果[​](#获得最佳结果 "获得最佳结果的直接链接")

### 明确说明你的需求[​](#明确说明你的需求 "明确说明你的需求的直接链接")
...
## 上下文文件[​](#上下文文件 "上下文文件的直接链接")

### AGENTS.md：你的项目大脑[​](#agentsmd你的项目大脑 "AGENTS.md：你的项目大脑的直接链接")
...
### SOUL.md：自定义个性[​](#soulmd自定义个性 "SOUL.md：自定义个性的直接链接")
...
完整说明请参阅 [在 Hermes 中使用 SOUL.md](/docs/zh-Hans/guides/use-soul-with-hermes)。
...
### .cursorrules 兼容性[​](#cursorrules-兼容性 ".cursorrules 兼容性的直接链接")
...
### 使用 /title 整理会话[​](#使用-title-整理会话 "使用 /title 整理会话的直接链接")
...
### 对不可信代码使用 Docker[​](#对不可信代码使用-docker "对不可信代码使用 Docker的直接链接")
...
### 避免 Windows 编码陷阱[​](#避免-windows-编码陷阱 "避免 Windows 编码陷阱的直接链接")
...
### 谨慎选择"始终允许"[​](#谨慎选择始终允许 "谨慎选择\"始终允许\"的直接链接")
...
### 命令审批是你的安全防线[​](#命令审批是你的安全防线 "命令审批是你的安全防线的直接链接")
...
### 为消息 Bot 使用白名单[​](#为消息-bot-使用白名单 "为消息 Bot 使用白名单的直接链接")
...
* [获得最佳结果](#获得最佳结果)
  + [明确说明你的需求](#明确说明你的需求)
  + [预先提供上下文](#预先提供上下文)
  + [使用上下文文件处理重复指令](#使用上下文文件处理重复指令)
  + [让 Agent 使用它的工具](#让-agent-使用它的工具)
  + [对复杂工作流使用 Skill](#对复杂工作流使用-skill)
* [CLI 高级用户技巧](#cli-高级用户技巧)
  + [多行输入](#多行输入)
  + [粘贴检测](#粘贴检测)
  + [中断与重定向](#中断与重定向)
  + [使用 `-c` 恢复会话](#使用--c-恢复会话)
  + [剪贴板图片粘贴](#剪贴板图片粘贴)
  + [Slash 命令自动补全](#slash-命令自动补全)
* [上下文文件](#上下文文件)
  + [AGENTS.md：你的项目大脑](#agentsmd你的项目大脑)
  + [SOUL.md：自定义个性](#soulmd自定义个性)
  + [.cursorrules 兼容性](#cursorrules-兼容性)
  + [发现机制](#发现机制)
* [记忆与 Skill](#记忆与-skill)
  + [记忆 vs. Skill：各司其职](#记忆-vs-skill各司其职)
  + [何时创建 Skill](#何时创建-skill)
  + [管理记忆容量](#管理记忆容量)
  + [让 Agent 记住内容](#让-agent-记住内容)
* [性能与成本](#性能与成本)
  + [不要破坏 Prompt 缓存](#不要破坏-prompt-缓存)
  + [在达到限制前使用 /compress](#在达到限制前使用-compress)
  + [使用委托实现并行工作](#使用委托实现并行工作)
  + [使用 execute\_code 进行批量操作](#使用-execute_code-进行批量操作)
  + [选择合适的模型](#选择合适的模型)
* [消息技巧](#消息技巧)
  + [设置主频道](#设置主频道)
  + [使用 /title 整理会话](#使用-title-整理会话)
  + [DM 配对实现团队访问](#dm-配对实现团队访问)
  + [工具进度显示模式](#工具进度显示模式)
* [安全](#安全)
  + [对不可信代码使用 Docker](#对不可信代码使用-docker)
  + [避免 Windows 编码陷阱](#避免-windows-编码陷阱)
  + [谨慎选择"始终允许"](#谨慎选择始终允许)
  + [命令审批是你的安全防线](#命令审批是你的安全防线)
  + [为消息 Bot 使用白名单](#为消息-bot-使用白名单)
