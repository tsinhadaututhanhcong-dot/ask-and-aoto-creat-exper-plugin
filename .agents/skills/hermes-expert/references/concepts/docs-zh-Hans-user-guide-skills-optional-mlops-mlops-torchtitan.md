...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-torchtitan](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-torchtitan)
...
## 常用工作流[​](#常用工作流 "常用工作流的直接链接")

### 工作流 1：在单节点上预训练 Llama 3.1 8B[​](#工作流-1在单节点上预训练-llama-31-8b "工作流 1：在单节点上预训练 Llama 3.1 8B的直接链接")
...
### 工作流 2：使用 SLURM 进行多节点训练[​](#工作流-2使用-slurm-进行多节点训练 "工作流 2：使用 SLURM 进行多节点训练的直接链接")
...
### 工作流 3：为 H100 启用 Float8 训练[​](#工作流-3为-h100-启用-float8-训练 "工作流 3：为 H100 启用 Float8 训练的直接链接")
...
### 工作流 4：405B 模型的 4D 并行[​](#工作流-4405b-模型的-4d-并行 "工作流 4：405B 模型的 4D 并行的直接链接")
...
## 何时使用 vs 替代方案[​](#何时使用-vs-替代方案 "何时使用 vs 替代方案的直接链接")
...
## 性能基准（H100）[​](#性能基准h100 "性能基准（H100）的直接链接")
...
* [快速开始](#快速开始)
* [常用工作流](#常用工作流)
  + [工作流 1：在单节点上预训练 Llama 3.1 8B](#工作流-1在单节点上预训练-llama-31-8b)
  + [工作流 2：使用 SLURM 进行多节点训练](#工作流-2使用-slurm-进行多节点训练)
  + [工作流 3：为 H100 启用 Float8 训练](#工作流-3为-h100-启用-float8-训练)
  + [工作流 4：405B 模型的 4D 并行](#工作流-4405b-模型的-4d-并行)
* [何时使用 vs 替代方案](#何时使用-vs-替代方案)
* [常见问题](#常见问题)
* [支持的模型](#支持的模型)
* [性能基准（H100）](#性能基准h100)
* [进阶主题](#进阶主题)
