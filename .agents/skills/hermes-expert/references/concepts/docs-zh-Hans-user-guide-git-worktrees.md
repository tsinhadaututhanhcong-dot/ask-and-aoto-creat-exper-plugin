...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees)
...
## 为什么在 Hermes 中使用 Worktrees？[​](#为什么在-hermes-中使用-worktrees "为什么在 Hermes 中使用 Worktrees？的直接链接")
...
另请参阅：[Checkpoints 与 /rollback](/docs/zh-Hans/user-guide/checkpoints-and-rollback)。

## 快速开始：创建 Worktree[​](#快速开始创建-worktree "快速开始：创建 Worktree的直接链接")
...
## 并行运行多个 Agent[​](#并行运行多个-agent "并行运行多个 Agent的直接链接")
...
## 安全清理 Worktrees[​](#安全清理-worktrees "安全清理 Worktrees的直接链接")
...
* **频繁提交**
  ...
  + 使用 [checkpoints 与 /rollback](/docs/zh-Hans/user-guide/checkpoints-and-rollback) 作为工具驱动编辑之间的安全网。
* **使用 worktrees 时避免从裸仓库根目录运行 Hermes**
  + 优先使用 worktree 目录，使每个 agent 拥有明确的作用范围。

## 使用 `hermes -w`（自动 Worktree 模式）[​](#使用-hermes--w自动-worktree-模式 "使用-hermes--w自动-worktree-模式的直接链接")
...
* [为什么在 Hermes 中使用 Worktrees？](#为什么在-hermes-中使用-worktrees)
* [快速开始：创建 Worktree](#快速开始创建-worktree)
* [并行运行多个 Agent](#并行运行多个-agent)
* [安全清理 Worktrees](#安全清理-worktrees)
* [最佳实践](#最佳实践)
* [使用 `hermes -w`（自动 Worktree 模式）](#使用-hermes--w自动-worktree-模式)
* [综合运用](#综合运用)
