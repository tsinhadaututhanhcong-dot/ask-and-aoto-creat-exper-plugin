# 微信（Weixin） | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin)
...
本适配器适用于**个人微信账号**（微信）。如需对接企业微信，请参阅 [WeCom 适配器](/docs/zh-Hans/user-guide/messaging/wecom)。
...
### 1. 运行配置向导[​](#1-运行配置向导 "1. 运行配置向导的直接链接")
...
### AES-128-ECB 加密 CDN[​](#aes-128-ecb-加密-cdn "AES-128-ECB 加密 CDN的直接链接")
...
## 上下文 Token 持久化[​](#上下文-token-持久化 "上下文 Token 持久化的直接链接")
...
## Markdown 格式化[​](#markdown-格式化 "Markdown 格式化的直接链接")
...
* [媒体支持](#媒体支持)
  + [入站（接收）](#入站接收)
  + [AES-128-ECB 加密 CDN](#aes-128-ecb-加密-cdn)
  + [出站（发送）](#出站发送)
* [上下文 Token 持久化](#上下文-token-持久化)
