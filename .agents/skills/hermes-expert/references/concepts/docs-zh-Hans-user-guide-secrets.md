...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/secrets/](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/secrets/)
...
* [Bitwarden Secrets Manager](/docs/zh-Hans/user-guide/secrets/bitwarden) — 使用 `bws` CLI，懒加载安装，免费套餐可用。
...
- [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/secrets/bitwarden](./docs-zh-Hans-user-guide-secrets-bitwarden.md)
