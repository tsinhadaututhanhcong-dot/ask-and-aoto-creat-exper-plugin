...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline)
...
### Status and inspection (start here)[​](#status-and-inspection-start-here "Direct link to Status and inspection (start here)")
...
### Re-running / debugging[​](#re-running--debugging "Direct link to Re-running / debugging")
...
## Decision tree for common asks[​](#decision-tree-for-common-asks "Direct link to Decision tree for common asks")
...
## Critical pitfall: Graph subscriptions expire in 72 hours[​](#critical-pitfall-graph-subscriptions-expire-in-72-hours "Direct link to Critical pitfall: Graph subscriptions expire in 72 hours")
...
## Other pitfalls[​](#other-pitfalls "Direct link to Other pitfalls")
...
* [Command reference](#command-reference)
  + [Status and inspection (start here)](#status-and-inspection-start-here)
  + [Re-running / debugging](#re-running--debugging)
  + [Subscription management](#subscription-management)
* [Decision tree for common asks](#decision-tree-for-common-asks)
* [Critical pitfall: Graph subscriptions expire in 72 hours](#critical-pitfall-graph-subscriptions-expire-in-72-hours)
