...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/windows-native](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native)
...
### Desktop installer (alternative)[​](#desktop-installer-alternative "Direct link to Desktop installer (alternative)")
...
### Dependency bootstrap (`dep_ensure`)[​](#dependency-bootstrap-dep_ensure "Direct link to dependency-bootstrap-dep_ensure")
...
## What the installer actually does[​](#what-the-installer-actually-does "Direct link to What the installer actually does")
...
## How Hermes runs shell commands on Windows[​](#how-hermes-runs-shell-commands-on-windows "Direct link to How Hermes runs shell commands on Windows")
...
## UTF-8 console on Windows[​](#utf-8-console-on-windows "Direct link to UTF-8 console on Windows")
...
## The editor (`Ctrl-X Ctrl-E`, `/edit`)[​](#the-editor-ctrl-x-ctrl-e-edit "Direct link to the-editor-ctrl-x-ctrl-e-edit")
...
## `Ctrl+Enter` for newline in the CLI[​](#ctrlenter-for-newline-in-the-cli "Direct link to ctrlenter-for-newline-in-the-cli")
...
## Running the gateway at Windows login[​](#running-the-gateway-at-windows-login "Direct link to Running the gateway at Windows login")
...
### Why not a Windows Service?[​](#why-not-a-windows-service "Direct link to Why not a Windows Service?")
...
## Data layout[​](#data-layout "Direct link to Data layout")
...
## Browser tool[​](#browser-tool "Direct link to Browser tool")
...
## Running Hermes on Windows — practical notes[​](#running-hermes-on-windows--practical-notes "Direct link to Running Hermes on Windows — practical notes")

### PATH after install[​](#path-after-install "Direct link to PATH after install")
...
### Windows-specific env vars[​](#windows-specific-env-vars "Direct link to Windows-specific env vars")
...
## Process management internals[​](#process-management-internals "Direct link to Process management internals")
...
* [Quick install](#quick-install)
  + [Desktop installer (alternative)](#desktop-installer-alternative)
  + [Dependency bootstrap (`dep_ensure`)](#dependency-bootstrap-dep_ensure)
* [What the installer actually does](#what-the-installer-actually-does)
* [Feature matrix](#feature-matrix)
* [How Hermes runs shell commands on Windows](#how-hermes-runs-shell-commands-on-windows)
* [UTF-8 console on Windows](#utf-8-console-on-windows)
* [The editor (`Ctrl-X Ctrl-E`, `/edit`)](#the-editor-ctrl-x-ctrl-e-edit)
* [`Ctrl+Enter` for newline in the CLI](#ctrlenter-for-newline-in-the-cli)
* [Running the gateway at Windows login](#running-the-gateway-at-windows-login)
  + [Install](#install)
  + [Manage](#manage)
  + [Why not a Windows Service?](#why-not-a-windows-service)
* [Data layout](#data-layout)
* [Browser tool](#browser-tool)
* [Running Hermes on Windows — practical notes](#running-hermes-on-windows--practical-notes)
  + [PATH after install](#path-after-install)
  + [Environment variables](#environment-variables)
  + [Windows-specific env vars](#windows-specific-env-vars)
* [Uninstall](#uninstall)
* [Process management internals](#process-management-internals)
