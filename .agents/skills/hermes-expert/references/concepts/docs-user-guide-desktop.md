...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/desktop](https://hermes-agent.nousresearch.com/docs/user-guide/desktop)
...
## What's in the app[​](#whats-in-the-app "Direct link to What's in the app")
...
### File browser[​](#file-browser "Direct link to File browser")
...
### Settings & onboarding[​](#settings--onboarding "Direct link to Settings & onboarding")
...
### Management panes[​](#management-panes "Direct link to Management panes")
...
### Sessions & profiles[​](#sessions--profiles "Direct link to Sessions & profiles")
...
## CLI reference: `hermes desktop`[​](#cli-reference-hermes-desktop "Direct link to cli-reference-hermes-desktop")
...
## Connecting to a remote backend[​](#connecting-to-a-remote-backend "Direct link to Connecting to a remote backend")
...
### In the app[​](#in-the-app "Direct link to In the app")
...
### "Build desktop app" stuck on Electron download[​](#build-desktop-app-stuck-on-electron-download "Direct link to \"Build desktop app\" stuck on Electron download")
