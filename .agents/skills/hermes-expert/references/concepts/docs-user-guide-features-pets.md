...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/pets](https://hermes-agent.nousresearch.com/docs/user-guide/features/pets)
...
## Quick start (CLI)[​](#quick-start-cli "Direct link to Quick start (CLI)")
...
## `hermes pets` commands[​](#hermes-pets-commands "Direct link to hermes-pets-commands")
...
## `/pet` slash command[​](#pet-slash-command "Direct link to pet-slash-command")
...
## Generating a pet (`/hatch`)[​](#generating-a-pet-hatch "Direct link to generating-a-pet-hatch")
...
### Image backend[​](#image-backend "Direct link to Image backend")
...
### Pop-out overlay[​](#pop-out-overlay "Direct link to Pop-out overlay")
...
* The [`petdex` skill](/docs/user-guide/skills/bundled/productivity/productivity-petdex)
