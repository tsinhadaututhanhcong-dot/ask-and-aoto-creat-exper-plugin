# Watchers — 使用水印去重轮询 RSS、JSON API 和 GitHub | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/devops/devops-watchers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/devops/devops-watchers)
...
## 自定义 watcher[​](#自定义-watcher "自定义 watcher的直接链接")
