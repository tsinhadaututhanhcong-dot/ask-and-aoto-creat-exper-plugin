...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-stripe-link-cli](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-stripe-link-cli)
...
### 1. Check / establish auth[​](#1-check--establish-auth "Direct link to 1. Check / establish auth")
...
### 2. Evaluate the merchant before creating a spend request[​](#2-evaluate-the-merchant-before-creating-a-spend-request "Direct link to 2. Evaluate the merchant before creating a spend request")
...
### 3. List payment methods + shipping[​](#3-list-payment-methods--shipping "Direct link to 3. List payment methods + shipping")
...
### 4. Create the spend request[​](#4-create-the-spend-request "Direct link to 4. Create the spend request")
...
### 5. Retrieve the credential — SECURELY[​](#5-retrieve-the-credential--securely "Direct link to 5. Retrieve the credential — SECURELY")
...
### 6. Use the credential[​](#6-use-the-credential "Direct link to 6. Use the credential")
...
### 7. Clean up[​](#7-clean-up "Direct link to 7. Clean up")
...
## Optional: run as an MCP server instead[​](#optional-run-as-an-mcp-server-instead "Direct link to Optional: run as an MCP server instead")
...
* [Procedure](#procedure)
  + [1. Check / establish auth](#1-check--establish-auth)
  + [2. Evaluate the merchant before creating a spend request](#2-evaluate-the-merchant-before-creating-a-spend-request)
  + [3. List payment methods + shipping](#3-list-payment-methods--shipping)
  + [4. Create the spend request](#4-create-the-spend-request)
  + [5. Retrieve the credential — SECURELY](#5-retrieve-the-credential--securely)
  + [6. Use the credential](#6-use-the-credential)
  + [7. Clean up](#7-clean-up)
* [Optional: run as an MCP server instead](#optional-run-as-an-mcp-server-instead)
* [Pitfalls](#pitfalls)
