...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/sessions](https://hermes-agent.nousresearch.com/docs/user-guide/sessions)
...
### What Counts Toward Context[​](#what-counts-toward-context "Direct link to What Counts Toward Context")
...
## Cross-Platform Handoff[​](#cross-platform-handoff "Direct link to Cross-Platform Handoff")
...
### Bulk-Archive Sessions[​](#bulk-archive-sessions "Direct link to Bulk-Archive Sessions")
...
### Three calling shapes[​](#three-calling-shapes "Direct link to Three calling shapes")
...
> *"When the user references something from a past conversation or you suspect relevant prior context exists, use session\_search to recall it before asking them to repeat themselves."*
