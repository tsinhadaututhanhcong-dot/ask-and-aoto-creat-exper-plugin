# Agent Loop 内部机制 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop)
...
## 可中断的 API 调用[​](#可中断的-api-调用 "可中断的 API 调用的直接链接")
...
### 顺序执行与并发执行[​](#顺序执行与并发执行 "顺序执行与并发执行的直接链接")
...
### Agent 级工具[​](#agent-级工具 "Agent 级工具的直接链接")
...
## 压缩与持久化[​](#压缩与持久化 "压缩与持久化的直接链接")

### 压缩触发时机[​](#压缩触发时机 "压缩触发时机的直接链接")
...
### Session 持久化[​](#session-持久化 "Session 持久化的直接链接")
...
* [Prompt 组装](/docs/zh-Hans/developer-guide/prompt-assembly)
...
* [架构概览](/docs/zh-Hans/developer-guide/architecture)
