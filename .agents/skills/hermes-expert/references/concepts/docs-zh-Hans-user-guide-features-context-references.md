...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-references](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-references)

本页总览

输入 `@` 后跟一个引用，即可将内容直接注入消息。Hermes 会将引用内联展开，并在 `--- Attached Context ---` 区块下追加相应内容。

## 支持的引用类型[​](#支持的引用类型 "支持的引用类型的直接链接")
...
## CLI Tab 补全[​](#cli-tab-补全 "CLI Tab 补全的直接链接")
...
## 与 Context 压缩的交互[​](#与-context-压缩的交互 "与 Context 压缩的交互的直接链接")
...
* [安全性](#安全性)
  ...
  + [二进制文件检测](#二进制文件检测)
* [平台可用性](#平台可用性)
* [与 Context 压缩的交互](#与-context-压缩的交互)
* [常用模式](#常用模式)
* [错误处理](#错误处理)