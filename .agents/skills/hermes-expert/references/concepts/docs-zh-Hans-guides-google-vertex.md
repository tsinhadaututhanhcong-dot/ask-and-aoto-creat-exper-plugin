...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/google-vertex](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/google-vertex)

本页总览

Hermes Agent supports **Gemini models on Google Cloud Vertex AI** through Vertex's OpenAI-compatible endpoint. Unlike the [Google AI Studio provider](/docs/zh-Hans/guides/google-gemini) (which uses a static API key against `generativelanguage.googleapis.com`), Vertex gives you **enterprise-grade rate limits and GCP billing/credits**, and is the right choice when you want Gemini usage to draw on your Google Cloud account rather than an AI Studio key.
...
### How authentication works[​](#how-authentication-works "How authentication works的直接链接")
...
## Available Models[​](#available-models "Available Models的直接链接")
...
## Switching Models Mid-Session[​](#switching-models-mid-session "Switching Models Mid-Session的直接链接")
...
## Reasoning / Thinking[​](#reasoning--thinking "Reasoning / Thinking的直接链接")
...
## Diagnostics[​](#diagnostics "Diagnostics的直接链接")
...
### "Vertex AI credentials could not be resolved"[​](#vertex-ai-credentials-could-not-be-resolved "\"Vertex AI credentials could not be resolved\"的直接链接")
...
### `google-auth` not installed[​](#google-auth-not-installed "google-auth-not-installed的直接链接")
...
### 404 on Gemini 3.x models[​](#404-on-gemini-3x-models "404 on Gemini 3.x models的直接链接")

You are probably on a regional endpoint. Set `region: global` in the `vertex:` section of `config.yaml` (or unset `VERTEX_REGION`).

### 403 / permission denied[​](#403--permission-denied "403 / permission denied的直接链接")
...
## Related[​](#related "Related的直接链接")

* [Google Gemini (AI Studio)](/docs/zh-Hans/guides/google-gemini) — static-API-key Gemini without GCP
* [AWS Bedrock](/docs/zh-Hans/guides/aws-bedrock) — another native cloud-provider integration
