# Oss Forensics — GitHub 仓库的供应链调查、证据恢复与取证分析 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/security/security-oss-forensics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/security/security-oss-forensics)
...
## ⚠️ 反幻觉（Anti-Hallucination）防护规则[​](#️-反幻觉anti-hallucination防护规则 "⚠️ 反幻觉（Anti-Hallucination）防护规则的直接链接")
...
## 阶段 0：初始化[​](#阶段-0初始化 "阶段 0：初始化的直接链接")
...
## 阶段 1：Prompt 解析与 IOC 提取[​](#阶段-1prompt-解析与-ioc-提取 "阶段 1：Prompt 解析与 IOC 提取的直接链接")
...
* 类型（从以下选择：COMMIT\_SHA、FILE\_PATH、API\_KEY、SECRET、IP\_ADDRESS、DOMAIN、PACKAGE\_NAME、ACTOR\_USERNAME、MALICIOUS\_URL、OTHER）
* 值
* 来源（用户提供、推断得出）
...
## 阶段 2：并行证据收集[​](#阶段-2并行证据收集 "阶段 2：并行证据收集的直接链接")
...
### 调查员 1：本地 Git 调查员[​](#调查员-1本地-git-调查员 "调查员 1：本地 Git 调查员的直接链接")
...
### 调查员 2：GitHub API 调查员[​](#调查员-2github-api-调查员 "调查员 2：GitHub API 调查员的直接链接")
...
### 调查员 3：Wayback Machine 调查员[​](#调查员-3wayback-machine-调查员 "调查员 3：Wayback Machine 调查员的直接链接")
...
### 调查员 4：GH Archive / BigQuery 调查员[​](#调查员-4gh-archive--bigquery-调查员 "调查员 4：GH Archive / BigQuery 调查员的直接链接")
...
* 强制推送事件（payload.size > 0，payload.distinct\_size = 0）
* 分支/标签的 DeleteEvent
...
### 调查员 5：IOC 富化调查员[​](#调查员-5ioc-富化调查员 "调查员 5：IOC 富化调查员的直接链接")
...
## 阶段 3：证据整合[​](#阶段-3证据整合 "阶段 3：证据整合的直接链接")
...
## 阶段 4：假设形成[​](#阶段-4假设形成 "阶段 4：假设形成的直接链接")
...
## 阶段 5：假设验证[​](#阶段-5假设验证 "阶段 5：假设验证的直接链接")
...
## 阶段 6：最终报告生成[​](#阶段-6最终报告生成 "阶段 6：最终报告生成的直接链接")
...
## API 速率限制[​](#api-速率限制 "API 速率限制的直接链接")
...
* [⚠️ 反幻觉（Anti-Hallucination）防护规则](#️-反幻觉anti-hallucination防护规则)
* [示例场景](#示例场景)
* [阶段 0：初始化](#阶段-0初始化)
* [阶段 1：Prompt 解析与 IOC 提取](#阶段-1prompt-解析与-ioc-提取)
* [阶段 2：并行证据收集](#阶段-2并行证据收集)
  + [调查员 1：本地 Git 调查员](#调查员-1本地-git-调查员)
  + [调查员 2：GitHub API 调查员](#调查员-2github-api-调查员)
  + [调查员 3：Wayback Machine 调查员](#调查员-3wayback-machine-调查员)
  + [调查员 4：GH Archive / BigQuery 调查员](#调查员-4gh-archive--bigquery-调查员)
  + [调查员 5：IOC 富化调查员](#调查员-5ioc-富化调查员)
* [阶段 3：证据整合](#阶段-3证据整合)
* [阶段 4：假设形成](#阶段-4假设形成)
* [阶段 5：假设验证](#阶段-5假设验证)
* [阶段 6：最终报告生成](#阶段-6最终报告生成)
* [阶段 7：完成](#阶段-7完成)
* [道德使用准则](#道德使用准则)
* [API 速率限制](#api-速率限制)
* [参考资料](#参考资料)