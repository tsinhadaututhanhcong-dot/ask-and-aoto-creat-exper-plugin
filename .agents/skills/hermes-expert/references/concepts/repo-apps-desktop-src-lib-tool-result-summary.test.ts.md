# apps/desktop/src/lib/tool-result-summary.test.ts (repo source)
**Source:** https://github.com/NousResearch/hermes-agent/blob/main/apps/desktop/src/lib/tool-result-summary.test.ts
