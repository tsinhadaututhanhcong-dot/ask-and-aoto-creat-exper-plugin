...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/adding-platform-adapters](https://hermes-agent.nousresearch.com/docs/developer-guide/adding-platform-adapters)
...
## Env-Driven Auto-Configuration[​](#env-driven-auto-configuration "Direct link to Env-Driven Auto-Configuration")
...
## YAML→env Config Bridge[​](#yamlenv-config-bridge "Direct link to YAML→env Config Bridge")
...
## Cron Delivery[​](#cron-delivery "Direct link to Cron Delivery")
...
### Out-of-process cron delivery[​](#out-of-process-cron-delivery "Direct link to Out-of-process cron delivery")
...
## Surfacing Env Vars in `hermes config`[​](#surfacing-env-vars-in-hermes-config "Direct link to surfacing-env-vars-in-hermes-config")
...
## Platform-Specific Slow-LLM UX[​](#platform-specific-slow-llm-ux "Direct link to Platform-Specific Slow-LLM UX")
...
### Pattern: subclass `_keep_typing` to layer mid-flight UX[​](#pattern-subclass-_keep_typing-to-layer-mid-flight-ux "Direct link to pattern-subclass-_keep_typing-to-layer-mid-flight-ux")
...
### Pattern: subclass `send` to route through a cache instead of sending immediately[​](#pattern-subclass-send-to-route-through-a-cache-instead-of-sending-immediately "Direct link to pattern-subclass-send-to-route-through-a-cache-instead-of-sending-immediately")
...
### When this pattern is appropriate[​](#when-this-pattern-is-appropriate "Direct link to When this pattern is appropriate")
...
### Reference Implementations (Plugin Path)[​](#reference-implementations-plugin-path "Direct link to Reference Implementations (Plugin Path)")
...
* [Env-Driven Auto-Configuration](#env-driven-auto-configuration)
* [YAML→env Config Bridge](#yamlenv-config-bridge)
* [Cron Delivery](#cron-delivery)
  + [Out-of-process cron delivery](#out-of-process-cron-delivery)
* [Surfacing Env Vars in `hermes config`](#surfacing-env-vars-in-hermes-config)
* [Platform-Specific Slow-LLM UX](#platform-specific-slow-llm-ux)
  + [Pattern: subclass `_keep_typing` to layer mid-flight UX](#pattern-subclass-_keep_typing-to-layer-mid-flight-ux)
  + [Pattern: subclass `send` to route through a cache instead of sending immediately](#pattern-subclass-send-to-route-through-a-cache-instead-of-sending-immediately)
  + [When this pattern is appropriate](#when-this-pattern-is-appropriate)
  + [Reference Implementation](#reference-implementation)
  + [Reference Implementations (Plugin Path)](#reference-implementations-plugin-path)
