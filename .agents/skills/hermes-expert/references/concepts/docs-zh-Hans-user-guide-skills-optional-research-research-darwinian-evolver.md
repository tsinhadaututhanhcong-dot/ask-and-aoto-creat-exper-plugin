# Darwinian Evolver — 使用 Imbue 的进化循环来优化 prompt/正则/SQL/代码 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-darwinian-evolver](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-darwinian-evolver)
...
| 相关 skill | [`arxiv`](/docs/zh-Hans/user-guide/skills/bundled/research/research-arxiv), [`jupyter-live-kernel`](/docs/zh-Hans/user-guide/skills/bundled/data-science/data-science-jupyter-live-kernel) |
...
运行 Imbue 的 [darwinian\_evolver](https://github.com/imbue-ai/darwinian_evolver) —— 一个
...
## 快速开始 —— 内置 Parrot 示例[​](#快速开始--内置-parrot-示例 "快速开始 —— 内置 Parrot 示例的直接链接")
...
## 快速开始 —— OpenRouter 驱动（无需 Anthropic Key）[​](#快速开始--openrouter-驱动无需-anthropic-key "快速开始 —— OpenRouter 驱动（无需 Anthropic Key）的直接链接")
...
## 实际影响较大的超参数[​](#实际影响较大的超参数 "实际影响较大的超参数的直接链接")
...
* [前置条件](#前置条件)
* [安装（一次性）](#安装一次性)
* [快速开始 —— 内置 Parrot 示例](#快速开始--内置-parrot-示例)
* [快速开始 —— OpenRouter 驱动（无需 Anthropic Key）](#快速开始--openrouter-驱动无需-anthropic-key)
* [定义自定义问题](#定义自定义问题)
* [实际影响较大的超参数](#实际影响较大的超参数)
* [常见陷阱](#常见陷阱)
* [验证](#验证)
* [参考资料](#参考资料)
