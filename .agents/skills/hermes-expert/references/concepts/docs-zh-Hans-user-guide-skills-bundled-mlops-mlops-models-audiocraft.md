# Audiocraft 音频生成 — AudioCraft：MusicGen 文本转音乐，AudioGen 文本转声音 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/mlops/mlops-models-audiocraft](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/mlops/mlops-models-audiocraft)
...
## 何时使用 AudioCraft[​](#何时使用-audiocraft "何时使用 AudioCraft的直接链接")
...
### 基础文本转音乐（AudioCraft）[​](#基础文本转音乐audiocraft "基础文本转音乐（AudioCraft）的直接链接")
...
### 使用 HuggingFace Transformers[​](#使用-huggingface-transformers "使用 HuggingFace Transformers的直接链接")
...
### 使用 AudioGen 进行文本转声音[​](#使用-audiogen-进行文本转声音 "使用 AudioGen 进行文本转声音的直接链接")
...
## MusicGen 用法[​](#musicgen-用法 "MusicGen 用法的直接链接")

### 文本转音乐生成[​](#文本转音乐生成 "文本转音乐生成的直接链接")
...
## MusicGen-Style 用法[​](#musicgen-style-用法 "MusicGen-Style 用法的直接链接")

### 风格条件化生成[​](#风格条件化生成 "风格条件化生成的直接链接")
...
### 仅风格生成（无文本）[​](#仅风格生成无文本 "仅风格生成（无文本）的直接链接")
...
## AudioGen 用法[​](#audiogen-用法 "AudioGen 用法的直接链接")
...
## EnCodec 用法[​](#encodec-用法 "EnCodec 用法的直接链接")
...
### 工作流 1：音乐生成流水线[​](#工作流-1音乐生成流水线 "工作流 1：音乐生成流水线的直接链接")
...
### 工作流 2：音效批量处理[​](#工作流-2音效批量处理 "工作流 2：音效批量处理的直接链接")
...
### 工作流 3：Gradio 演示[​](#工作流-3gradio-演示 "工作流 3：Gradio 演示的直接链接")
...
### GPU 显存需求[​](#gpu-显存需求 "GPU 显存需求的直接链接")
...
* [何时使用 AudioCraft](#何时使用-audiocraft)
* [快速开始](#快速开始)
  + [安装](#安装)
  + [基础文本转音乐（AudioCraft）](#基础文本转音乐audiocraft)
  + [使用 HuggingFace Transformers](#使用-huggingface-transformers)
  + [使用 AudioGen 进行文本转声音](#使用-audiogen-进行文本转声音)
* [核心概念](#核心概念)
  + [架构概览](#架构概览)
  + [模型变体](#模型变体)
  + [生成参数](#生成参数)
* [MusicGen 用法](#musicgen-用法)
  + [文本转音乐生成](#文本转音乐生成)
  + [旋律条件化生成](#旋律条件化生成)
  + [立体声生成](#立体声生成)
  + [音频续写](#音频续写)
* [MusicGen-Style 用法](#musicgen-style-用法)
  + [风格条件化生成](#风格条件化生成)
  + [仅风格生成（无文本）](#仅风格生成无文本)
* [AudioGen 用法](#audiogen-用法)
  + [音效生成](#音效生成)
* [EnCodec 用法](#encodec-用法)
  + [音频压缩](#音频压缩)
* [常见工作流](#常见工作流)
  + [工作流 1：音乐生成流水线](#工作流-1音乐生成流水线)
  + [工作流 2：音效批量处理](#工作流-2音效批量处理)
  + [工作流 3：Gradio 演示](#工作流-3gradio-演示)
* [性能优化](#性能优化)
  + [内存优化](#内存优化)
  + [批处理效率](#批处理效率)
  + [GPU 显存需求](#gpu-显存需求)
