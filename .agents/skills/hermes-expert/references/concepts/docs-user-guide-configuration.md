...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/configuration](https://hermes-agent.nousresearch.com/docs/user-guide/configuration)
...
## Update Behavior[​](#update-behavior "Direct link to Update Behavior")
...
#### `terminal.home_mode`[​](#terminalhome_mode "Direct link to terminalhome_mode")
...
#### Container lifecycle[​](#container-lifecycle "Direct link to Container lifecycle")
...
#### Environment variable overrides[​](#environment-variable-overrides "Direct link to Environment variable overrides")
...
### Write approval for skill writes[​](#write-approval-for-skill-writes "Direct link to Write approval for skill writes")
...
## Context File Truncation[​](#context-file-truncation "Direct link to Context File Truncation")
...
## Standing Goals (`/goal`)[​](#standing-goals-goal "Direct link to standing-goals-goal")
...
### Per-task fallback chain for auxiliary tasks[​](#per-task-fallback-chain-for-auxiliary-tasks "Direct link to Per-task fallback chain for auxiliary tasks")
...
### OpenRouter routing & Pareto Code for auxiliary tasks[​](#openrouter-routing--pareto-code-for-auxiliary-tasks "Direct link to OpenRouter routing & Pareto Code for auxiliary tasks")
...
## Tool-Loop Guardrails[​](#tool-loop-guardrails "Direct link to Tool-Loop Guardrails")
...
### File-mutation verifier[​](#file-mutation-verifier "Direct link to File-mutation verifier")
...
### Deny rules[​](#deny-rules "Direct link to Deny rules")
...
* [Skill Settings](#skill-settings)
  ...
  + [Write approval for skill writes](#write-approval-for-skill-writes)
* [Memory Configuration](#memory-configuration)
* [Context File Truncation](#context-file-truncation)
...
* [Standing Goals (`/goal`)](#standing-goals-goal)
...
* [Auxiliary Models](#auxiliary-models)
  ...
  + [Per-task fallback chain for auxiliary tasks](#per-task-fallback-chain-for-auxiliary-tasks)
...
- [https://hermes-agent.nousresearch.com/docs/guides/minimax-oauth](./docs-guides-minimax-oauth.md)
- [https://hermes-agent.nousresearch.com/docs/guides/oauth-over-ssh](./docs-guides-oauth-over-ssh.md)
- [https://hermes-agent.nousresearch.com/docs/guides/xai-grok-oauth](./docs-guides-xai-grok-oauth.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/goals](./docs-user-guide-features-goals.md)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/web-search](./docs-user-guide-features-web-search.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/managed-scope](./docs-user-guide-managed-scope.md)
