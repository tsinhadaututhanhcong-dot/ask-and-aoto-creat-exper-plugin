...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu)
...
### Configure Events[​](#configure-events "Direct link to Configure Events")
...
### Publish the App[​](#publish-the-app "Direct link to Publish the App")
...
## Meeting Invitation Events[​](#meeting-invitation-events "Direct link to Meeting Invitation Events")
...
### Required Feishu App Configuration[​](#required-feishu-app-configuration-2 "Direct link to Required Feishu App Configuration")
...
| `Another local Hermes gateway is already using this Feishu app_id` | Only one Hermes instance can use the same app\_id at a time. Stop the other gateway first. |
...
* [Meeting Invitation Events](#meeting-invitation-events)
  + [Required Feishu App Configuration](#required-feishu-app-configuration-2)
