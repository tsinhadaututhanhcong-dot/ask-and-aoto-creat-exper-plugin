...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-grok](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-grok)
...
### Mode 1: Headless (`-p`) — Non-Interactive (PREFERRED)[​](#mode-1-headless--p--non-interactive-preferred "Direct link to mode-1-headless--p--non-interactive-preferred")
...
### Mode 2: Interactive PTY — Multi-Turn TUI Sessions[​](#mode-2-interactive-pty--multi-turn-tui-sessions "Direct link to Mode 2: Interactive PTY — Multi-Turn TUI Sessions")
...
## Headless Deep Dive[​](#headless-deep-dive "Direct link to Headless Deep Dive")
...
## Read-Only Audit → Markdown Note Pattern[​](#read-only-audit--markdown-note-pattern "Direct link to Read-Only Audit → Markdown Note Pattern")
...
## PR Review Patterns[​](#pr-review-patterns "Direct link to PR Review Patterns")

### Quick Review (Headless)[​](#quick-review-headless "Direct link to Quick Review (Headless)")
...
### Clone-to-temp Review (safe, no repo mutation)[​](#clone-to-temp-review-safe-no-repo-mutation "Direct link to Clone-to-temp Review (safe, no repo mutation)")
...
### Post the review[​](#post-the-review "Direct link to Post the review")
...
## Useful Subcommands & TUI Commands[​](#useful-subcommands--tui-commands "Direct link to Useful Subcommands & TUI Commands")
...
## Config (`~/.grok/config.toml`)[​](#config-grokconfigtoml "Direct link to config-grokconfigtoml")
