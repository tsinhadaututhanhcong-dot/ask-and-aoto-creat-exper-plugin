...
**Source:** [https://hermes-agent.nousresearch.com/docs/reference/profile-commands](https://hermes-agent.nousresearch.com/docs/reference/profile-commands)
...
## `hermes profile describe`[​](#hermes-profile-describe "Direct link to hermes-profile-describe")
...
## Distribution commands[​](#distribution-commands "Direct link to Distribution commands")
...
### `hermes profile install`[​](#hermes-profile-install "Direct link to hermes-profile-install")
...
### `hermes profile update`[​](#hermes-profile-update "Direct link to hermes-profile-update")
...
### `hermes profile info`[​](#hermes-profile-info "Direct link to hermes-profile-info")
...
### Private distributions[​](#private-distributions "Direct link to Private distributions")
...
### Distribution manifest (`distribution.yaml`)[​](#distribution-manifest-distributionyaml "Direct link to distribution-manifest-distributionyaml")
...
### Publishing a distribution[​](#publishing-a-distribution "Direct link to Publishing a distribution")
...
* [Distribution commands](#distribution-commands)
  ...
  + [Private distributions](#private-distributions)
  + [Distribution manifest (`distribution.yaml`)](#distribution-manifest-distributionyaml)
  + [Publishing a distribution](#publishing-a-distribution)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/profile-distributions](./docs-user-guide-profile-distributions.md)
