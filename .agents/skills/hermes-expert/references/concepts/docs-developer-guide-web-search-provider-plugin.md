...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/web-search-provider-plugin](https://hermes-agent.nousresearch.com/docs/developer-guide/web-search-provider-plugin)
...
## The WebSearchProvider ABC[​](#the-websearchprovider-abc "Direct link to The WebSearchProvider ABC")
...
| `requires_env` | Interactive credential prompt during `hermes plugins install` (see [Build a Hermes Plugin](/docs/developer-guide/plugins#gate-on-environment-variables) for the rich format) |
...
## Response shape[​](#response-shape "Direct link to Response shape")
...
## Capability flags[​](#capability-flags "Direct link to Capability flags")
...
## How Hermes wires it into the tools[​](#how-hermes-wires-it-into-the-tools "Direct link to How Hermes wires it into the tools")
...
## Lazy-installing optional dependencies[​](#lazy-installing-optional-dependencies "Direct link to Lazy-installing optional dependencies")
...
* [The WebSearchProvider ABC](#the-websearchprovider-abc)
* [plugin.yaml](#pluginyaml)
* [ABC reference](#abc-reference)
* [Response shape](#response-shape)
* [Capability flags](#capability-flags)
* [How Hermes wires it into the tools](#how-hermes-wires-it-into-the-tools)
* [Lazy-installing optional dependencies](#lazy-installing-optional-dependencies)
