...
**Source:** [https://hermes-agent.nousresearch.com/docs/guides/microsoft-graph-app-registration](https://hermes-agent.nousresearch.com/docs/guides/microsoft-graph-app-registration)
...
## Step 1: Create the App Registration[​](#step-1-create-the-app-registration "Direct link to Step 1: Create the App Registration")
...
## Step 2: Create a Client Secret[​](#step-2-create-a-client-secret "Direct link to Step 2: Create a Client Secret")
...
## Step 3: Grant Graph API Permissions[​](#step-3-grant-graph-api-permissions "Direct link to Step 3: Grant Graph API Permissions")
...
### Required for transcript-first summaries[​](#required-for-transcript-first-summaries "Direct link to Required for transcript-first summaries")
...
### Required for recording fallback (when a transcript is unavailable)[​](#required-for-recording-fallback-when-a-transcript-is-unavailable "Direct link to Required for recording fallback (when a transcript is unavailable)")
...
### Required for outbound summary delivery (Graph mode only)[​](#required-for-outbound-summary-delivery-graph-mode-only "Direct link to Required for outbound summary delivery (Graph mode only)")
...
### Not recommended[​](#not-recommended "Direct link to Not recommended")
...
## Step 4: (Recommended) Scope the App with an Application Access Policy[​](#step-4-recommended-scope-the-app-with-an-application-access-policy "Direct link to Step 4: (Recommended) Scope the App with an Application Access Policy")
...
## Step 5: Write the Credentials to Your Env File[​](#step-5-write-the-credentials-to-your-env-file "Direct link to Step 5: Write the Credentials to Your Env File")
...
## Step 6: Verify the Token Flow[​](#step-6-verify-the-token-flow "Direct link to Step 6: Verify the Token Flow")
...
## Rotating the Client Secret[​](#rotating-the-client-secret "Direct link to Rotating the Client Secret")
...
* [Step 3: Grant Graph API Permissions](#step-3-grant-graph-api-permissions)
  + [Required for transcript-first summaries](#required-for-transcript-first-summaries)
  + [Required for recording fallback (when a transcript is unavailable)](#required-for-recording-fallback-when-a-transcript-is-unavailable)
  + [Required for outbound summary delivery (Graph mode only)](#required-for-outbound-summary-delivery-graph-mode-only)
  + [Not recommended](#not-recommended)
* [Step 4: (Recommended) Scope the App with an Application Access Policy](#step-4-recommended-scope-the-app-with-an-application-access-policy)
* [Step 5: Write the Credentials to Your Env File](#step-5-write-the-credentials-to-your-env-file)
* [Step 6: Verify the Token Flow](#step-6-verify-the-token-flow)
