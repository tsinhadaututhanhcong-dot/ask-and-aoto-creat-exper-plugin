...
**Source:** [https://hermes-agent.nousresearch.com/docs/getting-started/updating](https://hermes-agent.nousresearch.com/docs/getting-started/updating)
...
### Updating against a non-default branch: `--branch`[​](#updating-against-a-non-default-branch---branch "Direct link to updating-against-a-non-default-branch---branch")
...
### Local changes on non-interactive updates[​](#local-changes-on-non-interactive-updates "Direct link to Local changes on non-interactive updates")
...
### Windows: another `hermes.exe` is running[​](#windows-another-hermesexe-is-running "Direct link to windows-another-hermesexe-is-running")
...
* [Updating](#updating)
  ...
  + [Updating against a non-default branch: `--branch`](#updating-against-a-non-default-branch---branch)
  + [Local changes on non-interactive updates](#local-changes-on-non-interactive-updates)
  ...
  + [Windows: another `hermes.exe` is running](#windows-another-hermesexe-is-running)
