...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/computer-use/computer-use-computer-use](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/computer-use/computer-use-computer-use)
...
## The canonical workflow[​](#the-canonical-workflow "The canonical workflow的直接链接")
...
## Capture modes[​](#capture-modes "Capture modes的直接链接")
...
### Key shortcuts vary per platform[​](#key-shortcuts-vary-per-platform "Key shortcuts vary per platform的直接链接")
...
## Background rules (the whole point)[​](#background-rules-the-whole-point "Background rules (the whole point)的直接链接")
...
## Drag & drop[​](#drag--drop "Drag & drop的直接链接")
...
## Managing what's focused[​](#managing-whats-focused "Managing what's focused的直接链接")
...
## Delivering screenshots to the user[​](#delivering-screenshots-to-the-user "Delivering screenshots to the user的直接链接")
...
## Safety — these are hard rules[​](#safety--these-are-hard-rules "Safety — these are hard rules的直接链接")
...
## Failure modes — what to do when things go sideways[​](#failure-modes--what-to-do-when-things-go-sideways "Failure modes — what to do when things go sideways的直接链接")
...
## When NOT to use `computer_use`[​](#when-not-to-use-computer_use "when-not-to-use-computer_use的直接链接")
...
## Going deeper — read the cua-driver skill pack[​](#going-deeper--read-the-cua-driver-skill-pack "Going deeper — read the cua-driver skill pack的直接链接")
