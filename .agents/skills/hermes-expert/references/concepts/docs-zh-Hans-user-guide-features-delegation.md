# 子智能体委派 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation)
...
## 子智能体上下文的工作方式[​](#子智能体上下文的工作方式 "子智能体上下文的工作方式的直接链接")
...
## 监控运行中的子智能体（`/agents`）[​](#监控运行中的子智能体agents "监控运行中的子智能体agents的直接链接")
...
经典 CLI 仅将 `/agents` 打印为文本摘要；TUI 才是浮层真正发挥作用的地方。参见 [TUI — 斜杠命令](/docs/zh-Hans/user-guide/tui#slash-commands)。

## 深度限制与嵌套编排[​](#depth-limit-and-nested-orchestration "深度限制与嵌套编排的直接链接")
...
## 生命周期与持久性[​](#生命周期与持久性 "生命周期与持久性的直接链接")

delegate\_task 是同步的——不具备持久性
...
## delegate\_task 与 execute\_code 对比[​](#delegate_task-与-execute_code-对比 "delegate_task 与 execute_code 对比的直接链接")
...
* [最大迭代次数](#最大迭代次数)
* [子智能体超时](#子智能体超时)
* [监控运行中的子智能体（`/agents`）](#监控运行中的子智能体agents)
* [深度限制与嵌套编排](#depth-limit-and-nested-orchestration)
* [生命周期与持久性](#生命周期与持久性)
* [关键特性](#关键特性)
* [delegate\_task 与 execute\_code 对比](#delegate_task-与-execute_code-对比)
* [配置](#配置)
