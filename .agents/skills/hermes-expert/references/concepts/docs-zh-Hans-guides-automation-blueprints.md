# 自动化蓝图 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/automation-blueprints](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/automation-blueprints)

本页总览

常见自动化模式的复制粘贴蓝图。每个蓝图使用 Hermes 内置的 [cron 调度器](/docs/zh-Hans/user-guide/features/cron) 实现基于时间的触发，使用 [webhook 平台](/docs/zh-Hans/user-guide/messaging/webhooks) 实现事件驱动触发。

所有蓝图适用于**任意模型**——不绑定单一提供商。

如需带表单的参数化蓝图（无需手写 cron 语法），请参阅[自动化蓝图目录](/docs/zh-Hans/reference/automation-blueprints-catalog)。
...
### 每晚待办事项分类[​](#每晚待办事项分类 "每晚待办事项分类的直接链接")
...
### 自动 PR 代码审查[​](#自动-pr-代码审查 "自动 PR 代码审查的直接链接")
...
## DevOps 与监控[​](#devops-与监控 "DevOps 与监控的直接链接")
...
## 研究与情报[​](#研究与情报 "研究与情报的直接链接")

### 竞品仓库侦察[​](#竞品仓库侦察 "竞品仓库侦察的直接链接")
...
## GitHub 事件自动化[​](#github-事件自动化 "GitHub 事件自动化的直接链接")

### Issue 自动打标签[​](#issue-自动打标签 "Issue 自动打标签的直接链接")
...
### 跨仓库自动移植变更[​](#跨仓库自动移植变更 "跨仓库自动移植变更的直接链接")
...
### Stripe 支付监控[​](#stripe-支付监控 "Stripe 支付监控的直接链接")
...
## 多技能工作流[​](#多技能工作流 "多技能工作流的直接链接")

### 安全审计流水线[​](#安全审计流水线 "安全审计流水线的直接链接")
...
### Cron 调度语法[​](#cron-调度语法 "Cron 调度语法的直接链接")
...
### Webhook 模板变量[​](#webhook-模板变量 "Webhook 模板变量的直接链接")
...
### [SILENT] 模式[​](#silent-模式 "[SILENT] 模式的直接链接")
...
* [开发工作流](#开发工作流)
  + [每晚待办事项分类](#每晚待办事项分类)
  + [自动 PR 代码审查](#自动-pr-代码审查)
  + [文档偏差检测](#文档偏差检测)
  + [依赖安全审计](#依赖安全审计)
* [DevOps 与监控](#devops-与监控)
  + [部署验证](#部署验证)
  + [告警分类](#告警分类)
  + [可用性监控](#可用性监控)
* [研究与情报](#研究与情报)
  ...
  + [AI 新闻摘要](#ai-新闻摘要)
  + [论文摘要与笔记](#论文摘要与笔记)
* [GitHub 事件自动化](#github-事件自动化)
  + [Issue 自动打标签](#issue-自动打标签)
  + [CI 失败分析](#ci-失败分析)
  + [跨仓库自动移植变更](#跨仓库自动移植变更)
* [业务运营](#业务运营)
  + [Stripe 支付监控](#stripe-支付监控)
  + [每日营收摘要](#每日营收摘要)
* [多技能工作流](#多技能工作流)
  + [安全审计流水线](#安全审计流水线)
  + [内容流水线](#内容流水线)
* [快速参考](#快速参考)
  + [Cron 调度语法](#cron-调度语法)
  + [投递目标](#投递目标)
  + [Webhook 模板变量](#webhook-模板变量)
  + [[SILENT] 模式](#silent-模式)

## Related Files
> **LLM Navigation:** Các tệp dưới đây được liên kết trực tiếp từ tài liệu này. Hãy đọc chúng nếu cần thêm ngữ cảnh.

- [https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/automation-blueprints-catalog](./docs-zh-Hans-reference-automation-blueprints-catalog.md)
