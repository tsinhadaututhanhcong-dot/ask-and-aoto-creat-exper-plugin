# MCP 配置参考 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/mcp-config-reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/mcp-config-reference)
...
* [MCP（Model Context Protocol）](/docs/zh-Hans/user-guide/features/mcp)
* [在 Hermes 中使用 MCP](/docs/zh-Hans/guides/use-mcp-with-hermes)

## 根配置结构[​](#根配置结构 "根配置结构的直接链接")
...
## `tools` 策略键[​](#tools-策略键 "tools-策略键的直接链接")
...
### 禁用 resources[​](#禁用-resources "禁用 resources的直接链接")
...
### 禁用 prompts[​](#禁用-prompts "禁用 prompts的直接链接")
...
## `enabled: false`[​](#enabled-false "enabled-false的直接链接")
...
## 空结果行为[​](#空结果行为 "空结果行为的直接链接")

若过滤后服务器原生工具全部被移除，且没有工具被注册，Hermes 不会为该服务器创建空的 MCP 运行时工具集。

## 配置示例[​](#配置示例 "配置示例的直接链接")

### GitHub 安全白名单[​](#github-安全白名单 "GitHub 安全白名单的直接链接")
...
### Stripe 黑名单[​](#stripe-黑名单 "Stripe 黑名单的直接链接")
...
### 仅资源的文档服务器[​](#仅资源的文档服务器 "仅资源的文档服务器的直接链接")
...
## OAuth 2.1 认证[​](#oauth-21-认证 "OAuth 2.1 认证的直接链接")
...
* [过滤语义](#过滤语义)
  ...
  + [优先级](#优先级)
* [工具策略](#工具策略)
  + [禁用 resources](#禁用-resources)
  + [禁用 prompts](#禁用-prompts)
  + [能力感知注册](#能力感知注册)
* [`enabled: false`](#enabled-false)
* [空结果行为](#空结果行为)
* [配置示例](#配置示例)
  + [GitHub 安全白名单](#github-安全白名单)
  + [Stripe 黑名单](#stripe-黑名单)
  + [仅资源的文档服务器](#仅资源的文档服务器)
* [重新加载配置](#重新加载配置)
* [工具命名](#工具命名)
  + [名称规范化](#名称规范化)
* [OAuth 2.1 认证](#oauth-21-认证)
