...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent)
...
## Scope & Verification[​](#scope--verification "Direct link to Scope & Verification")
...
### Credentials & Pools[​](#credentials--pools "Direct link to Credentials & Pools")
...
## Project Context Files[​](#project-context-files "Direct link to Project Context Files")
...
### Pick the right one[​](#pick-the-right-one "Direct link to Pick the right one")
...
### Size and truncation[​](#size-and-truncation "Direct link to Size and truncation")
...
### Disable for one session[​](#disable-for-one-session "Direct link to Disable for one session")
...
### Example: a small `.hermes.md`[​](#example-a-small-hermesmd "Direct link to example-a-small-hermesmd")
...
### When to Use This vs delegate\_task[​](#when-to-use-this-vs-delegate_task "Direct link to When to Use This vs delegate_task")
...
## Surfaces & Other Capabilities[​](#surfaces--other-capabilities "Direct link to Surfaces & Other Capabilities")
...
## Windows-Specific Quirks[​](#windows-specific-quirks "Direct link to Windows-Specific Quirks")
...
### Input / Keybindings[​](#input--keybindings "Direct link to Input / Keybindings")

**Alt+Enter doesn't insert a newline** — Windows Terminal (and mintty) grab it
for fullscreen before prompt\_toolkit sees it. Use **Ctrl+Enter** instead (the
...
### `execute_code` / Sandbox[​](#execute_code--sandbox "Direct link to execute_code--sandbox")
...
### Testing on Windows[​](#testing-on-windows "Direct link to Testing on Windows")
...
### Path / Filesystem[​](#path--filesystem "Direct link to Path / Filesystem")
...
### Adding a Tool[​](#adding-a-tool "Direct link to Adding a Tool")
...
### System prompt's execution-environment block[​](#system-prompts-execution-environment-block "Direct link to System prompt's execution-environment block")
...
* [CLI Reference](#cli-reference)
  ...
  + [Webhooks](#webhooks)
  + [Profiles](#profiles)
  + [Credentials & Pools](#credentials--pools)
  + [Other](#other)
...
* [Project Context Files](#project-context-files)
  ...
  + [Size and truncation](#size-and-truncation)
  + [Security](#security)
  + [Disable for one session](#disable-for-one-session)
  + [Example: a small `.hermes.md`](#example-a-small-hermesmd)
...
* [Spawning Additional Hermes Instances](#spawning-additional-hermes-instances)
  + [When to Use This vs delegate\_task](#when-to-use-this-vs-delegate_task)
...
* [Surfaces & Other Capabilities](#surfaces--other-capabilities)
...
* [Contributor Quick Reference](#contributor-quick-reference)
  ...
  + [Testing](#testing)
  + [System prompt's execution-environment block](#system-prompts-execution-environment-block)
