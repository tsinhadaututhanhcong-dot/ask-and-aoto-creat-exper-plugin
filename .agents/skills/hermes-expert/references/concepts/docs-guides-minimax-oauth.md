...
**Source:** [https://hermes-agent.nousresearch.com/docs/guides/minimax-oauth](https://hermes-agent.nousresearch.com/docs/guides/minimax-oauth)
...
### Region endpoints[​](#region-endpoints "Direct link to Region endpoints")
