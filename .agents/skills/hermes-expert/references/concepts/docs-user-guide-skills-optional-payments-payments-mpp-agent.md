...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-mpp-agent](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-mpp-agent)
...
## Choosing a client[​](#choosing-a-client "Direct link to Choosing a client")
...
## Procedure (mppx, fastest path)[​](#procedure-mppx-fastest-path "Direct link to Procedure (mppx, fastest path)")

Run all commands through the `terminal` tool.

### 1. Install + create an account[​](#1-install--create-an-account "Direct link to 1. Install + create an account")
...
### 2. Inspect the merchant's 402 challenge[​](#2-inspect-the-merchants-402-challenge "Direct link to 2. Inspect the merchant's 402 challenge")
...
### 3. Pay the request[​](#3-pay-the-request "Direct link to 3. Pay the request")
...
### 4. Verify the receipt[​](#4-verify-the-receipt "Direct link to 4. Verify the receipt")
...
## Procedure (Tempo Wallet)[​](#procedure-tempo-wallet "Direct link to Procedure (Tempo Wallet)")
