...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/teams-meetings](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/teams-meetings)
...
## What This Feature Does[​](#what-this-feature-does "Direct link to What This Feature Does")
...
## Step 1: Add Microsoft Graph Credentials[​](#step-1-add-microsoft-graph-credentials "Direct link to Step 1: Add Microsoft Graph Credentials")
...
## Step 2: Enable the Graph Webhook Listener[​](#step-2-enable-the-graph-webhook-listener "Direct link to Step 2: Enable the Graph Webhook Listener")
...
## Step 3: Configure Teams Delivery and Pipeline Behavior[​](#step-3-configure-teams-delivery-and-pipeline-behavior "Direct link to Step 3: Configure Teams Delivery and Pipeline Behavior")
...
## Teams Delivery Modes[​](#teams-delivery-modes "Direct link to Teams Delivery Modes")

The pipeline supports two Teams summary-delivery modes inside the existing Teams plugin.

### `incoming_webhook`[​](#incoming_webhook "Direct link to incoming_webhook")
...
## Step 5: Create Graph Subscriptions[​](#step-5-create-graph-subscriptions "Direct link to Step 5: Create Graph Subscriptions")
...
- [https://hermes-agent.nousresearch.com/docs/guides/operate-teams-meeting-pipeline](./docs-guides-operate-teams-meeting-pipeline.md)
