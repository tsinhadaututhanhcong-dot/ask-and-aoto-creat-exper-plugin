...
**Source:** [https://hermes-agent.nousresearch.com/docs/guides/pipe-script-output](https://hermes-agent.nousresearch.com/docs/guides/pipe-script-output)
...
## Argument Reference[​](#argument-reference "Direct link to Argument Reference")
...
### Target Formats[​](#target-formats "Direct link to Target Formats")
...
## Message Body Resolution[​](#message-body-resolution "Direct link to Message Body Resolution")
...
### Monitoring: Memory / Disk Alerts[​](#monitoring-memory--disk-alerts "Direct link to Monitoring: Memory / Disk Alerts")
...
### CI / CD: Build and Test Results[​](#ci--cd-build-and-test-results "Direct link to CI / CD: Build and Test Results")
...
### Cron: Daily Report[​](#cron-daily-report "Direct link to Cron: Daily Report")
...
### Long-Running Tasks: Ping When Done[​](#long-running-tasks-ping-when-done "Direct link to Long-Running Tasks: Ping When Done")
...
### Scripting with `--json` and `--quiet`[​](#scripting-with---json-and---quiet "Direct link to scripting-with---json-and---quiet")
...
## Does `hermes send` Need the Gateway Running?[​](#does-hermes-send-need-the-gateway-running "Direct link to does-hermes-send-need-the-gateway-running")
...
## Listing and Discovering Targets[​](#listing-and-discovering-targets "Direct link to Listing and Discovering Targets")
...
* [Message Body Resolution](#message-body-resolution)
* [Real-World Examples](#real-world-examples)
  + [Monitoring: Memory / Disk Alerts](#monitoring-memory--disk-alerts)
  + [CI / CD: Build and Test Results](#ci--cd-build-and-test-results)
  + [Cron: Daily Report](#cron-daily-report)
  + [Long-Running Tasks: Ping When Done](#long-running-tasks-ping-when-done)
  + [Scripting with `--json` and `--quiet`](#scripting-with---json-and---quiet)
* [Does `hermes send` Need the Gateway Running?](#does-hermes-send-need-the-gateway-running)
* [Listing and Discovering Targets](#listing-and-discovering-targets)
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/gateway-internals](./docs-developer-guide-gateway-internals.md)
