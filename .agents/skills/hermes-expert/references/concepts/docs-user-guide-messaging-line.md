# LINE | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line)
...
## Step 1: Create a LINE Messaging API channel[​](#step-1-create-a-line-messaging-api-channel "Direct link to Step 1: Create a LINE Messaging API channel")
...
## Step 4: Set the webhook URL[​](#step-4-set-the-webhook-url "Direct link to Step 4: Set the webhook URL")
...
## Step 5: Run the gateway[​](#step-5-run-the-gateway "Direct link to Step 5: Run the gateway")
...
## Slow LLM responses[​](#slow-llm-responses "Direct link to Slow LLM responses")
...
## Cron / notification delivery[​](#cron--notification-delivery "Direct link to Cron / notification delivery")
...
## Environment variable reference[​](#environment-variable-reference "Direct link to Environment variable reference")
...
* [Step 1: Create a LINE Messaging API channel](#step-1-create-a-line-messaging-api-channel)
* [Step 2: Expose the webhook port](#step-2-expose-the-webhook-port)
* [Step 3: Configure Hermes](#step-3-configure-hermes)
* [Step 4: Set the webhook URL](#step-4-set-the-webhook-url)
* [Step 5: Run the gateway](#step-5-run-the-gateway)
* [Slow LLM responses](#slow-llm-responses)
* [Cron / notification delivery](#cron--notification-delivery)
