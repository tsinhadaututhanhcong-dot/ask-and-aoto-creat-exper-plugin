...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/adding-tools](https://hermes-agent.nousresearch.com/docs/developer-guide/adding-tools)
...
## Handlers That Need task\_id[​](#handlers-that-need-task_id "Direct link to Handlers That Need task_id")
...
* [Handlers That Need task\_id](#handlers-that-need-task_id)
