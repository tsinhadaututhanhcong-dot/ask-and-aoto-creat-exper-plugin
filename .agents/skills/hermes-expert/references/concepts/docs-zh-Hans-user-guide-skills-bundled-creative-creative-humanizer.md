# Humanizer — 人性化文本：去除 AI 腔调，注入真实声音 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-humanizer](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-humanizer)
...
| 版本 | `2.5.1` |
| 作者 | Siqi Chen (@blader, [https://github.com/blader/humanizer)，由](https://github.com/blader/humanizer)%EF%BC%8C%E7%94%B1) Hermes Agent 移植 |
| 许可证 | MIT |
| 平台 | linux, macos, windows |
| 标签 | `writing`, `editing`, `humanize`, `anti-ai-slop`, `voice`, `prose`, `text` |
| 相关 skill | [`songwriting-and-ai-music`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music) |
...
## 如何在 Hermes 中使用[​](#如何在-hermes-中使用 "如何在 Hermes 中使用的直接链接")
...
## 个性与灵魂[​](#个性与灵魂 "个性与灵魂的直接链接")

避免 AI 模式只是工作的一半。无菌、无声的写作和 slop 一样明显。好的写作背后有真实的人。

### 无灵魂写作的特征（即使技术上"干净"）：[​](#无灵魂写作的特征即使技术上干净 "无灵魂写作的特征（即使技术上\"干净\"）：的直接链接")
...
### 之前（干净但无灵魂）：[​](#之前干净但无灵魂 "之前（干净但无灵魂）：的直接链接")

> The experiment produced interesting results. The agents generated 3 million lines of code. Some developers were impressed while others were skeptical. The implications remain unclear.

### 之后（有脉搏）：[​](#之后有脉搏 "之后（有脉搏）：的直接链接")

> I genuinely don't know how to feel about this one. 3 million lines of code, generated while the humans presumably slept. Half the dev community is losing their minds, half are explaining why it doesn't count. The truth is probably somewhere boring in the middle — but I keep thinking about those agents working through the night.

## 内容模式[​](#内容模式 "内容模式的直接链接")

### 1. 过度强调重要性、遗产与宏观趋势[​](#1-过度强调重要性遗产与宏观趋势 "1. 过度强调重要性、遗产与宏观趋势的直接链接")
...
### 2. 过度强调知名度和媒体报道[​](#2-过度强调知名度和媒体报道 "2. 过度强调知名度和媒体报道的直接链接")
...
### 3. 以 -ing 结尾的表面分析[​](#3-以--ing-结尾的表面分析 "3. 以 -ing 结尾的表面分析的直接链接")
...
### 4. 促销和广告式语言[​](#4-促销和广告式语言 "4. 促销和广告式语言的直接链接")
...
### 5. 模糊归因和含糊措辞[​](#5-模糊归因和含糊措辞 "5. 模糊归因和含糊措辞的直接链接")
...
### 6. 大纲式"挑战与未来展望"章节[​](#6-大纲式挑战与未来展望章节 "6. 大纲式\"挑战与未来展望\"章节的直接链接")
...
## 语言与语法模式[​](#语言与语法模式 "语言与语法模式的直接链接")

### 7. 过度使用的"AI 词汇"[​](#7-过度使用的ai-词汇 "7. 过度使用的\"AI 词汇\"的直接链接")
...
### 8. 回避"is"/"are"（系动词回避）[​](#8-回避isare系动词回避 "8. 回避\"is\"/\"are\"（系动词回避）的直接链接")
...
### 9. 否定并列与尾部否定[​](#9-否定并列与尾部否定 "9. 否定并列与尾部否定的直接链接")
...
### 10. 三元规则滥用[​](#10-三元规则滥用 "10. 三元规则滥用的直接链接")
...
### 11. 优雅变体（同义词循环）[​](#11-优雅变体同义词循环 "11. 优雅变体（同义词循环）的直接链接")
...
### 13. 被动语态与无主语片段[​](#13-被动语态与无主语片段 "13. 被动语态与无主语片段的直接链接")
...
### 14. 破折号滥用[​](#14-破折号滥用 "14. 破折号滥用的直接链接")
...
### 16. 内联标题垂直列表[​](#16-内联标题垂直列表 "16. 内联标题垂直列表的直接链接")
...
### 17. 标题中的标题大小写[​](#17-标题中的标题大小写 "17. 标题中的标题大小写的直接链接")

**问题：** AI 聊天机器人将标题中所有主要词汇首字母大写。

**之前：**

> ## Strategic Negotiations And Global Partnerships[​](#strategic-negotiations-and-global-partnerships "Strategic Negotiations And Global Partnerships的直接链接")

**之后：**

> ## Strategic negotiations and global partnerships[​](#strategic-negotiations-and-global-partnerships-1 "Strategic negotiations and global partnerships的直接链接")

### 18. Emoji[​](#18-emoji "18. Emoji的直接链接")
...
### 20. 协作沟通产物[​](#20-协作沟通产物 "20. 协作沟通产物的直接链接")
...
### 21. 知识截止日期免责声明[​](#21-知识截止日期免责声明 "21. 知识截止日期免责声明的直接链接")
...
### 22. 谄媚/顺从语气[​](#22-谄媚顺从语气 "22. 谄媚/顺从语气的直接链接")
...
## 填充词与过度修饰[​](#填充词与过度修饰 "填充词与过度修饰的直接链接")

### 23. 填充短语[​](#23-填充短语 "23. 填充短语的直接链接")
...
### 25. 泛泛的积极结尾[​](#25-泛泛的积极结尾 "25. 泛泛的积极结尾的直接链接")
...
### 26. 连字符词对滥用[​](#26-连字符词对滥用 "26. 连字符词对滥用的直接链接")
...
### 27. 说服性权威套语[​](#27-说服性权威套语 "27. 说服性权威套语的直接链接")
...
### 28. 路标语和预告语[​](#28-路标语和预告语 "28. 路标语和预告语的直接链接")
...
### 29. 碎片化标题[​](#29-碎片化标题 "29. 碎片化标题的直接链接")
...
> ## Performance[​](#performance "Performance的直接链接")
>
> Speed matters.
>
...
> ## Performance[​](#performance-1 "Performance的直接链接")
>
> When users hit a slow page, they leave.
...
* [声音校准（可选）](#声音校准可选)
  + [如何提供样本](#如何提供样本)
* [个性与灵魂](#个性与灵魂)
  + [无灵魂写作的特征（即使技术上"干净"）：](#无灵魂写作的特征即使技术上干净)
  + [如何注入声音：](#如何注入声音)
  + [之前（干净但无灵魂）：](#之前干净但无灵魂)
  + [之后（有脉搏）：](#之后有脉搏)
* [内容模式](#内容模式)
  + [1. 过度强调重要性、遗产与宏观趋势](#1-过度强调重要性遗产与宏观趋势)
  + [2. 过度强调知名度和媒体报道](#2-过度强调知名度和媒体报道)
  + [3. 以 -ing 结尾的表面分析](#3-以--ing-结尾的表面分析)
  + [4. 促销和广告式语言](#4-促销和广告式语言)
  + [5. 模糊归因和含糊措辞](#5-模糊归因和含糊措辞)
  + [6. 大纲式"挑战与未来展望"章节](#6-大纲式挑战与未来展望章节)
* [语言与语法模式](#语言与语法模式)
  + [7. 过度使用的"AI 词汇"](#7-过度使用的ai-词汇)
  + [8. 回避"is"/"are"（系动词回避）](#8-回避isare系动词回避)
  + [9. 否定并列与尾部否定](#9-否定并列与尾部否定)
  + [10. 三元规则滥用](#10-三元规则滥用)
  + [11. 优雅变体（同义词循环）](#11-优雅变体同义词循环)
  + [12. 虚假范围](#12-虚假范围)
  + [13. 被动语态与无主语片段](#13-被动语态与无主语片段)
* [风格模式](#风格模式)
  + [14. 破折号滥用](#14-破折号滥用)
  + [15. 粗体滥用](#15-粗体滥用)
  + [16. 内联标题垂直列表](#16-内联标题垂直列表)
  + [17. 标题中的标题大小写](#17-标题中的标题大小写)
...
* [沟通模式](#沟通模式)
  + [20. 协作沟通产物](#20-协作沟通产物)
  + [21. 知识截止日期免责声明](#21-知识截止日期免责声明)
  + [22. 谄媚/顺从语气](#22-谄媚顺从语气)
* [填充词与过度修饰](#填充词与过度修饰)
  + [23. 填充短语](#23-填充短语)
  + [24. 过度修饰](#24-过度修饰)
  + [25. 泛泛的积极结尾](#25-泛泛的积极结尾)
  + [26. 连字符词对滥用](#26-连字符词对滥用)
  + [27. 说服性权威套语](#27-说服性权威套语)
  + [28. 路标语和预告语](#28-路标语和预告语)
  + [29. 碎片化标题](#29-碎片化标题)
