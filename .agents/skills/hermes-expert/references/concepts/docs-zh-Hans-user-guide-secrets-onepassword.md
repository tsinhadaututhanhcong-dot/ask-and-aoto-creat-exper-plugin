# 1Password | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/secrets/onepassword](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/secrets/onepassword)
...
## Bootstrap token[​](#bootstrap-token "Bootstrap token的直接链接")
...
## Setup[​](#setup "Setup的直接链接")

### 1. Install and sign in to `op`[​](#1-install-and-sign-in-to-op "1-install-and-sign-in-to-op的直接链接")
...
### 2. Enable the integration[​](#2-enable-the-integration "2. Enable the integration的直接链接")
...
### 3. Map your credentials[​](#3-map-your-credentials "3. Map your credentials的直接链接")
...
### 4. Preview and confirm[​](#4-preview-and-confirm "4. Preview and confirm的直接链接")
...
## Failure modes[​](#failure-modes "Failure modes的直接链接")
...
## When NOT to use this[​](#when-not-to-use-this "When NOT to use this的直接链接")
...
* [Setup](#setup)
  + [1. Install and sign in to `op`](#1-install-and-sign-in-to-op)
  + [2. Enable the integration](#2-enable-the-integration)
  + [3. Map your credentials](#3-map-your-credentials)
  + [4. Preview and confirm](#4-preview-and-confirm)
* [CLI](#cli)
