...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-antigravity-cli](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-antigravity-cli)
...
## Delegation patterns[​](#delegation-patterns "Direct link to Delegation patterns")
...
### One-shot (preferred for scripted prompts and second opinions)[​](#one-shot-preferred-for-scripted-prompts-and-second-opinions "Direct link to One-shot (preferred for scripted prompts and second opinions)")
...
### Long / bounded runs (tests, builds, multi-file changes)[​](#long--bounded-runs-tests-builds-multi-file-changes "Direct link to Long / bounded runs (tests, builds, multi-file changes)")
...
### Interactive multi-turn (PTY + tmux)[​](#interactive-multi-turn-pty--tmux "Direct link to Interactive multi-turn (PTY + tmux)")
...
### Parallel instances (batch sub-issue / worktree fan-out)[​](#parallel-instances-batch-sub-issue--worktree-fan-out "Direct link to Parallel instances (batch sub-issue / worktree fan-out)")
...
### Output + bounding caveat (differs from Claude Code)[​](#output--bounding-caveat-differs-from-claude-code "Direct link to Output + bounding caveat (differs from Claude Code)")
...
### Orchestration boundary[​](#orchestration-boundary "Direct link to Orchestration boundary")
...
## Core paths[​](#core-paths "Direct link to Core paths")
...
### Wrapper commands[​](#wrapper-commands "Direct link to Wrapper commands")
...
### Useful flags[​](#useful-flags "Direct link to Useful flags")
...
### Plugin subcommands (`agy plugin --help`)[​](#plugin-subcommands-agy-plugin---help "Direct link to plugin-subcommands-agy-plugin---help")

* `list`, `import [source]`, `install <target>`, `uninstall <name>`,
  `enable <name>`, `disable <name>`, `validate [path]`, `link <mp> <target>`,
  `help`

### Install flags (`agy install --help`)[​](#install-flags-agy-install---help "Direct link to install-flags-agy-install---help")

* `--dir`, `--skip-aliases`, `--skip-path`

### In-session slash commands[​](#in-session-slash-commands "Direct link to In-session slash commands")
...
## Settings and permissions[​](#settings-and-permissions "Direct link to Settings and permissions")

### Common settings keys (`settings.json`)[​](#common-settings-keys-settingsjson "Direct link to common-settings-keys-settingsjson")
...
### Sandbox behavior[​](#sandbox-behavior "Direct link to Sandbox behavior")
...
## Authentication behavior[​](#authentication-behavior "Direct link to Authentication behavior")
...
## Support files[​](#support-files "Direct link to Support files")
