...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/software-development/software-development-code-wiki](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/software-development/software-development-code-wiki)
...
| Related skills | [`codebase-inspection`](/docs/zh-Hans/docs/user-guide/skills/bundled/github/github-codebase-inspection), [`github-repo-management`](/docs/zh-Hans/docs/user-guide/skills/bundled/github/github-github-repo-management) |
...
### 1. Resolve the target[​](#1-resolve-the-target "1. Resolve the target的直接链接")
...
### 2. Scan repo structure[​](#2-scan-repo-structure "2. Scan repo structure的直接链接")
...
### 3. Pick modules to document[​](#3-pick-modules-to-document "3. Pick modules to document的直接链接")
...
### 4. Write `README.md`[​](#4-write-readmemd "4-write-readmemd的直接链接")
...
### 5. Write `architecture.md`[​](#5-write-architecturemd "5-write-architecturemd的直接链接")
...
### 6. Write per-module docs in `modules/`[​](#6-write-per-module-docs-in-modules "6-write-per-module-docs-in-modules的直接链接")
...
### 7. Write `diagrams/class-diagram.md`[​](#7-write-diagramsclass-diagrammd "7-write-diagramsclass-diagrammd的直接链接")
...
### 8. Write `diagrams/sequences.md`[​](#8-write-diagramssequencesmd "8-write-diagramssequencesmd的直接链接")
...
### 9. Write `getting-started.md`[​](#9-write-getting-startedmd "9-write-getting-startedmd的直接链接")
...
### 10. Write `api.md` (skip if not applicable)[​](#10-write-apimd-skip-if-not-applicable "10-write-apimd-skip-if-not-applicable的直接链接")
...
### 11. Write the state file[​](#11-write-the-state-file "11. Write the state file的直接链接")
...
### 12. Report to user[​](#12-report-to-user "12. Report to user的直接链接")
...
## Scope Control[​](#scope-control "Scope Control的直接链接")
...
## Re-Run / Update[​](#re-run--update "Re-Run / Update的直接链接")
