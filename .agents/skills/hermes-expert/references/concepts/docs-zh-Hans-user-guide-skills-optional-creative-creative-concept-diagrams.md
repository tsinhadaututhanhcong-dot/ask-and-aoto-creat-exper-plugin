# 概念图 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-concept-diagrams](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-concept-diagrams)
...
| 相关 skills | [`architecture-diagram`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-architecture-diagram), [`excalidraw`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-excalidraw), `generative-widgets` |
...
### CSS 类（由模板提供）[​](#css-类由模板提供 "CSS 类（由模板提供）的直接链接")
...
## SVG 样板代码[​](#svg-样板代码 "SVG 样板代码的直接链接")
...
## 输出与预览[​](#输出与预览 "输出与预览的直接链接")

### 默认：独立 HTML 文件[​](#默认独立-html-文件 "默认：独立 HTML 文件的直接链接")
...
### 可选：本地预览服务器（多图表画廊）[​](#可选本地预览服务器多图表画廊 "可选：本地预览服务器（多图表画廊）的直接链接")
...
## 快速参考：何时使用何种图表[​](#快速参考何时使用何种图表 "快速参考：何时使用何种图表的直接链接")
...
* [设计系统](#设计系统)
  ...
  + [描边与形状](#描边与形状)
  + [箭头标记](#箭头标记)
  + [CSS 类（由模板提供）](#css-类由模板提供)
* [SVG 样板代码](#svg-样板代码)
  + [节点模式](#节点模式)
* [图表类型](#图表类型)
* [验证清单](#验证清单)
* [输出与预览](#输出与预览)
  + [默认：独立 HTML 文件](#默认独立-html-文件)
  + [可选：本地预览服务器（多图表画廊）](#可选本地预览服务器多图表画廊)
* [示例参考](#示例参考)
* [快速参考：何时使用何种图表](#快速参考何时使用何种图表)
