...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/secrets/](https://hermes-agent.nousresearch.com/docs/user-guide/secrets/)
...
## Multiple sources at once[​](#multiple-sources-at-once "Direct link to Multiple sources at once")
...
## Adding your own backend[​](#adding-your-own-backend "Direct link to Adding your own backend")
...
* [Multiple sources at once](#multiple-sources-at-once)
* [Adding your own backend](#adding-your-own-backend)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/secrets/onepassword](./docs-user-guide-secrets-onepassword.md)
