...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway)
...
## Why it's here[​](#why-its-here "Direct link to Why it's here")
...
## Mix and match[​](#mix-and-match "Direct link to Mix and match")
...
## Using individual image models[​](#using-individual-image-models "Direct link to Using individual image models")
...
### Per-tool `use_gateway` flag[​](#per-tool-use_gateway-flag "Direct link to per-tool-use_gateway-flag")
...
### Disabling the gateway[​](#disabling-the-gateway "Direct link to Disabling the gateway")
...
### Self-hosted gateway (advanced)[​](#self-hosted-gateway-advanced "Direct link to Self-hosted gateway (advanced)")
...
### Does it work with Telegram / Discord / the other messaging gateways?[​](#does-it-work-with-telegram--discord--the-other-messaging-gateways "Direct link to Does it work with Telegram / Discord / the other messaging gateways?")
...
### What happens if my subscription expires?[​](#what-happens-if-my-subscription-expires "Direct link to What happens if my subscription expires?")
...
### Can I see usage or costs per tool?[​](#can-i-see-usage-or-costs-per-tool "Direct link to Can I see usage or costs per tool?")
...
### Is Modal (serverless terminal) included?[​](#is-modal-serverless-terminal-included "Direct link to Is Modal (serverless terminal) included?")
...
### Do I need to delete my existing API keys when I enable the gateway?[​](#do-i-need-to-delete-my-existing-api-keys-when-i-enable-the-gateway "Direct link to Do I need to delete my existing API keys when I enable the gateway?")
...
* [Why it's here](#why-its-here)
* [Get started](#get-started)
* [Eligibility](#eligibility)
* [Mix and match](#mix-and-match)
* [Using individual image models](#using-individual-image-models)
* [Configuration reference](#configuration-reference)
  + [Per-tool `use_gateway` flag](#per-tool-use_gateway-flag)
  + [Disabling the gateway](#disabling-the-gateway)
  + [Self-hosted gateway (advanced)](#self-hosted-gateway-advanced)
* [FAQ](#faq)
  + [Does it work with Telegram / Discord / the other messaging gateways?](#does-it-work-with-telegram--discord--the-other-messaging-gateways)
  + [What happens if my subscription expires?](#what-happens-if-my-subscription-expires)
  + [Can I see usage or costs per tool?](#can-i-see-usage-or-costs-per-tool)
  + [Is Modal (serverless terminal) included?](#is-modal-serverless-terminal-included)
  + [Do I need to delete my existing API keys when I enable the gateway?](#do-i-need-to-delete-my-existing-api-keys-when-i-enable-the-gateway)