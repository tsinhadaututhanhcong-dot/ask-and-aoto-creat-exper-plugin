...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/acp](https://hermes-agent.nousresearch.com/docs/user-guide/features/acp)
...
### Browser tools (optional)[​](#browser-tools-optional "Direct link to Browser tools (optional)")
...
### Session-scoped edit auto-approval[​](#session-scoped-edit-auto-approval "Direct link to Session-scoped edit auto-approval")
...
### Zed registry launcher cannot find uv[​](#zed-registry-launcher-cannot-find-uv "Direct link to Zed registry launcher cannot find uv")
