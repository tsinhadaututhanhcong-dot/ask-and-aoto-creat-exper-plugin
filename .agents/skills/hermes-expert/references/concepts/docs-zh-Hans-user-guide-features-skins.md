# 皮肤与主题 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins)
...
## 可配置键完整列表[​](#可配置键完整列表 "可配置键完整列表的直接链接")

### 颜色（`colors:`）[​](#颜色colors "颜色colors的直接链接")
...
### Spinner（`spinner:`）[​](#spinnerspinner "spinnerspinner的直接链接")
...
### 品牌（`branding:`）[​](#品牌branding "品牌branding的直接链接")
...
### 最简自定义皮肤示例[​](#最简自定义皮肤示例 "最简自定义皮肤示例的直接链接")
...
## Hermes Mod — 可视化皮肤编辑器[​](#hermes-mod--可视化皮肤编辑器 "Hermes Mod — 可视化皮肤编辑器的直接链接")
...
Hermes Mod 遵循 `HERMES_HOME` 环境变量，因此也适用于[配置文件](/docs/zh-Hans/user-guide/profiles)。
...
* [可配置键完整列表](#可配置键完整列表)
  + [颜色（`colors:`）](#颜色colors)
  + [Spinner（`spinner:`）](#spinnerspinner)
  + [品牌（`branding:`）](#品牌branding)
  + [其他顶级键](#其他顶级键)
* [自定义皮肤](#自定义皮肤)
  + [完整自定义皮肤 YAML 模板](#完整自定义皮肤-yaml-模板)
  + [最简自定义皮肤示例](#最简自定义皮肤示例)
* [Hermes Mod — 可视化皮肤编辑器](#hermes-mod--可视化皮肤编辑器)
  + [安装](#安装)
  + [使用方法](#使用方法)
* [操作说明](#操作说明)
