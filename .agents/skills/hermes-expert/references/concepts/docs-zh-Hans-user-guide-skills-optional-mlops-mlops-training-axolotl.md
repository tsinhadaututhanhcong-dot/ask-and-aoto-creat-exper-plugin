# Axolotl — Axolotl：基于 YAML 的 LLM 微调（LoRA、DPO、GRPO） | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-axolotl](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-axolotl)
