# Context Engine 插件 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin)
...
## ContextEngine ABC[​](#contextengine-abc "ContextEngine ABC的直接链接")
...
### 引擎必须维护的类属性[​](#引擎必须维护的类属性 "引擎必须维护的类属性的直接链接")
...
| `update_model(model, context_length, ...)` | 更新 context\_length 和阈值 | 需要在切换模型时重新计算预算时 |
...
* [上下文压缩与缓存](/docs/zh-Hans/developer-guide/context-compression-and-caching) — 内置压缩器的工作原理
* [Memory Provider 插件](/docs/zh-Hans/developer-guide/memory-provider-plugin) — 类似的单选插件系统（用于内存）
* [插件](/docs/zh-Hans/user-guide/features/plugins) — 通用插件系统概述

* [工作原理](#工作原理)
* [目录结构](#目录结构)
* [ContextEngine ABC](#contextengine-abc)
  + [引擎必须维护的类属性](#引擎必须维护的类属性)
  + [可选方法](#可选方法)
* [引擎工具](#引擎工具)
* [注册](#注册)
  + [通过目录（推荐）](#通过目录推荐)
