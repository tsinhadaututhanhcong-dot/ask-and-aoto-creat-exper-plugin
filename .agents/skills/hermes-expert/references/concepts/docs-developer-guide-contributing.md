...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/contributing](https://hermes-agent.nousresearch.com/docs/developer-guide/contributing)
...
### Install with the standard installer[​](#install-with-the-standard-installer "Direct link to Install with the standard installer")
...
### Manual clone fallback[​](#manual-clone-fallback "Direct link to Manual clone fallback")
...
* [Development Setup](#development-setup)
  ...
  + [Install with the standard installer](#install-with-the-standard-installer)
  + [Manual clone fallback](#manual-clone-fallback)
