...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/plugin-llm-access](https://hermes-agent.nousresearch.com/docs/developer-guide/plugin-llm-access)
...
## The smallest possible call[​](#the-smallest-possible-call "Direct link to The smallest possible call")
...
## A more complete chat example[​](#a-more-complete-chat-example "Direct link to A more complete chat example")
...
## What this lane gives you[​](#what-this-lane-gives-you "Direct link to What this lane gives you")
...
### Chat completion — `/tldr`[​](#chat-completion--tldr "Direct link to chat-completion--tldr")
...
### Structured extraction — `/paste-to-tasks`[​](#structured-extraction--paste-to-tasks "Direct link to structured-extraction--paste-to-tasks")
...
## API surface[​](#api-surface "Direct link to API surface")

`ctx.llm` is an instance of `agent.plugin_llm.PluginLlm`.

### `complete()`[​](#complete "Direct link to complete")
...
### `complete_structured()`[​](#complete_structured "Direct link to complete_structured")
...
### Result attributes[​](#result-attributes "Direct link to Result attributes")
...
## Trust gate[​](#trust-gate "Direct link to Trust gate")
...
### What the gate enforces[​](#what-the-gate-enforces "Direct link to What the gate enforces")
...
### What the gate does NOT need to enforce[​](#what-the-gate-does-not-need-to-enforce "Direct link to What the gate does NOT need to enforce")
...
## What the host owns[​](#what-the-host-owns "Direct link to What the host owns")
...
## What the plugin owns[​](#what-the-plugin-owns "Direct link to What the plugin owns")
...
## Where this fits in the plugin surface[​](#where-this-fits-in-the-plugin-surface "Direct link to Where this fits in the plugin surface")
...
* [The smallest possible call](#the-smallest-possible-call)
* [A more complete chat example](#a-more-complete-chat-example)
* [Structured output](#structured-output)
* [What this lane gives you](#what-this-lane-gives-you)
* [Quick start](#quick-start)
  + [Chat completion — `/tldr`](#chat-completion--tldr)
  + [Structured extraction — `/paste-to-tasks`](#structured-extraction--paste-to-tasks)
...
* [Trust gate](#trust-gate)
  + [What the gate enforces](#what-the-gate-enforces)
  + [What the gate does NOT need to enforce](#what-the-gate-does-not-need-to-enforce)
* [What the host owns](#what-the-host-owns)
* [What the plugin owns](#what-the-plugin-owns)
* [Where this fits in the plugin surface](#where-this-fits-in-the-plugin-surface)
* [Reference](#reference)

## Related Files
> **LLM Navigation:** Các tệp dưới đây được liên kết trực tiếp từ tài liệu này. Hãy đọc chúng nếu cần thêm ngữ cảnh.

- [https://hermes-agent.nousresearch.com/docs/developer-guide/provider-runtime](./docs-developer-guide-provider-runtime.md)
