# Serving Llms Vllm — vLLM：高吞吐量 LLM 服务、OpenAI API、量化 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/mlops/mlops-inference-vllm](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/mlops/mlops-inference-vllm)
...
### 工作流 1：生产 API 部署[​](#工作流-1生产-api-部署 "工作流 1：生产 API 部署的直接链接")
...
### 工作流 2：离线批量推理[​](#工作流-2离线批量推理 "工作流 2：离线批量推理的直接链接")
...
### 工作流 3：量化模型服务[​](#工作流-3量化模型服务 "工作流 3：量化模型服务的直接链接")
...
* [快速开始](#快速开始)
* [常见工作流](#常见工作流)
  + [工作流 1：生产 API 部署](#工作流-1生产-api-部署)
  + [工作流 2：离线批量推理](#工作流-2离线批量推理)
  + [工作流 3：量化模型服务](#工作流-3量化模型服务)
* [与替代方案的对比](#与替代方案的对比)
* [常见问题](#常见问题)
* [高级主题](#高级主题)
* [硬件要求](#硬件要求)
