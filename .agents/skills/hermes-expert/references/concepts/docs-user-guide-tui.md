# TUI | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/tui](https://hermes-agent.nousresearch.com/docs/user-guide/tui)
...
### Collapsible banner sections[​](#collapsible-banner-sections "Direct link to Collapsible banner sections")
...
## Live session switcher[​](#live-session-switcher "Direct link to Live session switcher")
...
[](/img/docs/tui-session-orchestrator/session-orchestrator-demo.mp4)
...
## How the TUI talks to its gateway[​](#how-the-tui-talks-to-its-gateway "Direct link to How the TUI talks to its gateway")
