...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-meme-generation](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-meme-generation)
...
### Mode 2: Custom AI Image (when image\_generate is available)[​](#mode-2-custom-ai-image-when-image_generate-is-available "Direct link to Mode 2: Custom AI Image (when image_generate is available)")
...
* [Procedure](#procedure)
  ...
  + [Mode 2: Custom AI Image (when image\_generate is available)](#mode-2-custom-ai-image-when-image_generate-is-available)
* [Examples](#examples)
