...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline)
...
### 状态与检查（从这里开始）[​](#状态与检查从这里开始 "状态与检查（从这里开始）的直接链接")
...
## 关键注意事项：Graph 订阅 72 小时后过期[​](#关键注意事项graph-订阅-72-小时后过期 "关键注意事项：Graph 订阅 72 小时后过期的直接链接")
...
* [前置条件](#前置条件)
* [命令参考](#命令参考)
  + [状态与检查（从这里开始）](#状态与检查从这里开始)
  + [重新运行 / 调试](#重新运行--调试)
  + [订阅管理](#订阅管理)
* [常见问题决策树](#常见问题决策树)
* [关键注意事项：Graph 订阅 72 小时后过期](#关键注意事项graph-订阅-72-小时后过期)
* [其他注意事项](#其他注意事项)
* [相关文档](#相关文档)