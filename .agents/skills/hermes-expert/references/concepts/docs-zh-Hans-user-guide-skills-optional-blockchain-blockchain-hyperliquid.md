# Hyperliquid — Hyperliquid 市场数据、账户历史、交易复盘 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/blockchain/blockchain-hyperliquid](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/blockchain/blockchain-hyperliquid)
...
### 1. 发现 DEX 和市场[​](#1-发现-dex-和市场 "1. 发现 DEX 和市场的直接链接")
...
### 2. 拉取历史市场数据[​](#2-拉取历史市场数据 "2. 拉取历史市场数据的直接链接")
...
### 3. 查看实时盘口[​](#3-查看实时盘口 "3. 查看实时盘口的直接链接")
...
### 4. 查看账户信息[​](#4-查看账户信息 "4. 查看账户信息的直接链接")
...
### 5. 查看成交记录和挂单[​](#5-查看成交记录和挂单 "5. 查看成交记录和挂单的直接链接")
...
### 6. 生成交易复盘报告[​](#6-生成交易复盘报告 "6. 生成交易复盘报告的直接链接")
...
### 7. 导出可复用数据集[​](#7-导出可复用数据集 "7. 导出可复用数据集的直接链接")
...
* [快速参考](#快速参考)
* [操作流程](#操作流程)
  + [1. 发现 DEX 和市场](#1-发现-dex-和市场)
  + [2. 拉取历史市场数据](#2-拉取历史市场数据)
  + [3. 查看实时盘口](#3-查看实时盘口)
  + [4. 查看账户信息](#4-查看账户信息)
  + [5. 查看成交记录和挂单](#5-查看成交记录和挂单)
  + [6. 生成交易复盘报告](#6-生成交易复盘报告)
  + [7. 导出可复用数据集](#7-导出可复用数据集)
* [注意事项](#注意事项)
* [验证](#验证)