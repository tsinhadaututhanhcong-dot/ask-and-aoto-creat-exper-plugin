# 将 Hermes 作为 Python 库使用 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/python-library](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/python-library)
...
## 自定义系统 Prompt[​](#自定义系统-prompt "自定义系统 Prompt的直接链接")
...
### FastAPI 端点[​](#fastapi-端点 "FastAPI 端点的直接链接")
...
### Discord 机器人[​](#discord-机器人 "Discord 机器人的直接链接")
...
### CI/CD 流水线步骤[​](#cicd-流水线步骤 "CI/CD 流水线步骤的直接链接")
...
## 关键构造函数参数[​](#关键构造函数参数 "关键构造函数参数的直接链接")
...
* [批量处理](#批量处理)
* [集成示例](#集成示例)
  + [FastAPI 端点](#fastapi-端点)
  + [Discord 机器人](#discord-机器人)
  + [CI/CD 流水线步骤](#cicd-流水线步骤)
* [关键构造函数参数](#关键构造函数参数)
* [重要说明](#重要说明)