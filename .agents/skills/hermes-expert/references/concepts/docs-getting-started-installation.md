...
**Source:** [https://hermes-agent.nousresearch.com/docs/getting-started/installation](https://hermes-agent.nousresearch.com/docs/getting-started/installation)
...
platform-gated features are supported), see **[Platform Support](/docs/getting-started/platform-support)**.

## Quick Install[​](#quick-install "Direct link to Quick Install")

### With the Hermes Desktop installer on macOS or Windows (recommended)[​](#with-the-hermes-desktop-installer-on-macos-or-windows-recommended "Direct link to With the Hermes Desktop installer on macOS or Windows (recommended)")
...
## Non-Sudo / System Service User Installs[​](#non-sudo--system-service-user-installs "Direct link to Non-Sudo / System Service User Installs")
...
## Install method auto-detection[​](#install-method-auto-detection "Direct link to Install method auto-detection")
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/contributing](./docs-developer-guide-contributing.md)
