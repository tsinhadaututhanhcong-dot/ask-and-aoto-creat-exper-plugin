...
**Source:** [https://hermes-agent.nousresearch.com/docs/integrations/nous-portal](https://hermes-agent.nousresearch.com/docs/integrations/nous-portal)
...
## What's in the subscription[​](#whats-in-the-subscription "Direct link to What's in the subscription")

### 300+ frontier models, one bill[​](#300-frontier-models-one-bill "Direct link to 300+ frontier models, one bill")
...
### The Nous Tool Gateway[​](#the-nous-tool-gateway "Direct link to The Nous Tool Gateway")
...
### Nous Chat[​](#nous-chat "Direct link to Nous Chat")
...
### No credentials in your dotfiles[​](#no-credentials-in-your-dotfiles "Direct link to No credentials in your dotfiles")
...
### Cross-platform parity[​](#cross-platform-parity "Direct link to Cross-platform parity")
...
## A note on Hermes 4[​](#a-note-on-hermes-4 "Direct link to A note on Hermes 4")
...
### Fresh install — one command[​](#fresh-install--one-command "Direct link to Fresh install — one command")
...
### Existing install — add Portal alongside other providers[​](#existing-install--add-portal-alongside-other-providers "Direct link to Existing install — add Portal alongside other providers")
...
### Headless / SSH / remote setup[​](#headless--ssh--remote-setup "Direct link to Headless / SSH / remote setup")
...
### Profile setup[​](#profile-setup "Direct link to Profile setup")
...
## Using the Portal day-to-day[​](#using-the-portal-day-to-day "Direct link to Using the Portal day-to-day")

### Inspecting what's wired up[​](#inspecting-whats-wired-up "Direct link to Inspecting what's wired up")
...
### Mixing the gateway with your own backends[​](#mixing-the-gateway-with-your-own-backends "Direct link to Mixing the gateway with your own backends")
...
### Subscription management[​](#subscription-management "Direct link to Subscription management")
...
### `hermes portal info` shows "not logged in"[​](#hermes-portal-info-shows-not-logged-in "Direct link to hermes-portal-info-shows-not-logged-in")
...
### Got a "re-authentication required" message mid-session[​](#got-a-re-authentication-required-message-mid-session "Direct link to Got a \"re-authentication required\" message mid-session")
...
### Want to use a specific provider model that the Portal doesn't expose[​](#want-to-use-a-specific-provider-model-that-the-portal-doesnt-expose "Direct link to Want to use a specific provider model that the Portal doesn't expose")
...
### Bills not appearing on my Portal account[​](#bills-not-appearing-on-my-portal-account "Direct link to Bills not appearing on my Portal account")
...
* [What's in the subscription](#whats-in-the-subscription)
  + [300+ frontier models, one bill](#300-frontier-models-one-bill)
  + [The Nous Tool Gateway](#the-nous-tool-gateway)
  + [Nous Chat](#nous-chat)
  + [No credentials in your dotfiles](#no-credentials-in-your-dotfiles)
  + [Cross-platform parity](#cross-platform-parity)
* [A note on Hermes 4](#a-note-on-hermes-4)
* [Setup](#setup)
  + [Fresh install — one command](#fresh-install--one-command)
  + [Existing install — add Portal alongside other providers](#existing-install--add-portal-alongside-other-providers)
  + [Headless / SSH / remote setup](#headless--ssh--remote-setup)
  + [Profile setup](#profile-setup)
* [Using the Portal day-to-day](#using-the-portal-day-to-day)
  + [Inspecting what's wired up](#inspecting-whats-wired-up)
  + [Switching models](#switching-models)
  + [Mixing the gateway with your own backends](#mixing-the-gateway-with-your-own-backends)
  + [Subscription management](#subscription-management)
* [Configuration reference](#configuration-reference)
* [Token handling](#token-handling)
* [Troubleshooting](#troubleshooting)
  + [`hermes portal info` shows "not logged in"](#hermes-portal-info-shows-not-logged-in)
  + [Got a "re-authentication required" message mid-session](#got-a-re-authentication-required-message-mid-session)
  + [Want to use a specific provider model that the Portal doesn't expose](#want-to-use-a-specific-provider-model-that-the-portal-doesnt-expose)
