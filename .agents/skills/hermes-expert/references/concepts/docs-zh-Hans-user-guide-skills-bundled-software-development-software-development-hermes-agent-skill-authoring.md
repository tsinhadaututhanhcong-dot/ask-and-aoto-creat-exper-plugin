# Hermes Agent Skill 编写——在仓库中编写 SKILL | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-hermes-agent-skill-authoring](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-hermes-agent-skill-authoring)
...
| 相关 skill | [`writing-plans`](/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-writing-plans), [`requesting-code-review`](/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-requesting-code-review) |
...
## 必需的 Frontmatter[​](#必需的-frontmatter "必需的 Frontmatter的直接链接")
...
## 交叉引用其他 Skill[​](#交叉引用其他-skill "交叉引用其他 Skill的直接链接")
...
## 编辑现有仓库内 Skill[​](#编辑现有仓库内-skill "编辑现有仓库内 Skill的直接链接")
...
* [概述](#概述)
* [使用时机](#使用时机)
* [必需的 Frontmatter](#必需的-frontmatter)
* [大小限制](#大小限制)
* [对等匹配结构](#对等匹配结构)
* [目录放置](#目录放置)
* [工作流](#工作流)
* [交叉引用其他 Skill](#交叉引用其他-skill)
* [编辑现有仓库内 Skill](#编辑现有仓库内-skill)
* [常见问题](#常见问题)
* [验证清单](#验证清单)
