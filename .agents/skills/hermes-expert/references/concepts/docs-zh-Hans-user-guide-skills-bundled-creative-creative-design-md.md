# Design Md — 编写/验证/导出 Google 的 DESIGN | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-design-md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-design-md)
...
| 相关 skill | [`popular-web-designs`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-popular-web-designs), [`claude-design`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-claude-design), [`excalidraw`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-excalidraw), [`architecture-diagram`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-architecture-diagram) |
...
## Token 类型[​](#token-类型 "Token 类型的直接链接")
...
## 工作流：编写新的 DESIGN.md[​](#工作流编写新的-designmd "工作流：编写新的 DESIGN.md的直接链接")
...
## 工作流：lint / diff / 导出[​](#工作流lint--diff--导出 "工作流：lint / diff / 导出的直接链接")
...
### Lint 规则参考（7 条规则的检查内容）[​](#lint-规则参考7-条规则的检查内容 "Lint 规则参考（7 条规则的检查内容）的直接链接")
...
* 仓库：[https://github.com/google-labs-code/design.md（Apache-2.0）](https://github.com/google-labs-code/design.md%EF%BC%88Apache-2.0%EF%BC%89)
...
* [Token 类型](#token-类型)
* [规范章节顺序](#规范章节顺序)
* [工作流：编写新的 DESIGN.md](#工作流编写新的-designmd)
* [工作流：lint / diff / 导出](#工作流lint--diff--导出)
  + [Lint 规则参考（7 条规则的检查内容）](#lint-规则参考7-条规则的检查内容)
* [常见陷阱](#常见陷阱)
* [规范来源](#规范来源)
