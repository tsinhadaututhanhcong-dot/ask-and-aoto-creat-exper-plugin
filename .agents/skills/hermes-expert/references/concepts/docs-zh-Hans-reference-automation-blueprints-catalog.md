...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/automation-blueprints-catalog](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/automation-blueprints-catalog)
...
## Writing your own[​](#writing-your-own "Writing your own的直接链接")

A blueprint is just a skill with a `metadata.hermes.blueprint` block in its
`SKILL.md` frontmatter. See
[Creating Skills → Automation Blueprints](/docs/zh-Hans/developer-guide/creating-skills.md) for the
