# ACP 内部机制 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/acp-internals](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/acp-internals)
...
### `HermesACPAgent`[​](#hermesacpagent "hermesacpagent的直接链接")
...
### `SessionManager`[​](#sessionmanager "sessionmanager的直接链接")
...
## Provider/认证行为[​](#provider认证行为 "Provider/认证行为的直接链接")
