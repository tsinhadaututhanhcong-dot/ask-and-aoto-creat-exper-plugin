...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-excel-author](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-excel-author)
...
## Core conventions (non-negotiable)[​](#core-conventions-non-negotiable "Direct link to Core conventions (non-negotiable)")

### Blue / black / green cell color[​](#blue--black--green-cell-color "Direct link to Blue / black / green cell color")
...
### Formulas over hardcodes[​](#formulas-over-hardcodes "Direct link to Formulas over hardcodes")
...
### Named ranges for cross-sheet references[​](#named-ranges-for-cross-sheet-references "Direct link to Named ranges for cross-sheet references")
...
### Balance checks tab[​](#balance-checks-tab "Direct link to Balance checks tab")
...
### Cell comments on every hardcoded input[​](#cell-comments-on-every-hardcoded-input "Direct link to Cell comments on every hardcoded input")
...
## Skeleton: typical financial model[​](#skeleton-typical-financial-model "Direct link to Skeleton: typical financial model")
...
## Section headers with merged cells[​](#section-headers-with-merged-cells "Direct link to Section headers with merged cells")
...
## Recalculating before delivery[​](#recalculating-before-delivery "Direct link to Recalculating before delivery")
...
## Model layout planning[​](#model-layout-planning "Direct link to Model layout planning")
...
## Verify step-by-step with the user[​](#verify-step-by-step-with-the-user "Direct link to Verify step-by-step with the user")
...
* [Setup](#setup)
* [Core conventions (non-negotiable)](#core-conventions-non-negotiable)
  + [Blue / black / green cell color](#blue--black--green-cell-color)
  + [Formulas over hardcodes](#formulas-over-hardcodes)
  + [Named ranges for cross-sheet references](#named-ranges-for-cross-sheet-references)
  + [Balance checks tab](#balance-checks-tab)
  + [Cell comments on every hardcoded input](#cell-comments-on-every-hardcoded-input)
* [Skeleton: typical financial model](#skeleton-typical-financial-model)
* [Section headers with merged cells](#section-headers-with-merged-cells)
* [Sensitivity tables](#sensitivity-tables)
* [Recalculating before delivery](#recalculating-before-delivery)
* [Model layout planning](#model-layout-planning)
* [Verify step-by-step with the user](#verify-step-by-step-with-the-user)
