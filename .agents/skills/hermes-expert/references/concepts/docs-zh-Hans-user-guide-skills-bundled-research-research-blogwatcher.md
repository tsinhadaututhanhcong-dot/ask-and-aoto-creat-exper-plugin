# Blogwatcher — 通过 blogwatcher-cli 工具监控博客和 RSS/Atom 订阅源 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-blogwatcher](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-blogwatcher)
...
### Docker 持久化存储[​](#docker-持久化存储 "Docker 持久化存储的直接链接")
...
### 从原版 blogwatcher 迁移[​](#从原版-blogwatcher-迁移 "从原版 blogwatcher 迁移的直接链接")
...
* [安装](#安装)
  + [Docker 持久化存储](#docker-持久化存储)
  + [从原版 blogwatcher 迁移](#从原版-blogwatcher-迁移)
* [常用命令](#常用命令)
  + [管理博客](#管理博客)
  + [扫描与阅读](#扫描与阅读)
* [环境变量](#环境变量)
