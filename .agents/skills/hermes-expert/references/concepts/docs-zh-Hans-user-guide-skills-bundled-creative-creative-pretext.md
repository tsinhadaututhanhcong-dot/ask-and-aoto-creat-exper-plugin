...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pretext](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pretext)
...
| 相关 skill | [`p5js`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-p5js), [`claude-design`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-claude-design), [`excalidraw`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-excalidraw), [`architecture-diagram`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-architecture-diagram) |
...
## 两种使用场景[​](#两种使用场景 "两种使用场景的直接链接")

几乎所有需求都归结为以下两种形态之一。两种都要掌握。

### 场景 1 —— 测量，然后用 CSS/DOM 渲染[​](#场景-1--测量然后用-cssdom-渲染 "场景 1 —— 测量，然后用 CSS/DOM 渲染的直接链接")
...
### 场景 2 —— 自行测量*并*渲染[​](#场景-2--自行测量并渲染 "场景-2--自行测量并渲染的直接链接")
...
### 值得了解的辅助函数[​](#值得了解的辅助函数 "值得了解的辅助函数的直接链接")
...
* [技术栈](#技术栈)
* [两种使用场景](#两种使用场景)
  + [场景 1 —— 测量，然后用 CSS/DOM 渲染](#场景-1--测量然后用-cssdom-渲染)
  + [场景 2 —— 自行测量*并*渲染](#场景-2--自行测量并渲染)
  + [值得了解的辅助函数](#值得了解的辅助函数)
* [演示配方模式](#演示配方模式)
* [工作流程](#工作流程)
* [性能说明](#性能说明)
