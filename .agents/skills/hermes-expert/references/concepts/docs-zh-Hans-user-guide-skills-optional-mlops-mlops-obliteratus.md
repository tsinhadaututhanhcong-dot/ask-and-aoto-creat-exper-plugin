...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-obliteratus](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-obliteratus)
...
| Related skills | `vllm`, `gguf`, [`huggingface-tokenizers`](/docs/zh-Hans/docs/user-guide/skills/optional/mlops/mlops-huggingface-tokenizers) |
...
## What's inside[​](#whats-inside "What's inside的直接链接")
...
## Video Guide[​](#video-guide "Video Guide的直接链接")
...
## Step 1: Installation[​](#step-1-installation "Step 1: Installation的直接链接")
...
## Step 2: Check Hardware[​](#step-2-check-hardware "Step 2: Check Hardware的直接链接")
...
### VRAM Requirements (with 4-bit quantization)[​](#vram-requirements-with-4-bit-quantization "VRAM Requirements (with 4-bit quantization)的直接链接")
...
## Step 3: Browse Available Models & Get Recommendations[​](#step-3-browse-available-models--get-recommendations "Step 3: Browse Available Models & Get Recommendations的直接链接")
...
## Step 4: Choose a Method[​](#step-4-choose-a-method "Step 4: Choose a Method的直接链接")

### Method Selection Guide[​](#method-selection-guide "Method Selection Guide的直接链接")
...
### 9 CLI Methods[​](#9-cli-methods "9 CLI Methods的直接链接")
...
### Direction Extraction Methods (--direction-method flag)[​](#direction-extraction-methods---direction-method-flag "Direction Extraction Methods (--direction-method flag)的直接链接")
...
### 4 Python-API-Only Methods[​](#4-python-api-only-methods "4 Python-API-Only Methods的直接链接")
...
## Step 5: Run Abliteration[​](#step-5-run-abliteration "Step 5: Run Abliteration的直接链接")

### Standard usage[​](#standard-usage "Standard usage的直接链接")
...
### Fine-tuning parameters[​](#fine-tuning-parameters "Fine-tuning parameters的直接链接")
...
### Key flags[​](#key-flags "Key flags的直接链接")

| Flag | Description | Default |
| --- | --- | --- |
| `--method` | Abliteration method | advanced |
| `--direction-method` | Direction extraction | diff\_means |
...
| `--output-dir` | Where to save the abliterated model | ./obliterated\_model |
...
### Other execution modes[​](#other-execution-modes "Other execution modes的直接链接")
...
## Step 6: Verify Results[​](#step-6-verify-results "Step 6: Verify Results的直接链接")
...
### If refusals persist (> 10%)[​](#if-refusals-persist--10 "If refusals persist (> 10%)的直接链接")
...
### If coherence is damaged (perplexity > 15% increase)[​](#if-coherence-is-damaged-perplexity--15-increase "If coherence is damaged (perplexity > 15% increase)的直接链接")
...
## Step 7: Use the Abliterated Model[​](#step-7-use-the-abliterated-model "Step 7: Use the Abliterated Model的直接链接")
...
## CLI Command Reference[​](#cli-command-reference "CLI Command Reference的直接链接")
...
## Analysis Modules[​](#analysis-modules "Analysis Modules的直接链接")
...
### Quick analysis commands[​](#quick-analysis-commands "Quick analysis commands的直接链接")
...
### Steering Vectors (Reversible Alternative)[​](#steering-vectors-reversible-alternative "Steering Vectors (Reversible Alternative)的直接链接")
...
## Ablation Strategies[​](#ablation-strategies "Ablation Strategies的直接链接")
...
## Platform Support[​](#platform-support "Platform Support的直接链接")

* **CUDA** — Full support (NVIDIA GPUs)
* **Apple Silicon (MLX)** — Supported via MLX backend
* **CPU** — Supported for tiny models (< 1B params)

## YAML Config Templates[​](#yaml-config-templates "YAML Config Templates的直接链接")
...
## Telemetry[​](#telemetry "Telemetry的直接链接")
...
## Complementary Skills[​](#complementary-skills "Complementary Skills的直接链接")
