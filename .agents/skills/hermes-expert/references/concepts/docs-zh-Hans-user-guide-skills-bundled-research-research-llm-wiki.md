# Llm Wiki — Karpathy 的 LLM Wiki：构建/查询互联 Markdown 知识库 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki)
...
| 相关 skill | [`obsidian`](/docs/zh-Hans/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`arxiv`](/docs/zh-Hans/user-guide/skills/bundled/research/research-arxiv) |
...
## 此 Skill 的激活时机[​](#此-skill-的激活时机 "此 Skill 的激活时机的直接链接")
...
## 恢复已有 Wiki（关键——每次会话都必须执行）[​](#恢复已有-wiki关键每次会话都必须执行 "恢复已有 Wiki（关键——每次会话都必须执行）的直接链接")
...
## 初始化新 Wiki[​](#初始化新-wiki "初始化新 Wiki的直接链接")
...
### SCHEMA.md 模板[​](#schemamd-模板 "SCHEMA.md 模板的直接链接")
...
### raw/ Frontmatter[​](#raw-frontmatter "raw/ Frontmatter的直接链接")
...
## Tag Taxonomy[​](#tag-taxonomy "Tag Taxonomy的直接链接")
...
## Page Thresholds[​](#page-thresholds "Page Thresholds的直接链接")
...
## Entity Pages[​](#entity-pages "Entity Pages的直接链接")
...
## Concept Pages[​](#concept-pages "Concept Pages的直接链接")
...
## Comparison Pages[​](#comparison-pages "Comparison Pages的直接链接")
...
## Update Policy[​](#update-policy "Update Policy的直接链接")
...
### log.md 模板[​](#logmd-模板 "log.md 模板的直接链接")
...
### 1. 摄入（Ingest）[​](#1-摄入ingest "1. 摄入（Ingest）的直接链接")
...
### 2. 查询（Query）[​](#2-查询query "2. 查询（Query）的直接链接")
...
## Wiki 使用方法[​](#wiki-使用方法 "Wiki 使用方法的直接链接")
...
### Obsidian 集成[​](#obsidian-集成 "Obsidian 集成的直接链接")
...
### Obsidian 无头模式（服务器和无显示器机器）[​](#obsidian-无头模式服务器和无显示器机器 "Obsidian 无头模式（服务器和无显示器机器）的直接链接")
...
* [此 Skill 的激活时机](#此-skill-的激活时机)
* [Wiki 位置](#wiki-位置)
* [架构：三层结构](#架构三层结构)
* [恢复已有 Wiki（关键——每次会话都必须执行）](#恢复已有-wiki关键每次会话都必须执行)
* [初始化新 Wiki](#初始化新-wiki)
  + [SCHEMA.md 模板](#schemamd-模板)
...
* [Update Policy](#update-policy)
  + [log.md 模板](#logmd-模板)
* [核心操作](#核心操作)
  + [1. 摄入（Ingest）](#1-摄入ingest)
  + [2. 查询（Query）](#2-查询query)
  + [3. Lint](#3-lint)
* [Wiki 使用方法](#wiki-使用方法)
  + [搜索](#搜索)
  + [批量摄入](#批量摄入)
  ...
  + [Obsidian 无头模式（服务器和无显示器机器）](#obsidian-无头模式服务器和无显示器机器)
* [注意事项](#注意事项)
* [相关工具](#相关工具)
