...
**Source:** [https://hermes-agent.nousresearch.com/docs/guides/run-hermes-with-nous-portal](https://hermes-agent.nousresearch.com/docs/guides/run-hermes-with-nous-portal)
...
## 1. Get a subscription[​](#1-get-a-subscription "Direct link to 1. Get a subscription")
...
## 2. Run the one-shot setup[​](#2-run-the-one-shot-setup "Direct link to 2. Run the one-shot setup")
...
### What if I'm SSH'd into a server?[​](#what-if-im-sshd-into-a-server "Direct link to What if I'm SSH'd into a server?")
...
## 3. Verify it worked[​](#3-verify-it-worked "Direct link to 3. Verify it worked")
...
## 4. Run your first conversation[​](#4-run-your-first-conversation "Direct link to 4. Run your first conversation")
...
## 5. Pick the model you actually want[​](#5-pick-the-model-you-actually-want "Direct link to 5. Pick the model you actually want")
...
### Don't pick Hermes-4 for agent work[​](#dont-pick-hermes-4-for-agent-work "Direct link to Don't pick Hermes-4 for agent work")
...
## 6. (Optional) Customize Tool Gateway routing[​](#6-optional-customize-tool-gateway-routing "Direct link to 6. (Optional) Customize Tool Gateway routing")
...
## 7. (Optional) Enable voice mode[​](#7-optional-enable-voice-mode "Direct link to 7. (Optional) Enable voice mode")
...
## 8. (Optional) Cron + always-on workflows[​](#8-optional-cron--always-on-workflows "Direct link to 8. (Optional) Cron + always-on workflows")
...
## Profiles and multi-user setups[​](#profiles-and-multi-user-setups "Direct link to Profiles and multi-user setups")
...
### `hermes portal info` shows "not logged in" after `hermes setup --portal`[​](#hermes-portal-info-shows-not-logged-in-after-hermes-setup---portal "Direct link to hermes-portal-info-shows-not-logged-in-after-hermes-setup---portal")
...
### "Model: currently openrouter" (or some other provider) instead of "using Nous as inference provider"[​](#model-currently-openrouter-or-some-other-provider-instead-of-using-nous-as-inference-provider "Direct link to \"Model: currently openrouter\" (or some other provider) instead of \"using Nous as inference provider\"")
...
### Tool Gateway tools showing partner names instead of "via Nous Portal"[​](#tool-gateway-tools-showing-partner-names-instead-of-via-nous-portal "Direct link to Tool Gateway tools showing partner names instead of \"via Nous Portal\"")
...
### "Re-authentication required" mid-session[​](#re-authentication-required-mid-session "Direct link to \"Re-authentication required\" mid-session")
...
### Model I want isn't in the `/model` picker[​](#model-i-want-isnt-in-the-model-picker "Direct link to model-i-want-isnt-in-the-model-picker")
...
### Billing not appearing on my Portal account[​](#billing-not-appearing-on-my-portal-account "Direct link to Billing not appearing on my Portal account")
...
### Want to revoke and start clean[​](#want-to-revoke-and-start-clean "Direct link to Want to revoke and start clean")
...
## What this gets you, in plain numbers[​](#what-this-gets-you-in-plain-numbers "Direct link to What this gets you, in plain numbers")
...
* [1. Get a subscription](#1-get-a-subscription)
* [2. Run the one-shot setup](#2-run-the-one-shot-setup)
  + [What if I'm SSH'd into a server?](#what-if-im-sshd-into-a-server)
* [3. Verify it worked](#3-verify-it-worked)
* [4. Run your first conversation](#4-run-your-first-conversation)
* [5. Pick the model you actually want](#5-pick-the-model-you-actually-want)
  + [Don't pick Hermes-4 for agent work](#dont-pick-hermes-4-for-agent-work)
* [6. (Optional) Customize Tool Gateway routing](#6-optional-customize-tool-gateway-routing)
* [7. (Optional) Enable voice mode](#7-optional-enable-voice-mode)
* [8. (Optional) Cron + always-on workflows](#8-optional-cron--always-on-workflows)
* [Profiles and multi-user setups](#profiles-and-multi-user-setups)
* [Troubleshooting](#troubleshooting)
  + [`hermes portal info` shows "not logged in" after `hermes setup --portal`](#hermes-portal-info-shows-not-logged-in-after-hermes-setup---portal)
  + ["Model: currently openrouter" (or some other provider) instead of "using Nous as inference provider"](#model-currently-openrouter-or-some-other-provider-instead-of-using-nous-as-inference-provider)
  ...
  + ["Re-authentication required" mid-session](#re-authentication-required-mid-session)
  + [Model I want isn't in the `/model` picker](#model-i-want-isnt-in-the-model-picker)
  + [Billing not appearing on my Portal account](#billing-not-appearing-on-my-portal-account)
  + [Want to revoke and start clean](#want-to-revoke-and-start-clean)
* [What this gets you, in plain numbers](#what-this-gets-you-in-plain-numbers)
* [See also](#see-also)
...
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/subscription-proxy](./docs-user-guide-features-subscription-proxy.md)
- [https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway](./docs-user-guide-features-tool-gateway.md)
