...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/tool-search](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/tool-search)
...
## When does it activate?[​](#when-does-it-activate "When does it activate?的直接链接")
...
## When NOT to use it[​](#when-not-to-use-it "When NOT to use it的直接链接")
...
## Trade-offs that don't go away[​](#trade-offs-that-dont-go-away "Trade-offs that don't go away的直接链接")
...
## Implementation details[​](#implementation-details "Implementation details的直接链接")
...
* [Trade-offs that don't go away](#trade-offs-that-dont-go-away)
