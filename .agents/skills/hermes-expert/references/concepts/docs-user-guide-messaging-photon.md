...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/photon](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/photon)
...
## Authorizing users[​](#authorizing-users "Direct link to Authorizing users")
...
### Require mentions in group chats[​](#require-mentions-in-group-chats "Direct link to Require mentions in group chats")
...
## Status & troubleshooting[​](#status--troubleshooting "Direct link to Status & troubleshooting")
...
## Limits today[​](#limits-today "Direct link to Limits today")
...
## Env vars[​](#env-vars "Direct link to Env vars")
