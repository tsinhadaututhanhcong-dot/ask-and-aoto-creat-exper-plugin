# 会话存储 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/session-storage](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/session-storage)
...
## SQLite Schema[​](#sqlite-schema "SQLite Schema的直接链接")

### Sessions 表[​](#sessions-表 "Sessions 表的直接链接")
...
### Messages 表[​](#messages-表 "Messages 表的直接链接")
...
### FTS5 全文搜索[​](#fts5-全文搜索 "FTS5 全文搜索的直接链接")
...
## Schema 版本与迁移[​](#schema-版本与迁移 "Schema 版本与迁移的直接链接")
...
### 查询：查找会话血缘[​](#查询查找会话血缘 "查询：查找会话血缘的直接链接")
...
### 查询：带预览的最近会话[​](#查询带预览的最近会话 "查询：带预览的最近会话的直接链接")
...
### 查询：Token 使用统计[​](#查询token-使用统计 "查询：Token 使用统计的直接链接")
...
* [会话血缘](#会话血缘)
  + [查询：查找会话血缘](#查询查找会话血缘)
  + [查询：带预览的最近会话](#查询带预览的最近会话)
  + [查询：Token 使用统计](#查询token-使用统计)
* [导出与清理](#导出与清理)
* [数据库位置](#数据库位置)