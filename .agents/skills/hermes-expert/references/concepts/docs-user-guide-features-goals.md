...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/goals](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals)
...
## Completion contracts[​](#completion-contracts "Direct link to Completion contracts")
...
### Two ways to set a contract[​](#two-ways-to-set-a-contract "Direct link to Two ways to set a contract")
...
## Adding criteria mid-goal: `/subgoal`[​](#adding-criteria-mid-goal-subgoal "Direct link to adding-criteria-mid-goal-subgoal")
...
## Parking on a background process: automatic, with a manual override[​](#parking-on-a-background-process-automatic-with-a-manual-override "Direct link to Parking on a background process: automatic, with a manual override")
...
* [Completion contracts](#completion-contracts)
  + [Two ways to set a contract](#two-ways-to-set-a-contract)
* [Adding criteria mid-goal: `/subgoal`](#adding-criteria-mid-goal-subgoal)
* [Parking on a background process: automatic, with a manual override](#parking-on-a-background-process-automatic-with-a-manual-override)
