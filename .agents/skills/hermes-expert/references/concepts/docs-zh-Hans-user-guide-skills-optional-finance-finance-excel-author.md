...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-excel-author](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-excel-author)
...
| 相关 skill | [`pptx-author`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-pptx-author)、[`dcf-model`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-dcf-model)、[`comps-analysis`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis)、[`lbo-model`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-lbo-model)、[`3-statement-model`](/docs/zh-Hans/user-guide/skills/optional/finance/finance-3-statement-model) |
...
## 核心约定（不可更改）[​](#核心约定不可更改 "核心约定（不可更改）的直接链接")

### 蓝/黑/绿单元格颜色[​](#蓝黑绿单元格颜色 "蓝/黑/绿单元格颜色的直接链接")
...
### 公式优先于硬编码[​](#公式优先于硬编码 "公式优先于硬编码的直接链接")
...
### 跨工作表引用使用命名范围[​](#跨工作表引用使用命名范围 "跨工作表引用使用命名范围的直接链接")
...
### 每个硬编码输入均添加单元格注释[​](#每个硬编码输入均添加单元格注释 "每个硬编码输入均添加单元格注释的直接链接")
...
## 骨架：典型财务模型[​](#骨架典型财务模型 "骨架：典型财务模型的直接链接")
...
## 带合并单元格的节标题[​](#带合并单元格的节标题 "带合并单元格的节标题的直接链接")
...
* [核心约定（不可更改）](#核心约定不可更改)
  + [蓝/黑/绿单元格颜色](#蓝黑绿单元格颜色)
  + [公式优先于硬编码](#公式优先于硬编码)
  + [跨工作表引用使用命名范围](#跨工作表引用使用命名范围)
  + [余额检查标签页](#余额检查标签页)
  + [每个硬编码输入均添加单元格注释](#每个硬编码输入均添加单元格注释)
* [骨架：典型财务模型](#骨架典型财务模型)
* [带合并单元格的节标题](#带合并单元格的节标题)
* [敏感性表格](#敏感性表格)
* [交付前重新计算](#交付前重新计算)
* [模型布局规划](#模型布局规划)
* [与用户逐步验证](#与用户逐步验证)
