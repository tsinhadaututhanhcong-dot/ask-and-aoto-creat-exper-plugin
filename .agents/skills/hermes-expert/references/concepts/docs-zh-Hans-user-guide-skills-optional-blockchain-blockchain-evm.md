# Evm — 只读 EVM 客户端：跨 8 条链的钱包、代币、Gas | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/blockchain/blockchain-evm](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/blockchain/blockchain-evm)
...
| 相关 skill | [`solana`](/docs/zh-Hans/user-guide/skills/optional/blockchain/blockchain-solana) |
...
### 1. 钱包投资组合[​](#1-钱包投资组合 "1. 钱包投资组合的直接链接")
...
### 3. 比较（Gas + 价格）[​](#3-比较gas--价格 "3. 比较（Gas + 价格）的直接链接")
...
### 4. 交易详情与解码[​](#4-交易详情与解码 "4. 交易详情与解码的直接链接")
...
### 5. ENS 解析[​](#5-ens-解析 "5. ENS 解析的直接链接")
...
### 6. 授权检查器（安全）[​](#6-授权检查器安全 "6. 授权检查器（安全）的直接链接")
...
### 9. Gas 追踪器[​](#9-gas-追踪器 "9. Gas 追踪器的直接链接")
...
* 公共 RPC 可能限速。生产环境请将 EVM\_RPC\_URL 设置为私有端点。
...
* [操作流程](#操作流程)
  ...
  + [1. 钱包投资组合](#1-钱包投资组合)
  + [2. 多链扫描](#2-多链扫描)
  + [3. 比较（Gas + 价格）](#3-比较gas--价格)
  + [4. 交易详情与解码](#4-交易详情与解码)
  + [5. ENS 解析](#5-ens-解析)
  + [6. 授权检查器（安全）](#6-授权检查器安全)
  + [7. 合约检查器](#7-合约检查器)
  + [8. 巨鲸检测](#8-巨鲸检测)
  + [9. Gas 追踪器](#9-gas-追踪器)
* [支持的链](#支持的链)
