...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode)
