...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/model-provider-plugin](https://hermes-agent.nousresearch.com/docs/developer-guide/model-provider-plugin)
...
| `default_max_tokens` | `int | None` | Provider-level max\_tokens cap (Nvidia: 16384) |
...
## api\_mode selection[​](#api_mode-selection "Direct link to api_mode selection")
...
* [api\_mode selection](#api_mode-selection)
