# Codex — 将编码任务委托给 OpenAI Codex CLI（功能开发、PR） | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex)
...
| 相关 skill | [`claude-code`](/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`hermes-agent`](/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) |
...
## 使用 Worktree 并行修复问题[​](#使用-worktree-并行修复问题 "使用 Worktree 并行修复问题的直接链接")
...
## 批量 PR 审查[​](#批量-pr-审查 "批量 PR 审查的直接链接")
...
* [关键标志](#关键标志)
* [PR 审查](#pr-审查)
* [使用 Worktree 并行修复问题](#使用-worktree-并行修复问题)
* [批量 PR 审查](#批量-pr-审查)
* [规则](#规则)
