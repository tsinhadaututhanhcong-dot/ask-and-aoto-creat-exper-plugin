...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/secrets/onepassword](https://hermes-agent.nousresearch.com/docs/user-guide/secrets/onepassword)
...
## Bootstrap token[​](#bootstrap-token "Direct link to Bootstrap token")
...
### 1. Install and sign in to `op`[​](#1-install-and-sign-in-to-op "Direct link to 1-install-and-sign-in-to-op")
...
### 2. Enable the integration[​](#2-enable-the-integration "Direct link to 2. Enable the integration")
...
### 3. Map your credentials[​](#3-map-your-credentials "Direct link to 3. Map your credentials")
...
### 4. Preview and confirm[​](#4-preview-and-confirm "Direct link to 4. Preview and confirm")
