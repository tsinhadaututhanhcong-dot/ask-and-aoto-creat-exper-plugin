# Shop — Shop.app：商品搜索、订单追踪、退货、重新下单 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-shop](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-shop)
...
| 相关 skill | [`shopify`](/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-shopify), [`maps`](/docs/zh-Hans/user-guide/skills/bundled/productivity/productivity-maps) |
...
## 商品搜索（无需认证）[​](#商品搜索无需认证 "商品搜索（无需认证）的直接链接")
...
## 认证 — 设备授权流程（RFC 8628）[​](#认证--设备授权流程rfc-8628 "认证 — 设备授权流程（RFC 8628）的直接链接")
...
## 构建结账 URL[​](#构建结账-url "构建结账 URL的直接链接")
...
## 虚拟试穿与可视化[​](#虚拟试穿与可视化 "虚拟试穿与可视化的直接链接")
...
## 成为顶级购物助手[​](#成为顶级购物助手 "成为顶级购物助手的直接链接")
...
* [商品搜索（无需认证）](#商品搜索无需认证)
* [查找相似商品](#查找相似商品)
* [认证 — 设备授权流程（RFC 8628）](#认证--设备授权流程rfc-8628)
  + [流程](#流程)
* [订单](#订单)
  + [获取模式](#获取模式)
  + [追踪详情](#追踪详情)
