...
**Source:** [https://hermes-agent.nousresearch.com/docs/developer-guide/architecture](https://hermes-agent.nousresearch.com/docs/developer-guide/architecture)
...
### Trajectories[​](#trajectories "Direct link to Trajectories")
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly](./docs-developer-guide-prompt-assembly.md)
...
- [https://hermes-agent.nousresearch.com/docs/developer-guide/tools-runtime](./docs-developer-guide-tools-runtime.md)
- [https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format](./docs-developer-guide-trajectory-format.md)
