# Openclaw Migration — 将用户的 OpenClaw 自定义配置迁移到 Hermes Agent | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration)
...
| 相关 skill | [`hermes-agent`](/docs/zh-Hans/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) |
...
## 此 skill 的功能[​](#此-skill-的功能 "此 skill 的功能的直接链接")
...
## 决策到命令的映射[​](#决策到命令的映射 "决策到命令的映射的直接链接")
...
## 迁移 preset[​](#迁移-preset "迁移 preset的直接链接")
