...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-merger-model](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-merger-model)
...
### Step 1: Gather Inputs[​](#step-1-gather-inputs "Direct link to Step 1: Gather Inputs")
...
### Step 2: Purchase Price Analysis[​](#step-2-purchase-price-analysis "Direct link to Step 2: Purchase Price Analysis")
...
### Step 3: Sources & Uses[​](#step-3-sources--uses "Direct link to Step 3: Sources & Uses")
...
### Step 4: Pro Forma EPS (Accretion / Dilution)[​](#step-4-pro-forma-eps-accretion--dilution "Direct link to Step 4: Pro Forma EPS (Accretion / Dilution)")
...
### Step 5: Sensitivity Analysis[​](#step-5-sensitivity-analysis "Direct link to Step 5: Sensitivity Analysis")
...
### Step 6: Breakeven Synergies[​](#step-6-breakeven-synergies "Direct link to Step 6: Breakeven Synergies")

Calculate the minimum synergies needed for the deal to be EPS-neutral in Year 1.

### Step 7: Output[​](#step-7-output "Direct link to Step 7: Output")
...
* [Workflow](#workflow)
  + [Step 1: Gather Inputs](#step-1-gather-inputs)
  + [Step 2: Purchase Price Analysis](#step-2-purchase-price-analysis)
  + [Step 3: Sources & Uses](#step-3-sources--uses)
  + [Step 4: Pro Forma EPS (Accretion / Dilution)](#step-4-pro-forma-eps-accretion--dilution)
  + [Step 5: Sensitivity Analysis](#step-5-sensitivity-analysis)
  + [Step 6: Breakeven Synergies](#step-6-breakeven-synergies)
