# Whisper — OpenAI 的通用语音识别模型 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-whisper](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-whisper)
...
## 何时使用 Whisper[​](#何时使用-whisper "何时使用 Whisper的直接链接")
...
### 初始 prompt（提示词）[​](#初始-prompt提示词 "初始 prompt（提示词）的直接链接")
...
### 从视频中提取音频[​](#从视频中提取音频 "从视频中提取音频的直接链接")
