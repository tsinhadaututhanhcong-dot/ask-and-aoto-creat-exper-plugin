# Dogfood — 网页应用探索性 QA：发现缺陷、收集证据、生成报告 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/dogfood/dogfood-dogfood](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/dogfood/dogfood-dogfood)
...
### 阶段 3：收集证据[​](#阶段-3收集证据 "阶段 3：收集证据的直接链接")
...
### 阶段 4：分类整理[​](#阶段-4分类整理 "阶段 4：分类整理的直接链接")
