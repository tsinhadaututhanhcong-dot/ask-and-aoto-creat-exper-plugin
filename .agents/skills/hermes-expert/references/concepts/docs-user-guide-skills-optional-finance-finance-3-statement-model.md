...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-3-statement-model](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-3-statement-model)
...
## ⚠️ CRITICAL PRINCIPLES — Read Before Populating Any Template[​](#️-critical-principles--read-before-populating-any-template "Direct link to ⚠️ CRITICAL PRINCIPLES — Read Before Populating Any Template")
...
## Formatting — Professional Blue/Grey Palette (Default unless template/user specifies otherwise)[​](#formatting--professional-bluegrey-palette-default-unless-templateuser-specifies-otherwise "Direct link to Formatting — Professional Blue/Grey Palette (Default unless template/user specifies otherwise)")
...
## Model Structure[​](#model-structure "Direct link to Model Structure")

### Identifying Template Tab Organization[​](#identifying-template-tab-organization "Direct link to Identifying Template Tab Organization")
...
### Understanding Template Structure[​](#understanding-template-structure "Direct link to Understanding Template Structure")
...
### Projection Period[​](#projection-period "Direct link to Projection Period")
...
## Margin Analysis[​](#margin-analysis "Direct link to Margin Analysis")
...
### Core Margins to Include[​](#core-margins-to-include "Direct link to Core Margins to Include")
...
### Income Statement Layout with Margins[​](#income-statement-layout-with-margins "Direct link to Income Statement Layout with Margins")
...
## Credit Metrics[​](#credit-metrics "Direct link to Credit Metrics")
...
### Core Credit Metrics to Include[​](#core-credit-metrics-to-include "Direct link to Core Credit Metrics to Include")
...
### Credit Metric Hierarchy Checks[​](#credit-metric-hierarchy-checks "Direct link to Credit Metric Hierarchy Checks")
...
### Covenant Compliance Tracking[​](#covenant-compliance-tracking "Direct link to Covenant Compliance Tracking")

If debt covenants are known, add explicit compliance checks comparing actual metrics to covenant thresholds.

## Scenario Analysis (Base / Upside / Downside)[​](#scenario-analysis-base--upside--downside "Direct link to Scenario Analysis (Base / Upside / Downside)")
...
## SEC Filings Data Extraction[​](#sec-filings-data-extraction "Direct link to SEC Filings Data Extraction")
...
## Completing Model Templates[​](#completing-model-templates "Direct link to Completing Model Templates")
...
### Step 1: Analyze the Template Structure[​](#step-1-analyze-the-template-structure "Direct link to Step 1: Analyze the Template Structure")
...
### Step 2: Filling in Data Without Breaking Formulas[​](#step-2-filling-in-data-without-breaking-formulas "Direct link to Step 2: Filling in Data Without Breaking Formulas")
...
### Step 3: Validating Formulas[​](#step-3-validating-formulas "Direct link to Step 3: Validating Formulas")
...
### Step 4: Quality Checks by Sheet[​](#step-4-quality-checks-by-sheet "Direct link to Step 4: Quality Checks by Sheet")
...
### Step 5: Cross-Statement Integrity Checks[​](#step-5-cross-statement-integrity-checks "Direct link to Step 5: Cross-Statement Integrity Checks")
...
### Step 6: Final Review[​](#step-6-final-review "Direct link to Step 6: Final Review")
...
## Model Validation and Audit[​](#model-validation-and-audit "Direct link to Model Validation and Audit")

This section consolidates all validation checks and audit procedures for completed templates.

### Core Linkages (Must Always Hold)[​](#core-linkages-must-always-hold "Direct link to Core Linkages (Must Always Hold)")
...
### Sign Convention Reference[​](#sign-convention-reference "Direct link to Sign Convention Reference")
...
### Circular Reference Handling[​](#circular-reference-handling "Direct link to Circular Reference Handling")
...
### Check Categories[​](#check-categories "Direct link to Check Categories")
...
### Master Check Formula[​](#master-check-formula "Direct link to Master Check Formula")
...
### Quick Debug Workflow[​](#quick-debug-workflow "Direct link to Quick Debug Workflow")
...
* [⚠️ CRITICAL PRINCIPLES — Read Before Populating Any Template](#️-critical-principles--read-before-populating-any-template)
* [Formatting — Professional Blue/Grey Palette (Default unless template/user specifies otherwise)](#formatting--professional-bluegrey-palette-default-unless-templateuser-specifies-otherwise)
* [Model Structure](#model-structure)
  + [Identifying Template Tab Organization](#identifying-template-tab-organization)
...
* [Margin Analysis](#margin-analysis)
  + [Core Margins to Include](#core-margins-to-include)
  + [Income Statement Layout with Margins](#income-statement-layout-with-margins)
* [Credit Metrics](#credit-metrics)
  + [Core Credit Metrics to Include](#core-credit-metrics-to-include)
  + [Credit Metric Hierarchy Checks](#credit-metric-hierarchy-checks)
  + [Covenant Compliance Tracking](#covenant-compliance-tracking)
* [Scenario Analysis (Base / Upside / Downside)](#scenario-analysis-base--upside--downside)
* [SEC Filings Data Extraction](#sec-filings-data-extraction)
* [Completing Model Templates](#completing-model-templates)
  + [Step 1: Analyze the Template Structure](#step-1-analyze-the-template-structure)
  + [Step 2: Filling in Data Without Breaking Formulas](#step-2-filling-in-data-without-breaking-formulas)
  + [Step 3: Validating Formulas](#step-3-validating-formulas)
  + [Step 4: Quality Checks by Sheet](#step-4-quality-checks-by-sheet)
  + [Step 5: Cross-Statement Integrity Checks](#step-5-cross-statement-integrity-checks)
  + [Step 6: Final Review](#step-6-final-review)
* [Model Validation and Audit](#model-validation-and-audit)
  + [Core Linkages (Must Always Hold)](#core-linkages-must-always-hold)
  ...
  + [Master Check Formula](#master-check-formula)
  + [Quick Debug Workflow](#quick-debug-workflow)
