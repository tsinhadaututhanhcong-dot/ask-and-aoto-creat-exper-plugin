...
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/security/security-unbroker](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/security/security-unbroker)
...
| Related skills | [`google-workspace`](/docs/zh-Hans/docs/user-guide/skills/bundled/productivity/productivity-google-workspace), [`agentmail`](/docs/zh-Hans/docs/user-guide/skills/optional/email/email-agentmail), [`himalaya`](/docs/zh-Hans/docs/user-guide/skills/bundled/email/email-himalaya), [`scrapling`](/docs/zh-Hans/docs/user-guide/skills/optional/research/research-scrapling), [`osint-investigation`](/docs/zh-Hans/docs/user-guide/skills/optional/research/research-osint-investigation) |
...
## Autonomy contract[​](#autonomy-contract "Autonomy contract的直接链接")
...
## Batch operation (two-phase: crawl-all, then delete)[​](#batch-operation-two-phase-crawl-all-then-delete "Batch operation (two-phase: crawl-all, then delete)的直接链接")
...
## Procedure (the autonomous loop)[​](#procedure-the-autonomous-loop "Procedure (the autonomous loop)的直接链接")
