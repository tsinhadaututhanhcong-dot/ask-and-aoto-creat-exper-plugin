# Sketch — 一次性 HTML 原型：2-3 个设计方案对比 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-sketch](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-sketch)
...
| 相关 skill | [`spike`](/docs/zh-Hans/user-guide/skills/bundled/software-development/software-development-spike), [`claude-design`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-claude-design), [`popular-web-designs`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-popular-web-designs), [`excalidraw`](/docs/zh-Hans/user-guide/skills/bundled/creative/creative-excalidraw) |
...
## 如果用户安装了完整的 GSD 系统[​](#如果用户安装了完整的-gsd-系统 "如果用户安装了完整的 GSD 系统的直接链接")
...
### 1. Intake（如果用户已提供足够信息则跳过）[​](#1-intake如果用户已提供足够信息则跳过 "1. Intake（如果用户已提供足够信息则跳过）的直接链接")
...
### 2. 方案（2-3 个，不少于 1 个，极少超过 4 个）[​](#2-方案2-3-个不少于-1-个极少超过-4-个 "2. 方案（2-3 个，不少于 1 个，极少超过 4 个）的直接链接")
...
### 3. 制作真实的 HTML[​](#3-制作真实的-html "3. 制作真实的 HTML的直接链接")
...
### 4. 方案 README[​](#4-方案-readme "4. 方案 README的直接链接")
...
## 主题化（当项目有视觉标识时）[​](#主题化当项目有视觉标识时 "主题化（当项目有视觉标识时）的直接链接")
...
## 前沿模式（决定下一步草图内容）[​](#前沿模式决定下一步草图内容 "前沿模式（决定下一步草图内容）的直接链接")
...
* [不适用场景](#不适用场景)
* [如果用户安装了完整的 GSD 系统](#如果用户安装了完整的-gsd-系统)
* [核心方法](#核心方法)
  + [1. Intake（如果用户已提供足够信息则跳过）](#1-intake如果用户已提供足够信息则跳过)
  + [2. 方案（2-3 个，不少于 1 个，极少超过 4 个）](#2-方案2-3-个不少于-1-个极少超过-4-个)
  + [3. 制作真实的 HTML](#3-制作真实的-html)
  + [4. 方案 README](#4-方案-readme)
  + [5. 正面对比](#5-正面对比)
* [主题化（当项目有视觉标识时）](#主题化当项目有视觉标识时)
* [交互基准](#交互基准)
* [前沿模式（决定下一步草图内容）](#前沿模式决定下一步草图内容)
* [输出](#输出)
* [致谢](#致谢)
