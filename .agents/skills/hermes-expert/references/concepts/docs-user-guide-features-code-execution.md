...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/features/code-execution](https://hermes-agent.nousresearch.com/docs/user-guide/features/code-execution)
...
### `HERMES_*` variables in the child[​](#hermes_-variables-in-the-child "Direct link to hermes_-variables-in-the-child")
...
## execute\_code vs terminal[​](#execute_code-vs-terminal "Direct link to execute_code vs terminal")
...
* [Security](#security)
  ...
  + [`HERMES_*` variables in the child](#hermes_-variables-in-the-child)
* [execute\_code vs terminal](#execute_code-vs-terminal)
