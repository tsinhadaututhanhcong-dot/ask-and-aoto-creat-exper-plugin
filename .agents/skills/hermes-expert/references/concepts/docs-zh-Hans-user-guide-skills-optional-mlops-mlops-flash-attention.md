# 优化注意力 Flash | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-flash-attention](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-flash-attention)
...
### 工作流 1：在现有 PyTorch 模型中启用[​](#工作流-1在现有-pytorch-模型中启用 "工作流 1：在现有 PyTorch 模型中启用的直接链接")
...
### 工作流 2：使用 flash-attn 库实现高级功能[​](#工作流-2使用-flash-attn-库实现高级功能 "工作流 2：使用 flash-attn 库实现高级功能的直接链接")
...
### 工作流 3：H100 FP8 优化（FlashAttention-3）[​](#工作流-3h100-fp8-优化flashattention-3 "工作流 3：H100 FP8 优化（FlashAttention-3）的直接链接")
...
## 何时使用与替代方案[​](#何时使用与替代方案 "何时使用与替代方案的直接链接")
...
**问题：ImportError: cannot import flash\_attn**
...
* [快速开始](#快速开始)
* [常见工作流](#常见工作流)
  + [工作流 1：在现有 PyTorch 模型中启用](#工作流-1在现有-pytorch-模型中启用)
  + [工作流 2：使用 flash-attn 库实现高级功能](#工作流-2使用-flash-attn-库实现高级功能)
  + [工作流 3：H100 FP8 优化（FlashAttention-3）](#工作流-3h100-fp8-优化flashattention-3)
* [何时使用与替代方案](#何时使用与替代方案)
* [常见问题](#常见问题)
* [高级主题](#高级主题)
* [硬件要求](#硬件要求)
