# Apple Notes — 通过 memo CLI 管理 Apple Notes：创建、搜索、编辑 | Hermes Agent
**Source:** [https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/apple/apple-apple-notes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/apple/apple-apple-notes)
...
| 相关 skill | [`obsidian`](/docs/zh-Hans/user-guide/skills/bundled/note-taking/note-taking-obsidian) |
