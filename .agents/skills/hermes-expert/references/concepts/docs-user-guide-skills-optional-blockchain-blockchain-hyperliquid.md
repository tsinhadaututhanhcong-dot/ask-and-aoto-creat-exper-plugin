...
**Source:** [https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-hyperliquid](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-hyperliquid)
...
### 1. Discover DEXs and Markets[​](#1-discover-dexs-and-markets "Direct link to 1. Discover DEXs and Markets")
...
### 2. Pull Historical Market Data[​](#2-pull-historical-market-data "Direct link to 2. Pull Historical Market Data")
...
### 3. Inspect Live Order Book[​](#3-inspect-live-order-book "Direct link to 3. Inspect Live Order Book")
...
### 4. Review an Account[​](#4-review-an-account "Direct link to 4. Review an Account")
...
### 5. Review Fills and Orders[​](#5-review-fills-and-orders "Direct link to 5. Review Fills and Orders")
...
### 6. Generate a Trade Review[​](#6-generate-a-trade-review "Direct link to 6. Generate a Trade Review")
...
### 7. Export a Reusable Dataset[​](#7-export-a-reusable-dataset "Direct link to 7. Export a Reusable Dataset")
...
* [Procedure](#procedure)
  ...
  + [3. Inspect Live Order Book](#3-inspect-live-order-book)
  + [4. Review an Account](#4-review-an-account)
  + [5. Review Fills and Orders](#5-review-fills-and-orders)
  + [6. Generate a Trade Review](#6-generate-a-trade-review)
  + [7. Export a Reusable Dataset](#7-export-a-reusable-dataset)
* [Pitfalls](#pitfalls)
